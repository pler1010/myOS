...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	63d040ef          	jal	ra,ffffffffc0204e86 <memset>
...
ffffffffc0200056:	e8658593          	addi	a1,a1,-378 # ffffffffc0204ed8 <etext+0x4>
ffffffffc020005a:	00005517          	auipc	a0,0x5
ffffffffc020005e:	e9e50513          	addi	a0,a0,-354 # ffffffffc0204ef8 <etext+0x24>
...
ffffffffc020007a:	5c2040ef          	jal	ra,ffffffffc020463c <proc_init>
...
ffffffffc020008e:	02d040ef          	jal	ra,ffffffffc02048ba <cpu_idle>
...
ffffffffc02000ac:	e5850513          	addi	a0,a0,-424 # ffffffffc0204f00 <etext+0x2c>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	115040ef          	jal	ra,ffffffffc0204a88 <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	0df040ef          	jal	ra,ffffffffc0204a88 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001ce:	d3e50513          	addi	a0,a0,-706 # ffffffffc0204f08 <etext+0x34>
void print_kerninfo(void) {
...
ffffffffc02001e4:	d4850513          	addi	a0,a0,-696 # ffffffffc0204f28 <etext+0x54>
ffffffffc02001e8:	f99ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001ec:	00005597          	auipc	a1,0x5
ffffffffc02001f0:	ce858593          	addi	a1,a1,-792 # ffffffffc0204ed4 <etext>
ffffffffc02001f4:	00005517          	auipc	a0,0x5
ffffffffc02001f8:	d5450513          	addi	a0,a0,-684 # ffffffffc0204f48 <etext+0x74>
...
ffffffffc020020c:	d6050513          	addi	a0,a0,-672 # ffffffffc0204f68 <etext+0x94>
...
ffffffffc0200220:	d6c50513          	addi	a0,a0,-660 # ffffffffc0204f88 <etext+0xb4>
...
ffffffffc020024e:	d5e50513          	addi	a0,a0,-674 # ffffffffc0204fa8 <etext+0xd4>
}
...
ffffffffc020025c:	d8060613          	addi	a2,a2,-640 # ffffffffc0204fd8 <etext+0x104>
ffffffffc0200260:	04d00593          	li	a1,77
ffffffffc0200264:	00005517          	auipc	a0,0x5
ffffffffc0200268:	d8c50513          	addi	a0,a0,-628 # ffffffffc0204ff0 <etext+0x11c>
void print_stackframe(void) {
...
ffffffffc0200278:	d9460613          	addi	a2,a2,-620 # ffffffffc0205008 <etext+0x134>
ffffffffc020027c:	00005597          	auipc	a1,0x5
ffffffffc0200280:	dac58593          	addi	a1,a1,-596 # ffffffffc0205028 <etext+0x154>
ffffffffc0200284:	00005517          	auipc	a0,0x5
ffffffffc0200288:	dac50513          	addi	a0,a0,-596 # ffffffffc0205030 <etext+0x15c>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200296:	dae60613          	addi	a2,a2,-594 # ffffffffc0205040 <etext+0x16c>
ffffffffc020029a:	00005597          	auipc	a1,0x5
ffffffffc020029e:	dce58593          	addi	a1,a1,-562 # ffffffffc0205068 <etext+0x194>
ffffffffc02002a2:	00005517          	auipc	a0,0x5
ffffffffc02002a6:	d8e50513          	addi	a0,a0,-626 # ffffffffc0205030 <etext+0x15c>
ffffffffc02002aa:	ed7ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ae:	00005617          	auipc	a2,0x5
ffffffffc02002b2:	dca60613          	addi	a2,a2,-566 # ffffffffc0205078 <etext+0x1a4>
ffffffffc02002b6:	00005597          	auipc	a1,0x5
ffffffffc02002ba:	de258593          	addi	a1,a1,-542 # ffffffffc0205098 <etext+0x1c4>
ffffffffc02002be:	00005517          	auipc	a0,0x5
ffffffffc02002c2:	d7250513          	addi	a0,a0,-654 # ffffffffc0205030 <etext+0x15c>
...
ffffffffc02002fc:	db050513          	addi	a0,a0,-592 # ffffffffc02050a8 <etext+0x1d4>
kmonitor(struct trapframe *tf) {
...
ffffffffc020031e:	db650513          	addi	a0,a0,-586 # ffffffffc02050d0 <etext+0x1fc>
...
ffffffffc0200340:	e04c0c13          	addi	s8,s8,-508 # ffffffffc0205140 <commands>
        if ((buf = readline("K> ")) != NULL) {
ffffffffc0200344:	00005917          	auipc	s2,0x5
ffffffffc0200348:	db490913          	addi	s2,s2,-588 # ffffffffc02050f8 <etext+0x224>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020034c:	00005497          	auipc	s1,0x5
ffffffffc0200350:	db448493          	addi	s1,s1,-588 # ffffffffc0205100 <etext+0x22c>
        if (argc == MAXARGS - 1) {
ffffffffc0200354:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200356:	00005b17          	auipc	s6,0x5
ffffffffc020035a:	db2b0b13          	addi	s6,s6,-590 # ffffffffc0205108 <etext+0x234>
        argv[argc ++] = buf;
ffffffffc020035e:	00005a17          	auipc	s4,0x5
ffffffffc0200362:	ccaa0a13          	addi	s4,s4,-822 # ffffffffc0205028 <etext+0x154>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc0200384:	dc0d0d13          	addi	s10,s10,-576 # ffffffffc0205140 <commands>
        argv[argc ++] = buf;
...
ffffffffc020038c:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc020038e:	2c5040ef          	jal	ra,ffffffffc0204e52 <strcmp>
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	2b1040ef          	jal	ra,ffffffffc0204e52 <strcmp>
...
ffffffffc02003e0:	291040ef          	jal	ra,ffffffffc0204e70 <strchr>
...
ffffffffc020041e:	253040ef          	jal	ra,ffffffffc0204e70 <strchr>
...
ffffffffc020043c:	cf050513          	addi	a0,a0,-784 # ffffffffc0205128 <etext+0x254>
...
ffffffffc0200478:	d1450513          	addi	a0,a0,-748 # ffffffffc0205188 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc020048e:	c6e50513          	addi	a0,a0,-914 # ffffffffc02060f8 <default_pmm_manager+0x4d0>
...
ffffffffc02004cc:	ce050513          	addi	a0,a0,-800 # ffffffffc02051a8 <commands+0x68>
    ticks = 0;
...
ffffffffc020058a:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc020058c:	10d040ef          	jal	ra,ffffffffc0204e98 <memcpy>
    return 0;
}
...
ffffffffc02005ae:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005b0:	0e9040ef          	jal	ra,ffffffffc0204e98 <memcpy>
    return 0;
}
...
ffffffffc02005fe:	bce50513          	addi	a0,a0,-1074 # ffffffffc02051c8 <commands+0x88>
...
ffffffffc0200626:	bc660613          	addi	a2,a2,-1082 # ffffffffc02051e8 <commands+0xa8>
ffffffffc020062a:	06200593          	li	a1,98
ffffffffc020062e:	00005517          	auipc	a0,0x5
ffffffffc0200632:	bd250513          	addi	a0,a0,-1070 # ffffffffc0205200 <commands+0xc0>
...
ffffffffc0200660:	bbc50513          	addi	a0,a0,-1092 # ffffffffc0205218 <commands+0xd8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200670:	bc450513          	addi	a0,a0,-1084 # ffffffffc0205230 <commands+0xf0>
...
ffffffffc020067e:	bce50513          	addi	a0,a0,-1074 # ffffffffc0205248 <commands+0x108>
...
ffffffffc020068c:	bd850513          	addi	a0,a0,-1064 # ffffffffc0205260 <commands+0x120>
...
ffffffffc020069a:	be250513          	addi	a0,a0,-1054 # ffffffffc0205278 <commands+0x138>
...
ffffffffc02006a8:	bec50513          	addi	a0,a0,-1044 # ffffffffc0205290 <commands+0x150>
...
ffffffffc02006b6:	bf650513          	addi	a0,a0,-1034 # ffffffffc02052a8 <commands+0x168>
...
ffffffffc02006c4:	c0050513          	addi	a0,a0,-1024 # ffffffffc02052c0 <commands+0x180>
...
ffffffffc02006d2:	c0a50513          	addi	a0,a0,-1014 # ffffffffc02052d8 <commands+0x198>
...
ffffffffc02006e0:	c1450513          	addi	a0,a0,-1004 # ffffffffc02052f0 <commands+0x1b0>
...
ffffffffc02006ee:	c1e50513          	addi	a0,a0,-994 # ffffffffc0205308 <commands+0x1c8>
...
ffffffffc02006fc:	c2850513          	addi	a0,a0,-984 # ffffffffc0205320 <commands+0x1e0>
...
ffffffffc020070a:	c3250513          	addi	a0,a0,-974 # ffffffffc0205338 <commands+0x1f8>
...
ffffffffc0200718:	c3c50513          	addi	a0,a0,-964 # ffffffffc0205350 <commands+0x210>
...
ffffffffc0200726:	c4650513          	addi	a0,a0,-954 # ffffffffc0205368 <commands+0x228>
...
ffffffffc0200734:	c5050513          	addi	a0,a0,-944 # ffffffffc0205380 <commands+0x240>
...
ffffffffc0200742:	c5a50513          	addi	a0,a0,-934 # ffffffffc0205398 <commands+0x258>
...
ffffffffc0200750:	c6450513          	addi	a0,a0,-924 # ffffffffc02053b0 <commands+0x270>
...
ffffffffc020075e:	c6e50513          	addi	a0,a0,-914 # ffffffffc02053c8 <commands+0x288>
...
ffffffffc020076c:	c7850513          	addi	a0,a0,-904 # ffffffffc02053e0 <commands+0x2a0>
...
ffffffffc020077a:	c8250513          	addi	a0,a0,-894 # ffffffffc02053f8 <commands+0x2b8>
...
ffffffffc0200788:	c8c50513          	addi	a0,a0,-884 # ffffffffc0205410 <commands+0x2d0>
...
ffffffffc0200796:	c9650513          	addi	a0,a0,-874 # ffffffffc0205428 <commands+0x2e8>
...
ffffffffc02007a4:	ca050513          	addi	a0,a0,-864 # ffffffffc0205440 <commands+0x300>
...
ffffffffc02007b2:	caa50513          	addi	a0,a0,-854 # ffffffffc0205458 <commands+0x318>
ffffffffc02007b6:	9cbff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  s9       0x%08x\n", gpr->s9);
ffffffffc02007ba:	646c                	ld	a1,200(s0)
ffffffffc02007bc:	00005517          	auipc	a0,0x5
ffffffffc02007c0:	cb450513          	addi	a0,a0,-844 # ffffffffc0205470 <commands+0x330>
...
ffffffffc02007ce:	cbe50513          	addi	a0,a0,-834 # ffffffffc0205488 <commands+0x348>
...
ffffffffc02007dc:	cc850513          	addi	a0,a0,-824 # ffffffffc02054a0 <commands+0x360>
...
ffffffffc02007ea:	cd250513          	addi	a0,a0,-814 # ffffffffc02054b8 <commands+0x378>
...
ffffffffc02007f8:	cdc50513          	addi	a0,a0,-804 # ffffffffc02054d0 <commands+0x390>
...
ffffffffc0200806:	ce650513          	addi	a0,a0,-794 # ffffffffc02054e8 <commands+0x3a8>
...
ffffffffc0200818:	cec50513          	addi	a0,a0,-788 # ffffffffc0205500 <commands+0x3c0>
}
...
ffffffffc020082c:	cf050513          	addi	a0,a0,-784 # ffffffffc0205518 <commands+0x3d8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200844:	cf050513          	addi	a0,a0,-784 # ffffffffc0205530 <commands+0x3f0>
...
ffffffffc0200854:	cf850513          	addi	a0,a0,-776 # ffffffffc0205548 <commands+0x408>
...
ffffffffc0200864:	d0050513          	addi	a0,a0,-768 # ffffffffc0205560 <commands+0x420>
...
ffffffffc0200878:	d0450513          	addi	a0,a0,-764 # ffffffffc0205578 <commands+0x438>
}
...
ffffffffc0200894:	db070713          	addi	a4,a4,-592 # ffffffffc0205640 <commands+0x500>
...
ffffffffc02008a6:	d4e50513          	addi	a0,a0,-690 # ffffffffc02055f0 <commands+0x4b0>
ffffffffc02008aa:	8d7ff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02008ae:	00005517          	auipc	a0,0x5
ffffffffc02008b2:	d2250513          	addi	a0,a0,-734 # ffffffffc02055d0 <commands+0x490>
ffffffffc02008b6:	8cbff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02008ba:	00005517          	auipc	a0,0x5
ffffffffc02008be:	cd650513          	addi	a0,a0,-810 # ffffffffc0205590 <commands+0x450>
ffffffffc02008c2:	8bfff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02008c6:	00005517          	auipc	a0,0x5
ffffffffc02008ca:	cea50513          	addi	a0,a0,-790 # ffffffffc02055b0 <commands+0x470>
...
ffffffffc02008fc:	d2850513          	addi	a0,a0,-728 # ffffffffc0205620 <commands+0x4e0>
...
ffffffffc0200910:	d0450513          	addi	a0,a0,-764 # ffffffffc0205610 <commands+0x4d0>
}
...
ffffffffc0200932:	efa70713          	addi	a4,a4,-262 # ffffffffc0205828 <commands+0x6e8>
...
ffffffffc0200944:	ed050513          	addi	a0,a0,-304 # ffffffffc0205810 <commands+0x6d0>
...
ffffffffc0200966:	d0e50513          	addi	a0,a0,-754 # ffffffffc0205670 <commands+0x530>
}
...
ffffffffc02009c0:	d5460613          	addi	a2,a2,-684 # ffffffffc0205710 <commands+0x5d0>
ffffffffc02009c4:	0b300593          	li	a1,179
ffffffffc02009c8:	00005517          	auipc	a0,0x5
ffffffffc02009cc:	83850513          	addi	a0,a0,-1992 # ffffffffc0205200 <commands+0xc0>
ffffffffc02009d0:	a77ff0ef          	jal	ra,ffffffffc0200446 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc02009d4:	00005517          	auipc	a0,0x5
ffffffffc02009d8:	d5c50513          	addi	a0,a0,-676 # ffffffffc0205730 <commands+0x5f0>
ffffffffc02009dc:	b779                	j	ffffffffc020096a <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc02009de:	00005517          	auipc	a0,0x5
ffffffffc02009e2:	d6a50513          	addi	a0,a0,-662 # ffffffffc0205748 <commands+0x608>
...
ffffffffc0200a6a:	caa60613          	addi	a2,a2,-854 # ffffffffc0205710 <commands+0x5d0>
ffffffffc0200a6e:	0d300593          	li	a1,211
ffffffffc0200a72:	00004517          	auipc	a0,0x4
ffffffffc0200a76:	78e50513          	addi	a0,a0,1934 # ffffffffc0205200 <commands+0xc0>
...
ffffffffc0200a96:	c7e60613          	addi	a2,a2,-898 # ffffffffc0205710 <commands+0x5d0>
ffffffffc0200a9a:	0da00593          	li	a1,218
ffffffffc0200a9e:	00004517          	auipc	a0,0x4
ffffffffc0200aa2:	76250513          	addi	a0,a0,1890 # ffffffffc0205200 <commands+0xc0>
...
ffffffffc0200c2e:	3f663603          	ld	a2,1014(a2) # ffffffffc0207020 <nbase>
...
ffffffffc0200e74:	9f868693          	addi	a3,a3,-1544 # ffffffffc0205868 <commands+0x728>
ffffffffc0200e78:	00005617          	auipc	a2,0x5
ffffffffc0200e7c:	a0060613          	addi	a2,a2,-1536 # ffffffffc0205878 <commands+0x738>
ffffffffc0200e80:	0f000593          	li	a1,240
ffffffffc0200e84:	00005517          	auipc	a0,0x5
ffffffffc0200e88:	a0c50513          	addi	a0,a0,-1524 # ffffffffc0205890 <commands+0x750>
ffffffffc0200e8c:	dbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200e90:	00005697          	auipc	a3,0x5
ffffffffc0200e94:	a9868693          	addi	a3,a3,-1384 # ffffffffc0205928 <commands+0x7e8>
ffffffffc0200e98:	00005617          	auipc	a2,0x5
ffffffffc0200e9c:	9e060613          	addi	a2,a2,-1568 # ffffffffc0205878 <commands+0x738>
ffffffffc0200ea0:	0bd00593          	li	a1,189
ffffffffc0200ea4:	00005517          	auipc	a0,0x5
ffffffffc0200ea8:	9ec50513          	addi	a0,a0,-1556 # ffffffffc0205890 <commands+0x750>
ffffffffc0200eac:	d9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200eb0:	00005697          	auipc	a3,0x5
ffffffffc0200eb4:	aa068693          	addi	a3,a3,-1376 # ffffffffc0205950 <commands+0x810>
ffffffffc0200eb8:	00005617          	auipc	a2,0x5
ffffffffc0200ebc:	9c060613          	addi	a2,a2,-1600 # ffffffffc0205878 <commands+0x738>
ffffffffc0200ec0:	0be00593          	li	a1,190
ffffffffc0200ec4:	00005517          	auipc	a0,0x5
ffffffffc0200ec8:	9cc50513          	addi	a0,a0,-1588 # ffffffffc0205890 <commands+0x750>
ffffffffc0200ecc:	d7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200ed0:	00005697          	auipc	a3,0x5
ffffffffc0200ed4:	ac068693          	addi	a3,a3,-1344 # ffffffffc0205990 <commands+0x850>
ffffffffc0200ed8:	00005617          	auipc	a2,0x5
ffffffffc0200edc:	9a060613          	addi	a2,a2,-1632 # ffffffffc0205878 <commands+0x738>
ffffffffc0200ee0:	0c000593          	li	a1,192
ffffffffc0200ee4:	00005517          	auipc	a0,0x5
ffffffffc0200ee8:	9ac50513          	addi	a0,a0,-1620 # ffffffffc0205890 <commands+0x750>
ffffffffc0200eec:	d5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200ef0:	00005697          	auipc	a3,0x5
ffffffffc0200ef4:	b2868693          	addi	a3,a3,-1240 # ffffffffc0205a18 <commands+0x8d8>
ffffffffc0200ef8:	00005617          	auipc	a2,0x5
ffffffffc0200efc:	98060613          	addi	a2,a2,-1664 # ffffffffc0205878 <commands+0x738>
ffffffffc0200f00:	0d900593          	li	a1,217
ffffffffc0200f04:	00005517          	auipc	a0,0x5
ffffffffc0200f08:	98c50513          	addi	a0,a0,-1652 # ffffffffc0205890 <commands+0x750>
ffffffffc0200f0c:	d3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f10:	00005697          	auipc	a3,0x5
ffffffffc0200f14:	9b868693          	addi	a3,a3,-1608 # ffffffffc02058c8 <commands+0x788>
ffffffffc0200f18:	00005617          	auipc	a2,0x5
ffffffffc0200f1c:	96060613          	addi	a2,a2,-1696 # ffffffffc0205878 <commands+0x738>
ffffffffc0200f20:	0d200593          	li	a1,210
ffffffffc0200f24:	00005517          	auipc	a0,0x5
ffffffffc0200f28:	96c50513          	addi	a0,a0,-1684 # ffffffffc0205890 <commands+0x750>
ffffffffc0200f2c:	d1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 3);
ffffffffc0200f30:	00005697          	auipc	a3,0x5
ffffffffc0200f34:	ad868693          	addi	a3,a3,-1320 # ffffffffc0205a08 <commands+0x8c8>
ffffffffc0200f38:	00005617          	auipc	a2,0x5
ffffffffc0200f3c:	94060613          	addi	a2,a2,-1728 # ffffffffc0205878 <commands+0x738>
ffffffffc0200f40:	0d000593          	li	a1,208
ffffffffc0200f44:	00005517          	auipc	a0,0x5
ffffffffc0200f48:	94c50513          	addi	a0,a0,-1716 # ffffffffc0205890 <commands+0x750>
ffffffffc0200f4c:	cfaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f50:	00005697          	auipc	a3,0x5
ffffffffc0200f54:	aa068693          	addi	a3,a3,-1376 # ffffffffc02059f0 <commands+0x8b0>
ffffffffc0200f58:	00005617          	auipc	a2,0x5
ffffffffc0200f5c:	92060613          	addi	a2,a2,-1760 # ffffffffc0205878 <commands+0x738>
ffffffffc0200f60:	0cb00593          	li	a1,203
ffffffffc0200f64:	00005517          	auipc	a0,0x5
ffffffffc0200f68:	92c50513          	addi	a0,a0,-1748 # ffffffffc0205890 <commands+0x750>
ffffffffc0200f6c:	cdaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200f70:	00005697          	auipc	a3,0x5
ffffffffc0200f74:	a6068693          	addi	a3,a3,-1440 # ffffffffc02059d0 <commands+0x890>
ffffffffc0200f78:	00005617          	auipc	a2,0x5
ffffffffc0200f7c:	90060613          	addi	a2,a2,-1792 # ffffffffc0205878 <commands+0x738>
ffffffffc0200f80:	0c200593          	li	a1,194
ffffffffc0200f84:	00005517          	auipc	a0,0x5
ffffffffc0200f88:	90c50513          	addi	a0,a0,-1780 # ffffffffc0205890 <commands+0x750>
ffffffffc0200f8c:	cbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 != NULL);
ffffffffc0200f90:	00005697          	auipc	a3,0x5
ffffffffc0200f94:	ad068693          	addi	a3,a3,-1328 # ffffffffc0205a60 <commands+0x920>
ffffffffc0200f98:	00005617          	auipc	a2,0x5
ffffffffc0200f9c:	8e060613          	addi	a2,a2,-1824 # ffffffffc0205878 <commands+0x738>
ffffffffc0200fa0:	0f800593          	li	a1,248
ffffffffc0200fa4:	00005517          	auipc	a0,0x5
ffffffffc0200fa8:	8ec50513          	addi	a0,a0,-1812 # ffffffffc0205890 <commands+0x750>
ffffffffc0200fac:	c9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 0);
ffffffffc0200fb0:	00005697          	auipc	a3,0x5
ffffffffc0200fb4:	aa068693          	addi	a3,a3,-1376 # ffffffffc0205a50 <commands+0x910>
ffffffffc0200fb8:	00005617          	auipc	a2,0x5
ffffffffc0200fbc:	8c060613          	addi	a2,a2,-1856 # ffffffffc0205878 <commands+0x738>
ffffffffc0200fc0:	0df00593          	li	a1,223
ffffffffc0200fc4:	00005517          	auipc	a0,0x5
ffffffffc0200fc8:	8cc50513          	addi	a0,a0,-1844 # ffffffffc0205890 <commands+0x750>
ffffffffc0200fcc:	c7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200fd0:	00005697          	auipc	a3,0x5
ffffffffc0200fd4:	a2068693          	addi	a3,a3,-1504 # ffffffffc02059f0 <commands+0x8b0>
ffffffffc0200fd8:	00005617          	auipc	a2,0x5
ffffffffc0200fdc:	8a060613          	addi	a2,a2,-1888 # ffffffffc0205878 <commands+0x738>
ffffffffc0200fe0:	0dd00593          	li	a1,221
ffffffffc0200fe4:	00005517          	auipc	a0,0x5
ffffffffc0200fe8:	8ac50513          	addi	a0,a0,-1876 # ffffffffc0205890 <commands+0x750>
ffffffffc0200fec:	c5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200ff0:	00005697          	auipc	a3,0x5
ffffffffc0200ff4:	a4068693          	addi	a3,a3,-1472 # ffffffffc0205a30 <commands+0x8f0>
ffffffffc0200ff8:	00005617          	auipc	a2,0x5
ffffffffc0200ffc:	88060613          	addi	a2,a2,-1920 # ffffffffc0205878 <commands+0x738>
ffffffffc0201000:	0dc00593          	li	a1,220
ffffffffc0201004:	00005517          	auipc	a0,0x5
ffffffffc0201008:	88c50513          	addi	a0,a0,-1908 # ffffffffc0205890 <commands+0x750>
ffffffffc020100c:	c3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201010:	00005697          	auipc	a3,0x5
ffffffffc0201014:	8b868693          	addi	a3,a3,-1864 # ffffffffc02058c8 <commands+0x788>
ffffffffc0201018:	00005617          	auipc	a2,0x5
ffffffffc020101c:	86060613          	addi	a2,a2,-1952 # ffffffffc0205878 <commands+0x738>
ffffffffc0201020:	0b900593          	li	a1,185
ffffffffc0201024:	00005517          	auipc	a0,0x5
ffffffffc0201028:	86c50513          	addi	a0,a0,-1940 # ffffffffc0205890 <commands+0x750>
ffffffffc020102c:	c1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201030:	00005697          	auipc	a3,0x5
ffffffffc0201034:	9c068693          	addi	a3,a3,-1600 # ffffffffc02059f0 <commands+0x8b0>
ffffffffc0201038:	00005617          	auipc	a2,0x5
ffffffffc020103c:	84060613          	addi	a2,a2,-1984 # ffffffffc0205878 <commands+0x738>
ffffffffc0201040:	0d600593          	li	a1,214
ffffffffc0201044:	00005517          	auipc	a0,0x5
ffffffffc0201048:	84c50513          	addi	a0,a0,-1972 # ffffffffc0205890 <commands+0x750>
ffffffffc020104c:	bfaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201050:	00005697          	auipc	a3,0x5
ffffffffc0201054:	8b868693          	addi	a3,a3,-1864 # ffffffffc0205908 <commands+0x7c8>
ffffffffc0201058:	00005617          	auipc	a2,0x5
ffffffffc020105c:	82060613          	addi	a2,a2,-2016 # ffffffffc0205878 <commands+0x738>
ffffffffc0201060:	0d400593          	li	a1,212
ffffffffc0201064:	00005517          	auipc	a0,0x5
ffffffffc0201068:	82c50513          	addi	a0,a0,-2004 # ffffffffc0205890 <commands+0x750>
ffffffffc020106c:	bdaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201070:	00005697          	auipc	a3,0x5
ffffffffc0201074:	87868693          	addi	a3,a3,-1928 # ffffffffc02058e8 <commands+0x7a8>
ffffffffc0201078:	00005617          	auipc	a2,0x5
ffffffffc020107c:	80060613          	addi	a2,a2,-2048 # ffffffffc0205878 <commands+0x738>
ffffffffc0201080:	0d300593          	li	a1,211
ffffffffc0201084:	00005517          	auipc	a0,0x5
ffffffffc0201088:	80c50513          	addi	a0,a0,-2036 # ffffffffc0205890 <commands+0x750>
ffffffffc020108c:	bbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201090:	00005697          	auipc	a3,0x5
ffffffffc0201094:	87868693          	addi	a3,a3,-1928 # ffffffffc0205908 <commands+0x7c8>
ffffffffc0201098:	00004617          	auipc	a2,0x4
ffffffffc020109c:	7e060613          	addi	a2,a2,2016 # ffffffffc0205878 <commands+0x738>
ffffffffc02010a0:	0bb00593          	li	a1,187
ffffffffc02010a4:	00004517          	auipc	a0,0x4
ffffffffc02010a8:	7ec50513          	addi	a0,a0,2028 # ffffffffc0205890 <commands+0x750>
ffffffffc02010ac:	b9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(count == 0);
ffffffffc02010b0:	00005697          	auipc	a3,0x5
ffffffffc02010b4:	b0068693          	addi	a3,a3,-1280 # ffffffffc0205bb0 <commands+0xa70>
ffffffffc02010b8:	00004617          	auipc	a2,0x4
ffffffffc02010bc:	7c060613          	addi	a2,a2,1984 # ffffffffc0205878 <commands+0x738>
ffffffffc02010c0:	12500593          	li	a1,293
ffffffffc02010c4:	00004517          	auipc	a0,0x4
ffffffffc02010c8:	7cc50513          	addi	a0,a0,1996 # ffffffffc0205890 <commands+0x750>
ffffffffc02010cc:	b7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 0);
ffffffffc02010d0:	00005697          	auipc	a3,0x5
ffffffffc02010d4:	98068693          	addi	a3,a3,-1664 # ffffffffc0205a50 <commands+0x910>
ffffffffc02010d8:	00004617          	auipc	a2,0x4
ffffffffc02010dc:	7a060613          	addi	a2,a2,1952 # ffffffffc0205878 <commands+0x738>
ffffffffc02010e0:	11a00593          	li	a1,282
ffffffffc02010e4:	00004517          	auipc	a0,0x4
ffffffffc02010e8:	7ac50513          	addi	a0,a0,1964 # ffffffffc0205890 <commands+0x750>
ffffffffc02010ec:	b5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02010f0:	00005697          	auipc	a3,0x5
ffffffffc02010f4:	90068693          	addi	a3,a3,-1792 # ffffffffc02059f0 <commands+0x8b0>
ffffffffc02010f8:	00004617          	auipc	a2,0x4
ffffffffc02010fc:	78060613          	addi	a2,a2,1920 # ffffffffc0205878 <commands+0x738>
ffffffffc0201100:	11800593          	li	a1,280
ffffffffc0201104:	00004517          	auipc	a0,0x4
ffffffffc0201108:	78c50513          	addi	a0,a0,1932 # ffffffffc0205890 <commands+0x750>
ffffffffc020110c:	b3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201110:	00005697          	auipc	a3,0x5
ffffffffc0201114:	8a068693          	addi	a3,a3,-1888 # ffffffffc02059b0 <commands+0x870>
ffffffffc0201118:	00004617          	auipc	a2,0x4
ffffffffc020111c:	76060613          	addi	a2,a2,1888 # ffffffffc0205878 <commands+0x738>
ffffffffc0201120:	0c100593          	li	a1,193
ffffffffc0201124:	00004517          	auipc	a0,0x4
ffffffffc0201128:	76c50513          	addi	a0,a0,1900 # ffffffffc0205890 <commands+0x750>
ffffffffc020112c:	b1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201130:	00005697          	auipc	a3,0x5
ffffffffc0201134:	a4068693          	addi	a3,a3,-1472 # ffffffffc0205b70 <commands+0xa30>
ffffffffc0201138:	00004617          	auipc	a2,0x4
ffffffffc020113c:	74060613          	addi	a2,a2,1856 # ffffffffc0205878 <commands+0x738>
ffffffffc0201140:	11200593          	li	a1,274
ffffffffc0201144:	00004517          	auipc	a0,0x4
ffffffffc0201148:	74c50513          	addi	a0,a0,1868 # ffffffffc0205890 <commands+0x750>
ffffffffc020114c:	afaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc0201150:	00005697          	auipc	a3,0x5
ffffffffc0201154:	a0068693          	addi	a3,a3,-1536 # ffffffffc0205b50 <commands+0xa10>
ffffffffc0201158:	00004617          	auipc	a2,0x4
ffffffffc020115c:	72060613          	addi	a2,a2,1824 # ffffffffc0205878 <commands+0x738>
ffffffffc0201160:	11000593          	li	a1,272
ffffffffc0201164:	00004517          	auipc	a0,0x4
ffffffffc0201168:	72c50513          	addi	a0,a0,1836 # ffffffffc0205890 <commands+0x750>
ffffffffc020116c:	adaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc0201170:	00005697          	auipc	a3,0x5
ffffffffc0201174:	9b868693          	addi	a3,a3,-1608 # ffffffffc0205b28 <commands+0x9e8>
ffffffffc0201178:	00004617          	auipc	a2,0x4
ffffffffc020117c:	70060613          	addi	a2,a2,1792 # ffffffffc0205878 <commands+0x738>
ffffffffc0201180:	10e00593          	li	a1,270
ffffffffc0201184:	00004517          	auipc	a0,0x4
ffffffffc0201188:	70c50513          	addi	a0,a0,1804 # ffffffffc0205890 <commands+0x750>
ffffffffc020118c:	abaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc0201190:	00005697          	auipc	a3,0x5
ffffffffc0201194:	97068693          	addi	a3,a3,-1680 # ffffffffc0205b00 <commands+0x9c0>
ffffffffc0201198:	00004617          	auipc	a2,0x4
ffffffffc020119c:	6e060613          	addi	a2,a2,1760 # ffffffffc0205878 <commands+0x738>
ffffffffc02011a0:	10d00593          	li	a1,269
ffffffffc02011a4:	00004517          	auipc	a0,0x4
ffffffffc02011a8:	6ec50513          	addi	a0,a0,1772 # ffffffffc0205890 <commands+0x750>
ffffffffc02011ac:	a9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 + 2 == p1);
ffffffffc02011b0:	00005697          	auipc	a3,0x5
ffffffffc02011b4:	94068693          	addi	a3,a3,-1728 # ffffffffc0205af0 <commands+0x9b0>
ffffffffc02011b8:	00004617          	auipc	a2,0x4
ffffffffc02011bc:	6c060613          	addi	a2,a2,1728 # ffffffffc0205878 <commands+0x738>
ffffffffc02011c0:	10800593          	li	a1,264
ffffffffc02011c4:	00004517          	auipc	a0,0x4
ffffffffc02011c8:	6cc50513          	addi	a0,a0,1740 # ffffffffc0205890 <commands+0x750>
ffffffffc02011cc:	a7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011d0:	00005697          	auipc	a3,0x5
ffffffffc02011d4:	82068693          	addi	a3,a3,-2016 # ffffffffc02059f0 <commands+0x8b0>
ffffffffc02011d8:	00004617          	auipc	a2,0x4
ffffffffc02011dc:	6a060613          	addi	a2,a2,1696 # ffffffffc0205878 <commands+0x738>
ffffffffc02011e0:	10700593          	li	a1,263
ffffffffc02011e4:	00004517          	auipc	a0,0x4
ffffffffc02011e8:	6ac50513          	addi	a0,a0,1708 # ffffffffc0205890 <commands+0x750>
ffffffffc02011ec:	a5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc02011f0:	00005697          	auipc	a3,0x5
ffffffffc02011f4:	8e068693          	addi	a3,a3,-1824 # ffffffffc0205ad0 <commands+0x990>
ffffffffc02011f8:	00004617          	auipc	a2,0x4
ffffffffc02011fc:	68060613          	addi	a2,a2,1664 # ffffffffc0205878 <commands+0x738>
ffffffffc0201200:	10600593          	li	a1,262
ffffffffc0201204:	00004517          	auipc	a0,0x4
ffffffffc0201208:	68c50513          	addi	a0,a0,1676 # ffffffffc0205890 <commands+0x750>
ffffffffc020120c:	a3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201210:	00005697          	auipc	a3,0x5
ffffffffc0201214:	89068693          	addi	a3,a3,-1904 # ffffffffc0205aa0 <commands+0x960>
ffffffffc0201218:	00004617          	auipc	a2,0x4
ffffffffc020121c:	66060613          	addi	a2,a2,1632 # ffffffffc0205878 <commands+0x738>
ffffffffc0201220:	10500593          	li	a1,261
ffffffffc0201224:	00004517          	auipc	a0,0x4
ffffffffc0201228:	66c50513          	addi	a0,a0,1644 # ffffffffc0205890 <commands+0x750>
ffffffffc020122c:	a1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201230:	00005697          	auipc	a3,0x5
ffffffffc0201234:	85868693          	addi	a3,a3,-1960 # ffffffffc0205a88 <commands+0x948>
ffffffffc0201238:	00004617          	auipc	a2,0x4
ffffffffc020123c:	64060613          	addi	a2,a2,1600 # ffffffffc0205878 <commands+0x738>
ffffffffc0201240:	10400593          	li	a1,260
ffffffffc0201244:	00004517          	auipc	a0,0x4
ffffffffc0201248:	64c50513          	addi	a0,a0,1612 # ffffffffc0205890 <commands+0x750>
ffffffffc020124c:	9faff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201250:	00004697          	auipc	a3,0x4
ffffffffc0201254:	7a068693          	addi	a3,a3,1952 # ffffffffc02059f0 <commands+0x8b0>
ffffffffc0201258:	00004617          	auipc	a2,0x4
ffffffffc020125c:	62060613          	addi	a2,a2,1568 # ffffffffc0205878 <commands+0x738>
ffffffffc0201260:	0fe00593          	li	a1,254
ffffffffc0201264:	00004517          	auipc	a0,0x4
ffffffffc0201268:	62c50513          	addi	a0,a0,1580 # ffffffffc0205890 <commands+0x750>
ffffffffc020126c:	9daff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(!PageProperty(p0));
ffffffffc0201270:	00005697          	auipc	a3,0x5
ffffffffc0201274:	80068693          	addi	a3,a3,-2048 # ffffffffc0205a70 <commands+0x930>
ffffffffc0201278:	00004617          	auipc	a2,0x4
ffffffffc020127c:	60060613          	addi	a2,a2,1536 # ffffffffc0205878 <commands+0x738>
ffffffffc0201280:	0f900593          	li	a1,249
ffffffffc0201284:	00004517          	auipc	a0,0x4
ffffffffc0201288:	60c50513          	addi	a0,a0,1548 # ffffffffc0205890 <commands+0x750>
ffffffffc020128c:	9baff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc0201290:	00005697          	auipc	a3,0x5
ffffffffc0201294:	90068693          	addi	a3,a3,-1792 # ffffffffc0205b90 <commands+0xa50>
ffffffffc0201298:	00004617          	auipc	a2,0x4
ffffffffc020129c:	5e060613          	addi	a2,a2,1504 # ffffffffc0205878 <commands+0x738>
ffffffffc02012a0:	11700593          	li	a1,279
ffffffffc02012a4:	00004517          	auipc	a0,0x4
ffffffffc02012a8:	5ec50513          	addi	a0,a0,1516 # ffffffffc0205890 <commands+0x750>
ffffffffc02012ac:	99aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(total == 0);
ffffffffc02012b0:	00005697          	auipc	a3,0x5
ffffffffc02012b4:	91068693          	addi	a3,a3,-1776 # ffffffffc0205bc0 <commands+0xa80>
ffffffffc02012b8:	00004617          	auipc	a2,0x4
ffffffffc02012bc:	5c060613          	addi	a2,a2,1472 # ffffffffc0205878 <commands+0x738>
ffffffffc02012c0:	12600593          	li	a1,294
ffffffffc02012c4:	00004517          	auipc	a0,0x4
ffffffffc02012c8:	5cc50513          	addi	a0,a0,1484 # ffffffffc0205890 <commands+0x750>
ffffffffc02012cc:	97aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(total == nr_free_pages());
ffffffffc02012d0:	00004697          	auipc	a3,0x4
ffffffffc02012d4:	5d868693          	addi	a3,a3,1496 # ffffffffc02058a8 <commands+0x768>
ffffffffc02012d8:	00004617          	auipc	a2,0x4
ffffffffc02012dc:	5a060613          	addi	a2,a2,1440 # ffffffffc0205878 <commands+0x738>
ffffffffc02012e0:	0f300593          	li	a1,243
ffffffffc02012e4:	00004517          	auipc	a0,0x4
ffffffffc02012e8:	5ac50513          	addi	a0,a0,1452 # ffffffffc0205890 <commands+0x750>
ffffffffc02012ec:	95aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02012f0:	00004697          	auipc	a3,0x4
ffffffffc02012f4:	5f868693          	addi	a3,a3,1528 # ffffffffc02058e8 <commands+0x7a8>
ffffffffc02012f8:	00004617          	auipc	a2,0x4
ffffffffc02012fc:	58060613          	addi	a2,a2,1408 # ffffffffc0205878 <commands+0x738>
ffffffffc0201300:	0ba00593          	li	a1,186
ffffffffc0201304:	00004517          	auipc	a0,0x4
ffffffffc0201308:	58c50513          	addi	a0,a0,1420 # ffffffffc0205890 <commands+0x750>
...
ffffffffc0201440:	79c68693          	addi	a3,a3,1948 # ffffffffc0205bd8 <commands+0xa98>
ffffffffc0201444:	00004617          	auipc	a2,0x4
ffffffffc0201448:	43460613          	addi	a2,a2,1076 # ffffffffc0205878 <commands+0x738>
ffffffffc020144c:	08300593          	li	a1,131
ffffffffc0201450:	00004517          	auipc	a0,0x4
ffffffffc0201454:	44050513          	addi	a0,a0,1088 # ffffffffc0205890 <commands+0x750>
ffffffffc0201458:	feffe0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(n > 0);
ffffffffc020145c:	00004697          	auipc	a3,0x4
ffffffffc0201460:	77468693          	addi	a3,a3,1908 # ffffffffc0205bd0 <commands+0xa90>
ffffffffc0201464:	00004617          	auipc	a2,0x4
ffffffffc0201468:	41460613          	addi	a2,a2,1044 # ffffffffc0205878 <commands+0x738>
ffffffffc020146c:	08000593          	li	a1,128
ffffffffc0201470:	00004517          	auipc	a0,0x4
ffffffffc0201474:	42050513          	addi	a0,a0,1056 # ffffffffc0205890 <commands+0x750>
...
ffffffffc0201512:	6c268693          	addi	a3,a3,1730 # ffffffffc0205bd0 <commands+0xa90>
ffffffffc0201516:	00004617          	auipc	a2,0x4
ffffffffc020151a:	36260613          	addi	a2,a2,866 # ffffffffc0205878 <commands+0x738>
ffffffffc020151e:	06200593          	li	a1,98
ffffffffc0201522:	00004517          	auipc	a0,0x4
ffffffffc0201526:	36e50513          	addi	a0,a0,878 # ffffffffc0205890 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc02015e4:	62068693          	addi	a3,a3,1568 # ffffffffc0205c00 <commands+0xac0>
ffffffffc02015e8:	00004617          	auipc	a2,0x4
ffffffffc02015ec:	29060613          	addi	a2,a2,656 # ffffffffc0205878 <commands+0x738>
ffffffffc02015f0:	04900593          	li	a1,73
ffffffffc02015f4:	00004517          	auipc	a0,0x4
ffffffffc02015f8:	29c50513          	addi	a0,a0,668 # ffffffffc0205890 <commands+0x750>
ffffffffc02015fc:	e4bfe0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(n > 0);
ffffffffc0201600:	00004697          	auipc	a3,0x4
ffffffffc0201604:	5d068693          	addi	a3,a3,1488 # ffffffffc0205bd0 <commands+0xa90>
ffffffffc0201608:	00004617          	auipc	a2,0x4
ffffffffc020160c:	27060613          	addi	a2,a2,624 # ffffffffc0205878 <commands+0x738>
ffffffffc0201610:	04600593          	li	a1,70
ffffffffc0201614:	00004517          	auipc	a0,0x4
ffffffffc0201618:	27c50513          	addi	a0,a0,636 # ffffffffc0205890 <commands+0x750>
...
ffffffffc02016f4:	9306b683          	ld	a3,-1744(a3) # ffffffffc0207020 <nbase>
...
ffffffffc0201724:	54060613          	addi	a2,a2,1344 # ffffffffc0205c60 <default_pmm_manager+0x38>
ffffffffc0201728:	06900593          	li	a1,105
ffffffffc020172c:	00004517          	auipc	a0,0x4
ffffffffc0201730:	55c50513          	addi	a0,a0,1372 # ffffffffc0205c88 <default_pmm_manager+0x60>
...
ffffffffc0201812:	48a68693          	addi	a3,a3,1162 # ffffffffc0205c98 <default_pmm_manager+0x70>
ffffffffc0201816:	00004617          	auipc	a2,0x4
ffffffffc020181a:	06260613          	addi	a2,a2,98 # ffffffffc0205878 <commands+0x738>
ffffffffc020181e:	06300593          	li	a1,99
ffffffffc0201822:	00004517          	auipc	a0,0x4
ffffffffc0201826:	49650513          	addi	a0,a0,1174 # ffffffffc0205cb8 <default_pmm_manager+0x90>
...
ffffffffc0201834:	4a050513          	addi	a0,a0,1184 # ffffffffc0205cd0 <default_pmm_manager+0xa8>
kmalloc_init(void) {
...
ffffffffc0201844:	4a850513          	addi	a0,a0,1192 # ffffffffc0205ce8 <default_pmm_manager+0xc0>
}
...
ffffffffc0201968:	6bc53503          	ld	a0,1724(a0) # ffffffffc0207020 <nbase>
...
ffffffffc02019c6:	36e60613          	addi	a2,a2,878 # ffffffffc0205d30 <default_pmm_manager+0x108>
ffffffffc02019ca:	06200593          	li	a1,98
ffffffffc02019ce:	00004517          	auipc	a0,0x4
ffffffffc02019d2:	2ba50513          	addi	a0,a0,698 # ffffffffc0205c88 <default_pmm_manager+0x60>
...
ffffffffc02019e0:	32c60613          	addi	a2,a2,812 # ffffffffc0205d08 <default_pmm_manager+0xe0>
ffffffffc02019e4:	06e00593          	li	a1,110
ffffffffc02019e8:	00004517          	auipc	a0,0x4
ffffffffc02019ec:	2a050513          	addi	a0,a0,672 # ffffffffc0205c88 <default_pmm_manager+0x60>
...
ffffffffc02019fa:	33a60613          	addi	a2,a2,826 # ffffffffc0205d30 <default_pmm_manager+0x108>
ffffffffc02019fe:	06200593          	li	a1,98
ffffffffc0201a02:	00004517          	auipc	a0,0x4
ffffffffc0201a06:	28650513          	addi	a0,a0,646 # ffffffffc0205c88 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0201a16:	33e60613          	addi	a2,a2,830 # ffffffffc0205d50 <default_pmm_manager+0x128>
ffffffffc0201a1a:	07400593          	li	a1,116
ffffffffc0201a1e:	00004517          	auipc	a0,0x4
ffffffffc0201a22:	26a50513          	addi	a0,a0,618 # ffffffffc0205c88 <default_pmm_manager+0x60>
pte2page(pte_t pte) {
...
ffffffffc0201bbe:	2c8030ef          	jal	ra,ffffffffc0204e86 <memset>
    return page - pages + nbase;
...
ffffffffc0201c50:	236030ef          	jal	ra,ffffffffc0204e86 <memset>
    return page - pages + nbase;
...
ffffffffc0201caa:	fba60613          	addi	a2,a2,-70 # ffffffffc0205c60 <default_pmm_manager+0x38>
ffffffffc0201cae:	0e400593          	li	a1,228
ffffffffc0201cb2:	00004517          	auipc	a0,0x4
ffffffffc0201cb6:	0c650513          	addi	a0,a0,198 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc0201cba:	f8cfe0ef          	jal	ra,ffffffffc0200446 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201cbe:	00004617          	auipc	a2,0x4
ffffffffc0201cc2:	fa260613          	addi	a2,a2,-94 # ffffffffc0205c60 <default_pmm_manager+0x38>
ffffffffc0201cc6:	0ef00593          	li	a1,239
ffffffffc0201cca:	00004517          	auipc	a0,0x4
ffffffffc0201cce:	0ae50513          	addi	a0,a0,174 # ffffffffc0205d78 <default_pmm_manager+0x150>
...
ffffffffc0201cdc:	f8860613          	addi	a2,a2,-120 # ffffffffc0205c60 <default_pmm_manager+0x38>
ffffffffc0201ce0:	0ec00593          	li	a1,236
ffffffffc0201ce4:	00004517          	auipc	a0,0x4
ffffffffc0201ce8:	09450513          	addi	a0,a0,148 # ffffffffc0205d78 <default_pmm_manager+0x150>
...
ffffffffc0201cf6:	f6e60613          	addi	a2,a2,-146 # ffffffffc0205c60 <default_pmm_manager+0x38>
ffffffffc0201cfa:	0e100593          	li	a1,225
ffffffffc0201cfe:	00004517          	auipc	a0,0x4
ffffffffc0201d02:	07a50513          	addi	a0,a0,122 # ffffffffc0205d78 <default_pmm_manager+0x150>
...
ffffffffc0201ef4:	d3878793          	addi	a5,a5,-712 # ffffffffc0205c28 <default_pmm_manager>
...
ffffffffc0201f02:	e8a50513          	addi	a0,a0,-374 # ffffffffc0205d88 <default_pmm_manager+0x160>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201f50:	e5450513          	addi	a0,a0,-428 # ffffffffc0205da0 <default_pmm_manager+0x178>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201f70:	e4c50513          	addi	a0,a0,-436 # ffffffffc0205db8 <default_pmm_manager+0x190>
...
ffffffffc0201fd8:	e0c50513          	addi	a0,a0,-500 # ffffffffc0205de0 <default_pmm_manager+0x1b8>
...
ffffffffc0201ff4:	e0850513          	addi	a0,a0,-504 # ffffffffc0205df8 <default_pmm_manager+0x1d0>
...
ffffffffc0202294:	e5050513          	addi	a0,a0,-432 # ffffffffc02060e0 <default_pmm_manager+0x4b8>
...
ffffffffc020234a:	ed258593          	addi	a1,a1,-302 # ffffffffc0206218 <default_pmm_manager+0x5f0>
ffffffffc020234e:	10000513          	li	a0,256
ffffffffc0202352:	2ef020ef          	jal	ra,ffffffffc0204e40 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202356:	10040593          	addi	a1,s0,256
ffffffffc020235a:	10000513          	li	a0,256
ffffffffc020235e:	2f5020ef          	jal	ra,ffffffffc0204e52 <strcmp>
...
ffffffffc0202390:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202394:	277020ef          	jal	ra,ffffffffc0204e0a <strlen>
...
ffffffffc0202458:	e3c50513          	addi	a0,a0,-452 # ffffffffc0206290 <default_pmm_manager+0x668>
...
ffffffffc0202572:	bd268693          	addi	a3,a3,-1070 # ffffffffc0206140 <default_pmm_manager+0x518>
ffffffffc0202576:	00003617          	auipc	a2,0x3
ffffffffc020257a:	30260613          	addi	a2,a2,770 # ffffffffc0205878 <commands+0x738>
ffffffffc020257e:	19e00593          	li	a1,414
ffffffffc0202582:	00003517          	auipc	a0,0x3
ffffffffc0202586:	7f650513          	addi	a0,a0,2038 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc020258a:	ebdfd0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc020258e:	00004697          	auipc	a3,0x4
ffffffffc0202592:	b7268693          	addi	a3,a3,-1166 # ffffffffc0206100 <default_pmm_manager+0x4d8>
ffffffffc0202596:	00003617          	auipc	a2,0x3
ffffffffc020259a:	2e260613          	addi	a2,a2,738 # ffffffffc0205878 <commands+0x738>
ffffffffc020259e:	19d00593          	li	a1,413
ffffffffc02025a2:	00003517          	auipc	a0,0x3
ffffffffc02025a6:	7d650513          	addi	a0,a0,2006 # ffffffffc0205d78 <default_pmm_manager+0x150>
...
ffffffffc02025b4:	6b060613          	addi	a2,a2,1712 # ffffffffc0205c60 <default_pmm_manager+0x38>
ffffffffc02025b8:	19d00593          	li	a1,413
ffffffffc02025bc:	00003517          	auipc	a0,0x3
ffffffffc02025c0:	7bc50513          	addi	a0,a0,1980 # ffffffffc0205d78 <default_pmm_manager+0x150>
...
ffffffffc02025d0:	73c60613          	addi	a2,a2,1852 # ffffffffc0205d08 <default_pmm_manager+0xe0>
ffffffffc02025d4:	07f00593          	li	a1,127
ffffffffc02025d8:	00003517          	auipc	a0,0x3
ffffffffc02025dc:	7a050513          	addi	a0,a0,1952 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc02025e0:	e67fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc02025e4:	00003617          	auipc	a2,0x3
ffffffffc02025e8:	72460613          	addi	a2,a2,1828 # ffffffffc0205d08 <default_pmm_manager+0xe0>
ffffffffc02025ec:	0c300593          	li	a1,195
ffffffffc02025f0:	00003517          	auipc	a0,0x3
ffffffffc02025f4:	78850513          	addi	a0,a0,1928 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc02025f8:	e4ffd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc02025fc:	00004697          	auipc	a3,0x4
ffffffffc0202600:	83c68693          	addi	a3,a3,-1988 # ffffffffc0205e38 <default_pmm_manager+0x210>
ffffffffc0202604:	00003617          	auipc	a2,0x3
ffffffffc0202608:	27460613          	addi	a2,a2,628 # ffffffffc0205878 <commands+0x738>
ffffffffc020260c:	16100593          	li	a1,353
ffffffffc0202610:	00003517          	auipc	a0,0x3
ffffffffc0202614:	76850513          	addi	a0,a0,1896 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc0202618:	e2ffd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020261c:	00003697          	auipc	a3,0x3
ffffffffc0202620:	7fc68693          	addi	a3,a3,2044 # ffffffffc0205e18 <default_pmm_manager+0x1f0>
ffffffffc0202624:	00003617          	auipc	a2,0x3
ffffffffc0202628:	25460613          	addi	a2,a2,596 # ffffffffc0205878 <commands+0x738>
ffffffffc020262c:	16000593          	li	a1,352
ffffffffc0202630:	00003517          	auipc	a0,0x3
ffffffffc0202634:	74850513          	addi	a0,a0,1864 # ffffffffc0205d78 <default_pmm_manager+0x150>
...
ffffffffc0202644:	88868693          	addi	a3,a3,-1912 # ffffffffc0205ec8 <default_pmm_manager+0x2a0>
ffffffffc0202648:	00003617          	auipc	a2,0x3
ffffffffc020264c:	23060613          	addi	a2,a2,560 # ffffffffc0205878 <commands+0x738>
ffffffffc0202650:	16900593          	li	a1,361
ffffffffc0202654:	00003517          	auipc	a0,0x3
ffffffffc0202658:	72450513          	addi	a0,a0,1828 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc020265c:	debfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202660:	00004697          	auipc	a3,0x4
ffffffffc0202664:	83868693          	addi	a3,a3,-1992 # ffffffffc0205e98 <default_pmm_manager+0x270>
ffffffffc0202668:	00003617          	auipc	a2,0x3
ffffffffc020266c:	21060613          	addi	a2,a2,528 # ffffffffc0205878 <commands+0x738>
ffffffffc0202670:	16600593          	li	a1,358
ffffffffc0202674:	00003517          	auipc	a0,0x3
ffffffffc0202678:	70450513          	addi	a0,a0,1796 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc020267c:	dcbfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc0202680:	00003697          	auipc	a3,0x3
ffffffffc0202684:	7f068693          	addi	a3,a3,2032 # ffffffffc0205e70 <default_pmm_manager+0x248>
ffffffffc0202688:	00003617          	auipc	a2,0x3
ffffffffc020268c:	1f060613          	addi	a2,a2,496 # ffffffffc0205878 <commands+0x738>
ffffffffc0202690:	16200593          	li	a1,354
ffffffffc0202694:	00003517          	auipc	a0,0x3
ffffffffc0202698:	6e450513          	addi	a0,a0,1764 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc020269c:	dabfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02026a0:	00004697          	auipc	a3,0x4
ffffffffc02026a4:	8b068693          	addi	a3,a3,-1872 # ffffffffc0205f50 <default_pmm_manager+0x328>
ffffffffc02026a8:	00003617          	auipc	a2,0x3
ffffffffc02026ac:	1d060613          	addi	a2,a2,464 # ffffffffc0205878 <commands+0x738>
ffffffffc02026b0:	17200593          	li	a1,370
ffffffffc02026b4:	00003517          	auipc	a0,0x3
ffffffffc02026b8:	6c450513          	addi	a0,a0,1732 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc02026bc:	d8bfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02026c0:	00004697          	auipc	a3,0x4
ffffffffc02026c4:	93068693          	addi	a3,a3,-1744 # ffffffffc0205ff0 <default_pmm_manager+0x3c8>
ffffffffc02026c8:	00003617          	auipc	a2,0x3
ffffffffc02026cc:	1b060613          	addi	a2,a2,432 # ffffffffc0205878 <commands+0x738>
ffffffffc02026d0:	17700593          	li	a1,375
ffffffffc02026d4:	00003517          	auipc	a0,0x3
ffffffffc02026d8:	6a450513          	addi	a0,a0,1700 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc02026dc:	d6bfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc02026e0:	00004697          	auipc	a3,0x4
ffffffffc02026e4:	84868693          	addi	a3,a3,-1976 # ffffffffc0205f28 <default_pmm_manager+0x300>
ffffffffc02026e8:	00003617          	auipc	a2,0x3
ffffffffc02026ec:	19060613          	addi	a2,a2,400 # ffffffffc0205878 <commands+0x738>
ffffffffc02026f0:	16f00593          	li	a1,367
ffffffffc02026f4:	00003517          	auipc	a0,0x3
ffffffffc02026f8:	68450513          	addi	a0,a0,1668 # ffffffffc0205d78 <default_pmm_manager+0x150>
...
ffffffffc0202706:	55e60613          	addi	a2,a2,1374 # ffffffffc0205c60 <default_pmm_manager+0x38>
ffffffffc020270a:	16e00593          	li	a1,366
ffffffffc020270e:	00003517          	auipc	a0,0x3
ffffffffc0202712:	66a50513          	addi	a0,a0,1642 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc0202716:	d31fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020271a:	00004697          	auipc	a3,0x4
ffffffffc020271e:	86e68693          	addi	a3,a3,-1938 # ffffffffc0205f88 <default_pmm_manager+0x360>
ffffffffc0202722:	00003617          	auipc	a2,0x3
ffffffffc0202726:	15660613          	addi	a2,a2,342 # ffffffffc0205878 <commands+0x738>
ffffffffc020272a:	17c00593          	li	a1,380
ffffffffc020272e:	00003517          	auipc	a0,0x3
ffffffffc0202732:	64a50513          	addi	a0,a0,1610 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc0202736:	d11fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020273a:	00004697          	auipc	a3,0x4
ffffffffc020273e:	91668693          	addi	a3,a3,-1770 # ffffffffc0206050 <default_pmm_manager+0x428>
ffffffffc0202742:	00003617          	auipc	a2,0x3
ffffffffc0202746:	13660613          	addi	a2,a2,310 # ffffffffc0205878 <commands+0x738>
ffffffffc020274a:	17b00593          	li	a1,379
ffffffffc020274e:	00003517          	auipc	a0,0x3
ffffffffc0202752:	62a50513          	addi	a0,a0,1578 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc0202756:	cf1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020275a:	00004697          	auipc	a3,0x4
ffffffffc020275e:	8de68693          	addi	a3,a3,-1826 # ffffffffc0206038 <default_pmm_manager+0x410>
ffffffffc0202762:	00003617          	auipc	a2,0x3
ffffffffc0202766:	11660613          	addi	a2,a2,278 # ffffffffc0205878 <commands+0x738>
ffffffffc020276a:	17a00593          	li	a1,378
ffffffffc020276e:	00003517          	auipc	a0,0x3
ffffffffc0202772:	60a50513          	addi	a0,a0,1546 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc0202776:	cd1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc020277a:	00004697          	auipc	a3,0x4
ffffffffc020277e:	88e68693          	addi	a3,a3,-1906 # ffffffffc0206008 <default_pmm_manager+0x3e0>
ffffffffc0202782:	00003617          	auipc	a2,0x3
ffffffffc0202786:	0f660613          	addi	a2,a2,246 # ffffffffc0205878 <commands+0x738>
ffffffffc020278a:	17900593          	li	a1,377
ffffffffc020278e:	00003517          	auipc	a0,0x3
ffffffffc0202792:	5ea50513          	addi	a0,a0,1514 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc0202796:	cb1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc020279a:	00004697          	auipc	a3,0x4
ffffffffc020279e:	a2668693          	addi	a3,a3,-1498 # ffffffffc02061c0 <default_pmm_manager+0x598>
ffffffffc02027a2:	00003617          	auipc	a2,0x3
ffffffffc02027a6:	0d660613          	addi	a2,a2,214 # ffffffffc0205878 <commands+0x738>
ffffffffc02027aa:	1a700593          	li	a1,423
ffffffffc02027ae:	00003517          	auipc	a0,0x3
ffffffffc02027b2:	5ca50513          	addi	a0,a0,1482 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc02027b6:	c91fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02027ba:	00004697          	auipc	a3,0x4
ffffffffc02027be:	81e68693          	addi	a3,a3,-2018 # ffffffffc0205fd8 <default_pmm_manager+0x3b0>
ffffffffc02027c2:	00003617          	auipc	a2,0x3
ffffffffc02027c6:	0b660613          	addi	a2,a2,182 # ffffffffc0205878 <commands+0x738>
ffffffffc02027ca:	17600593          	li	a1,374
ffffffffc02027ce:	00003517          	auipc	a0,0x3
ffffffffc02027d2:	5aa50513          	addi	a0,a0,1450 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc02027d6:	c71fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*ptep & PTE_W);
ffffffffc02027da:	00003697          	auipc	a3,0x3
ffffffffc02027de:	7ee68693          	addi	a3,a3,2030 # ffffffffc0205fc8 <default_pmm_manager+0x3a0>
ffffffffc02027e2:	00003617          	auipc	a2,0x3
ffffffffc02027e6:	09660613          	addi	a2,a2,150 # ffffffffc0205878 <commands+0x738>
ffffffffc02027ea:	17500593          	li	a1,373
ffffffffc02027ee:	00003517          	auipc	a0,0x3
ffffffffc02027f2:	58a50513          	addi	a0,a0,1418 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc02027f6:	c51fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02027fa:	00004697          	auipc	a3,0x4
ffffffffc02027fe:	8c668693          	addi	a3,a3,-1850 # ffffffffc02060c0 <default_pmm_manager+0x498>
ffffffffc0202802:	00003617          	auipc	a2,0x3
ffffffffc0202806:	07660613          	addi	a2,a2,118 # ffffffffc0205878 <commands+0x738>
ffffffffc020280a:	1b800593          	li	a1,440
ffffffffc020280e:	00003517          	auipc	a0,0x3
ffffffffc0202812:	56a50513          	addi	a0,a0,1386 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc0202816:	c31fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*ptep & PTE_U);
ffffffffc020281a:	00003697          	auipc	a3,0x3
ffffffffc020281e:	79e68693          	addi	a3,a3,1950 # ffffffffc0205fb8 <default_pmm_manager+0x390>
ffffffffc0202822:	00003617          	auipc	a2,0x3
ffffffffc0202826:	05660613          	addi	a2,a2,86 # ffffffffc0205878 <commands+0x738>
ffffffffc020282a:	17400593          	li	a1,372
ffffffffc020282e:	00003517          	auipc	a0,0x3
ffffffffc0202832:	54a50513          	addi	a0,a0,1354 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc0202836:	c11fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020283a:	00003697          	auipc	a3,0x3
ffffffffc020283e:	6d668693          	addi	a3,a3,1750 # ffffffffc0205f10 <default_pmm_manager+0x2e8>
ffffffffc0202842:	00003617          	auipc	a2,0x3
ffffffffc0202846:	03660613          	addi	a2,a2,54 # ffffffffc0205878 <commands+0x738>
ffffffffc020284a:	18100593          	li	a1,385
ffffffffc020284e:	00003517          	auipc	a0,0x3
ffffffffc0202852:	52a50513          	addi	a0,a0,1322 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc0202856:	bf1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020285a:	00004697          	auipc	a3,0x4
ffffffffc020285e:	80e68693          	addi	a3,a3,-2034 # ffffffffc0206068 <default_pmm_manager+0x440>
ffffffffc0202862:	00003617          	auipc	a2,0x3
ffffffffc0202866:	01660613          	addi	a2,a2,22 # ffffffffc0205878 <commands+0x738>
ffffffffc020286a:	17e00593          	li	a1,382
ffffffffc020286e:	00003517          	auipc	a0,0x3
ffffffffc0202872:	50a50513          	addi	a0,a0,1290 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc0202876:	bd1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc020287a:	00003697          	auipc	a3,0x3
ffffffffc020287e:	67e68693          	addi	a3,a3,1662 # ffffffffc0205ef8 <default_pmm_manager+0x2d0>
ffffffffc0202882:	00003617          	auipc	a2,0x3
ffffffffc0202886:	ff660613          	addi	a2,a2,-10 # ffffffffc0205878 <commands+0x738>
ffffffffc020288a:	17d00593          	li	a1,381
ffffffffc020288e:	00003517          	auipc	a0,0x3
ffffffffc0202892:	4ea50513          	addi	a0,a0,1258 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc0202896:	bb1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc020289a:	00003617          	auipc	a2,0x3
ffffffffc020289e:	3c660613          	addi	a2,a2,966 # ffffffffc0205c60 <default_pmm_manager+0x38>
ffffffffc02028a2:	06900593          	li	a1,105
ffffffffc02028a6:	00003517          	auipc	a0,0x3
ffffffffc02028aa:	3e250513          	addi	a0,a0,994 # ffffffffc0205c88 <default_pmm_manager+0x60>
ffffffffc02028ae:	b99fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02028b2:	00003697          	auipc	a3,0x3
ffffffffc02028b6:	7e668693          	addi	a3,a3,2022 # ffffffffc0206098 <default_pmm_manager+0x470>
ffffffffc02028ba:	00003617          	auipc	a2,0x3
ffffffffc02028be:	fbe60613          	addi	a2,a2,-66 # ffffffffc0205878 <commands+0x738>
ffffffffc02028c2:	18800593          	li	a1,392
ffffffffc02028c6:	00003517          	auipc	a0,0x3
ffffffffc02028ca:	4b250513          	addi	a0,a0,1202 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc02028ce:	b79fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc02028d2:	00003697          	auipc	a3,0x3
ffffffffc02028d6:	77e68693          	addi	a3,a3,1918 # ffffffffc0206050 <default_pmm_manager+0x428>
ffffffffc02028da:	00003617          	auipc	a2,0x3
ffffffffc02028de:	f9e60613          	addi	a2,a2,-98 # ffffffffc0205878 <commands+0x738>
ffffffffc02028e2:	18600593          	li	a1,390
ffffffffc02028e6:	00003517          	auipc	a0,0x3
ffffffffc02028ea:	49250513          	addi	a0,a0,1170 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc02028ee:	b59fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc02028f2:	00003697          	auipc	a3,0x3
ffffffffc02028f6:	78e68693          	addi	a3,a3,1934 # ffffffffc0206080 <default_pmm_manager+0x458>
ffffffffc02028fa:	00003617          	auipc	a2,0x3
ffffffffc02028fe:	f7e60613          	addi	a2,a2,-130 # ffffffffc0205878 <commands+0x738>
ffffffffc0202902:	18500593          	li	a1,389
ffffffffc0202906:	00003517          	auipc	a0,0x3
ffffffffc020290a:	47250513          	addi	a0,a0,1138 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc020290e:	b39fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202912:	00003697          	auipc	a3,0x3
ffffffffc0202916:	73e68693          	addi	a3,a3,1854 # ffffffffc0206050 <default_pmm_manager+0x428>
ffffffffc020291a:	00003617          	auipc	a2,0x3
ffffffffc020291e:	f5e60613          	addi	a2,a2,-162 # ffffffffc0205878 <commands+0x738>
ffffffffc0202922:	18200593          	li	a1,386
ffffffffc0202926:	00003517          	auipc	a0,0x3
ffffffffc020292a:	45250513          	addi	a0,a0,1106 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc020292e:	b19fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202932:	00004697          	auipc	a3,0x4
ffffffffc0202936:	87668693          	addi	a3,a3,-1930 # ffffffffc02061a8 <default_pmm_manager+0x580>
ffffffffc020293a:	00003617          	auipc	a2,0x3
ffffffffc020293e:	f3e60613          	addi	a2,a2,-194 # ffffffffc0205878 <commands+0x738>
ffffffffc0202942:	1a600593          	li	a1,422
ffffffffc0202946:	00003517          	auipc	a0,0x3
ffffffffc020294a:	43250513          	addi	a0,a0,1074 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc020294e:	af9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202952:	00004697          	auipc	a3,0x4
ffffffffc0202956:	81e68693          	addi	a3,a3,-2018 # ffffffffc0206170 <default_pmm_manager+0x548>
ffffffffc020295a:	00003617          	auipc	a2,0x3
ffffffffc020295e:	f1e60613          	addi	a2,a2,-226 # ffffffffc0205878 <commands+0x738>
ffffffffc0202962:	1a500593          	li	a1,421
ffffffffc0202966:	00003517          	auipc	a0,0x3
ffffffffc020296a:	41250513          	addi	a0,a0,1042 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc020296e:	ad9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc0202972:	00003697          	auipc	a3,0x3
ffffffffc0202976:	7e668693          	addi	a3,a3,2022 # ffffffffc0206158 <default_pmm_manager+0x530>
ffffffffc020297a:	00003617          	auipc	a2,0x3
ffffffffc020297e:	efe60613          	addi	a2,a2,-258 # ffffffffc0205878 <commands+0x738>
ffffffffc0202982:	1a100593          	li	a1,417
ffffffffc0202986:	00003517          	auipc	a0,0x3
ffffffffc020298a:	3f250513          	addi	a0,a0,1010 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc020298e:	ab9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc0202992:	00003697          	auipc	a3,0x3
ffffffffc0202996:	72e68693          	addi	a3,a3,1838 # ffffffffc02060c0 <default_pmm_manager+0x498>
ffffffffc020299a:	00003617          	auipc	a2,0x3
ffffffffc020299e:	ede60613          	addi	a2,a2,-290 # ffffffffc0205878 <commands+0x738>
ffffffffc02029a2:	19000593          	li	a1,400
ffffffffc02029a6:	00003517          	auipc	a0,0x3
ffffffffc02029aa:	3d250513          	addi	a0,a0,978 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc02029ae:	a99fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02029b2:	00003697          	auipc	a3,0x3
ffffffffc02029b6:	54668693          	addi	a3,a3,1350 # ffffffffc0205ef8 <default_pmm_manager+0x2d0>
ffffffffc02029ba:	00003617          	auipc	a2,0x3
ffffffffc02029be:	ebe60613          	addi	a2,a2,-322 # ffffffffc0205878 <commands+0x738>
ffffffffc02029c2:	16a00593          	li	a1,362
ffffffffc02029c6:	00003517          	auipc	a0,0x3
ffffffffc02029ca:	3b250513          	addi	a0,a0,946 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc02029ce:	a79fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc02029d2:	00003617          	auipc	a2,0x3
ffffffffc02029d6:	28e60613          	addi	a2,a2,654 # ffffffffc0205c60 <default_pmm_manager+0x38>
ffffffffc02029da:	16d00593          	li	a1,365
ffffffffc02029de:	00003517          	auipc	a0,0x3
ffffffffc02029e2:	39a50513          	addi	a0,a0,922 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc02029e6:	a61fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02029ea:	00003697          	auipc	a3,0x3
ffffffffc02029ee:	52668693          	addi	a3,a3,1318 # ffffffffc0205f10 <default_pmm_manager+0x2e8>
ffffffffc02029f2:	00003617          	auipc	a2,0x3
ffffffffc02029f6:	e8660613          	addi	a2,a2,-378 # ffffffffc0205878 <commands+0x738>
ffffffffc02029fa:	16b00593          	li	a1,363
ffffffffc02029fe:	00003517          	auipc	a0,0x3
ffffffffc0202a02:	37a50513          	addi	a0,a0,890 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc0202a06:	a41fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202a0a:	00003697          	auipc	a3,0x3
ffffffffc0202a0e:	57e68693          	addi	a3,a3,1406 # ffffffffc0205f88 <default_pmm_manager+0x360>
ffffffffc0202a12:	00003617          	auipc	a2,0x3
ffffffffc0202a16:	e6660613          	addi	a2,a2,-410 # ffffffffc0205878 <commands+0x738>
ffffffffc0202a1a:	17300593          	li	a1,371
ffffffffc0202a1e:	00003517          	auipc	a0,0x3
ffffffffc0202a22:	35a50513          	addi	a0,a0,858 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc0202a26:	a21fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202a2a:	00004697          	auipc	a3,0x4
ffffffffc0202a2e:	83e68693          	addi	a3,a3,-1986 # ffffffffc0206268 <default_pmm_manager+0x640>
ffffffffc0202a32:	00003617          	auipc	a2,0x3
ffffffffc0202a36:	e4660613          	addi	a2,a2,-442 # ffffffffc0205878 <commands+0x738>
ffffffffc0202a3a:	1af00593          	li	a1,431
ffffffffc0202a3e:	00003517          	auipc	a0,0x3
ffffffffc0202a42:	33a50513          	addi	a0,a0,826 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc0202a46:	a01fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202a4a:	00003697          	auipc	a3,0x3
ffffffffc0202a4e:	7e668693          	addi	a3,a3,2022 # ffffffffc0206230 <default_pmm_manager+0x608>
ffffffffc0202a52:	00003617          	auipc	a2,0x3
ffffffffc0202a56:	e2660613          	addi	a2,a2,-474 # ffffffffc0205878 <commands+0x738>
ffffffffc0202a5a:	1ac00593          	li	a1,428
ffffffffc0202a5e:	00003517          	auipc	a0,0x3
ffffffffc0202a62:	31a50513          	addi	a0,a0,794 # ffffffffc0205d78 <default_pmm_manager+0x150>
ffffffffc0202a66:	9e1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p) == 2);
ffffffffc0202a6a:	00003697          	auipc	a3,0x3
ffffffffc0202a6e:	79668693          	addi	a3,a3,1942 # ffffffffc0206200 <default_pmm_manager+0x5d8>
ffffffffc0202a72:	00003617          	auipc	a2,0x3
ffffffffc0202a76:	e0660613          	addi	a2,a2,-506 # ffffffffc0205878 <commands+0x738>
ffffffffc0202a7a:	1a800593          	li	a1,424
ffffffffc0202a7e:	00003517          	auipc	a0,0x3
ffffffffc0202a82:	2fa50513          	addi	a0,a0,762 # ffffffffc0205d78 <default_pmm_manager+0x150>
...
ffffffffc0202af4:	7c068693          	addi	a3,a3,1984 # ffffffffc02062b0 <default_pmm_manager+0x688>
ffffffffc0202af8:	00003617          	auipc	a2,0x3
ffffffffc0202afc:	d8060613          	addi	a2,a2,-640 # ffffffffc0205878 <commands+0x738>
ffffffffc0202b00:	14800593          	li	a1,328
ffffffffc0202b04:	00003517          	auipc	a0,0x3
ffffffffc0202b08:	27450513          	addi	a0,a0,628 # ffffffffc0205d78 <default_pmm_manager+0x150>
...
ffffffffc0202b4e:	1e660613          	addi	a2,a2,486 # ffffffffc0205d30 <default_pmm_manager+0x108>
ffffffffc0202b52:	06200593          	li	a1,98
ffffffffc0202b56:	00003517          	auipc	a0,0x3
ffffffffc0202b5a:	13250513          	addi	a0,a0,306 # ffffffffc0205c88 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0202b7e:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202b80:	564010ef          	jal	ra,ffffffffc02040e4 <swapfs_init>
...
ffffffffc0202bde:	71e50513          	addi	a0,a0,1822 # ffffffffc02062f8 <default_pmm_manager+0x6d0>
    return listelm->next;
...
ffffffffc0202c30:	6e450513          	addi	a0,a0,1764 # ffffffffc0206310 <default_pmm_manager+0x6e8>
...
ffffffffc0202c84:	70050513          	addi	a0,a0,1792 # ffffffffc0206380 <default_pmm_manager+0x758>
...
ffffffffc0202ca0:	73450513          	addi	a0,a0,1844 # ffffffffc02063d0 <default_pmm_manager+0x7a8>
...
ffffffffc0202d14:	74850513          	addi	a0,a0,1864 # ffffffffc0206458 <default_pmm_manager+0x830>
...
ffffffffc0202e2c:	1f860613          	addi	a2,a2,504 # ffffffffc0207020 <nbase>
...
ffffffffc0202e58:	6ac50513          	addi	a0,a0,1708 # ffffffffc0206500 <default_pmm_manager+0x8d8>
...
ffffffffc0202f2c:	62850513          	addi	a0,a0,1576 # ffffffffc0206550 <default_pmm_manager+0x928>
...
ffffffffc0202f3e:	92e68693          	addi	a3,a3,-1746 # ffffffffc0205868 <commands+0x728>
ffffffffc0202f42:	00003617          	auipc	a2,0x3
ffffffffc0202f46:	93660613          	addi	a2,a2,-1738 # ffffffffc0205878 <commands+0x738>
ffffffffc0202f4a:	0bd00593          	li	a1,189
ffffffffc0202f4e:	00003517          	auipc	a0,0x3
ffffffffc0202f52:	39a50513          	addi	a0,a0,922 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
...
ffffffffc0202f62:	dd260613          	addi	a2,a2,-558 # ffffffffc0205d30 <default_pmm_manager+0x108>
ffffffffc0202f66:	06200593          	li	a1,98
ffffffffc0202f6a:	00003517          	auipc	a0,0x3
ffffffffc0202f6e:	d1e50513          	addi	a0,a0,-738 # ffffffffc0205c88 <default_pmm_manager+0x60>
ffffffffc0202f72:	cd4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202f76:	00003697          	auipc	a3,0x3
ffffffffc0202f7a:	56268693          	addi	a3,a3,1378 # ffffffffc02064d8 <default_pmm_manager+0x8b0>
ffffffffc0202f7e:	00003617          	auipc	a2,0x3
ffffffffc0202f82:	8fa60613          	addi	a2,a2,-1798 # ffffffffc0205878 <commands+0x738>
ffffffffc0202f86:	0fd00593          	li	a1,253
ffffffffc0202f8a:	00003517          	auipc	a0,0x3
ffffffffc0202f8e:	35e50513          	addi	a0,a0,862 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
ffffffffc0202f92:	cb4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202f96:	00003697          	auipc	a3,0x3
ffffffffc0202f9a:	46268693          	addi	a3,a3,1122 # ffffffffc02063f8 <default_pmm_manager+0x7d0>
ffffffffc0202f9e:	00003617          	auipc	a2,0x3
ffffffffc0202fa2:	8da60613          	addi	a2,a2,-1830 # ffffffffc0205878 <commands+0x738>
ffffffffc0202fa6:	0dd00593          	li	a1,221
ffffffffc0202faa:	00003517          	auipc	a0,0x3
ffffffffc0202fae:	33e50513          	addi	a0,a0,830 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
ffffffffc0202fb2:	c94fd0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202fb6:	00003617          	auipc	a2,0x3
ffffffffc0202fba:	31260613          	addi	a2,a2,786 # ffffffffc02062c8 <default_pmm_manager+0x6a0>
ffffffffc0202fbe:	02a00593          	li	a1,42
ffffffffc0202fc2:	00003517          	auipc	a0,0x3
ffffffffc0202fc6:	32650513          	addi	a0,a0,806 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
ffffffffc0202fca:	c7cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202fce:	00003697          	auipc	a3,0x3
ffffffffc0202fd2:	4f268693          	addi	a3,a3,1266 # ffffffffc02064c0 <default_pmm_manager+0x898>
ffffffffc0202fd6:	00003617          	auipc	a2,0x3
ffffffffc0202fda:	8a260613          	addi	a2,a2,-1886 # ffffffffc0205878 <commands+0x738>
ffffffffc0202fde:	0fc00593          	li	a1,252
ffffffffc0202fe2:	00003517          	auipc	a0,0x3
ffffffffc0202fe6:	30650513          	addi	a0,a0,774 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
ffffffffc0202fea:	c5cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202fee:	00003617          	auipc	a2,0x3
ffffffffc0202ff2:	d6260613          	addi	a2,a2,-670 # ffffffffc0205d50 <default_pmm_manager+0x128>
ffffffffc0202ff6:	07400593          	li	a1,116
ffffffffc0202ffa:	00003517          	auipc	a0,0x3
ffffffffc0202ffe:	c8e50513          	addi	a0,a0,-882 # ffffffffc0205c88 <default_pmm_manager+0x60>
ffffffffc0203002:	c44fd0ef          	jal	ra,ffffffffc0200446 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0203006:	00003697          	auipc	a3,0x3
ffffffffc020300a:	40a68693          	addi	a3,a3,1034 # ffffffffc0206410 <default_pmm_manager+0x7e8>
ffffffffc020300e:	00003617          	auipc	a2,0x3
ffffffffc0203012:	86a60613          	addi	a2,a2,-1942 # ffffffffc0205878 <commands+0x738>
ffffffffc0203016:	0de00593          	li	a1,222
ffffffffc020301a:	00003517          	auipc	a0,0x3
ffffffffc020301e:	2ce50513          	addi	a0,a0,718 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
ffffffffc0203022:	c24fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0203026:	00003697          	auipc	a3,0x3
ffffffffc020302a:	32268693          	addi	a3,a3,802 # ffffffffc0206348 <default_pmm_manager+0x720>
ffffffffc020302e:	00003617          	auipc	a2,0x3
ffffffffc0203032:	84a60613          	addi	a2,a2,-1974 # ffffffffc0205878 <commands+0x738>
ffffffffc0203036:	0c800593          	li	a1,200
ffffffffc020303a:	00003517          	auipc	a0,0x3
ffffffffc020303e:	2ae50513          	addi	a0,a0,686 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
ffffffffc0203042:	c04fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(total == nr_free_pages());
ffffffffc0203046:	00003697          	auipc	a3,0x3
ffffffffc020304a:	86268693          	addi	a3,a3,-1950 # ffffffffc02058a8 <commands+0x768>
ffffffffc020304e:	00003617          	auipc	a2,0x3
ffffffffc0203052:	82a60613          	addi	a2,a2,-2006 # ffffffffc0205878 <commands+0x738>
ffffffffc0203056:	0c000593          	li	a1,192
ffffffffc020305a:	00003517          	auipc	a0,0x3
ffffffffc020305e:	28e50513          	addi	a0,a0,654 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
ffffffffc0203062:	be4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert( nr_free == 0);         
ffffffffc0203066:	00003697          	auipc	a3,0x3
ffffffffc020306a:	9ea68693          	addi	a3,a3,-1558 # ffffffffc0205a50 <commands+0x910>
ffffffffc020306e:	00003617          	auipc	a2,0x3
ffffffffc0203072:	80a60613          	addi	a2,a2,-2038 # ffffffffc0205878 <commands+0x738>
ffffffffc0203076:	0f400593          	li	a1,244
ffffffffc020307a:	00003517          	auipc	a0,0x3
ffffffffc020307e:	26e50513          	addi	a0,a0,622 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
ffffffffc0203082:	bc4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0203086:	00003697          	auipc	a3,0x3
ffffffffc020308a:	2da68693          	addi	a3,a3,730 # ffffffffc0206360 <default_pmm_manager+0x738>
ffffffffc020308e:	00002617          	auipc	a2,0x2
ffffffffc0203092:	7ea60613          	addi	a2,a2,2026 # ffffffffc0205878 <commands+0x738>
ffffffffc0203096:	0cd00593          	li	a1,205
ffffffffc020309a:	00003517          	auipc	a0,0x3
ffffffffc020309e:	24e50513          	addi	a0,a0,590 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
ffffffffc02030a2:	ba4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(mm != NULL);
ffffffffc02030a6:	00003697          	auipc	a3,0x3
ffffffffc02030aa:	29268693          	addi	a3,a3,658 # ffffffffc0206338 <default_pmm_manager+0x710>
ffffffffc02030ae:	00002617          	auipc	a2,0x2
ffffffffc02030b2:	7ca60613          	addi	a2,a2,1994 # ffffffffc0205878 <commands+0x738>
ffffffffc02030b6:	0c500593          	li	a1,197
ffffffffc02030ba:	00003517          	auipc	a0,0x3
ffffffffc02030be:	22e50513          	addi	a0,a0,558 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
ffffffffc02030c2:	b84fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(total==0);
ffffffffc02030c6:	00003697          	auipc	a3,0x3
ffffffffc02030ca:	47a68693          	addi	a3,a3,1146 # ffffffffc0206540 <default_pmm_manager+0x918>
ffffffffc02030ce:	00002617          	auipc	a2,0x2
ffffffffc02030d2:	7aa60613          	addi	a2,a2,1962 # ffffffffc0205878 <commands+0x738>
ffffffffc02030d6:	11d00593          	li	a1,285
ffffffffc02030da:	00003517          	auipc	a0,0x3
ffffffffc02030de:	20e50513          	addi	a0,a0,526 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
ffffffffc02030e2:	b64fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc02030e6:	00003617          	auipc	a2,0x3
ffffffffc02030ea:	b7a60613          	addi	a2,a2,-1158 # ffffffffc0205c60 <default_pmm_manager+0x38>
ffffffffc02030ee:	06900593          	li	a1,105
ffffffffc02030f2:	00003517          	auipc	a0,0x3
ffffffffc02030f6:	b9650513          	addi	a0,a0,-1130 # ffffffffc0205c88 <default_pmm_manager+0x60>
ffffffffc02030fa:	b4cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(count==0);
ffffffffc02030fe:	00003697          	auipc	a3,0x3
ffffffffc0203102:	43268693          	addi	a3,a3,1074 # ffffffffc0206530 <default_pmm_manager+0x908>
ffffffffc0203106:	00002617          	auipc	a2,0x2
ffffffffc020310a:	77260613          	addi	a2,a2,1906 # ffffffffc0205878 <commands+0x738>
ffffffffc020310e:	11c00593          	li	a1,284
ffffffffc0203112:	00003517          	auipc	a0,0x3
ffffffffc0203116:	1d650513          	addi	a0,a0,470 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
ffffffffc020311a:	b2cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==1);
ffffffffc020311e:	00003697          	auipc	a3,0x3
ffffffffc0203122:	36268693          	addi	a3,a3,866 # ffffffffc0206480 <default_pmm_manager+0x858>
ffffffffc0203126:	00002617          	auipc	a2,0x2
ffffffffc020312a:	75260613          	addi	a2,a2,1874 # ffffffffc0205878 <commands+0x738>
ffffffffc020312e:	09600593          	li	a1,150
ffffffffc0203132:	00003517          	auipc	a0,0x3
ffffffffc0203136:	1b650513          	addi	a0,a0,438 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
ffffffffc020313a:	b0cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc020313e:	00003697          	auipc	a3,0x3
ffffffffc0203142:	2f268693          	addi	a3,a3,754 # ffffffffc0206430 <default_pmm_manager+0x808>
ffffffffc0203146:	00002617          	auipc	a2,0x2
ffffffffc020314a:	73260613          	addi	a2,a2,1842 # ffffffffc0205878 <commands+0x738>
ffffffffc020314e:	0eb00593          	li	a1,235
ffffffffc0203152:	00003517          	auipc	a0,0x3
ffffffffc0203156:	19650513          	addi	a0,a0,406 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
ffffffffc020315a:	aecfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc020315e:	00003697          	auipc	a3,0x3
ffffffffc0203162:	25a68693          	addi	a3,a3,602 # ffffffffc02063b8 <default_pmm_manager+0x790>
ffffffffc0203166:	00002617          	auipc	a2,0x2
ffffffffc020316a:	71260613          	addi	a2,a2,1810 # ffffffffc0205878 <commands+0x738>
ffffffffc020316e:	0d800593          	li	a1,216
ffffffffc0203172:	00003517          	auipc	a0,0x3
ffffffffc0203176:	17650513          	addi	a0,a0,374 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
ffffffffc020317a:	accfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(ret==0);
ffffffffc020317e:	00003697          	auipc	a3,0x3
ffffffffc0203182:	3aa68693          	addi	a3,a3,938 # ffffffffc0206528 <default_pmm_manager+0x900>
ffffffffc0203186:	00002617          	auipc	a2,0x2
ffffffffc020318a:	6f260613          	addi	a2,a2,1778 # ffffffffc0205878 <commands+0x738>
ffffffffc020318e:	10300593          	li	a1,259
ffffffffc0203192:	00003517          	auipc	a0,0x3
ffffffffc0203196:	15650513          	addi	a0,a0,342 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
ffffffffc020319a:	aacfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(vma != NULL);
ffffffffc020319e:	00003697          	auipc	a3,0x3
ffffffffc02031a2:	1d268693          	addi	a3,a3,466 # ffffffffc0206370 <default_pmm_manager+0x748>
ffffffffc02031a6:	00002617          	auipc	a2,0x2
ffffffffc02031aa:	6d260613          	addi	a2,a2,1746 # ffffffffc0205878 <commands+0x738>
ffffffffc02031ae:	0d000593          	li	a1,208
ffffffffc02031b2:	00003517          	auipc	a0,0x3
ffffffffc02031b6:	13650513          	addi	a0,a0,310 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
ffffffffc02031ba:	a8cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==4);
ffffffffc02031be:	00003697          	auipc	a3,0x3
ffffffffc02031c2:	2f268693          	addi	a3,a3,754 # ffffffffc02064b0 <default_pmm_manager+0x888>
ffffffffc02031c6:	00002617          	auipc	a2,0x2
ffffffffc02031ca:	6b260613          	addi	a2,a2,1714 # ffffffffc0205878 <commands+0x738>
ffffffffc02031ce:	0a000593          	li	a1,160
ffffffffc02031d2:	00003517          	auipc	a0,0x3
ffffffffc02031d6:	11650513          	addi	a0,a0,278 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
ffffffffc02031da:	a6cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==4);
ffffffffc02031de:	00003697          	auipc	a3,0x3
ffffffffc02031e2:	2d268693          	addi	a3,a3,722 # ffffffffc02064b0 <default_pmm_manager+0x888>
ffffffffc02031e6:	00002617          	auipc	a2,0x2
ffffffffc02031ea:	69260613          	addi	a2,a2,1682 # ffffffffc0205878 <commands+0x738>
ffffffffc02031ee:	0a200593          	li	a1,162
ffffffffc02031f2:	00003517          	auipc	a0,0x3
ffffffffc02031f6:	0f650513          	addi	a0,a0,246 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
ffffffffc02031fa:	a4cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==2);
ffffffffc02031fe:	00003697          	auipc	a3,0x3
ffffffffc0203202:	29268693          	addi	a3,a3,658 # ffffffffc0206490 <default_pmm_manager+0x868>
ffffffffc0203206:	00002617          	auipc	a2,0x2
ffffffffc020320a:	67260613          	addi	a2,a2,1650 # ffffffffc0205878 <commands+0x738>
ffffffffc020320e:	09800593          	li	a1,152
ffffffffc0203212:	00003517          	auipc	a0,0x3
ffffffffc0203216:	0d650513          	addi	a0,a0,214 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
ffffffffc020321a:	a2cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==2);
ffffffffc020321e:	00003697          	auipc	a3,0x3
ffffffffc0203222:	27268693          	addi	a3,a3,626 # ffffffffc0206490 <default_pmm_manager+0x868>
ffffffffc0203226:	00002617          	auipc	a2,0x2
ffffffffc020322a:	65260613          	addi	a2,a2,1618 # ffffffffc0205878 <commands+0x738>
ffffffffc020322e:	09a00593          	li	a1,154
ffffffffc0203232:	00003517          	auipc	a0,0x3
ffffffffc0203236:	0b650513          	addi	a0,a0,182 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
ffffffffc020323a:	a0cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==3);
ffffffffc020323e:	00003697          	auipc	a3,0x3
ffffffffc0203242:	26268693          	addi	a3,a3,610 # ffffffffc02064a0 <default_pmm_manager+0x878>
ffffffffc0203246:	00002617          	auipc	a2,0x2
ffffffffc020324a:	63260613          	addi	a2,a2,1586 # ffffffffc0205878 <commands+0x738>
ffffffffc020324e:	09c00593          	li	a1,156
ffffffffc0203252:	00003517          	auipc	a0,0x3
ffffffffc0203256:	09650513          	addi	a0,a0,150 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
ffffffffc020325a:	9ecfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==3);
ffffffffc020325e:	00003697          	auipc	a3,0x3
ffffffffc0203262:	24268693          	addi	a3,a3,578 # ffffffffc02064a0 <default_pmm_manager+0x878>
ffffffffc0203266:	00002617          	auipc	a2,0x2
ffffffffc020326a:	61260613          	addi	a2,a2,1554 # ffffffffc0205878 <commands+0x738>
ffffffffc020326e:	09e00593          	li	a1,158
ffffffffc0203272:	00003517          	auipc	a0,0x3
ffffffffc0203276:	07650513          	addi	a0,a0,118 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
ffffffffc020327a:	9ccfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==1);
ffffffffc020327e:	00003697          	auipc	a3,0x3
ffffffffc0203282:	20268693          	addi	a3,a3,514 # ffffffffc0206480 <default_pmm_manager+0x858>
ffffffffc0203286:	00002617          	auipc	a2,0x2
ffffffffc020328a:	5f260613          	addi	a2,a2,1522 # ffffffffc0205878 <commands+0x738>
ffffffffc020328e:	09400593          	li	a1,148
ffffffffc0203292:	00003517          	auipc	a0,0x3
ffffffffc0203296:	05650513          	addi	a0,a0,86 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
...
ffffffffc02032e2:	2f2b0b13          	addi	s6,s6,754 # ffffffffc02065d0 <default_pmm_manager+0x9a8>
                    cprintf("SWAP: failed to save\n");
ffffffffc02032e6:	00003b97          	auipc	s7,0x3
ffffffffc02032ea:	2d2b8b93          	addi	s7,s7,722 # ffffffffc02065b8 <default_pmm_manager+0x990>
...
ffffffffc020335a:	651000ef          	jal	ra,ffffffffc02041aa <swapfs_write>
...
ffffffffc020339c:	1d850513          	addi	a0,a0,472 # ffffffffc0206570 <default_pmm_manager+0x948>
...
ffffffffc02033ae:	1f668693          	addi	a3,a3,502 # ffffffffc02065a0 <default_pmm_manager+0x978>
ffffffffc02033b2:	00002617          	auipc	a2,0x2
ffffffffc02033b6:	4c660613          	addi	a2,a2,1222 # ffffffffc0205878 <commands+0x738>
ffffffffc02033ba:	06900593          	li	a1,105
ffffffffc02033be:	00003517          	auipc	a0,0x3
ffffffffc02033c2:	f2a50513          	addi	a0,a0,-214 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
...
ffffffffc02033f8:	525000ef          	jal	ra,ffffffffc020411c <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc02033fc:	00093583          	ld	a1,0(s2)
ffffffffc0203400:	8626                	mv	a2,s1
ffffffffc0203402:	00003517          	auipc	a0,0x3
ffffffffc0203406:	21e50513          	addi	a0,a0,542 # ffffffffc0206620 <default_pmm_manager+0x9f8>
...
ffffffffc0203428:	1ec68693          	addi	a3,a3,492 # ffffffffc0206610 <default_pmm_manager+0x9e8>
ffffffffc020342c:	00002617          	auipc	a2,0x2
ffffffffc0203430:	44c60613          	addi	a2,a2,1100 # ffffffffc0205878 <commands+0x738>
ffffffffc0203434:	07f00593          	li	a1,127
ffffffffc0203438:	00003517          	auipc	a0,0x3
ffffffffc020343c:	eb050513          	addi	a0,a0,-336 # ffffffffc02062e8 <default_pmm_manager+0x6c0>
...
ffffffffc020346c:	1f850513          	addi	a0,a0,504 # ffffffffc0206660 <default_pmm_manager+0xa38>
    *(unsigned char *)0x3000 = 0x0c;
...
ffffffffc02034a2:	20250513          	addi	a0,a0,514 # ffffffffc02066a0 <default_pmm_manager+0xa78>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc02034c6:	20650513          	addi	a0,a0,518 # ffffffffc02066c8 <default_pmm_manager+0xaa0>
    *(unsigned char *)0x4000 = 0x0d;
...
ffffffffc02034e4:	21050513          	addi	a0,a0,528 # ffffffffc02066f0 <default_pmm_manager+0xac8>
    *(unsigned char *)0x2000 = 0x0b;
...
ffffffffc0203500:	21c50513          	addi	a0,a0,540 # ffffffffc0206718 <default_pmm_manager+0xaf0>
...
ffffffffc020351e:	1d650513          	addi	a0,a0,470 # ffffffffc02066f0 <default_pmm_manager+0xac8>
...
ffffffffc0203536:	16e50513          	addi	a0,a0,366 # ffffffffc02066a0 <default_pmm_manager+0xa78>
...
ffffffffc0203550:	1a450513          	addi	a0,a0,420 # ffffffffc02066f0 <default_pmm_manager+0xac8>
...
ffffffffc020356a:	0fa50513          	addi	a0,a0,250 # ffffffffc0206660 <default_pmm_manager+0xa38>
...
ffffffffc0203584:	14850513          	addi	a0,a0,328 # ffffffffc02066c8 <default_pmm_manager+0xaa0>
...
ffffffffc020359e:	17e50513          	addi	a0,a0,382 # ffffffffc0206718 <default_pmm_manager+0xaf0>
...
ffffffffc02035bc:	0e850513          	addi	a0,a0,232 # ffffffffc02066a0 <default_pmm_manager+0xa78>
...
ffffffffc02035fa:	eba68693          	addi	a3,a3,-326 # ffffffffc02064b0 <default_pmm_manager+0x888>
ffffffffc02035fe:	00002617          	auipc	a2,0x2
ffffffffc0203602:	27a60613          	addi	a2,a2,634 # ffffffffc0205878 <commands+0x738>
ffffffffc0203606:	05100593          	li	a1,81
ffffffffc020360a:	00003517          	auipc	a0,0x3
ffffffffc020360e:	07e50513          	addi	a0,a0,126 # ffffffffc0206688 <default_pmm_manager+0xa60>
ffffffffc0203612:	e35fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==11);
ffffffffc0203616:	00003697          	auipc	a3,0x3
ffffffffc020361a:	1b268693          	addi	a3,a3,434 # ffffffffc02067c8 <default_pmm_manager+0xba0>
ffffffffc020361e:	00002617          	auipc	a2,0x2
ffffffffc0203622:	25a60613          	addi	a2,a2,602 # ffffffffc0205878 <commands+0x738>
ffffffffc0203626:	07300593          	li	a1,115
ffffffffc020362a:	00003517          	auipc	a0,0x3
ffffffffc020362e:	05e50513          	addi	a0,a0,94 # ffffffffc0206688 <default_pmm_manager+0xa60>
ffffffffc0203632:	e15fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203636:	00003697          	auipc	a3,0x3
ffffffffc020363a:	16a68693          	addi	a3,a3,362 # ffffffffc02067a0 <default_pmm_manager+0xb78>
ffffffffc020363e:	00002617          	auipc	a2,0x2
ffffffffc0203642:	23a60613          	addi	a2,a2,570 # ffffffffc0205878 <commands+0x738>
ffffffffc0203646:	07100593          	li	a1,113
ffffffffc020364a:	00003517          	auipc	a0,0x3
ffffffffc020364e:	03e50513          	addi	a0,a0,62 # ffffffffc0206688 <default_pmm_manager+0xa60>
ffffffffc0203652:	df5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==10);
ffffffffc0203656:	00003697          	auipc	a3,0x3
ffffffffc020365a:	13a68693          	addi	a3,a3,314 # ffffffffc0206790 <default_pmm_manager+0xb68>
ffffffffc020365e:	00002617          	auipc	a2,0x2
ffffffffc0203662:	21a60613          	addi	a2,a2,538 # ffffffffc0205878 <commands+0x738>
ffffffffc0203666:	06f00593          	li	a1,111
ffffffffc020366a:	00003517          	auipc	a0,0x3
ffffffffc020366e:	01e50513          	addi	a0,a0,30 # ffffffffc0206688 <default_pmm_manager+0xa60>
ffffffffc0203672:	dd5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==9);
ffffffffc0203676:	00003697          	auipc	a3,0x3
ffffffffc020367a:	10a68693          	addi	a3,a3,266 # ffffffffc0206780 <default_pmm_manager+0xb58>
ffffffffc020367e:	00002617          	auipc	a2,0x2
ffffffffc0203682:	1fa60613          	addi	a2,a2,506 # ffffffffc0205878 <commands+0x738>
ffffffffc0203686:	06c00593          	li	a1,108
ffffffffc020368a:	00003517          	auipc	a0,0x3
ffffffffc020368e:	ffe50513          	addi	a0,a0,-2 # ffffffffc0206688 <default_pmm_manager+0xa60>
ffffffffc0203692:	db5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==8);
ffffffffc0203696:	00003697          	auipc	a3,0x3
ffffffffc020369a:	0da68693          	addi	a3,a3,218 # ffffffffc0206770 <default_pmm_manager+0xb48>
ffffffffc020369e:	00002617          	auipc	a2,0x2
ffffffffc02036a2:	1da60613          	addi	a2,a2,474 # ffffffffc0205878 <commands+0x738>
ffffffffc02036a6:	06900593          	li	a1,105
ffffffffc02036aa:	00003517          	auipc	a0,0x3
ffffffffc02036ae:	fde50513          	addi	a0,a0,-34 # ffffffffc0206688 <default_pmm_manager+0xa60>
ffffffffc02036b2:	d95fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==7);
ffffffffc02036b6:	00003697          	auipc	a3,0x3
ffffffffc02036ba:	0aa68693          	addi	a3,a3,170 # ffffffffc0206760 <default_pmm_manager+0xb38>
ffffffffc02036be:	00002617          	auipc	a2,0x2
ffffffffc02036c2:	1ba60613          	addi	a2,a2,442 # ffffffffc0205878 <commands+0x738>
ffffffffc02036c6:	06600593          	li	a1,102
ffffffffc02036ca:	00003517          	auipc	a0,0x3
ffffffffc02036ce:	fbe50513          	addi	a0,a0,-66 # ffffffffc0206688 <default_pmm_manager+0xa60>
ffffffffc02036d2:	d75fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==6);
ffffffffc02036d6:	00003697          	auipc	a3,0x3
ffffffffc02036da:	07a68693          	addi	a3,a3,122 # ffffffffc0206750 <default_pmm_manager+0xb28>
ffffffffc02036de:	00002617          	auipc	a2,0x2
ffffffffc02036e2:	19a60613          	addi	a2,a2,410 # ffffffffc0205878 <commands+0x738>
ffffffffc02036e6:	06300593          	li	a1,99
ffffffffc02036ea:	00003517          	auipc	a0,0x3
ffffffffc02036ee:	f9e50513          	addi	a0,a0,-98 # ffffffffc0206688 <default_pmm_manager+0xa60>
ffffffffc02036f2:	d55fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==5);
ffffffffc02036f6:	00003697          	auipc	a3,0x3
ffffffffc02036fa:	04a68693          	addi	a3,a3,74 # ffffffffc0206740 <default_pmm_manager+0xb18>
ffffffffc02036fe:	00002617          	auipc	a2,0x2
ffffffffc0203702:	17a60613          	addi	a2,a2,378 # ffffffffc0205878 <commands+0x738>
ffffffffc0203706:	06000593          	li	a1,96
ffffffffc020370a:	00003517          	auipc	a0,0x3
ffffffffc020370e:	f7e50513          	addi	a0,a0,-130 # ffffffffc0206688 <default_pmm_manager+0xa60>
ffffffffc0203712:	d35fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==5);
ffffffffc0203716:	00003697          	auipc	a3,0x3
ffffffffc020371a:	02a68693          	addi	a3,a3,42 # ffffffffc0206740 <default_pmm_manager+0xb18>
ffffffffc020371e:	00002617          	auipc	a2,0x2
ffffffffc0203722:	15a60613          	addi	a2,a2,346 # ffffffffc0205878 <commands+0x738>
ffffffffc0203726:	05d00593          	li	a1,93
ffffffffc020372a:	00003517          	auipc	a0,0x3
ffffffffc020372e:	f5e50513          	addi	a0,a0,-162 # ffffffffc0206688 <default_pmm_manager+0xa60>
ffffffffc0203732:	d15fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203736:	00003697          	auipc	a3,0x3
ffffffffc020373a:	d7a68693          	addi	a3,a3,-646 # ffffffffc02064b0 <default_pmm_manager+0x888>
ffffffffc020373e:	00002617          	auipc	a2,0x2
ffffffffc0203742:	13a60613          	addi	a2,a2,314 # ffffffffc0205878 <commands+0x738>
ffffffffc0203746:	05a00593          	li	a1,90
ffffffffc020374a:	00003517          	auipc	a0,0x3
ffffffffc020374e:	f3e50513          	addi	a0,a0,-194 # ffffffffc0206688 <default_pmm_manager+0xa60>
ffffffffc0203752:	cf5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203756:	00003697          	auipc	a3,0x3
ffffffffc020375a:	d5a68693          	addi	a3,a3,-678 # ffffffffc02064b0 <default_pmm_manager+0x888>
ffffffffc020375e:	00002617          	auipc	a2,0x2
ffffffffc0203762:	11a60613          	addi	a2,a2,282 # ffffffffc0205878 <commands+0x738>
ffffffffc0203766:	05700593          	li	a1,87
ffffffffc020376a:	00003517          	auipc	a0,0x3
ffffffffc020376e:	f1e50513          	addi	a0,a0,-226 # ffffffffc0206688 <default_pmm_manager+0xa60>
ffffffffc0203772:	cd5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203776:	00003697          	auipc	a3,0x3
ffffffffc020377a:	d3a68693          	addi	a3,a3,-710 # ffffffffc02064b0 <default_pmm_manager+0x888>
ffffffffc020377e:	00002617          	auipc	a2,0x2
ffffffffc0203782:	0fa60613          	addi	a2,a2,250 # ffffffffc0205878 <commands+0x738>
ffffffffc0203786:	05400593          	li	a1,84
ffffffffc020378a:	00003517          	auipc	a0,0x3
ffffffffc020378e:	efe50513          	addi	a0,a0,-258 # ffffffffc0206688 <default_pmm_manager+0xa60>
...
ffffffffc02037bc:	02068693          	addi	a3,a3,32 # ffffffffc02067d8 <default_pmm_manager+0xbb0>
ffffffffc02037c0:	00002617          	auipc	a2,0x2
ffffffffc02037c4:	0b860613          	addi	a2,a2,184 # ffffffffc0205878 <commands+0x738>
ffffffffc02037c8:	04100593          	li	a1,65
ffffffffc02037cc:	00003517          	auipc	a0,0x3
ffffffffc02037d0:	ebc50513          	addi	a0,a0,-324 # ffffffffc0206688 <default_pmm_manager+0xa60>
ffffffffc02037d4:	c73fc0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(in_tick==0);
ffffffffc02037d8:	00003697          	auipc	a3,0x3
ffffffffc02037dc:	01068693          	addi	a3,a3,16 # ffffffffc02067e8 <default_pmm_manager+0xbc0>
ffffffffc02037e0:	00002617          	auipc	a2,0x2
ffffffffc02037e4:	09860613          	addi	a2,a2,152 # ffffffffc0205878 <commands+0x738>
ffffffffc02037e8:	04200593          	li	a1,66
ffffffffc02037ec:	00003517          	auipc	a0,0x3
ffffffffc02037f0:	e9c50513          	addi	a0,a0,-356 # ffffffffc0206688 <default_pmm_manager+0xa60>
...
ffffffffc0203814:	fe868693          	addi	a3,a3,-24 # ffffffffc02067f8 <default_pmm_manager+0xbd0>
ffffffffc0203818:	00002617          	auipc	a2,0x2
ffffffffc020381c:	06060613          	addi	a2,a2,96 # ffffffffc0205878 <commands+0x738>
ffffffffc0203820:	03200593          	li	a1,50
ffffffffc0203824:	00003517          	auipc	a0,0x3
ffffffffc0203828:	e6450513          	addi	a0,a0,-412 # ffffffffc0206688 <default_pmm_manager+0xa60>
{
...
ffffffffc0203838:	ffc68693          	addi	a3,a3,-4 # ffffffffc0206830 <default_pmm_manager+0xc08>
ffffffffc020383c:	00002617          	auipc	a2,0x2
ffffffffc0203840:	03c60613          	addi	a2,a2,60 # ffffffffc0205878 <commands+0x738>
ffffffffc0203844:	07e00593          	li	a1,126
ffffffffc0203848:	00003517          	auipc	a0,0x3
ffffffffc020384c:	00850513          	addi	a0,a0,8 # ffffffffc0206850 <default_pmm_manager+0xc28>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc0203980:	ee468693          	addi	a3,a3,-284 # ffffffffc0206860 <default_pmm_manager+0xc38>
ffffffffc0203984:	00002617          	auipc	a2,0x2
ffffffffc0203988:	ef460613          	addi	a2,a2,-268 # ffffffffc0205878 <commands+0x738>
ffffffffc020398c:	08500593          	li	a1,133
ffffffffc0203990:	00003517          	auipc	a0,0x3
ffffffffc0203994:	ec050513          	addi	a0,a0,-320 # ffffffffc0206850 <default_pmm_manager+0xc28>
ffffffffc0203998:	aaffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020399c:	00003697          	auipc	a3,0x3
ffffffffc02039a0:	f0468693          	addi	a3,a3,-252 # ffffffffc02068a0 <default_pmm_manager+0xc78>
ffffffffc02039a4:	00002617          	auipc	a2,0x2
ffffffffc02039a8:	ed460613          	addi	a2,a2,-300 # ffffffffc0205878 <commands+0x738>
ffffffffc02039ac:	07d00593          	li	a1,125
ffffffffc02039b0:	00003517          	auipc	a0,0x3
ffffffffc02039b4:	ea050513          	addi	a0,a0,-352 # ffffffffc0206850 <default_pmm_manager+0xc28>
ffffffffc02039b8:	a8ffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02039bc:	00003697          	auipc	a3,0x3
ffffffffc02039c0:	ec468693          	addi	a3,a3,-316 # ffffffffc0206880 <default_pmm_manager+0xc58>
ffffffffc02039c4:	00002617          	auipc	a2,0x2
ffffffffc02039c8:	eb460613          	addi	a2,a2,-332 # ffffffffc0205878 <commands+0x738>
ffffffffc02039cc:	07c00593          	li	a1,124
ffffffffc02039d0:	00003517          	auipc	a0,0x3
ffffffffc02039d4:	e8050513          	addi	a0,a0,-384 # ffffffffc0206850 <default_pmm_manager+0xc28>
...
ffffffffc0203a72:	90268693          	addi	a3,a3,-1790 # ffffffffc0206370 <default_pmm_manager+0x748>
ffffffffc0203a76:	00002617          	auipc	a2,0x2
ffffffffc0203a7a:	e0260613          	addi	a2,a2,-510 # ffffffffc0205878 <commands+0x738>
ffffffffc0203a7e:	0c900593          	li	a1,201
ffffffffc0203a82:	00003517          	auipc	a0,0x3
ffffffffc0203a86:	dce50513          	addi	a0,a0,-562 # ffffffffc0206850 <default_pmm_manager+0xc28>
...
ffffffffc0203ac6:	8ae68693          	addi	a3,a3,-1874 # ffffffffc0206370 <default_pmm_manager+0x748>
ffffffffc0203aca:	00002617          	auipc	a2,0x2
ffffffffc0203ace:	dae60613          	addi	a2,a2,-594 # ffffffffc0205878 <commands+0x738>
ffffffffc0203ad2:	0cf00593          	li	a1,207
ffffffffc0203ad6:	00003517          	auipc	a0,0x3
ffffffffc0203ada:	d7a50513          	addi	a0,a0,-646 # ffffffffc0206850 <default_pmm_manager+0xc28>
...
ffffffffc0203b9a:	e2a50513          	addi	a0,a0,-470 # ffffffffc02069c0 <default_pmm_manager+0xd98>
ffffffffc0203b9e:	de2fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203ba2:	00003697          	auipc	a3,0x3
ffffffffc0203ba6:	e4668693          	addi	a3,a3,-442 # ffffffffc02069e8 <default_pmm_manager+0xdc0>
ffffffffc0203baa:	00002617          	auipc	a2,0x2
ffffffffc0203bae:	cce60613          	addi	a2,a2,-818 # ffffffffc0205878 <commands+0x738>
ffffffffc0203bb2:	0f100593          	li	a1,241
ffffffffc0203bb6:	00003517          	auipc	a0,0x3
ffffffffc0203bba:	c9a50513          	addi	a0,a0,-870 # ffffffffc0206850 <default_pmm_manager+0xc28>
...
ffffffffc0203be8:	e1c50513          	addi	a0,a0,-484 # ffffffffc0206a00 <default_pmm_manager+0xdd8>
...
ffffffffc0203cc2:	362a3a03          	ld	s4,866(s4) # ffffffffc0207020 <nbase>
...
ffffffffc0203d7c:	d0050513          	addi	a0,a0,-768 # ffffffffc0206a78 <default_pmm_manager+0xe50>
...
ffffffffc0203d96:	d0650513          	addi	a0,a0,-762 # ffffffffc0206a98 <default_pmm_manager+0xe70>
}
...
ffffffffc0203daa:	b3268693          	addi	a3,a3,-1230 # ffffffffc02068d8 <default_pmm_manager+0xcb0>
ffffffffc0203dae:	00002617          	auipc	a2,0x2
ffffffffc0203db2:	aca60613          	addi	a2,a2,-1334 # ffffffffc0205878 <commands+0x738>
ffffffffc0203db6:	0d800593          	li	a1,216
ffffffffc0203dba:	00003517          	auipc	a0,0x3
ffffffffc0203dbe:	a9650513          	addi	a0,a0,-1386 # ffffffffc0206850 <default_pmm_manager+0xc28>
ffffffffc0203dc2:	e84fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203dc6:	00003697          	auipc	a3,0x3
ffffffffc0203dca:	b9a68693          	addi	a3,a3,-1126 # ffffffffc0206960 <default_pmm_manager+0xd38>
ffffffffc0203dce:	00002617          	auipc	a2,0x2
ffffffffc0203dd2:	aaa60613          	addi	a2,a2,-1366 # ffffffffc0205878 <commands+0x738>
ffffffffc0203dd6:	0e800593          	li	a1,232
ffffffffc0203dda:	00003517          	auipc	a0,0x3
ffffffffc0203dde:	a7650513          	addi	a0,a0,-1418 # ffffffffc0206850 <default_pmm_manager+0xc28>
ffffffffc0203de2:	e64fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203de6:	00003697          	auipc	a3,0x3
ffffffffc0203dea:	baa68693          	addi	a3,a3,-1110 # ffffffffc0206990 <default_pmm_manager+0xd68>
ffffffffc0203dee:	00002617          	auipc	a2,0x2
ffffffffc0203df2:	a8a60613          	addi	a2,a2,-1398 # ffffffffc0205878 <commands+0x738>
ffffffffc0203df6:	0e900593          	li	a1,233
ffffffffc0203dfa:	00003517          	auipc	a0,0x3
ffffffffc0203dfe:	a5650513          	addi	a0,a0,-1450 # ffffffffc0206850 <default_pmm_manager+0xc28>
ffffffffc0203e02:	e44fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203e06:	00003697          	auipc	a3,0x3
ffffffffc0203e0a:	aba68693          	addi	a3,a3,-1350 # ffffffffc02068c0 <default_pmm_manager+0xc98>
ffffffffc0203e0e:	00002617          	auipc	a2,0x2
ffffffffc0203e12:	a6a60613          	addi	a2,a2,-1430 # ffffffffc0205878 <commands+0x738>
ffffffffc0203e16:	0d600593          	li	a1,214
ffffffffc0203e1a:	00003517          	auipc	a0,0x3
ffffffffc0203e1e:	a3650513          	addi	a0,a0,-1482 # ffffffffc0206850 <default_pmm_manager+0xc28>
ffffffffc0203e22:	e24fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma4 == NULL);
ffffffffc0203e26:	00003697          	auipc	a3,0x3
ffffffffc0203e2a:	b1a68693          	addi	a3,a3,-1254 # ffffffffc0206940 <default_pmm_manager+0xd18>
ffffffffc0203e2e:	00002617          	auipc	a2,0x2
ffffffffc0203e32:	a4a60613          	addi	a2,a2,-1462 # ffffffffc0205878 <commands+0x738>
ffffffffc0203e36:	0e400593          	li	a1,228
ffffffffc0203e3a:	00003517          	auipc	a0,0x3
ffffffffc0203e3e:	a1650513          	addi	a0,a0,-1514 # ffffffffc0206850 <default_pmm_manager+0xc28>
ffffffffc0203e42:	e04fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma5 == NULL);
ffffffffc0203e46:	00003697          	auipc	a3,0x3
ffffffffc0203e4a:	b0a68693          	addi	a3,a3,-1270 # ffffffffc0206950 <default_pmm_manager+0xd28>
ffffffffc0203e4e:	00002617          	auipc	a2,0x2
ffffffffc0203e52:	a2a60613          	addi	a2,a2,-1494 # ffffffffc0205878 <commands+0x738>
ffffffffc0203e56:	0e600593          	li	a1,230
ffffffffc0203e5a:	00003517          	auipc	a0,0x3
ffffffffc0203e5e:	9f650513          	addi	a0,a0,-1546 # ffffffffc0206850 <default_pmm_manager+0xc28>
ffffffffc0203e62:	de4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1 != NULL);
ffffffffc0203e66:	00003697          	auipc	a3,0x3
ffffffffc0203e6a:	aaa68693          	addi	a3,a3,-1366 # ffffffffc0206910 <default_pmm_manager+0xce8>
ffffffffc0203e6e:	00002617          	auipc	a2,0x2
ffffffffc0203e72:	a0a60613          	addi	a2,a2,-1526 # ffffffffc0205878 <commands+0x738>
ffffffffc0203e76:	0de00593          	li	a1,222
ffffffffc0203e7a:	00003517          	auipc	a0,0x3
ffffffffc0203e7e:	9d650513          	addi	a0,a0,-1578 # ffffffffc0206850 <default_pmm_manager+0xc28>
ffffffffc0203e82:	dc4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2 != NULL);
ffffffffc0203e86:	00003697          	auipc	a3,0x3
ffffffffc0203e8a:	a9a68693          	addi	a3,a3,-1382 # ffffffffc0206920 <default_pmm_manager+0xcf8>
ffffffffc0203e8e:	00002617          	auipc	a2,0x2
ffffffffc0203e92:	9ea60613          	addi	a2,a2,-1558 # ffffffffc0205878 <commands+0x738>
ffffffffc0203e96:	0e000593          	li	a1,224
ffffffffc0203e9a:	00003517          	auipc	a0,0x3
ffffffffc0203e9e:	9b650513          	addi	a0,a0,-1610 # ffffffffc0206850 <default_pmm_manager+0xc28>
ffffffffc0203ea2:	da4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma3 == NULL);
ffffffffc0203ea6:	00003697          	auipc	a3,0x3
ffffffffc0203eaa:	a8a68693          	addi	a3,a3,-1398 # ffffffffc0206930 <default_pmm_manager+0xd08>
ffffffffc0203eae:	00002617          	auipc	a2,0x2
ffffffffc0203eb2:	9ca60613          	addi	a2,a2,-1590 # ffffffffc0205878 <commands+0x738>
ffffffffc0203eb6:	0e200593          	li	a1,226
ffffffffc0203eba:	00003517          	auipc	a0,0x3
ffffffffc0203ebe:	99650513          	addi	a0,a0,-1642 # ffffffffc0206850 <default_pmm_manager+0xc28>
ffffffffc0203ec2:	d84fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203ec6:	00003697          	auipc	a3,0x3
ffffffffc0203eca:	bea68693          	addi	a3,a3,-1046 # ffffffffc0206ab0 <default_pmm_manager+0xe88>
ffffffffc0203ece:	00002617          	auipc	a2,0x2
ffffffffc0203ed2:	9aa60613          	addi	a2,a2,-1622 # ffffffffc0205878 <commands+0x738>
ffffffffc0203ed6:	10100593          	li	a1,257
ffffffffc0203eda:	00003517          	auipc	a0,0x3
ffffffffc0203ede:	97650513          	addi	a0,a0,-1674 # ffffffffc0206850 <default_pmm_manager+0xc28>
    check_mm_struct = mm_create();
...
ffffffffc0203ef2:	48268693          	addi	a3,a3,1154 # ffffffffc0206370 <default_pmm_manager+0x748>
ffffffffc0203ef6:	00002617          	auipc	a2,0x2
ffffffffc0203efa:	98260613          	addi	a2,a2,-1662 # ffffffffc0205878 <commands+0x738>
ffffffffc0203efe:	10800593          	li	a1,264
ffffffffc0203f02:	00003517          	auipc	a0,0x3
ffffffffc0203f06:	94e50513          	addi	a0,a0,-1714 # ffffffffc0206850 <default_pmm_manager+0xc28>
ffffffffc0203f0a:	d3cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203f0e:	00003697          	auipc	a3,0x3
ffffffffc0203f12:	b1268693          	addi	a3,a3,-1262 # ffffffffc0206a20 <default_pmm_manager+0xdf8>
ffffffffc0203f16:	00002617          	auipc	a2,0x2
ffffffffc0203f1a:	96260613          	addi	a2,a2,-1694 # ffffffffc0205878 <commands+0x738>
ffffffffc0203f1e:	10d00593          	li	a1,269
ffffffffc0203f22:	00003517          	auipc	a0,0x3
ffffffffc0203f26:	92e50513          	addi	a0,a0,-1746 # ffffffffc0206850 <default_pmm_manager+0xc28>
ffffffffc0203f2a:	d1cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(sum == 0);
ffffffffc0203f2e:	00003697          	auipc	a3,0x3
ffffffffc0203f32:	b1268693          	addi	a3,a3,-1262 # ffffffffc0206a40 <default_pmm_manager+0xe18>
ffffffffc0203f36:	00002617          	auipc	a2,0x2
ffffffffc0203f3a:	94260613          	addi	a2,a2,-1726 # ffffffffc0205878 <commands+0x738>
ffffffffc0203f3e:	11700593          	li	a1,279
ffffffffc0203f42:	00003517          	auipc	a0,0x3
ffffffffc0203f46:	90e50513          	addi	a0,a0,-1778 # ffffffffc0206850 <default_pmm_manager+0xc28>
ffffffffc0203f4a:	cfcfc0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203f4e:	00002617          	auipc	a2,0x2
ffffffffc0203f52:	de260613          	addi	a2,a2,-542 # ffffffffc0205d30 <default_pmm_manager+0x108>
ffffffffc0203f56:	06200593          	li	a1,98
ffffffffc0203f5a:	00002517          	auipc	a0,0x2
ffffffffc0203f5e:	d2e50513          	addi	a0,a0,-722 # ffffffffc0205c88 <default_pmm_manager+0x60>
ffffffffc0203f62:	ce4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc0203f66:	00002617          	auipc	a2,0x2
ffffffffc0203f6a:	cfa60613          	addi	a2,a2,-774 # ffffffffc0205c60 <default_pmm_manager+0x38>
ffffffffc0203f6e:	06900593          	li	a1,105
ffffffffc0203f72:	00002517          	auipc	a0,0x2
ffffffffc0203f76:	d1650513          	addi	a0,a0,-746 # ffffffffc0205c88 <default_pmm_manager+0x60>
ffffffffc0203f7a:	cccfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203f7e:	00003697          	auipc	a3,0x3
ffffffffc0203f82:	ad268693          	addi	a3,a3,-1326 # ffffffffc0206a50 <default_pmm_manager+0xe28>
ffffffffc0203f86:	00002617          	auipc	a2,0x2
ffffffffc0203f8a:	8f260613          	addi	a2,a2,-1806 # ffffffffc0205878 <commands+0x738>
ffffffffc0203f8e:	12400593          	li	a1,292
ffffffffc0203f92:	00003517          	auipc	a0,0x3
ffffffffc0203f96:	8be50513          	addi	a0,a0,-1858 # ffffffffc0206850 <default_pmm_manager+0xc28>
ffffffffc0203f9a:	cacfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203f9e:	00002697          	auipc	a3,0x2
ffffffffc0203fa2:	3c268693          	addi	a3,a3,962 # ffffffffc0206360 <default_pmm_manager+0x738>
ffffffffc0203fa6:	00002617          	auipc	a2,0x2
ffffffffc0203faa:	8d260613          	addi	a2,a2,-1838 # ffffffffc0205878 <commands+0x738>
ffffffffc0203fae:	10500593          	li	a1,261
ffffffffc0203fb2:	00003517          	auipc	a0,0x3
ffffffffc0203fb6:	89e50513          	addi	a0,a0,-1890 # ffffffffc0206850 <default_pmm_manager+0xc28>
ffffffffc0203fba:	c8cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(mm != NULL);
ffffffffc0203fbe:	00002697          	auipc	a3,0x2
ffffffffc0203fc2:	37a68693          	addi	a3,a3,890 # ffffffffc0206338 <default_pmm_manager+0x710>
ffffffffc0203fc6:	00002617          	auipc	a2,0x2
ffffffffc0203fca:	8b260613          	addi	a2,a2,-1870 # ffffffffc0205878 <commands+0x738>
ffffffffc0203fce:	0c200593          	li	a1,194
ffffffffc0203fd2:	00003517          	auipc	a0,0x3
ffffffffc0203fd6:	87e50513          	addi	a0,a0,-1922 # ffffffffc0206850 <default_pmm_manager+0xc28>
...
ffffffffc0204012:	efa9                	bnez	a5,ffffffffc020406c <do_pgfault+0x8e>
        perm |= READ_WRITE;
    }
...
ffffffffc0204022:	c94d                	beqz	a0,ffffffffc02040d4 <do_pgfault+0xf6>
        cprintf("get_pte in do_pgfault failed\n");
        goto failed;
    }
    if (*ptep == 0) { // if the phy addr isn't exist, then alloc a page & map the phy addr with logical addr
ffffffffc0204024:	610c                	ld	a1,0(a0)
ffffffffc0204026:	c5a9                	beqz	a1,ffffffffc0204070 <do_pgfault+0x92>
...
ffffffffc020403e:	e92d                	bnez	a0,ffffffffc02040b0 <do_pgfault+0xd2>
            {
...
ffffffffc020404e:	e935                	bnez	a0,ffffffffc02040c2 <do_pgfault+0xe4>
            {
...
ffffffffc0204054:	85a2                	mv	a1,s0
            page->pra_vaddr = addr;
ffffffffc0204056:	fe00                	sd	s0,56(a2)
            swap_map_swappable(mm, addr, page, 1);
ffffffffc0204058:	8526                	mv	a0,s1
ffffffffc020405a:	a50ff0ef          	jal	ra,ffffffffc02032aa <swap_map_swappable>
   }
...
ffffffffc020406a:	8082                	ret
        perm |= READ_WRITE;
ffffffffc020406c:	495d                	li	s2,23
ffffffffc020406e:	b75d                	j	ffffffffc0204014 <do_pgfault+0x36>
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0204070:	6c88                	ld	a0,24(s1)
ffffffffc0204072:	864a                	mv	a2,s2
ffffffffc0204074:	85a2                	mv	a1,s0
ffffffffc0204076:	a1bfe0ef          	jal	ra,ffffffffc0202a90 <pgdir_alloc_page>
   ret = 0;
ffffffffc020407a:	4901                	li	s2,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc020407c:	f16d                	bnez	a0,ffffffffc020405e <do_pgfault+0x80>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc020407e:	00003517          	auipc	a0,0x3
ffffffffc0204082:	a9a50513          	addi	a0,a0,-1382 # ffffffffc0206b18 <default_pmm_manager+0xef0>
ffffffffc0204086:	8fafc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc020408a:	5971                	li	s2,-4
            goto failed;
...
ffffffffc0204094:	a3850513          	addi	a0,a0,-1480 # ffffffffc0206ac8 <default_pmm_manager+0xea0>
ffffffffc0204098:	8e8fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    int ret = -E_INVAL;
ffffffffc020409c:	5975                	li	s2,-3
        goto failed;
ffffffffc020409e:	b7c1                	j	ffffffffc020405e <do_pgfault+0x80>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc02040a0:	00003517          	auipc	a0,0x3
ffffffffc02040a4:	b0850513          	addi	a0,a0,-1272 # ffffffffc0206ba8 <default_pmm_manager+0xf80>
ffffffffc02040a8:	8d8fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040ac:	5971                	li	s2,-4
            goto failed;
...
ffffffffc02040b6:	a8e50513          	addi	a0,a0,-1394 # ffffffffc0206b40 <default_pmm_manager+0xf18>
ffffffffc02040ba:	8c6fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040be:	5971                	li	s2,-4
ffffffffc02040c0:	bf79                	j	ffffffffc020405e <do_pgfault+0x80>
                cprintf("Failed to insert page into page table for address: %x\n", addr);
ffffffffc02040c2:	85a2                	mv	a1,s0
ffffffffc02040c4:	00003517          	auipc	a0,0x3
ffffffffc02040c8:	aac50513          	addi	a0,a0,-1364 # ffffffffc0206b70 <default_pmm_manager+0xf48>
ffffffffc02040cc:	8b4fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040d0:	5971                	li	s2,-4
ffffffffc02040d2:	b771                	j	ffffffffc020405e <do_pgfault+0x80>
        cprintf("get_pte in do_pgfault failed\n");
ffffffffc02040d4:	00003517          	auipc	a0,0x3
ffffffffc02040d8:	a2450513          	addi	a0,a0,-1500 # ffffffffc0206af8 <default_pmm_manager+0xed0>
ffffffffc02040dc:	8a4fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040e0:	5971                	li	s2,-4
        goto failed;
ffffffffc02040e2:	bfb5                	j	ffffffffc020405e <do_pgfault+0x80>
...
ffffffffc02040e8:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc02040ea:	c7efc0ef          	jal	ra,ffffffffc0200568 <ide_device_valid>
ffffffffc02040ee:	cd01                	beqz	a0,ffffffffc0204106 <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc02040f0:	4505                	li	a0,1
ffffffffc02040f2:	c7cfc0ef          	jal	ra,ffffffffc020056e <ide_device_size>
}
ffffffffc02040f6:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc02040f8:	810d                	srli	a0,a0,0x3
ffffffffc02040fa:	00012797          	auipc	a5,0x12
ffffffffc02040fe:	48a7b723          	sd	a0,1166(a5) # ffffffffc0216588 <max_swap_offset>
}
ffffffffc0204102:	0141                	addi	sp,sp,16
ffffffffc0204104:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0204106:	00003617          	auipc	a2,0x3
ffffffffc020410a:	aca60613          	addi	a2,a2,-1334 # ffffffffc0206bd0 <default_pmm_manager+0xfa8>
ffffffffc020410e:	45b5                	li	a1,13
ffffffffc0204110:	00003517          	auipc	a0,0x3
ffffffffc0204114:	ae050513          	addi	a0,a0,-1312 # ffffffffc0206bf0 <default_pmm_manager+0xfc8>
ffffffffc0204118:	b2efc0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc020412a:	46273703          	ld	a4,1122(a4) # ffffffffc0216588 <max_swap_offset>
ffffffffc020412e:	04e7f563          	bgeu	a5,a4,ffffffffc0204178 <swapfs_read+0x5c>
    return page - pages + nbase;
ffffffffc0204132:	00012617          	auipc	a2,0x12
ffffffffc0204136:	43e63603          	ld	a2,1086(a2) # ffffffffc0216570 <pages>
...
ffffffffc0204154:	4186b683          	ld	a3,1048(a3) # ffffffffc0216568 <npage>
...
ffffffffc0204168:	41c7b783          	ld	a5,1052(a5) # ffffffffc0216580 <va_pa_offset>
...
ffffffffc0204172:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204174:	c00fc06f          	j	ffffffffc0200574 <ide_read_secs>
ffffffffc0204178:	86aa                	mv	a3,a0
ffffffffc020417a:	00003617          	auipc	a2,0x3
ffffffffc020417e:	a8e60613          	addi	a2,a2,-1394 # ffffffffc0206c08 <default_pmm_manager+0xfe0>
ffffffffc0204182:	45d1                	li	a1,20
ffffffffc0204184:	00003517          	auipc	a0,0x3
ffffffffc0204188:	a6c50513          	addi	a0,a0,-1428 # ffffffffc0206bf0 <default_pmm_manager+0xfc8>
ffffffffc020418c:	abafc0ef          	jal	ra,ffffffffc0200446 <__panic>
ffffffffc0204190:	86b2                	mv	a3,a2
ffffffffc0204192:	06900593          	li	a1,105
ffffffffc0204196:	00002617          	auipc	a2,0x2
ffffffffc020419a:	aca60613          	addi	a2,a2,-1334 # ffffffffc0205c60 <default_pmm_manager+0x38>
ffffffffc020419e:	00002517          	auipc	a0,0x2
ffffffffc02041a2:	aea50513          	addi	a0,a0,-1302 # ffffffffc0205c88 <default_pmm_manager+0x60>
ffffffffc02041a6:	aa0fc0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc02041b8:	3d473703          	ld	a4,980(a4) # ffffffffc0216588 <max_swap_offset>
ffffffffc02041bc:	04e7f563          	bgeu	a5,a4,ffffffffc0204206 <swapfs_write+0x5c>
    return page - pages + nbase;
ffffffffc02041c0:	00012617          	auipc	a2,0x12
ffffffffc02041c4:	3b063603          	ld	a2,944(a2) # ffffffffc0216570 <pages>
...
ffffffffc02041e2:	38a6b683          	ld	a3,906(a3) # ffffffffc0216568 <npage>
...
ffffffffc02041f6:	38e7b783          	ld	a5,910(a5) # ffffffffc0216580 <va_pa_offset>
...
ffffffffc0204200:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204202:	b96fc06f          	j	ffffffffc0200598 <ide_write_secs>
ffffffffc0204206:	86aa                	mv	a3,a0
ffffffffc0204208:	00003617          	auipc	a2,0x3
ffffffffc020420c:	a0060613          	addi	a2,a2,-1536 # ffffffffc0206c08 <default_pmm_manager+0xfe0>
ffffffffc0204210:	45e5                	li	a1,25
ffffffffc0204212:	00003517          	auipc	a0,0x3
ffffffffc0204216:	9de50513          	addi	a0,a0,-1570 # ffffffffc0206bf0 <default_pmm_manager+0xfc8>
ffffffffc020421a:	a2cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
ffffffffc020421e:	86b2                	mv	a3,a2
ffffffffc0204220:	06900593          	li	a1,105
ffffffffc0204224:	00002617          	auipc	a2,0x2
ffffffffc0204228:	a3c60613          	addi	a2,a2,-1476 # ffffffffc0205c60 <default_pmm_manager+0x38>
ffffffffc020422c:	00002517          	auipc	a0,0x2
ffffffffc0204230:	a5c50513          	addi	a0,a0,-1444 # ffffffffc0205c88 <default_pmm_manager+0x60>
ffffffffc0204234:	a12fc0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc020423a:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc020423c:	3e4000ef          	jal	ra,ffffffffc0204620 <do_exit>

ffffffffc0204240 <forkret>:
...
{
    forkrets(current->tf);
ffffffffc0204240:	00012797          	auipc	a5,0x12
ffffffffc0204244:	3707b783          	ld	a5,880(a5) # ffffffffc02165b0 <current>
ffffffffc0204248:	73c8                	ld	a0,160(a5)
ffffffffc020424a:	923fc06f          	j	ffffffffc0200b6c <forkrets>

ffffffffc020424e <init_main>:
}
...
init_main(void *arg)
{
ffffffffc020424e:	7179                	addi	sp,sp,-48
ffffffffc0204250:	ec26                	sd	s1,24(sp)
    memset(name, 0, sizeof(name));
ffffffffc0204252:	00012497          	auipc	s1,0x12
ffffffffc0204256:	2c648493          	addi	s1,s1,710 # ffffffffc0216518 <name.2>
{
ffffffffc020425a:	f022                	sd	s0,32(sp)
ffffffffc020425c:	e84a                	sd	s2,16(sp)
ffffffffc020425e:	842a                	mv	s0,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc0204260:	00012917          	auipc	s2,0x12
ffffffffc0204264:	35093903          	ld	s2,848(s2) # ffffffffc02165b0 <current>
    memset(name, 0, sizeof(name));
ffffffffc0204268:	4641                	li	a2,16
ffffffffc020426a:	4581                	li	a1,0
ffffffffc020426c:	8526                	mv	a0,s1
{
ffffffffc020426e:	f406                	sd	ra,40(sp)
ffffffffc0204270:	e44e                	sd	s3,8(sp)
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc0204272:	00492983          	lw	s3,4(s2)
    memset(name, 0, sizeof(name));
ffffffffc0204276:	411000ef          	jal	ra,ffffffffc0204e86 <memset>
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc020427a:	0b490593          	addi	a1,s2,180
ffffffffc020427e:	463d                	li	a2,15
ffffffffc0204280:	8526                	mv	a0,s1
ffffffffc0204282:	417000ef          	jal	ra,ffffffffc0204e98 <memcpy>
ffffffffc0204286:	862a                	mv	a2,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc0204288:	85ce                	mv	a1,s3
ffffffffc020428a:	00003517          	auipc	a0,0x3
ffffffffc020428e:	99e50513          	addi	a0,a0,-1634 # ffffffffc0206c28 <default_pmm_manager+0x1000>
ffffffffc0204292:	eeffb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"%s\".\n", (const char *)arg);
ffffffffc0204296:	85a2                	mv	a1,s0
ffffffffc0204298:	00003517          	auipc	a0,0x3
ffffffffc020429c:	9b850513          	addi	a0,a0,-1608 # ffffffffc0206c50 <default_pmm_manager+0x1028>
ffffffffc02042a0:	ee1fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc02042a4:	00003517          	auipc	a0,0x3
ffffffffc02042a8:	9bc50513          	addi	a0,a0,-1604 # ffffffffc0206c60 <default_pmm_manager+0x1038>
ffffffffc02042ac:	ed5fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    return 0;
}
ffffffffc02042b0:	70a2                	ld	ra,40(sp)
ffffffffc02042b2:	7402                	ld	s0,32(sp)
...
ffffffffc02042bc:	6145                	addi	sp,sp,48
ffffffffc02042be:	8082                	ret

ffffffffc02042c0 <proc_run>:
{
ffffffffc02042c0:	7179                	addi	sp,sp,-48
ffffffffc02042c2:	f026                	sd	s1,32(sp)
    if (proc != current)
ffffffffc02042c4:	00012497          	auipc	s1,0x12
ffffffffc02042c8:	2ec48493          	addi	s1,s1,748 # ffffffffc02165b0 <current>
ffffffffc02042cc:	6098                	ld	a4,0(s1)
{
ffffffffc02042ce:	f406                	sd	ra,40(sp)
ffffffffc02042d0:	ec4a                	sd	s2,24(sp)
    if (proc != current)
ffffffffc02042d2:	02a70863          	beq	a4,a0,ffffffffc0204302 <proc_run+0x42>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02042d6:	100027f3          	csrr	a5,sstatus
ffffffffc02042da:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc02042dc:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02042de:	ef8d                	bnez	a5,ffffffffc0204318 <proc_run+0x58>
            lcr3(current->cr3);
ffffffffc02042e0:	755c                	ld	a5,168(a0)
...
ffffffffc02042e2:	800006b7          	lui	a3,0x80000
            current = proc;
ffffffffc02042e6:	e088                	sd	a0,0(s1)
ffffffffc02042e8:	00c7d79b          	srliw	a5,a5,0xc
ffffffffc02042ec:	8fd5                	or	a5,a5,a3
ffffffffc02042ee:	18079073          	csrw	satp,a5
            switch_to(&(temp->context), &(proc->context));
ffffffffc02042f2:	03050593          	addi	a1,a0,48
ffffffffc02042f6:	03070513          	addi	a0,a4,48
ffffffffc02042fa:	5dc000ef          	jal	ra,ffffffffc02048d6 <switch_to>
    if (flag) {
ffffffffc02042fe:	00091763          	bnez	s2,ffffffffc020430c <proc_run+0x4c>
}
ffffffffc0204302:	70a2                	ld	ra,40(sp)
ffffffffc0204304:	7482                	ld	s1,32(sp)
ffffffffc0204306:	6962                	ld	s2,24(sp)
ffffffffc0204308:	6145                	addi	sp,sp,48
ffffffffc020430a:	8082                	ret
ffffffffc020430c:	70a2                	ld	ra,40(sp)
ffffffffc020430e:	7482                	ld	s1,32(sp)
ffffffffc0204310:	6962                	ld	s2,24(sp)
ffffffffc0204312:	6145                	addi	sp,sp,48
        intr_enable();
ffffffffc0204314:	aa8fc06f          	j	ffffffffc02005bc <intr_enable>
ffffffffc0204318:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc020431a:	aa8fc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
            struct proc_struct *temp = current;
ffffffffc020431e:	6098                	ld	a4,0(s1)
        return 1;
ffffffffc0204320:	6522                	ld	a0,8(sp)
ffffffffc0204322:	4905                	li	s2,1
ffffffffc0204324:	bf75                	j	ffffffffc02042e0 <proc_run+0x20>

ffffffffc0204326 <do_fork>:
{
ffffffffc0204326:	7139                	addi	sp,sp,-64
ffffffffc0204328:	f426                	sd	s1,40(sp)
    if (nr_process >= MAX_PROCESS)
ffffffffc020432a:	00012497          	auipc	s1,0x12
ffffffffc020432e:	29e48493          	addi	s1,s1,670 # ffffffffc02165c8 <nr_process>
ffffffffc0204332:	4098                	lw	a4,0(s1)
{
ffffffffc0204334:	fc06                	sd	ra,56(sp)
ffffffffc0204336:	f822                	sd	s0,48(sp)
ffffffffc0204338:	f04a                	sd	s2,32(sp)
ffffffffc020433a:	ec4e                	sd	s3,24(sp)
ffffffffc020433c:	e852                	sd	s4,16(sp)
ffffffffc020433e:	e456                	sd	s5,8(sp)
    if (nr_process >= MAX_PROCESS)
ffffffffc0204340:	6785                	lui	a5,0x1
ffffffffc0204342:	24f75663          	bge	a4,a5,ffffffffc020458e <do_fork+0x268>
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc0204346:	0e800513          	li	a0,232
ffffffffc020434a:	892e                	mv	s2,a1
ffffffffc020434c:	8432                	mv	s0,a2
ffffffffc020434e:	d00fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
ffffffffc0204352:	89aa                	mv	s3,a0
    if (proc != NULL)
ffffffffc0204354:	20050963          	beqz	a0,ffffffffc0204566 <do_fork+0x240>
        memset(proc, 0, sizeof(struct proc_struct));
ffffffffc0204358:	0e800613          	li	a2,232
ffffffffc020435c:	4581                	li	a1,0
ffffffffc020435e:	329000ef          	jal	ra,ffffffffc0204e86 <memset>
        proc->state = PROC_UNINIT;
ffffffffc0204362:	5a7d                	li	s4,-1
ffffffffc0204364:	020a1793          	slli	a5,s4,0x20
ffffffffc0204368:	00f9b023          	sd	a5,0(s3)
    proc->parent = current;
ffffffffc020436c:	00012a97          	auipc	s5,0x12
ffffffffc0204370:	244a8a93          	addi	s5,s5,580 # ffffffffc02165b0 <current>
ffffffffc0204374:	000ab783          	ld	a5,0(s5)
        proc->cr3 = boot_cr3;
ffffffffc0204378:	00012717          	auipc	a4,0x12
ffffffffc020437c:	1e073703          	ld	a4,480(a4) # ffffffffc0216558 <boot_cr3>
ffffffffc0204380:	0ae9b423          	sd	a4,168(s3)
    proc->parent = current;
ffffffffc0204384:	02f9b023          	sd	a5,32(s3)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0204388:	4509                	li	a0,2
ffffffffc020438a:	ea2fd0ef          	jal	ra,ffffffffc0201a2c <alloc_pages>
    if (page != NULL)
ffffffffc020438e:	1e050b63          	beqz	a0,ffffffffc0204584 <do_fork+0x25e>
    return page - pages + nbase;
ffffffffc0204392:	00012697          	auipc	a3,0x12
ffffffffc0204396:	1de6b683          	ld	a3,478(a3) # ffffffffc0216570 <pages>
ffffffffc020439a:	40d506b3          	sub	a3,a0,a3
ffffffffc020439e:	8699                	srai	a3,a3,0x6
ffffffffc02043a0:	00003517          	auipc	a0,0x3
ffffffffc02043a4:	c8053503          	ld	a0,-896(a0) # ffffffffc0207020 <nbase>
ffffffffc02043a8:	96aa                	add	a3,a3,a0
    return KADDR(page2pa(page));
ffffffffc02043aa:	00ca5a13          	srli	s4,s4,0xc
ffffffffc02043ae:	0146fa33          	and	s4,a3,s4
ffffffffc02043b2:	00012797          	auipc	a5,0x12
ffffffffc02043b6:	1b67b783          	ld	a5,438(a5) # ffffffffc0216568 <npage>
    return page2ppn(page) << PGSHIFT;
ffffffffc02043ba:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02043bc:	1efa7e63          	bgeu	s4,a5,ffffffffc02045b8 <do_fork+0x292>
    assert(current->mm == NULL);
ffffffffc02043c0:	000ab783          	ld	a5,0(s5)
ffffffffc02043c4:	00012717          	auipc	a4,0x12
ffffffffc02043c8:	1bc73703          	ld	a4,444(a4) # ffffffffc0216580 <va_pa_offset>
ffffffffc02043cc:	96ba                	add	a3,a3,a4
ffffffffc02043ce:	779c                	ld	a5,40(a5)
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc02043d0:	00d9b823          	sd	a3,16(s3)
    assert(current->mm == NULL);
ffffffffc02043d4:	1c079263          	bnez	a5,ffffffffc0204598 <do_fork+0x272>
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc02043d8:	6789                	lui	a5,0x2
ffffffffc02043da:	ee078793          	addi	a5,a5,-288 # 1ee0 <kern_entry-0xffffffffc01fe120>
ffffffffc02043de:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc02043e0:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc02043e2:	0ad9b023          	sd	a3,160(s3)
    *(proc->tf) = *tf;
ffffffffc02043e6:	87b6                	mv	a5,a3
ffffffffc02043e8:	12040893          	addi	a7,s0,288
ffffffffc02043ec:	00063803          	ld	a6,0(a2)
ffffffffc02043f0:	6608                	ld	a0,8(a2)
ffffffffc02043f2:	6a0c                	ld	a1,16(a2)
ffffffffc02043f4:	6e18                	ld	a4,24(a2)
ffffffffc02043f6:	0107b023          	sd	a6,0(a5)
ffffffffc02043fa:	e788                	sd	a0,8(a5)
ffffffffc02043fc:	eb8c                	sd	a1,16(a5)
ffffffffc02043fe:	ef98                	sd	a4,24(a5)
ffffffffc0204400:	02060613          	addi	a2,a2,32
ffffffffc0204404:	02078793          	addi	a5,a5,32
ffffffffc0204408:	ff1612e3          	bne	a2,a7,ffffffffc02043ec <do_fork+0xc6>
    proc->tf->gpr.a0 = 0;
ffffffffc020440c:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204410:	12090663          	beqz	s2,ffffffffc020453c <do_fork+0x216>
ffffffffc0204414:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204418:	00000797          	auipc	a5,0x0
ffffffffc020441c:	e2878793          	addi	a5,a5,-472 # ffffffffc0204240 <forkret>
ffffffffc0204420:	02f9b823          	sd	a5,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204424:	02d9bc23          	sd	a3,56(s3)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204428:	100027f3          	csrr	a5,sstatus
ffffffffc020442c:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020442e:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204430:	12079763          	bnez	a5,ffffffffc020455e <do_fork+0x238>
    if (++last_pid >= MAX_PID)
ffffffffc0204434:	00007817          	auipc	a6,0x7
ffffffffc0204438:	c2480813          	addi	a6,a6,-988 # ffffffffc020b058 <last_pid.1>
ffffffffc020443c:	00082783          	lw	a5,0(a6)
ffffffffc0204440:	6709                	lui	a4,0x2
ffffffffc0204442:	0017851b          	addiw	a0,a5,1
ffffffffc0204446:	00a82023          	sw	a0,0(a6)
ffffffffc020444a:	08e55263          	bge	a0,a4,ffffffffc02044ce <do_fork+0x1a8>
    if (last_pid >= next_safe)
ffffffffc020444e:	00007317          	auipc	t1,0x7
ffffffffc0204452:	c0e30313          	addi	t1,t1,-1010 # ffffffffc020b05c <next_safe.0>
ffffffffc0204456:	00032783          	lw	a5,0(t1)
ffffffffc020445a:	00012417          	auipc	s0,0x12
ffffffffc020445e:	0ce40413          	addi	s0,s0,206 # ffffffffc0216528 <proc_list>
ffffffffc0204462:	06f55e63          	bge	a0,a5,ffffffffc02044de <do_fork+0x1b8>
        proc->pid = get_pid();
ffffffffc0204466:	00a9a223          	sw	a0,4(s3)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc020446a:	45a9                	li	a1,10
ffffffffc020446c:	2501                	sext.w	a0,a0
ffffffffc020446e:	598000ef          	jal	ra,ffffffffc0204a06 <hash32>
ffffffffc0204472:	02051793          	slli	a5,a0,0x20
ffffffffc0204476:	01c7d513          	srli	a0,a5,0x1c
ffffffffc020447a:	0000e797          	auipc	a5,0xe
ffffffffc020447e:	09e78793          	addi	a5,a5,158 # ffffffffc0212518 <hash_list>
ffffffffc0204482:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc0204484:	6510                	ld	a2,8(a0)
ffffffffc0204486:	0d898793          	addi	a5,s3,216
ffffffffc020448a:	6414                	ld	a3,8(s0)
        nr_process++;
ffffffffc020448c:	4098                	lw	a4,0(s1)
    prev->next = next->prev = elm;
ffffffffc020448e:	e21c                	sd	a5,0(a2)
ffffffffc0204490:	e51c                	sd	a5,8(a0)
    elm->next = next;
ffffffffc0204492:	0ec9b023          	sd	a2,224(s3)
        list_add(&proc_list, &(proc->list_link)); // 5.把设置好的进程加入链表
ffffffffc0204496:	0c898793          	addi	a5,s3,200
    elm->prev = prev;
ffffffffc020449a:	0ca9bc23          	sd	a0,216(s3)
    prev->next = next->prev = elm;
ffffffffc020449e:	e29c                	sd	a5,0(a3)
        nr_process++;
ffffffffc02044a0:	2705                	addiw	a4,a4,1
ffffffffc02044a2:	e41c                	sd	a5,8(s0)
    elm->next = next;
ffffffffc02044a4:	0cd9b823          	sd	a3,208(s3)
    elm->prev = prev;
ffffffffc02044a8:	0c89b423          	sd	s0,200(s3)
ffffffffc02044ac:	c098                	sw	a4,0(s1)
    if (flag) {
ffffffffc02044ae:	0a091e63          	bnez	s2,ffffffffc020456a <do_fork+0x244>
    wakeup_proc(proc); // 6.将新建的进程设为就绪态
ffffffffc02044b2:	854e                	mv	a0,s3
ffffffffc02044b4:	48c000ef          	jal	ra,ffffffffc0204940 <wakeup_proc>
    ret = proc->pid; // 7.将返回值设为线程id
ffffffffc02044b8:	0049a503          	lw	a0,4(s3)
}
ffffffffc02044bc:	70e2                	ld	ra,56(sp)
ffffffffc02044be:	7442                	ld	s0,48(sp)
ffffffffc02044c0:	74a2                	ld	s1,40(sp)
ffffffffc02044c2:	7902                	ld	s2,32(sp)
ffffffffc02044c4:	69e2                	ld	s3,24(sp)
ffffffffc02044c6:	6a42                	ld	s4,16(sp)
ffffffffc02044c8:	6aa2                	ld	s5,8(sp)
ffffffffc02044ca:	6121                	addi	sp,sp,64
ffffffffc02044cc:	8082                	ret
        last_pid = 1; // 重置last_pid为1，PID从1开始分配
ffffffffc02044ce:	4785                	li	a5,1
ffffffffc02044d0:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc02044d4:	4505                	li	a0,1
ffffffffc02044d6:	00007317          	auipc	t1,0x7
ffffffffc02044da:	b8630313          	addi	t1,t1,-1146 # ffffffffc020b05c <next_safe.0>
    return listelm->next;
ffffffffc02044de:	00012417          	auipc	s0,0x12
ffffffffc02044e2:	04a40413          	addi	s0,s0,74 # ffffffffc0216528 <proc_list>
ffffffffc02044e6:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID; // 假设最大PID为下一个安全的PID
ffffffffc02044ea:	6789                	lui	a5,0x2
ffffffffc02044ec:	00f32023          	sw	a5,0(t1)
ffffffffc02044f0:	86aa                	mv	a3,a0
ffffffffc02044f2:	4581                	li	a1,0
        while ((le = list_next(le)) != list)
ffffffffc02044f4:	6e89                	lui	t4,0x2
ffffffffc02044f6:	088e0263          	beq	t3,s0,ffffffffc020457a <do_fork+0x254>
ffffffffc02044fa:	88ae                	mv	a7,a1
ffffffffc02044fc:	87f2                	mv	a5,t3
ffffffffc02044fe:	6609                	lui	a2,0x2
ffffffffc0204500:	a811                	j	ffffffffc0204514 <do_fork+0x1ee>
            else if (proc->pid > last_pid && next_safe > proc->pid)
ffffffffc0204502:	00e6d663          	bge	a3,a4,ffffffffc020450e <do_fork+0x1e8>
ffffffffc0204506:	00c75463          	bge	a4,a2,ffffffffc020450e <do_fork+0x1e8>
ffffffffc020450a:	863a                	mv	a2,a4
ffffffffc020450c:	4885                	li	a7,1
ffffffffc020450e:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc0204510:	00878d63          	beq	a5,s0,ffffffffc020452a <do_fork+0x204>
            if (proc->pid == last_pid)
ffffffffc0204514:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc0204518:	fed715e3          	bne	a4,a3,ffffffffc0204502 <do_fork+0x1dc>
                if (++last_pid >= next_safe)
ffffffffc020451c:	2685                	addiw	a3,a3,1
ffffffffc020451e:	04c6d963          	bge	a3,a2,ffffffffc0204570 <do_fork+0x24a>
ffffffffc0204522:	679c                	ld	a5,8(a5)
ffffffffc0204524:	4585                	li	a1,1
        while ((le = list_next(le)) != list)
ffffffffc0204526:	fe8797e3          	bne	a5,s0,ffffffffc0204514 <do_fork+0x1ee>
ffffffffc020452a:	c581                	beqz	a1,ffffffffc0204532 <do_fork+0x20c>
ffffffffc020452c:	00d82023          	sw	a3,0(a6)
ffffffffc0204530:	8536                	mv	a0,a3
ffffffffc0204532:	f2088ae3          	beqz	a7,ffffffffc0204466 <do_fork+0x140>
ffffffffc0204536:	00c32023          	sw	a2,0(t1)
ffffffffc020453a:	b735                	j	ffffffffc0204466 <do_fork+0x140>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020453c:	8936                	mv	s2,a3
ffffffffc020453e:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204542:	00000797          	auipc	a5,0x0
ffffffffc0204546:	cfe78793          	addi	a5,a5,-770 # ffffffffc0204240 <forkret>
ffffffffc020454a:	02f9b823          	sd	a5,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc020454e:	02d9bc23          	sd	a3,56(s3)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204552:	100027f3          	csrr	a5,sstatus
ffffffffc0204556:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204558:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020455a:	ec078de3          	beqz	a5,ffffffffc0204434 <do_fork+0x10e>
        intr_disable();
ffffffffc020455e:	864fc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204562:	4905                	li	s2,1
ffffffffc0204564:	bdc1                	j	ffffffffc0204434 <do_fork+0x10e>
    ret = -E_NO_MEM;
ffffffffc0204566:	5571                	li	a0,-4
    return ret;
ffffffffc0204568:	bf91                	j	ffffffffc02044bc <do_fork+0x196>
        intr_enable();
ffffffffc020456a:	852fc0ef          	jal	ra,ffffffffc02005bc <intr_enable>
ffffffffc020456e:	b791                	j	ffffffffc02044b2 <do_fork+0x18c>
                    if (last_pid >= MAX_PID)
ffffffffc0204570:	01d6c363          	blt	a3,t4,ffffffffc0204576 <do_fork+0x250>
                        last_pid = 1;
ffffffffc0204574:	4685                	li	a3,1
                    goto repeat;
ffffffffc0204576:	4585                	li	a1,1
ffffffffc0204578:	bfbd                	j	ffffffffc02044f6 <do_fork+0x1d0>
ffffffffc020457a:	cd81                	beqz	a1,ffffffffc0204592 <do_fork+0x26c>
ffffffffc020457c:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc0204580:	8536                	mv	a0,a3
ffffffffc0204582:	b5d5                	j	ffffffffc0204466 <do_fork+0x140>
    kfree(proc);
ffffffffc0204584:	854e                	mv	a0,s3
ffffffffc0204586:	b78fd0ef          	jal	ra,ffffffffc02018fe <kfree>
    ret = -E_NO_MEM;
ffffffffc020458a:	5571                	li	a0,-4
    goto fork_out;
ffffffffc020458c:	bf05                	j	ffffffffc02044bc <do_fork+0x196>
    int ret = -E_NO_FREE_PROC;
ffffffffc020458e:	556d                	li	a0,-5
ffffffffc0204590:	b735                	j	ffffffffc02044bc <do_fork+0x196>
    return last_pid;
ffffffffc0204592:	00082503          	lw	a0,0(a6)
ffffffffc0204596:	bdc1                	j	ffffffffc0204466 <do_fork+0x140>
    assert(current->mm == NULL);
ffffffffc0204598:	00002697          	auipc	a3,0x2
ffffffffc020459c:	6e868693          	addi	a3,a3,1768 # ffffffffc0206c80 <default_pmm_manager+0x1058>
ffffffffc02045a0:	00001617          	auipc	a2,0x1
ffffffffc02045a4:	2d860613          	addi	a2,a2,728 # ffffffffc0205878 <commands+0x738>
ffffffffc02045a8:	13800593          	li	a1,312
ffffffffc02045ac:	00002517          	auipc	a0,0x2
ffffffffc02045b0:	6ec50513          	addi	a0,a0,1772 # ffffffffc0206c98 <default_pmm_manager+0x1070>
ffffffffc02045b4:	e93fb0ef          	jal	ra,ffffffffc0200446 <__panic>
ffffffffc02045b8:	00001617          	auipc	a2,0x1
ffffffffc02045bc:	6a860613          	addi	a2,a2,1704 # ffffffffc0205c60 <default_pmm_manager+0x38>
ffffffffc02045c0:	06900593          	li	a1,105
ffffffffc02045c4:	00001517          	auipc	a0,0x1
ffffffffc02045c8:	6c450513          	addi	a0,a0,1732 # ffffffffc0205c88 <default_pmm_manager+0x60>
ffffffffc02045cc:	e7bfb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02045d0 <kernel_thread>:
{
ffffffffc02045d0:	7129                	addi	sp,sp,-320
ffffffffc02045d2:	fa22                	sd	s0,304(sp)
ffffffffc02045d4:	f626                	sd	s1,296(sp)
ffffffffc02045d6:	f24a                	sd	s2,288(sp)
ffffffffc02045d8:	84ae                	mv	s1,a1
ffffffffc02045da:	892a                	mv	s2,a0
ffffffffc02045dc:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02045de:	4581                	li	a1,0
ffffffffc02045e0:	12000613          	li	a2,288
ffffffffc02045e4:	850a                	mv	a0,sp
{
ffffffffc02045e6:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02045e8:	09f000ef          	jal	ra,ffffffffc0204e86 <memset>
    tf.gpr.s0 = (uintptr_t)fn;  // s0 寄存器保存函数指针
ffffffffc02045ec:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg; // s1 寄存器保存函数参数
ffffffffc02045ee:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc02045f0:	100027f3          	csrr	a5,sstatus
ffffffffc02045f4:	edd7f793          	andi	a5,a5,-291
ffffffffc02045f8:	1207e793          	ori	a5,a5,288
ffffffffc02045fc:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02045fe:	860a                	mv	a2,sp
ffffffffc0204600:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0204604:	00000797          	auipc	a5,0x0
ffffffffc0204608:	c3478793          	addi	a5,a5,-972 # ffffffffc0204238 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020460c:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc020460e:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204610:	d17ff0ef          	jal	ra,ffffffffc0204326 <do_fork>
}
ffffffffc0204614:	70f2                	ld	ra,312(sp)
ffffffffc0204616:	7452                	ld	s0,304(sp)
ffffffffc0204618:	74b2                	ld	s1,296(sp)
ffffffffc020461a:	7912                	ld	s2,288(sp)
ffffffffc020461c:	6131                	addi	sp,sp,320
ffffffffc020461e:	8082                	ret

ffffffffc0204620 <do_exit>:
{
ffffffffc0204620:	1141                	addi	sp,sp,-16
    panic("process exit!!.\n");
ffffffffc0204622:	00002617          	auipc	a2,0x2
ffffffffc0204626:	68e60613          	addi	a2,a2,1678 # ffffffffc0206cb0 <default_pmm_manager+0x1088>
ffffffffc020462a:	1b600593          	li	a1,438
ffffffffc020462e:	00002517          	auipc	a0,0x2
ffffffffc0204632:	66a50513          	addi	a0,a0,1642 # ffffffffc0206c98 <default_pmm_manager+0x1070>
{
ffffffffc0204636:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc0204638:	e0ffb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc020463c <proc_init>:
...
void proc_init(void)
{
ffffffffc020463c:	7139                	addi	sp,sp,-64
ffffffffc020463e:	f426                	sd	s1,40(sp)
    elm->prev = elm->next = elm;
ffffffffc0204640:	00012797          	auipc	a5,0x12
ffffffffc0204644:	ee878793          	addi	a5,a5,-280 # ffffffffc0216528 <proc_list>
ffffffffc0204648:	fc06                	sd	ra,56(sp)
ffffffffc020464a:	f822                	sd	s0,48(sp)
ffffffffc020464c:	f04a                	sd	s2,32(sp)
ffffffffc020464e:	ec4e                	sd	s3,24(sp)
ffffffffc0204650:	e852                	sd	s4,16(sp)
ffffffffc0204652:	e456                	sd	s5,8(sp)
ffffffffc0204654:	0000e497          	auipc	s1,0xe
ffffffffc0204658:	ec448493          	addi	s1,s1,-316 # ffffffffc0212518 <hash_list>
ffffffffc020465c:	e79c                	sd	a5,8(a5)
ffffffffc020465e:	e39c                	sd	a5,0(a5)
...
ffffffffc0204660:	00012717          	auipc	a4,0x12
ffffffffc0204664:	eb870713          	addi	a4,a4,-328 # ffffffffc0216518 <name.2>
ffffffffc0204668:	87a6                	mv	a5,s1
ffffffffc020466a:	e79c                	sd	a5,8(a5)
ffffffffc020466c:	e39c                	sd	a5,0(a5)
ffffffffc020466e:	07c1                	addi	a5,a5,16
ffffffffc0204670:	fef71de3          	bne	a4,a5,ffffffffc020466a <proc_init+0x2e>
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc0204674:	0e800513          	li	a0,232
ffffffffc0204678:	9d6fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
ffffffffc020467c:	842a                	mv	s0,a0
    if (proc != NULL)
ffffffffc020467e:	1c050263          	beqz	a0,ffffffffc0204842 <proc_init+0x206>
        proc->state = PROC_UNINIT;
ffffffffc0204682:	59fd                	li	s3,-1
        memset(proc, 0, sizeof(struct proc_struct));
ffffffffc0204684:	0e800613          	li	a2,232
ffffffffc0204688:	4581                	li	a1,0
        proc->state = PROC_UNINIT;
ffffffffc020468a:	1982                	slli	s3,s3,0x20
        memset(proc, 0, sizeof(struct proc_struct));
ffffffffc020468c:	7fa000ef          	jal	ra,ffffffffc0204e86 <memset>
        proc->cr3 = boot_cr3;
ffffffffc0204690:	00012a97          	auipc	s5,0x12
ffffffffc0204694:	ec8a8a93          	addi	s5,s5,-312 # ffffffffc0216558 <boot_cr3>
        proc->state = PROC_UNINIT;
ffffffffc0204698:	01343023          	sd	s3,0(s0)
        proc->cr3 = boot_cr3;
ffffffffc020469c:	000ab783          	ld	a5,0(s5)
    {
...
ffffffffc02046a0:	00012917          	auipc	s2,0x12
ffffffffc02046a4:	f1890913          	addi	s2,s2,-232 # ffffffffc02165b8 <idleproc>
...
ffffffffc02046a8:	07000513          	li	a0,112
        proc->cr3 = boot_cr3;
ffffffffc02046ac:	f45c                	sd	a5,168(s0)
    if ((idleproc = alloc_proc()) == NULL)
ffffffffc02046ae:	00893023          	sd	s0,0(s2)
    int *context_mem = (int *)kmalloc(sizeof(struct context));
ffffffffc02046b2:	99cfd0ef          	jal	ra,ffffffffc020184e <kmalloc>
    memset(context_mem, 0, sizeof(struct context));
ffffffffc02046b6:	07000613          	li	a2,112
ffffffffc02046ba:	4581                	li	a1,0
    int *context_mem = (int *)kmalloc(sizeof(struct context));
ffffffffc02046bc:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc02046be:	7c8000ef          	jal	ra,ffffffffc0204e86 <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc02046c2:	00093503          	ld	a0,0(s2)
ffffffffc02046c6:	85a2                	mv	a1,s0
ffffffffc02046c8:	07000613          	li	a2,112
ffffffffc02046cc:	03050513          	addi	a0,a0,48
ffffffffc02046d0:	7e0000ef          	jal	ra,ffffffffc0204eb0 <memcmp>
ffffffffc02046d4:	8a2a                	mv	s4,a0

    int *proc_name_mem = (int *)kmalloc(PROC_NAME_LEN);
ffffffffc02046d6:	453d                	li	a0,15
ffffffffc02046d8:	976fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc02046dc:	463d                	li	a2,15
ffffffffc02046de:	4581                	li	a1,0
    int *proc_name_mem = (int *)kmalloc(PROC_NAME_LEN);
ffffffffc02046e0:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc02046e2:	7a4000ef          	jal	ra,ffffffffc0204e86 <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc02046e6:	00093503          	ld	a0,0(s2)
ffffffffc02046ea:	463d                	li	a2,15
ffffffffc02046ec:	85a2                	mv	a1,s0
ffffffffc02046ee:	0b450513          	addi	a0,a0,180
ffffffffc02046f2:	7be000ef          	jal	ra,ffffffffc0204eb0 <memcmp>
...
ffffffffc02046f6:	00093783          	ld	a5,0(s2)
ffffffffc02046fa:	000ab703          	ld	a4,0(s5)
ffffffffc02046fe:	77d4                	ld	a3,168(a5)
ffffffffc0204700:	0ee68663          	beq	a3,a4,ffffffffc02047ec <proc_init+0x1b0>
    }
...
ffffffffc0204704:	4709                	li	a4,2
ffffffffc0204706:	e398                	sd	a4,0(a5)
    // 设置 idleproc 的内核栈（bootstack 是一个全局栈，已经在系统启动时定义）
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0204708:	00004717          	auipc	a4,0x4
ffffffffc020470c:	8f870713          	addi	a4,a4,-1800 # ffffffffc0208000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204710:	0b478413          	addi	s0,a5,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0204714:	eb98                	sd	a4,16(a5)
    // 设置 idleproc 需要调度标志为 1，表示需要立即进行调度
    idleproc->need_resched = 1;
ffffffffc0204716:	4705                	li	a4,1
ffffffffc0204718:	cf98                	sw	a4,24(a5)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020471a:	4641                	li	a2,16
ffffffffc020471c:	4581                	li	a1,0
ffffffffc020471e:	8522                	mv	a0,s0
ffffffffc0204720:	766000ef          	jal	ra,ffffffffc0204e86 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204724:	463d                	li	a2,15
ffffffffc0204726:	00002597          	auipc	a1,0x2
ffffffffc020472a:	5ba58593          	addi	a1,a1,1466 # ffffffffc0206ce0 <default_pmm_manager+0x10b8>
ffffffffc020472e:	8522                	mv	a0,s0
ffffffffc0204730:	768000ef          	jal	ra,ffffffffc0204e98 <memcpy>
    // 设置进程名称为 "idle"
    set_proc_name(idleproc, "idle");
    // 增加系统进程数量
    nr_process++;
ffffffffc0204734:	00012717          	auipc	a4,0x12
ffffffffc0204738:	e9470713          	addi	a4,a4,-364 # ffffffffc02165c8 <nr_process>
ffffffffc020473c:	431c                	lw	a5,0(a4)
    // 将当前运行的进程设置为 idleproc
    current = idleproc;
ffffffffc020473e:	00093683          	ld	a3,0(s2)

    // 4、创建第二个内核线程 init_main，进程名称为 "Hello world!!"
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0204742:	4601                	li	a2,0
    nr_process++;
ffffffffc0204744:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0204746:	00002597          	auipc	a1,0x2
ffffffffc020474a:	5a258593          	addi	a1,a1,1442 # ffffffffc0206ce8 <default_pmm_manager+0x10c0>
ffffffffc020474e:	00000517          	auipc	a0,0x0
ffffffffc0204752:	b0050513          	addi	a0,a0,-1280 # ffffffffc020424e <init_main>
    nr_process++;
ffffffffc0204756:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc0204758:	00012797          	auipc	a5,0x12
ffffffffc020475c:	e4d7bc23          	sd	a3,-424(a5) # ffffffffc02165b0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0204760:	e71ff0ef          	jal	ra,ffffffffc02045d0 <kernel_thread>
ffffffffc0204764:	842a                	mv	s0,a0
    if (pid <= 0)
ffffffffc0204766:	0ea05e63          	blez	a0,ffffffffc0204862 <proc_init+0x226>
    if (0 < pid && pid < MAX_PID)
ffffffffc020476a:	6789                	lui	a5,0x2
ffffffffc020476c:	fff5071b          	addiw	a4,a0,-1
ffffffffc0204770:	17f9                	addi	a5,a5,-2
ffffffffc0204772:	2501                	sext.w	a0,a0
ffffffffc0204774:	02e7e363          	bltu	a5,a4,ffffffffc020479a <proc_init+0x15e>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0204778:	45a9                	li	a1,10
ffffffffc020477a:	28c000ef          	jal	ra,ffffffffc0204a06 <hash32>
ffffffffc020477e:	02051793          	slli	a5,a0,0x20
ffffffffc0204782:	01c7d693          	srli	a3,a5,0x1c
ffffffffc0204786:	96a6                	add	a3,a3,s1
ffffffffc0204788:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list)
ffffffffc020478a:	a029                	j	ffffffffc0204794 <proc_init+0x158>
            if (proc->pid == pid)
ffffffffc020478c:	f2c7a703          	lw	a4,-212(a5) # 1f2c <kern_entry-0xffffffffc01fe0d4>
ffffffffc0204790:	0a870663          	beq	a4,s0,ffffffffc020483c <proc_init+0x200>
    return listelm->next;
ffffffffc0204794:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc0204796:	fef69be3          	bne	a3,a5,ffffffffc020478c <proc_init+0x150>
    return NULL;
ffffffffc020479a:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020479c:	0b478493          	addi	s1,a5,180
ffffffffc02047a0:	4641                	li	a2,16
ffffffffc02047a2:	4581                	li	a1,0
    {
...
ffffffffc02047a4:	00012417          	auipc	s0,0x12
ffffffffc02047a8:	e1c40413          	addi	s0,s0,-484 # ffffffffc02165c0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047ac:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc02047ae:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047b0:	6d6000ef          	jal	ra,ffffffffc0204e86 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02047b4:	463d                	li	a2,15
ffffffffc02047b6:	00002597          	auipc	a1,0x2
ffffffffc02047ba:	56258593          	addi	a1,a1,1378 # ffffffffc0206d18 <default_pmm_manager+0x10f0>
ffffffffc02047be:	8526                	mv	a0,s1
ffffffffc02047c0:	6d8000ef          	jal	ra,ffffffffc0204e98 <memcpy>
...
ffffffffc02047c4:	00093783          	ld	a5,0(s2)
ffffffffc02047c8:	cbe9                	beqz	a5,ffffffffc020489a <proc_init+0x25e>
ffffffffc02047ca:	43dc                	lw	a5,4(a5)
ffffffffc02047cc:	e7f9                	bnez	a5,ffffffffc020489a <proc_init+0x25e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc02047ce:	601c                	ld	a5,0(s0)
ffffffffc02047d0:	c7cd                	beqz	a5,ffffffffc020487a <proc_init+0x23e>
ffffffffc02047d2:	43d8                	lw	a4,4(a5)
ffffffffc02047d4:	4785                	li	a5,1
ffffffffc02047d6:	0af71263          	bne	a4,a5,ffffffffc020487a <proc_init+0x23e>
}
ffffffffc02047da:	70e2                	ld	ra,56(sp)
ffffffffc02047dc:	7442                	ld	s0,48(sp)
...
ffffffffc02047e8:	6121                	addi	sp,sp,64
ffffffffc02047ea:	8082                	ret
    if (idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0 && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag)
ffffffffc02047ec:	73d8                	ld	a4,160(a5)
ffffffffc02047ee:	f0071be3          	bnez	a4,ffffffffc0204704 <proc_init+0xc8>
ffffffffc02047f2:	f00a19e3          	bnez	s4,ffffffffc0204704 <proc_init+0xc8>
ffffffffc02047f6:	6398                	ld	a4,0(a5)
ffffffffc02047f8:	f13716e3          	bne	a4,s3,ffffffffc0204704 <proc_init+0xc8>
ffffffffc02047fc:	4798                	lw	a4,8(a5)
ffffffffc02047fe:	f00713e3          	bnez	a4,ffffffffc0204704 <proc_init+0xc8>
ffffffffc0204802:	6b98                	ld	a4,16(a5)
ffffffffc0204804:	f00710e3          	bnez	a4,ffffffffc0204704 <proc_init+0xc8>
ffffffffc0204808:	4f98                	lw	a4,24(a5)
ffffffffc020480a:	2701                	sext.w	a4,a4
ffffffffc020480c:	ee071ce3          	bnez	a4,ffffffffc0204704 <proc_init+0xc8>
ffffffffc0204810:	7398                	ld	a4,32(a5)
ffffffffc0204812:	ee0719e3          	bnez	a4,ffffffffc0204704 <proc_init+0xc8>
ffffffffc0204816:	7798                	ld	a4,40(a5)
ffffffffc0204818:	ee0716e3          	bnez	a4,ffffffffc0204704 <proc_init+0xc8>
ffffffffc020481c:	0b07a703          	lw	a4,176(a5)
ffffffffc0204820:	8d59                	or	a0,a0,a4
ffffffffc0204822:	0005071b          	sext.w	a4,a0
ffffffffc0204826:	ec071fe3          	bnez	a4,ffffffffc0204704 <proc_init+0xc8>
        cprintf("alloc_proc() correct!\n");
ffffffffc020482a:	00002517          	auipc	a0,0x2
ffffffffc020482e:	49e50513          	addi	a0,a0,1182 # ffffffffc0206cc8 <default_pmm_manager+0x10a0>
ffffffffc0204832:	94ffb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    idleproc->pid = 0;
ffffffffc0204836:	00093783          	ld	a5,0(s2)
ffffffffc020483a:	b5e9                	j	ffffffffc0204704 <proc_init+0xc8>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc020483c:	f2878793          	addi	a5,a5,-216
ffffffffc0204840:	bfb1                	j	ffffffffc020479c <proc_init+0x160>
        panic("cannot alloc idleproc.\n");
ffffffffc0204842:	00002617          	auipc	a2,0x2
ffffffffc0204846:	52e60613          	addi	a2,a2,1326 # ffffffffc0206d70 <default_pmm_manager+0x1148>
ffffffffc020484a:	1d600593          	li	a1,470
ffffffffc020484e:	00002517          	auipc	a0,0x2
ffffffffc0204852:	44a50513          	addi	a0,a0,1098 # ffffffffc0206c98 <default_pmm_manager+0x1070>
    if ((idleproc = alloc_proc()) == NULL)
ffffffffc0204856:	00012797          	auipc	a5,0x12
ffffffffc020485a:	d607b123          	sd	zero,-670(a5) # ffffffffc02165b8 <idleproc>
        panic("cannot alloc idleproc.\n");
ffffffffc020485e:	be9fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("create init_main failed.\n");
ffffffffc0204862:	00002617          	auipc	a2,0x2
ffffffffc0204866:	49660613          	addi	a2,a2,1174 # ffffffffc0206cf8 <default_pmm_manager+0x10d0>
ffffffffc020486a:	1fb00593          	li	a1,507
ffffffffc020486e:	00002517          	auipc	a0,0x2
ffffffffc0204872:	42a50513          	addi	a0,a0,1066 # ffffffffc0206c98 <default_pmm_manager+0x1070>
ffffffffc0204876:	bd1fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc020487a:	00002697          	auipc	a3,0x2
ffffffffc020487e:	4ce68693          	addi	a3,a3,1230 # ffffffffc0206d48 <default_pmm_manager+0x1120>
ffffffffc0204882:	00001617          	auipc	a2,0x1
ffffffffc0204886:	ff660613          	addi	a2,a2,-10 # ffffffffc0205878 <commands+0x738>
ffffffffc020488a:	20600593          	li	a1,518
ffffffffc020488e:	00002517          	auipc	a0,0x2
ffffffffc0204892:	40a50513          	addi	a0,a0,1034 # ffffffffc0206c98 <default_pmm_manager+0x1070>
ffffffffc0204896:	bb1fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc020489a:	00002697          	auipc	a3,0x2
ffffffffc020489e:	48668693          	addi	a3,a3,1158 # ffffffffc0206d20 <default_pmm_manager+0x10f8>
ffffffffc02048a2:	00001617          	auipc	a2,0x1
ffffffffc02048a6:	fd660613          	addi	a2,a2,-42 # ffffffffc0205878 <commands+0x738>
ffffffffc02048aa:	20500593          	li	a1,517
ffffffffc02048ae:	00002517          	auipc	a0,0x2
ffffffffc02048b2:	3ea50513          	addi	a0,a0,1002 # ffffffffc0206c98 <default_pmm_manager+0x1070>
ffffffffc02048b6:	b91fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02048ba <cpu_idle>:
...
ffffffffc02048c0:	00012417          	auipc	s0,0x12
ffffffffc02048c4:	cf040413          	addi	s0,s0,-784 # ffffffffc02165b0 <current>
    while (1)
    {
        if (current->need_resched)
ffffffffc02048c8:	6018                	ld	a4,0(s0)
ffffffffc02048ca:	4f1c                	lw	a5,24(a4)
ffffffffc02048cc:	2781                	sext.w	a5,a5
ffffffffc02048ce:	dff5                	beqz	a5,ffffffffc02048ca <cpu_idle+0x10>
        {
            schedule();
ffffffffc02048d0:	0a2000ef          	jal	ra,ffffffffc0204972 <schedule>
ffffffffc02048d4:	bfd5                	j	ffffffffc02048c8 <cpu_idle+0xe>

ffffffffc02048d6 <switch_to>:
.text
...
ffffffffc02048d6:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc02048da:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc02048de:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc02048e0:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc02048e2:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc02048e6:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc02048ea:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc02048ee:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc02048f2:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc02048f6:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc02048fa:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc02048fe:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc0204902:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc0204906:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc020490a:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc020490e:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc0204912:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc0204914:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc0204916:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc020491a:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc020491e:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc0204922:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc0204926:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc020492a:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc020492e:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc0204932:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc0204936:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc020493a:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc020493e:	8082                	ret

ffffffffc0204940 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc0204940:	411c                	lw	a5,0(a0)
ffffffffc0204942:	4705                	li	a4,1
ffffffffc0204944:	37f9                	addiw	a5,a5,-2
ffffffffc0204946:	00f77563          	bgeu	a4,a5,ffffffffc0204950 <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;
ffffffffc020494a:	4789                	li	a5,2
ffffffffc020494c:	c11c                	sw	a5,0(a0)
ffffffffc020494e:	8082                	ret
{
ffffffffc0204950:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc0204952:	00002697          	auipc	a3,0x2
ffffffffc0204956:	43668693          	addi	a3,a3,1078 # ffffffffc0206d88 <default_pmm_manager+0x1160>
ffffffffc020495a:	00001617          	auipc	a2,0x1
ffffffffc020495e:	f1e60613          	addi	a2,a2,-226 # ffffffffc0205878 <commands+0x738>
ffffffffc0204962:	45a5                	li	a1,9
ffffffffc0204964:	00002517          	auipc	a0,0x2
ffffffffc0204968:	46450513          	addi	a0,a0,1124 # ffffffffc0206dc8 <default_pmm_manager+0x11a0>
{
ffffffffc020496c:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc020496e:	ad9fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0204972 <schedule>:
}

void schedule(void)
{
ffffffffc0204972:	1141                	addi	sp,sp,-16
ffffffffc0204974:	e406                	sd	ra,8(sp)
ffffffffc0204976:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204978:	100027f3          	csrr	a5,sstatus
ffffffffc020497c:	8b89                	andi	a5,a5,2
ffffffffc020497e:	4401                	li	s0,0
ffffffffc0204980:	efbd                	bnez	a5,ffffffffc02049fe <schedule+0x8c>
...
ffffffffc0204982:	00012897          	auipc	a7,0x12
ffffffffc0204986:	c2e8b883          	ld	a7,-978(a7) # ffffffffc02165b0 <current>
ffffffffc020498a:	0008ac23          	sw	zero,24(a7)

        // 判断当前进程是否是空闲进程（idleproc），如果是，设置last为proc_list
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc020498e:	00012517          	auipc	a0,0x12
ffffffffc0204992:	c2a53503          	ld	a0,-982(a0) # ffffffffc02165b8 <idleproc>
ffffffffc0204996:	04a88e63          	beq	a7,a0,ffffffffc02049f2 <schedule+0x80>
ffffffffc020499a:	0c888693          	addi	a3,a7,200
ffffffffc020499e:	00012617          	auipc	a2,0x12
ffffffffc02049a2:	b8a60613          	addi	a2,a2,-1142 # ffffffffc0216528 <proc_list>
        le = last;
ffffffffc02049a6:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL; // next保存下一个要调度的进程
ffffffffc02049a8:	4581                	li	a1,0
            // 获取下一个进程
...
ffffffffc02049aa:	4809                	li	a6,2
ffffffffc02049ac:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list)
ffffffffc02049ae:	00c78863          	beq	a5,a2,ffffffffc02049be <schedule+0x4c>
                if (next->state == PROC_RUNNABLE)
ffffffffc02049b2:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc02049b6:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE)
ffffffffc02049ba:	03070163          	beq	a4,a6,ffffffffc02049dc <schedule+0x6a>
                {
                    break;
                }
            }
        } while (le != last); // 如果没找到，继续循环
ffffffffc02049be:	fef697e3          	bne	a3,a5,ffffffffc02049ac <schedule+0x3a>

        // 如果没有找到就绪进程，则选择空闲进程作为下一个进程
        if (next == NULL || next->state != PROC_RUNNABLE)
ffffffffc02049c2:	ed89                	bnez	a1,ffffffffc02049dc <schedule+0x6a>
        {
            next = idleproc;
        }
        ...
        // 增加该进程的运行次数
        next->runs++;
ffffffffc02049c4:	451c                	lw	a5,8(a0)
ffffffffc02049c6:	2785                	addiw	a5,a5,1
ffffffffc02049c8:	c51c                	sw	a5,8(a0)

        // 如果下一个进程与当前进程不同，则执行进程切换
        if (next != current)
ffffffffc02049ca:	00a88463          	beq	a7,a0,ffffffffc02049d2 <schedule+0x60>
        {
            proc_run(next); // 切换到下一个进程
ffffffffc02049ce:	8f3ff0ef          	jal	ra,ffffffffc02042c0 <proc_run>
    if (flag) {
ffffffffc02049d2:	e819                	bnez	s0,ffffffffc02049e8 <schedule+0x76>
        }
    }
...
ffffffffc02049da:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE)
ffffffffc02049dc:	4198                	lw	a4,0(a1)
ffffffffc02049de:	4789                	li	a5,2
ffffffffc02049e0:	fef712e3          	bne	a4,a5,ffffffffc02049c4 <schedule+0x52>
ffffffffc02049e4:	852e                	mv	a0,a1
ffffffffc02049e6:	bff9                	j	ffffffffc02049c4 <schedule+0x52>
}
ffffffffc02049e8:	6402                	ld	s0,0(sp)
ffffffffc02049ea:	60a2                	ld	ra,8(sp)
ffffffffc02049ec:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc02049ee:	bcffb06f          	j	ffffffffc02005bc <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02049f2:	00012617          	auipc	a2,0x12
ffffffffc02049f6:	b3660613          	addi	a2,a2,-1226 # ffffffffc0216528 <proc_list>
ffffffffc02049fa:	86b2                	mv	a3,a2
ffffffffc02049fc:	b76d                	j	ffffffffc02049a6 <schedule+0x34>
        intr_disable();
ffffffffc02049fe:	bc5fb0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204a02:	4405                	li	s0,1
ffffffffc0204a04:	bfbd                	j	ffffffffc0204982 <schedule+0x10>

ffffffffc0204a06 <hash32>:
 *
...
ffffffffc0204a06:	9e3707b7          	lui	a5,0x9e370
ffffffffc0204a0a:	2785                	addiw	a5,a5,1
ffffffffc0204a0c:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc0204a10:	02000793          	li	a5,32
ffffffffc0204a14:	9f8d                	subw	a5,a5,a1
}
ffffffffc0204a16:	00f5553b          	srlw	a0,a0,a5
ffffffffc0204a1a:	8082                	ret

ffffffffc0204a1c <printnum>:
 * */
static void
...
ffffffffc0204a1c:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a20:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0204a22:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a26:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0204a28:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a2c:	f022                	sd	s0,32(sp)
ffffffffc0204a2e:	ec26                	sd	s1,24(sp)
ffffffffc0204a30:	e84a                	sd	s2,16(sp)
ffffffffc0204a32:	f406                	sd	ra,40(sp)
ffffffffc0204a34:	e44e                	sd	s3,8(sp)
ffffffffc0204a36:	84aa                	mv	s1,a0
ffffffffc0204a38:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0204a3a:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0204a3e:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0204a40:	03067e63          	bgeu	a2,a6,ffffffffc0204a7c <printnum+0x60>
ffffffffc0204a44:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0204a46:	00805763          	blez	s0,ffffffffc0204a54 <printnum+0x38>
ffffffffc0204a4a:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0204a4c:	85ca                	mv	a1,s2
ffffffffc0204a4e:	854e                	mv	a0,s3
ffffffffc0204a50:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0204a52:	fc65                	bnez	s0,ffffffffc0204a4a <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a54:	1a02                	slli	s4,s4,0x20
ffffffffc0204a56:	00002797          	auipc	a5,0x2
ffffffffc0204a5a:	38a78793          	addi	a5,a5,906 # ffffffffc0206de0 <default_pmm_manager+0x11b8>
ffffffffc0204a5e:	020a5a13          	srli	s4,s4,0x20
ffffffffc0204a62:	9a3e                	add	s4,s4,a5
}
ffffffffc0204a64:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a66:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0204a6a:	70a2                	ld	ra,40(sp)
ffffffffc0204a6c:	69a2                	ld	s3,8(sp)
ffffffffc0204a6e:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a70:	85ca                	mv	a1,s2
ffffffffc0204a72:	87a6                	mv	a5,s1
}
ffffffffc0204a74:	6942                	ld	s2,16(sp)
ffffffffc0204a76:	64e2                	ld	s1,24(sp)
ffffffffc0204a78:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a7a:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204a7c:	03065633          	divu	a2,a2,a6
ffffffffc0204a80:	8722                	mv	a4,s0
ffffffffc0204a82:	f9bff0ef          	jal	ra,ffffffffc0204a1c <printnum>
ffffffffc0204a86:	b7f9                	j	ffffffffc0204a54 <printnum+0x38>

ffffffffc0204a88 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0204a88:	7119                	addi	sp,sp,-128
ffffffffc0204a8a:	f4a6                	sd	s1,104(sp)
ffffffffc0204a8c:	f0ca                	sd	s2,96(sp)
ffffffffc0204a8e:	ecce                	sd	s3,88(sp)
ffffffffc0204a90:	e8d2                	sd	s4,80(sp)
ffffffffc0204a92:	e4d6                	sd	s5,72(sp)
ffffffffc0204a94:	e0da                	sd	s6,64(sp)
ffffffffc0204a96:	fc5e                	sd	s7,56(sp)
ffffffffc0204a98:	f06a                	sd	s10,32(sp)
ffffffffc0204a9a:	fc86                	sd	ra,120(sp)
ffffffffc0204a9c:	f8a2                	sd	s0,112(sp)
ffffffffc0204a9e:	f862                	sd	s8,48(sp)
ffffffffc0204aa0:	f466                	sd	s9,40(sp)
ffffffffc0204aa2:	ec6e                	sd	s11,24(sp)
ffffffffc0204aa4:	892a                	mv	s2,a0
ffffffffc0204aa6:	84ae                	mv	s1,a1
ffffffffc0204aa8:	8d32                	mv	s10,a2
ffffffffc0204aaa:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204aac:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0204ab0:	5b7d                	li	s6,-1
ffffffffc0204ab2:	00002a97          	auipc	s5,0x2
ffffffffc0204ab6:	35aa8a93          	addi	s5,s5,858 # ffffffffc0206e0c <default_pmm_manager+0x11e4>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0204aba:	00002b97          	auipc	s7,0x2
ffffffffc0204abe:	52eb8b93          	addi	s7,s7,1326 # ffffffffc0206fe8 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204ac2:	000d4503          	lbu	a0,0(s10)
ffffffffc0204ac6:	001d0413          	addi	s0,s10,1
ffffffffc0204aca:	01350a63          	beq	a0,s3,ffffffffc0204ade <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0204ace:	c121                	beqz	a0,ffffffffc0204b0e <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0204ad0:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204ad2:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0204ad4:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204ad6:	fff44503          	lbu	a0,-1(s0)
ffffffffc0204ada:	ff351ae3          	bne	a0,s3,ffffffffc0204ace <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204ade:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204ae2:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204ae6:	4c81                	li	s9,0
ffffffffc0204ae8:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204aea:	5c7d                	li	s8,-1
ffffffffc0204aec:	5dfd                	li	s11,-1
ffffffffc0204aee:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0204af2:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204af4:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204af8:	0ff5f593          	zext.b	a1,a1
ffffffffc0204afc:	00140d13          	addi	s10,s0,1
ffffffffc0204b00:	04b56263          	bltu	a0,a1,ffffffffc0204b44 <vprintfmt+0xbc>
ffffffffc0204b04:	058a                	slli	a1,a1,0x2
ffffffffc0204b06:	95d6                	add	a1,a1,s5
ffffffffc0204b08:	4194                	lw	a3,0(a1)
ffffffffc0204b0a:	96d6                	add	a3,a3,s5
ffffffffc0204b0c:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0204b0e:	70e6                	ld	ra,120(sp)
ffffffffc0204b10:	7446                	ld	s0,112(sp)
ffffffffc0204b12:	74a6                	ld	s1,104(sp)
ffffffffc0204b14:	7906                	ld	s2,96(sp)
ffffffffc0204b16:	69e6                	ld	s3,88(sp)
ffffffffc0204b18:	6a46                	ld	s4,80(sp)
ffffffffc0204b1a:	6aa6                	ld	s5,72(sp)
ffffffffc0204b1c:	6b06                	ld	s6,64(sp)
ffffffffc0204b1e:	7be2                	ld	s7,56(sp)
ffffffffc0204b20:	7c42                	ld	s8,48(sp)
ffffffffc0204b22:	7ca2                	ld	s9,40(sp)
ffffffffc0204b24:	7d02                	ld	s10,32(sp)
ffffffffc0204b26:	6de2                	ld	s11,24(sp)
ffffffffc0204b28:	6109                	addi	sp,sp,128
ffffffffc0204b2a:	8082                	ret
            padc = '0';
ffffffffc0204b2c:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204b2e:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b32:	846a                	mv	s0,s10
ffffffffc0204b34:	00140d13          	addi	s10,s0,1
ffffffffc0204b38:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b3c:	0ff5f593          	zext.b	a1,a1
ffffffffc0204b40:	fcb572e3          	bgeu	a0,a1,ffffffffc0204b04 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204b44:	85a6                	mv	a1,s1
ffffffffc0204b46:	02500513          	li	a0,37
ffffffffc0204b4a:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204b4c:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204b50:	8d22                	mv	s10,s0
ffffffffc0204b52:	f73788e3          	beq	a5,s3,ffffffffc0204ac2 <vprintfmt+0x3a>
ffffffffc0204b56:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204b5a:	1d7d                	addi	s10,s10,-1
ffffffffc0204b5c:	ff379de3          	bne	a5,s3,ffffffffc0204b56 <vprintfmt+0xce>
ffffffffc0204b60:	b78d                	j	ffffffffc0204ac2 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204b62:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0204b66:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b6a:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204b6c:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204b70:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204b74:	02d86463          	bltu	a6,a3,ffffffffc0204b9c <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204b78:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204b7c:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204b80:	0186873b          	addw	a4,a3,s8
ffffffffc0204b84:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204b88:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204b8a:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204b8e:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204b90:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204b94:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204b98:	fed870e3          	bgeu	a6,a3,ffffffffc0204b78 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204b9c:	f40ddce3          	bgez	s11,ffffffffc0204af4 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204ba0:	8de2                	mv	s11,s8
ffffffffc0204ba2:	5c7d                	li	s8,-1
ffffffffc0204ba4:	bf81                	j	ffffffffc0204af4 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204ba6:	fffdc693          	not	a3,s11
ffffffffc0204baa:	96fd                	srai	a3,a3,0x3f
ffffffffc0204bac:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bb0:	00144603          	lbu	a2,1(s0)
ffffffffc0204bb4:	2d81                	sext.w	s11,s11
ffffffffc0204bb6:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204bb8:	bf35                	j	ffffffffc0204af4 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204bba:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bbe:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0204bc2:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bc4:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0204bc6:	bfd9                	j	ffffffffc0204b9c <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204bc8:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204bca:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204bce:	01174463          	blt	a4,a7,ffffffffc0204bd6 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204bd2:	1a088e63          	beqz	a7,ffffffffc0204d8e <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204bd6:	000a3603          	ld	a2,0(s4)
ffffffffc0204bda:	46c1                	li	a3,16
ffffffffc0204bdc:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204bde:	2781                	sext.w	a5,a5
ffffffffc0204be0:	876e                	mv	a4,s11
ffffffffc0204be2:	85a6                	mv	a1,s1
ffffffffc0204be4:	854a                	mv	a0,s2
ffffffffc0204be6:	e37ff0ef          	jal	ra,ffffffffc0204a1c <printnum>
            break;
ffffffffc0204bea:	bde1                	j	ffffffffc0204ac2 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204bec:	000a2503          	lw	a0,0(s4)
ffffffffc0204bf0:	85a6                	mv	a1,s1
ffffffffc0204bf2:	0a21                	addi	s4,s4,8
ffffffffc0204bf4:	9902                	jalr	s2
            break;
ffffffffc0204bf6:	b5f1                	j	ffffffffc0204ac2 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204bf8:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204bfa:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204bfe:	01174463          	blt	a4,a7,ffffffffc0204c06 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204c02:	18088163          	beqz	a7,ffffffffc0204d84 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204c06:	000a3603          	ld	a2,0(s4)
ffffffffc0204c0a:	46a9                	li	a3,10
ffffffffc0204c0c:	8a2e                	mv	s4,a1
ffffffffc0204c0e:	bfc1                	j	ffffffffc0204bde <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c10:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204c14:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c16:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c18:	bdf1                	j	ffffffffc0204af4 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204c1a:	85a6                	mv	a1,s1
ffffffffc0204c1c:	02500513          	li	a0,37
ffffffffc0204c20:	9902                	jalr	s2
            break;
ffffffffc0204c22:	b545                	j	ffffffffc0204ac2 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c24:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204c28:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c2a:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c2c:	b5e1                	j	ffffffffc0204af4 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204c2e:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c30:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c34:	01174463          	blt	a4,a7,ffffffffc0204c3c <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204c38:	14088163          	beqz	a7,ffffffffc0204d7a <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204c3c:	000a3603          	ld	a2,0(s4)
ffffffffc0204c40:	46a1                	li	a3,8
ffffffffc0204c42:	8a2e                	mv	s4,a1
ffffffffc0204c44:	bf69                	j	ffffffffc0204bde <vprintfmt+0x156>
            putch('0', putdat);
...
ffffffffc0204c58:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204c5a:	6782                	ld	a5,0(sp)
ffffffffc0204c5c:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c5e:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204c62:	bfb5                	j	ffffffffc0204bde <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204c64:	000a3403          	ld	s0,0(s4)
ffffffffc0204c68:	008a0713          	addi	a4,s4,8
ffffffffc0204c6c:	e03a                	sd	a4,0(sp)
ffffffffc0204c6e:	14040263          	beqz	s0,ffffffffc0204db2 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204c72:	0fb05763          	blez	s11,ffffffffc0204d60 <vprintfmt+0x2d8>
ffffffffc0204c76:	02d00693          	li	a3,45
ffffffffc0204c7a:	0cd79163          	bne	a5,a3,ffffffffc0204d3c <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c7e:	00044783          	lbu	a5,0(s0)
ffffffffc0204c82:	0007851b          	sext.w	a0,a5
ffffffffc0204c86:	cf85                	beqz	a5,ffffffffc0204cbe <vprintfmt+0x236>
ffffffffc0204c88:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204c8c:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c90:	000c4563          	bltz	s8,ffffffffc0204c9a <vprintfmt+0x212>
ffffffffc0204c94:	3c7d                	addiw	s8,s8,-1
ffffffffc0204c96:	036c0263          	beq	s8,s6,ffffffffc0204cba <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204c9a:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204c9c:	0e0c8e63          	beqz	s9,ffffffffc0204d98 <vprintfmt+0x310>
ffffffffc0204ca0:	3781                	addiw	a5,a5,-32
ffffffffc0204ca2:	0ef47b63          	bgeu	s0,a5,ffffffffc0204d98 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204ca6:	03f00513          	li	a0,63
ffffffffc0204caa:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204cac:	000a4783          	lbu	a5,0(s4)
ffffffffc0204cb0:	3dfd                	addiw	s11,s11,-1
ffffffffc0204cb2:	0a05                	addi	s4,s4,1
ffffffffc0204cb4:	0007851b          	sext.w	a0,a5
ffffffffc0204cb8:	ffe1                	bnez	a5,ffffffffc0204c90 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204cba:	01b05963          	blez	s11,ffffffffc0204ccc <vprintfmt+0x244>
...
ffffffffc0204cc6:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204cc8:	fe0d9be3          	bnez	s11,ffffffffc0204cbe <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204ccc:	6a02                	ld	s4,0(sp)
ffffffffc0204cce:	bbd5                	j	ffffffffc0204ac2 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204cd0:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204cd2:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204cd6:	01174463          	blt	a4,a7,ffffffffc0204cde <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204cda:	08088d63          	beqz	a7,ffffffffc0204d74 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204cde:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204ce2:	0a044d63          	bltz	s0,ffffffffc0204d9c <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204ce6:	8622                	mv	a2,s0
ffffffffc0204ce8:	8a66                	mv	s4,s9
ffffffffc0204cea:	46a9                	li	a3,10
ffffffffc0204cec:	bdcd                	j	ffffffffc0204bde <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204cee:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204cf2:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204cf4:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204cf6:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204cfa:	8fb5                	xor	a5,a5,a3
ffffffffc0204cfc:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d00:	02d74163          	blt	a4,a3,ffffffffc0204d22 <vprintfmt+0x29a>
ffffffffc0204d04:	00369793          	slli	a5,a3,0x3
ffffffffc0204d08:	97de                	add	a5,a5,s7
ffffffffc0204d0a:	639c                	ld	a5,0(a5)
ffffffffc0204d0c:	cb99                	beqz	a5,ffffffffc0204d22 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204d0e:	86be                	mv	a3,a5
ffffffffc0204d10:	00000617          	auipc	a2,0x0
ffffffffc0204d14:	1f060613          	addi	a2,a2,496 # ffffffffc0204f00 <etext+0x2c>
ffffffffc0204d18:	85a6                	mv	a1,s1
ffffffffc0204d1a:	854a                	mv	a0,s2
ffffffffc0204d1c:	0ce000ef          	jal	ra,ffffffffc0204dea <printfmt>
ffffffffc0204d20:	b34d                	j	ffffffffc0204ac2 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204d22:	00002617          	auipc	a2,0x2
ffffffffc0204d26:	0de60613          	addi	a2,a2,222 # ffffffffc0206e00 <default_pmm_manager+0x11d8>
ffffffffc0204d2a:	85a6                	mv	a1,s1
ffffffffc0204d2c:	854a                	mv	a0,s2
ffffffffc0204d2e:	0bc000ef          	jal	ra,ffffffffc0204dea <printfmt>
ffffffffc0204d32:	bb41                	j	ffffffffc0204ac2 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204d34:	00002417          	auipc	s0,0x2
ffffffffc0204d38:	0c440413          	addi	s0,s0,196 # ffffffffc0206df8 <default_pmm_manager+0x11d0>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d3c:	85e2                	mv	a1,s8
ffffffffc0204d3e:	8522                	mv	a0,s0
ffffffffc0204d40:	e43e                	sd	a5,8(sp)
ffffffffc0204d42:	0e2000ef          	jal	ra,ffffffffc0204e24 <strnlen>
ffffffffc0204d46:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204d4a:	01b05b63          	blez	s11,ffffffffc0204d60 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204d4e:	67a2                	ld	a5,8(sp)
ffffffffc0204d50:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d54:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204d56:	85a6                	mv	a1,s1
ffffffffc0204d58:	8552                	mv	a0,s4
ffffffffc0204d5a:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d5c:	fe0d9ce3          	bnez	s11,ffffffffc0204d54 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d60:	00044783          	lbu	a5,0(s0)
ffffffffc0204d64:	00140a13          	addi	s4,s0,1
ffffffffc0204d68:	0007851b          	sext.w	a0,a5
ffffffffc0204d6c:	d3a5                	beqz	a5,ffffffffc0204ccc <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204d6e:	05e00413          	li	s0,94
ffffffffc0204d72:	bf39                	j	ffffffffc0204c90 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204d74:	000a2403          	lw	s0,0(s4)
ffffffffc0204d78:	b7ad                	j	ffffffffc0204ce2 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204d7a:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d7e:	46a1                	li	a3,8
ffffffffc0204d80:	8a2e                	mv	s4,a1
ffffffffc0204d82:	bdb1                	j	ffffffffc0204bde <vprintfmt+0x156>
ffffffffc0204d84:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d88:	46a9                	li	a3,10
ffffffffc0204d8a:	8a2e                	mv	s4,a1
ffffffffc0204d8c:	bd89                	j	ffffffffc0204bde <vprintfmt+0x156>
ffffffffc0204d8e:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d92:	46c1                	li	a3,16
ffffffffc0204d94:	8a2e                	mv	s4,a1
ffffffffc0204d96:	b5a1                	j	ffffffffc0204bde <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204d98:	9902                	jalr	s2
ffffffffc0204d9a:	bf09                	j	ffffffffc0204cac <vprintfmt+0x224>
                putch('-', putdat);
...
ffffffffc0204da4:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204da6:	6782                	ld	a5,0(sp)
ffffffffc0204da8:	8a66                	mv	s4,s9
ffffffffc0204daa:	40800633          	neg	a2,s0
ffffffffc0204dae:	46a9                	li	a3,10
ffffffffc0204db0:	b53d                	j	ffffffffc0204bde <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204db2:	03b05163          	blez	s11,ffffffffc0204dd4 <vprintfmt+0x34c>
ffffffffc0204db6:	02d00693          	li	a3,45
ffffffffc0204dba:	f6d79de3          	bne	a5,a3,ffffffffc0204d34 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204dbe:	00002417          	auipc	s0,0x2
ffffffffc0204dc2:	03a40413          	addi	s0,s0,58 # ffffffffc0206df8 <default_pmm_manager+0x11d0>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204dc6:	02800793          	li	a5,40
ffffffffc0204dca:	02800513          	li	a0,40
ffffffffc0204dce:	00140a13          	addi	s4,s0,1
ffffffffc0204dd2:	bd6d                	j	ffffffffc0204c8c <vprintfmt+0x204>
ffffffffc0204dd4:	00002a17          	auipc	s4,0x2
ffffffffc0204dd8:	025a0a13          	addi	s4,s4,37 # ffffffffc0206df9 <default_pmm_manager+0x11d1>
ffffffffc0204ddc:	02800513          	li	a0,40
ffffffffc0204de0:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204de4:	05e00413          	li	s0,94
ffffffffc0204de8:	b565                	j	ffffffffc0204c90 <vprintfmt+0x208>

ffffffffc0204dea <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204dea:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204dec:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204df0:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204df2:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204df4:	ec06                	sd	ra,24(sp)
ffffffffc0204df6:	f83a                	sd	a4,48(sp)
ffffffffc0204df8:	fc3e                	sd	a5,56(sp)
ffffffffc0204dfa:	e0c2                	sd	a6,64(sp)
ffffffffc0204dfc:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204dfe:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204e00:	c89ff0ef          	jal	ra,ffffffffc0204a88 <vprintfmt>
}
ffffffffc0204e04:	60e2                	ld	ra,24(sp)
ffffffffc0204e06:	6161                	addi	sp,sp,80
ffffffffc0204e08:	8082                	ret

ffffffffc0204e0a <strlen>:
...
strlen(const char *s) {
ffffffffc0204e0e:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204e10:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204e12:	cb81                	beqz	a5,ffffffffc0204e22 <strlen+0x18>
        cnt ++;
ffffffffc0204e14:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204e16:	00a707b3          	add	a5,a4,a0
ffffffffc0204e1a:	0007c783          	lbu	a5,0(a5)
ffffffffc0204e1e:	fbfd                	bnez	a5,ffffffffc0204e14 <strlen+0xa>
...
ffffffffc0204e24:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e26:	e589                	bnez	a1,ffffffffc0204e30 <strnlen+0xc>
ffffffffc0204e28:	a811                	j	ffffffffc0204e3c <strnlen+0x18>
        cnt ++;
ffffffffc0204e2a:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e2c:	00f58863          	beq	a1,a5,ffffffffc0204e3c <strnlen+0x18>
ffffffffc0204e30:	00f50733          	add	a4,a0,a5
ffffffffc0204e34:	00074703          	lbu	a4,0(a4)
ffffffffc0204e38:	fb6d                	bnez	a4,ffffffffc0204e2a <strnlen+0x6>
ffffffffc0204e3a:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204e3c:	852e                	mv	a0,a1
ffffffffc0204e3e:	8082                	ret

ffffffffc0204e40 <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0204e40:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204e42:	0005c703          	lbu	a4,0(a1)
ffffffffc0204e46:	0785                	addi	a5,a5,1
ffffffffc0204e48:	0585                	addi	a1,a1,1
ffffffffc0204e4a:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204e4e:	fb75                	bnez	a4,ffffffffc0204e42 <strcpy+0x2>
        /* nothing */;
    return dst;
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e52:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e56:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e5a:	cb89                	beqz	a5,ffffffffc0204e6c <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204e5c:	0505                	addi	a0,a0,1
ffffffffc0204e5e:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e60:	fee789e3          	beq	a5,a4,ffffffffc0204e52 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e64:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204e68:	9d19                	subw	a0,a0,a4
ffffffffc0204e6a:	8082                	ret
ffffffffc0204e6c:	4501                	li	a0,0
ffffffffc0204e6e:	bfed                	j	ffffffffc0204e68 <strcmp+0x16>
...
ffffffffc0204e74:	c799                	beqz	a5,ffffffffc0204e82 <strchr+0x12>
        if (*s == c) {
ffffffffc0204e76:	00f58763          	beq	a1,a5,ffffffffc0204e84 <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204e7a:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204e7e:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204e80:	fbfd                	bnez	a5,ffffffffc0204e76 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204e86:	ca01                	beqz	a2,ffffffffc0204e96 <memset+0x10>
ffffffffc0204e88:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204e8a:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204e8c:	0785                	addi	a5,a5,1
ffffffffc0204e8e:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204e92:	fec79de3          	bne	a5,a2,ffffffffc0204e8c <memset+0x6>
    }
    return s;
...
ffffffffc0204e98 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204e98:	ca19                	beqz	a2,ffffffffc0204eae <memcpy+0x16>
ffffffffc0204e9a:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204e9c:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204e9e:	0005c703          	lbu	a4,0(a1)
ffffffffc0204ea2:	0585                	addi	a1,a1,1
ffffffffc0204ea4:	0785                	addi	a5,a5,1
ffffffffc0204ea6:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204eaa:	fec59ae3          	bne	a1,a2,ffffffffc0204e9e <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204eb0:	c205                	beqz	a2,ffffffffc0204ed0 <memcmp+0x20>
ffffffffc0204eb2:	962e                	add	a2,a2,a1
ffffffffc0204eb4:	a019                	j	ffffffffc0204eba <memcmp+0xa>
ffffffffc0204eb6:	00c58d63          	beq	a1,a2,ffffffffc0204ed0 <memcmp+0x20>
        if (*s1 != *s2) {
...
ffffffffc0204ebe:	0005c703          	lbu	a4,0(a1)
        ...
        s1 ++, s2 ++;
ffffffffc0204ec2:	0505                	addi	a0,a0,1
ffffffffc0204ec4:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0204ec6:	fee788e3          	beq	a5,a4,ffffffffc0204eb6 <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204eca:	40e7853b          	subw	a0,a5,a4
