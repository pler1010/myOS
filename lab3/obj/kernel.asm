...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	346040ef          	jal	ra,ffffffffc0204390 <memset>

    const char *message = "(THU.CST) os is loading ...";
    cprintf("%s\n\n", message);
ffffffffc020004e:	00004597          	auipc	a1,0x4
ffffffffc0200052:	37258593          	addi	a1,a1,882 # ffffffffc02043c0 <etext+0x6>
ffffffffc0200056:	00004517          	auipc	a0,0x4
ffffffffc020005a:	38a50513          	addi	a0,a0,906 # ffffffffc02043e0 <etext+0x26>
...
ffffffffc020006e:	5ca030ef          	jal	ra,ffffffffc0203638 <vmm_init>
...
ffffffffc02000ac:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000ae:	631030ef          	jal	ra,ffffffffc0203ede <vprintfmt>
    return cnt;
}
...
ffffffffc02000e2:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e4:	5fb030ef          	jal	ra,ffffffffc0203ede <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200108:	2e450513          	addi	a0,a0,740 # ffffffffc02043e8 <etext+0x2e>
void print_kerninfo(void) {
...
ffffffffc020011e:	2ee50513          	addi	a0,a0,750 # ffffffffc0204408 <etext+0x4e>
ffffffffc0200122:	f99ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200126:	00004597          	auipc	a1,0x4
ffffffffc020012a:	29458593          	addi	a1,a1,660 # ffffffffc02043ba <etext>
ffffffffc020012e:	00004517          	auipc	a0,0x4
ffffffffc0200132:	2fa50513          	addi	a0,a0,762 # ffffffffc0204428 <etext+0x6e>
...
ffffffffc0200146:	30650513          	addi	a0,a0,774 # ffffffffc0204448 <etext+0x8e>
...
ffffffffc020015a:	31250513          	addi	a0,a0,786 # ffffffffc0204468 <etext+0xae>
...
ffffffffc0200188:	30450513          	addi	a0,a0,772 # ffffffffc0204488 <etext+0xce>
}
...
ffffffffc0200196:	32660613          	addi	a2,a2,806 # ffffffffc02044b8 <etext+0xfe>
ffffffffc020019a:	04e00593          	li	a1,78
ffffffffc020019e:	00004517          	auipc	a0,0x4
ffffffffc02001a2:	33250513          	addi	a0,a0,818 # ffffffffc02044d0 <etext+0x116>
void print_stackframe(void) {
...
ffffffffc02001b2:	33a60613          	addi	a2,a2,826 # ffffffffc02044e8 <etext+0x12e>
ffffffffc02001b6:	00004597          	auipc	a1,0x4
ffffffffc02001ba:	35258593          	addi	a1,a1,850 # ffffffffc0204508 <etext+0x14e>
ffffffffc02001be:	00004517          	auipc	a0,0x4
ffffffffc02001c2:	35250513          	addi	a0,a0,850 # ffffffffc0204510 <etext+0x156>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d0:	35460613          	addi	a2,a2,852 # ffffffffc0204520 <etext+0x166>
ffffffffc02001d4:	00004597          	auipc	a1,0x4
ffffffffc02001d8:	37458593          	addi	a1,a1,884 # ffffffffc0204548 <etext+0x18e>
ffffffffc02001dc:	00004517          	auipc	a0,0x4
ffffffffc02001e0:	33450513          	addi	a0,a0,820 # ffffffffc0204510 <etext+0x156>
ffffffffc02001e4:	ed7ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc02001e8:	00004617          	auipc	a2,0x4
ffffffffc02001ec:	37060613          	addi	a2,a2,880 # ffffffffc0204558 <etext+0x19e>
ffffffffc02001f0:	00004597          	auipc	a1,0x4
ffffffffc02001f4:	38858593          	addi	a1,a1,904 # ffffffffc0204578 <etext+0x1be>
ffffffffc02001f8:	00004517          	auipc	a0,0x4
ffffffffc02001fc:	31850513          	addi	a0,a0,792 # ffffffffc0204510 <etext+0x156>
...
ffffffffc0200236:	35650513          	addi	a0,a0,854 # ffffffffc0204588 <etext+0x1ce>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200258:	35c50513          	addi	a0,a0,860 # ffffffffc02045b0 <etext+0x1f6>
...
ffffffffc020026e:	3aec0c13          	addi	s8,s8,942 # ffffffffc0204618 <commands>
        if ((buf = readline("")) != NULL) {
ffffffffc0200272:	00005917          	auipc	s2,0x5
ffffffffc0200276:	7b690913          	addi	s2,s2,1974 # ffffffffc0205a28 <default_pmm_manager+0x928>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020027a:	00004497          	auipc	s1,0x4
ffffffffc020027e:	35e48493          	addi	s1,s1,862 # ffffffffc02045d8 <etext+0x21e>
        if (argc == MAXARGS - 1) {
ffffffffc0200282:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200284:	00004b17          	auipc	s6,0x4
ffffffffc0200288:	35cb0b13          	addi	s6,s6,860 # ffffffffc02045e0 <etext+0x226>
        argv[argc ++] = buf;
ffffffffc020028c:	00004a17          	auipc	s4,0x4
ffffffffc0200290:	27ca0a13          	addi	s4,s4,636 # ffffffffc0204508 <etext+0x14e>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200294:	4a8d                	li	s5,3
        if ((buf = readline("")) != NULL) {
ffffffffc0200296:	854a                	mv	a0,s2
ffffffffc0200298:	7c9030ef          	jal	ra,ffffffffc0204260 <readline>
...
ffffffffc02002b2:	36ad0d13          	addi	s10,s10,874 # ffffffffc0204618 <commands>
        argv[argc ++] = buf;
...
ffffffffc02002ba:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002bc:	0a0040ef          	jal	ra,ffffffffc020435c <strcmp>
...
ffffffffc02002ce:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002d0:	08c040ef          	jal	ra,ffffffffc020435c <strcmp>
...
ffffffffc020030e:	06c040ef          	jal	ra,ffffffffc020437a <strchr>
...
ffffffffc020034c:	02e040ef          	jal	ra,ffffffffc020437a <strchr>
...
ffffffffc020036a:	29a50513          	addi	a0,a0,666 # ffffffffc0204600 <etext+0x246>
...
ffffffffc02003a6:	2be50513          	addi	a0,a0,702 # ffffffffc0204660 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc02003bc:	1c050513          	addi	a0,a0,448 # ffffffffc0205578 <default_pmm_manager+0x478>
...
ffffffffc02003fa:	28a50513          	addi	a0,a0,650 # ffffffffc0204680 <commands+0x68>
    ticks = 0;
...
ffffffffc02004b6:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004b8:	6eb030ef          	jal	ra,ffffffffc02043a2 <memcpy>
    return 0;
}
...
ffffffffc02004da:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004dc:	6c7030ef          	jal	ra,ffffffffc02043a2 <memcpy>
    return 0;
}
...
ffffffffc0200528:	17c50513          	addi	a0,a0,380 # ffffffffc02046a0 <commands+0x88>
...
ffffffffc0200546:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc0200548:	6c80306f          	j	ffffffffc0203c10 <do_pgfault>
    panic("unhandled page fault.\n");
ffffffffc020054c:	00004617          	auipc	a2,0x4
ffffffffc0200550:	17460613          	addi	a2,a2,372 # ffffffffc02046c0 <commands+0xa8>
ffffffffc0200554:	07800593          	li	a1,120
ffffffffc0200558:	00004517          	auipc	a0,0x4
ffffffffc020055c:	18050513          	addi	a0,a0,384 # ffffffffc02046d8 <commands+0xc0>
...
ffffffffc020058e:	16650513          	addi	a0,a0,358 # ffffffffc02046f0 <commands+0xd8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200746:	29650513          	addi	a0,a0,662 # ffffffffc02049d8 <commands+0x3c0>
}
...
ffffffffc020075a:	29a50513          	addi	a0,a0,666 # ffffffffc02049f0 <commands+0x3d8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200772:	29a50513          	addi	a0,a0,666 # ffffffffc0204a08 <commands+0x3f0>
ffffffffc0200776:	945ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  epc      0x%08x\n", tf->epc);
ffffffffc020077a:	10843583          	ld	a1,264(s0)
ffffffffc020077e:	00004517          	auipc	a0,0x4
ffffffffc0200782:	2a250513          	addi	a0,a0,674 # ffffffffc0204a20 <commands+0x408>
ffffffffc0200786:	935ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  badvaddr 0x%08x\n", tf->badvaddr);
ffffffffc020078a:	11043583          	ld	a1,272(s0)
ffffffffc020078e:	00004517          	auipc	a0,0x4
ffffffffc0200792:	2aa50513          	addi	a0,a0,682 # ffffffffc0204a38 <commands+0x420>
...
ffffffffc02007a6:	2ae50513          	addi	a0,a0,686 # ffffffffc0204a50 <commands+0x438>
}
...
ffffffffc02007c2:	35a70713          	addi	a4,a4,858 # ffffffffc0204b18 <commands+0x500>
...
ffffffffc02007d4:	2f850513          	addi	a0,a0,760 # ffffffffc0204ac8 <commands+0x4b0>
ffffffffc02007d8:	8e3ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02007dc:	00004517          	auipc	a0,0x4
ffffffffc02007e0:	2cc50513          	addi	a0,a0,716 # ffffffffc0204aa8 <commands+0x490>
ffffffffc02007e4:	8d7ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02007e8:	00004517          	auipc	a0,0x4
ffffffffc02007ec:	28050513          	addi	a0,a0,640 # ffffffffc0204a68 <commands+0x450>
ffffffffc02007f0:	8cbff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02007f4:	00004517          	auipc	a0,0x4
ffffffffc02007f8:	29450513          	addi	a0,a0,660 # ffffffffc0204a88 <commands+0x470>
...
ffffffffc020082a:	2d250513          	addi	a0,a0,722 # ffffffffc0204af8 <commands+0x4e0>
...
ffffffffc020083e:	2ae50513          	addi	a0,a0,686 # ffffffffc0204ae8 <commands+0x4d0>
}
...
ffffffffc0200860:	4a470713          	addi	a4,a4,1188 # ffffffffc0204d00 <commands+0x6e8>
...
ffffffffc0200872:	47a50513          	addi	a0,a0,1146 # ffffffffc0204ce8 <commands+0x6d0>
...
ffffffffc0200894:	2b850513          	addi	a0,a0,696 # ffffffffc0204b48 <commands+0x530>
}
...
ffffffffc02008a8:	2c450513          	addi	a0,a0,708 # ffffffffc0204b68 <commands+0x550>
ffffffffc02008ac:	b7f5                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Illegal instruction\n");
ffffffffc02008ae:	00004517          	auipc	a0,0x4
ffffffffc02008b2:	2da50513          	addi	a0,a0,730 # ffffffffc0204b88 <commands+0x570>
ffffffffc02008b6:	b7cd                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Breakpoint\n");
ffffffffc02008b8:	00004517          	auipc	a0,0x4
ffffffffc02008bc:	2e850513          	addi	a0,a0,744 # ffffffffc0204ba0 <commands+0x588>
ffffffffc02008c0:	bfe1                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load address misaligned\n");
ffffffffc02008c2:	00004517          	auipc	a0,0x4
ffffffffc02008c6:	2ee50513          	addi	a0,a0,750 # ffffffffc0204bb0 <commands+0x598>
ffffffffc02008ca:	b7f9                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load access fault\n");
ffffffffc02008cc:	00004517          	auipc	a0,0x4
ffffffffc02008d0:	30450513          	addi	a0,a0,772 # ffffffffc0204bd0 <commands+0x5b8>
...
ffffffffc02008ee:	2fe60613          	addi	a2,a2,766 # ffffffffc0204be8 <commands+0x5d0>
ffffffffc02008f2:	0ca00593          	li	a1,202
ffffffffc02008f6:	00004517          	auipc	a0,0x4
ffffffffc02008fa:	de250513          	addi	a0,a0,-542 # ffffffffc02046d8 <commands+0xc0>
ffffffffc02008fe:	a77ff0ef          	jal	ra,ffffffffc0200374 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc0200902:	00004517          	auipc	a0,0x4
ffffffffc0200906:	30650513          	addi	a0,a0,774 # ffffffffc0204c08 <commands+0x5f0>
ffffffffc020090a:	b779                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc020090c:	00004517          	auipc	a0,0x4
ffffffffc0200910:	31450513          	addi	a0,a0,788 # ffffffffc0204c20 <commands+0x608>
...
ffffffffc0200998:	25460613          	addi	a2,a2,596 # ffffffffc0204be8 <commands+0x5d0>
ffffffffc020099c:	0ea00593          	li	a1,234
ffffffffc02009a0:	00004517          	auipc	a0,0x4
ffffffffc02009a4:	d3850513          	addi	a0,a0,-712 # ffffffffc02046d8 <commands+0xc0>
...
ffffffffc02009c4:	22860613          	addi	a2,a2,552 # ffffffffc0204be8 <commands+0x5d0>
ffffffffc02009c8:	0f100593          	li	a1,241
ffffffffc02009cc:	00004517          	auipc	a0,0x4
ffffffffc02009d0:	d0c50513          	addi	a0,a0,-756 # ffffffffc02046d8 <commands+0xc0>
...
ffffffffc0200b6e:	6a65b583          	ld	a1,1702(a1) # ffffffffc0206210 <error_string+0x38>
ffffffffc0200b72:	02b70733          	mul	a4,a4,a1
ffffffffc0200b76:	00005617          	auipc	a2,0x5
ffffffffc0200b7a:	6a263603          	ld	a2,1698(a2) # ffffffffc0206218 <nbase>
...
ffffffffc0200dc6:	f7e68693          	addi	a3,a3,-130 # ffffffffc0204d40 <commands+0x728>
ffffffffc0200dca:	00004617          	auipc	a2,0x4
ffffffffc0200dce:	f8660613          	addi	a2,a2,-122 # ffffffffc0204d50 <commands+0x738>
ffffffffc0200dd2:	0f000593          	li	a1,240
ffffffffc0200dd6:	00004517          	auipc	a0,0x4
ffffffffc0200dda:	f9250513          	addi	a0,a0,-110 # ffffffffc0204d68 <commands+0x750>
ffffffffc0200dde:	d96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200de2:	00004697          	auipc	a3,0x4
ffffffffc0200de6:	01e68693          	addi	a3,a3,30 # ffffffffc0204e00 <commands+0x7e8>
ffffffffc0200dea:	00004617          	auipc	a2,0x4
ffffffffc0200dee:	f6660613          	addi	a2,a2,-154 # ffffffffc0204d50 <commands+0x738>
ffffffffc0200df2:	0bd00593          	li	a1,189
ffffffffc0200df6:	00004517          	auipc	a0,0x4
ffffffffc0200dfa:	f7250513          	addi	a0,a0,-142 # ffffffffc0204d68 <commands+0x750>
ffffffffc0200dfe:	d76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200e02:	00004697          	auipc	a3,0x4
ffffffffc0200e06:	02668693          	addi	a3,a3,38 # ffffffffc0204e28 <commands+0x810>
ffffffffc0200e0a:	00004617          	auipc	a2,0x4
ffffffffc0200e0e:	f4660613          	addi	a2,a2,-186 # ffffffffc0204d50 <commands+0x738>
ffffffffc0200e12:	0be00593          	li	a1,190
ffffffffc0200e16:	00004517          	auipc	a0,0x4
ffffffffc0200e1a:	f5250513          	addi	a0,a0,-174 # ffffffffc0204d68 <commands+0x750>
ffffffffc0200e1e:	d56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200e22:	00004697          	auipc	a3,0x4
ffffffffc0200e26:	04668693          	addi	a3,a3,70 # ffffffffc0204e68 <commands+0x850>
ffffffffc0200e2a:	00004617          	auipc	a2,0x4
ffffffffc0200e2e:	f2660613          	addi	a2,a2,-218 # ffffffffc0204d50 <commands+0x738>
ffffffffc0200e32:	0c000593          	li	a1,192
ffffffffc0200e36:	00004517          	auipc	a0,0x4
ffffffffc0200e3a:	f3250513          	addi	a0,a0,-206 # ffffffffc0204d68 <commands+0x750>
ffffffffc0200e3e:	d36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200e42:	00004697          	auipc	a3,0x4
ffffffffc0200e46:	0ae68693          	addi	a3,a3,174 # ffffffffc0204ef0 <commands+0x8d8>
ffffffffc0200e4a:	00004617          	auipc	a2,0x4
ffffffffc0200e4e:	f0660613          	addi	a2,a2,-250 # ffffffffc0204d50 <commands+0x738>
ffffffffc0200e52:	0d900593          	li	a1,217
ffffffffc0200e56:	00004517          	auipc	a0,0x4
ffffffffc0200e5a:	f1250513          	addi	a0,a0,-238 # ffffffffc0204d68 <commands+0x750>
ffffffffc0200e5e:	d16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200e62:	00004697          	auipc	a3,0x4
ffffffffc0200e66:	f3e68693          	addi	a3,a3,-194 # ffffffffc0204da0 <commands+0x788>
ffffffffc0200e6a:	00004617          	auipc	a2,0x4
ffffffffc0200e6e:	ee660613          	addi	a2,a2,-282 # ffffffffc0204d50 <commands+0x738>
ffffffffc0200e72:	0d200593          	li	a1,210
ffffffffc0200e76:	00004517          	auipc	a0,0x4
ffffffffc0200e7a:	ef250513          	addi	a0,a0,-270 # ffffffffc0204d68 <commands+0x750>
ffffffffc0200e7e:	cf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 3);
ffffffffc0200e82:	00004697          	auipc	a3,0x4
ffffffffc0200e86:	05e68693          	addi	a3,a3,94 # ffffffffc0204ee0 <commands+0x8c8>
ffffffffc0200e8a:	00004617          	auipc	a2,0x4
ffffffffc0200e8e:	ec660613          	addi	a2,a2,-314 # ffffffffc0204d50 <commands+0x738>
ffffffffc0200e92:	0d000593          	li	a1,208
ffffffffc0200e96:	00004517          	auipc	a0,0x4
ffffffffc0200e9a:	ed250513          	addi	a0,a0,-302 # ffffffffc0204d68 <commands+0x750>
ffffffffc0200e9e:	cd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200ea2:	00004697          	auipc	a3,0x4
ffffffffc0200ea6:	02668693          	addi	a3,a3,38 # ffffffffc0204ec8 <commands+0x8b0>
ffffffffc0200eaa:	00004617          	auipc	a2,0x4
ffffffffc0200eae:	ea660613          	addi	a2,a2,-346 # ffffffffc0204d50 <commands+0x738>
ffffffffc0200eb2:	0cb00593          	li	a1,203
ffffffffc0200eb6:	00004517          	auipc	a0,0x4
ffffffffc0200eba:	eb250513          	addi	a0,a0,-334 # ffffffffc0204d68 <commands+0x750>
ffffffffc0200ebe:	cb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200ec2:	00004697          	auipc	a3,0x4
ffffffffc0200ec6:	fe668693          	addi	a3,a3,-26 # ffffffffc0204ea8 <commands+0x890>
ffffffffc0200eca:	00004617          	auipc	a2,0x4
ffffffffc0200ece:	e8660613          	addi	a2,a2,-378 # ffffffffc0204d50 <commands+0x738>
ffffffffc0200ed2:	0c200593          	li	a1,194
ffffffffc0200ed6:	00004517          	auipc	a0,0x4
ffffffffc0200eda:	e9250513          	addi	a0,a0,-366 # ffffffffc0204d68 <commands+0x750>
ffffffffc0200ede:	c96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != NULL);
ffffffffc0200ee2:	00004697          	auipc	a3,0x4
ffffffffc0200ee6:	05668693          	addi	a3,a3,86 # ffffffffc0204f38 <commands+0x920>
ffffffffc0200eea:	00004617          	auipc	a2,0x4
ffffffffc0200eee:	e6660613          	addi	a2,a2,-410 # ffffffffc0204d50 <commands+0x738>
ffffffffc0200ef2:	0f800593          	li	a1,248
ffffffffc0200ef6:	00004517          	auipc	a0,0x4
ffffffffc0200efa:	e7250513          	addi	a0,a0,-398 # ffffffffc0204d68 <commands+0x750>
ffffffffc0200efe:	c76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0200f02:	00004697          	auipc	a3,0x4
ffffffffc0200f06:	02668693          	addi	a3,a3,38 # ffffffffc0204f28 <commands+0x910>
ffffffffc0200f0a:	00004617          	auipc	a2,0x4
ffffffffc0200f0e:	e4660613          	addi	a2,a2,-442 # ffffffffc0204d50 <commands+0x738>
ffffffffc0200f12:	0df00593          	li	a1,223
ffffffffc0200f16:	00004517          	auipc	a0,0x4
ffffffffc0200f1a:	e5250513          	addi	a0,a0,-430 # ffffffffc0204d68 <commands+0x750>
ffffffffc0200f1e:	c56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f22:	00004697          	auipc	a3,0x4
ffffffffc0200f26:	fa668693          	addi	a3,a3,-90 # ffffffffc0204ec8 <commands+0x8b0>
ffffffffc0200f2a:	00004617          	auipc	a2,0x4
ffffffffc0200f2e:	e2660613          	addi	a2,a2,-474 # ffffffffc0204d50 <commands+0x738>
ffffffffc0200f32:	0dd00593          	li	a1,221
ffffffffc0200f36:	00004517          	auipc	a0,0x4
ffffffffc0200f3a:	e3250513          	addi	a0,a0,-462 # ffffffffc0204d68 <commands+0x750>
ffffffffc0200f3e:	c36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200f42:	00004697          	auipc	a3,0x4
ffffffffc0200f46:	fc668693          	addi	a3,a3,-58 # ffffffffc0204f08 <commands+0x8f0>
ffffffffc0200f4a:	00004617          	auipc	a2,0x4
ffffffffc0200f4e:	e0660613          	addi	a2,a2,-506 # ffffffffc0204d50 <commands+0x738>
ffffffffc0200f52:	0dc00593          	li	a1,220
ffffffffc0200f56:	00004517          	auipc	a0,0x4
ffffffffc0200f5a:	e1250513          	addi	a0,a0,-494 # ffffffffc0204d68 <commands+0x750>
ffffffffc0200f5e:	c16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f62:	00004697          	auipc	a3,0x4
ffffffffc0200f66:	e3e68693          	addi	a3,a3,-450 # ffffffffc0204da0 <commands+0x788>
ffffffffc0200f6a:	00004617          	auipc	a2,0x4
ffffffffc0200f6e:	de660613          	addi	a2,a2,-538 # ffffffffc0204d50 <commands+0x738>
ffffffffc0200f72:	0b900593          	li	a1,185
ffffffffc0200f76:	00004517          	auipc	a0,0x4
ffffffffc0200f7a:	df250513          	addi	a0,a0,-526 # ffffffffc0204d68 <commands+0x750>
ffffffffc0200f7e:	bf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f82:	00004697          	auipc	a3,0x4
ffffffffc0200f86:	f4668693          	addi	a3,a3,-186 # ffffffffc0204ec8 <commands+0x8b0>
ffffffffc0200f8a:	00004617          	auipc	a2,0x4
ffffffffc0200f8e:	dc660613          	addi	a2,a2,-570 # ffffffffc0204d50 <commands+0x738>
ffffffffc0200f92:	0d600593          	li	a1,214
ffffffffc0200f96:	00004517          	auipc	a0,0x4
ffffffffc0200f9a:	dd250513          	addi	a0,a0,-558 # ffffffffc0204d68 <commands+0x750>
ffffffffc0200f9e:	bd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fa2:	00004697          	auipc	a3,0x4
ffffffffc0200fa6:	e3e68693          	addi	a3,a3,-450 # ffffffffc0204de0 <commands+0x7c8>
ffffffffc0200faa:	00004617          	auipc	a2,0x4
ffffffffc0200fae:	da660613          	addi	a2,a2,-602 # ffffffffc0204d50 <commands+0x738>
ffffffffc0200fb2:	0d400593          	li	a1,212
ffffffffc0200fb6:	00004517          	auipc	a0,0x4
ffffffffc0200fba:	db250513          	addi	a0,a0,-590 # ffffffffc0204d68 <commands+0x750>
ffffffffc0200fbe:	bb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0200fc2:	00004697          	auipc	a3,0x4
ffffffffc0200fc6:	dfe68693          	addi	a3,a3,-514 # ffffffffc0204dc0 <commands+0x7a8>
ffffffffc0200fca:	00004617          	auipc	a2,0x4
ffffffffc0200fce:	d8660613          	addi	a2,a2,-634 # ffffffffc0204d50 <commands+0x738>
ffffffffc0200fd2:	0d300593          	li	a1,211
ffffffffc0200fd6:	00004517          	auipc	a0,0x4
ffffffffc0200fda:	d9250513          	addi	a0,a0,-622 # ffffffffc0204d68 <commands+0x750>
ffffffffc0200fde:	b96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fe2:	00004697          	auipc	a3,0x4
ffffffffc0200fe6:	dfe68693          	addi	a3,a3,-514 # ffffffffc0204de0 <commands+0x7c8>
ffffffffc0200fea:	00004617          	auipc	a2,0x4
ffffffffc0200fee:	d6660613          	addi	a2,a2,-666 # ffffffffc0204d50 <commands+0x738>
ffffffffc0200ff2:	0bb00593          	li	a1,187
ffffffffc0200ff6:	00004517          	auipc	a0,0x4
ffffffffc0200ffa:	d7250513          	addi	a0,a0,-654 # ffffffffc0204d68 <commands+0x750>
ffffffffc0200ffe:	b76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(count == 0);
ffffffffc0201002:	00004697          	auipc	a3,0x4
ffffffffc0201006:	08668693          	addi	a3,a3,134 # ffffffffc0205088 <commands+0xa70>
ffffffffc020100a:	00004617          	auipc	a2,0x4
ffffffffc020100e:	d4660613          	addi	a2,a2,-698 # ffffffffc0204d50 <commands+0x738>
ffffffffc0201012:	12500593          	li	a1,293
ffffffffc0201016:	00004517          	auipc	a0,0x4
ffffffffc020101a:	d5250513          	addi	a0,a0,-686 # ffffffffc0204d68 <commands+0x750>
ffffffffc020101e:	b56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0201022:	00004697          	auipc	a3,0x4
ffffffffc0201026:	f0668693          	addi	a3,a3,-250 # ffffffffc0204f28 <commands+0x910>
ffffffffc020102a:	00004617          	auipc	a2,0x4
ffffffffc020102e:	d2660613          	addi	a2,a2,-730 # ffffffffc0204d50 <commands+0x738>
ffffffffc0201032:	11a00593          	li	a1,282
ffffffffc0201036:	00004517          	auipc	a0,0x4
ffffffffc020103a:	d3250513          	addi	a0,a0,-718 # ffffffffc0204d68 <commands+0x750>
ffffffffc020103e:	b36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201042:	00004697          	auipc	a3,0x4
ffffffffc0201046:	e8668693          	addi	a3,a3,-378 # ffffffffc0204ec8 <commands+0x8b0>
ffffffffc020104a:	00004617          	auipc	a2,0x4
ffffffffc020104e:	d0660613          	addi	a2,a2,-762 # ffffffffc0204d50 <commands+0x738>
ffffffffc0201052:	11800593          	li	a1,280
ffffffffc0201056:	00004517          	auipc	a0,0x4
ffffffffc020105a:	d1250513          	addi	a0,a0,-750 # ffffffffc0204d68 <commands+0x750>
ffffffffc020105e:	b16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201062:	00004697          	auipc	a3,0x4
ffffffffc0201066:	e2668693          	addi	a3,a3,-474 # ffffffffc0204e88 <commands+0x870>
ffffffffc020106a:	00004617          	auipc	a2,0x4
ffffffffc020106e:	ce660613          	addi	a2,a2,-794 # ffffffffc0204d50 <commands+0x738>
ffffffffc0201072:	0c100593          	li	a1,193
ffffffffc0201076:	00004517          	auipc	a0,0x4
ffffffffc020107a:	cf250513          	addi	a0,a0,-782 # ffffffffc0204d68 <commands+0x750>
ffffffffc020107e:	af6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201082:	00004697          	auipc	a3,0x4
ffffffffc0201086:	fc668693          	addi	a3,a3,-58 # ffffffffc0205048 <commands+0xa30>
ffffffffc020108a:	00004617          	auipc	a2,0x4
ffffffffc020108e:	cc660613          	addi	a2,a2,-826 # ffffffffc0204d50 <commands+0x738>
ffffffffc0201092:	11200593          	li	a1,274
ffffffffc0201096:	00004517          	auipc	a0,0x4
ffffffffc020109a:	cd250513          	addi	a0,a0,-814 # ffffffffc0204d68 <commands+0x750>
ffffffffc020109e:	ad6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc02010a2:	00004697          	auipc	a3,0x4
ffffffffc02010a6:	f8668693          	addi	a3,a3,-122 # ffffffffc0205028 <commands+0xa10>
ffffffffc02010aa:	00004617          	auipc	a2,0x4
ffffffffc02010ae:	ca660613          	addi	a2,a2,-858 # ffffffffc0204d50 <commands+0x738>
ffffffffc02010b2:	11000593          	li	a1,272
ffffffffc02010b6:	00004517          	auipc	a0,0x4
ffffffffc02010ba:	cb250513          	addi	a0,a0,-846 # ffffffffc0204d68 <commands+0x750>
ffffffffc02010be:	ab6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02010c2:	00004697          	auipc	a3,0x4
ffffffffc02010c6:	f3e68693          	addi	a3,a3,-194 # ffffffffc0205000 <commands+0x9e8>
ffffffffc02010ca:	00004617          	auipc	a2,0x4
ffffffffc02010ce:	c8660613          	addi	a2,a2,-890 # ffffffffc0204d50 <commands+0x738>
ffffffffc02010d2:	10e00593          	li	a1,270
ffffffffc02010d6:	00004517          	auipc	a0,0x4
ffffffffc02010da:	c9250513          	addi	a0,a0,-878 # ffffffffc0204d68 <commands+0x750>
ffffffffc02010de:	a96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc02010e2:	00004697          	auipc	a3,0x4
ffffffffc02010e6:	ef668693          	addi	a3,a3,-266 # ffffffffc0204fd8 <commands+0x9c0>
ffffffffc02010ea:	00004617          	auipc	a2,0x4
ffffffffc02010ee:	c6660613          	addi	a2,a2,-922 # ffffffffc0204d50 <commands+0x738>
ffffffffc02010f2:	10d00593          	li	a1,269
ffffffffc02010f6:	00004517          	auipc	a0,0x4
ffffffffc02010fa:	c7250513          	addi	a0,a0,-910 # ffffffffc0204d68 <commands+0x750>
ffffffffc02010fe:	a76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201102:	00004697          	auipc	a3,0x4
ffffffffc0201106:	ec668693          	addi	a3,a3,-314 # ffffffffc0204fc8 <commands+0x9b0>
ffffffffc020110a:	00004617          	auipc	a2,0x4
ffffffffc020110e:	c4660613          	addi	a2,a2,-954 # ffffffffc0204d50 <commands+0x738>
ffffffffc0201112:	10800593          	li	a1,264
ffffffffc0201116:	00004517          	auipc	a0,0x4
ffffffffc020111a:	c5250513          	addi	a0,a0,-942 # ffffffffc0204d68 <commands+0x750>
ffffffffc020111e:	a56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201122:	00004697          	auipc	a3,0x4
ffffffffc0201126:	da668693          	addi	a3,a3,-602 # ffffffffc0204ec8 <commands+0x8b0>
ffffffffc020112a:	00004617          	auipc	a2,0x4
ffffffffc020112e:	c2660613          	addi	a2,a2,-986 # ffffffffc0204d50 <commands+0x738>
ffffffffc0201132:	10700593          	li	a1,263
ffffffffc0201136:	00004517          	auipc	a0,0x4
ffffffffc020113a:	c3250513          	addi	a0,a0,-974 # ffffffffc0204d68 <commands+0x750>
ffffffffc020113e:	a36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc0201142:	00004697          	auipc	a3,0x4
ffffffffc0201146:	e6668693          	addi	a3,a3,-410 # ffffffffc0204fa8 <commands+0x990>
ffffffffc020114a:	00004617          	auipc	a2,0x4
ffffffffc020114e:	c0660613          	addi	a2,a2,-1018 # ffffffffc0204d50 <commands+0x738>
ffffffffc0201152:	10600593          	li	a1,262
ffffffffc0201156:	00004517          	auipc	a0,0x4
ffffffffc020115a:	c1250513          	addi	a0,a0,-1006 # ffffffffc0204d68 <commands+0x750>
ffffffffc020115e:	a16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201162:	00004697          	auipc	a3,0x4
ffffffffc0201166:	e1668693          	addi	a3,a3,-490 # ffffffffc0204f78 <commands+0x960>
ffffffffc020116a:	00004617          	auipc	a2,0x4
ffffffffc020116e:	be660613          	addi	a2,a2,-1050 # ffffffffc0204d50 <commands+0x738>
ffffffffc0201172:	10500593          	li	a1,261
ffffffffc0201176:	00004517          	auipc	a0,0x4
ffffffffc020117a:	bf250513          	addi	a0,a0,-1038 # ffffffffc0204d68 <commands+0x750>
ffffffffc020117e:	9f6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201182:	00004697          	auipc	a3,0x4
ffffffffc0201186:	dde68693          	addi	a3,a3,-546 # ffffffffc0204f60 <commands+0x948>
ffffffffc020118a:	00004617          	auipc	a2,0x4
ffffffffc020118e:	bc660613          	addi	a2,a2,-1082 # ffffffffc0204d50 <commands+0x738>
ffffffffc0201192:	10400593          	li	a1,260
ffffffffc0201196:	00004517          	auipc	a0,0x4
ffffffffc020119a:	bd250513          	addi	a0,a0,-1070 # ffffffffc0204d68 <commands+0x750>
ffffffffc020119e:	9d6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011a2:	00004697          	auipc	a3,0x4
ffffffffc02011a6:	d2668693          	addi	a3,a3,-730 # ffffffffc0204ec8 <commands+0x8b0>
ffffffffc02011aa:	00004617          	auipc	a2,0x4
ffffffffc02011ae:	ba660613          	addi	a2,a2,-1114 # ffffffffc0204d50 <commands+0x738>
ffffffffc02011b2:	0fe00593          	li	a1,254
ffffffffc02011b6:	00004517          	auipc	a0,0x4
ffffffffc02011ba:	bb250513          	addi	a0,a0,-1102 # ffffffffc0204d68 <commands+0x750>
ffffffffc02011be:	9b6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!PageProperty(p0));
ffffffffc02011c2:	00004697          	auipc	a3,0x4
ffffffffc02011c6:	d8668693          	addi	a3,a3,-634 # ffffffffc0204f48 <commands+0x930>
ffffffffc02011ca:	00004617          	auipc	a2,0x4
ffffffffc02011ce:	b8660613          	addi	a2,a2,-1146 # ffffffffc0204d50 <commands+0x738>
ffffffffc02011d2:	0f900593          	li	a1,249
ffffffffc02011d6:	00004517          	auipc	a0,0x4
ffffffffc02011da:	b9250513          	addi	a0,a0,-1134 # ffffffffc0204d68 <commands+0x750>
ffffffffc02011de:	996ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc02011e2:	00004697          	auipc	a3,0x4
ffffffffc02011e6:	e8668693          	addi	a3,a3,-378 # ffffffffc0205068 <commands+0xa50>
ffffffffc02011ea:	00004617          	auipc	a2,0x4
ffffffffc02011ee:	b6660613          	addi	a2,a2,-1178 # ffffffffc0204d50 <commands+0x738>
ffffffffc02011f2:	11700593          	li	a1,279
ffffffffc02011f6:	00004517          	auipc	a0,0x4
ffffffffc02011fa:	b7250513          	addi	a0,a0,-1166 # ffffffffc0204d68 <commands+0x750>
ffffffffc02011fe:	976ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == 0);
ffffffffc0201202:	00004697          	auipc	a3,0x4
ffffffffc0201206:	e9668693          	addi	a3,a3,-362 # ffffffffc0205098 <commands+0xa80>
ffffffffc020120a:	00004617          	auipc	a2,0x4
ffffffffc020120e:	b4660613          	addi	a2,a2,-1210 # ffffffffc0204d50 <commands+0x738>
ffffffffc0201212:	12600593          	li	a1,294
ffffffffc0201216:	00004517          	auipc	a0,0x4
ffffffffc020121a:	b5250513          	addi	a0,a0,-1198 # ffffffffc0204d68 <commands+0x750>
ffffffffc020121e:	956ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == nr_free_pages());
ffffffffc0201222:	00004697          	auipc	a3,0x4
ffffffffc0201226:	b5e68693          	addi	a3,a3,-1186 # ffffffffc0204d80 <commands+0x768>
ffffffffc020122a:	00004617          	auipc	a2,0x4
ffffffffc020122e:	b2660613          	addi	a2,a2,-1242 # ffffffffc0204d50 <commands+0x738>
ffffffffc0201232:	0f300593          	li	a1,243
ffffffffc0201236:	00004517          	auipc	a0,0x4
ffffffffc020123a:	b3250513          	addi	a0,a0,-1230 # ffffffffc0204d68 <commands+0x750>
ffffffffc020123e:	936ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201242:	00004697          	auipc	a3,0x4
ffffffffc0201246:	b7e68693          	addi	a3,a3,-1154 # ffffffffc0204dc0 <commands+0x7a8>
ffffffffc020124a:	00004617          	auipc	a2,0x4
ffffffffc020124e:	b0660613          	addi	a2,a2,-1274 # ffffffffc0204d50 <commands+0x738>
ffffffffc0201252:	0ba00593          	li	a1,186
ffffffffc0201256:	00004517          	auipc	a0,0x4
ffffffffc020125a:	b1250513          	addi	a0,a0,-1262 # ffffffffc0204d68 <commands+0x750>
...
ffffffffc020139e:	d1668693          	addi	a3,a3,-746 # ffffffffc02050b0 <commands+0xa98>
ffffffffc02013a2:	00004617          	auipc	a2,0x4
ffffffffc02013a6:	9ae60613          	addi	a2,a2,-1618 # ffffffffc0204d50 <commands+0x738>
ffffffffc02013aa:	08300593          	li	a1,131
ffffffffc02013ae:	00004517          	auipc	a0,0x4
ffffffffc02013b2:	9ba50513          	addi	a0,a0,-1606 # ffffffffc0204d68 <commands+0x750>
ffffffffc02013b6:	fbffe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc02013ba:	00004697          	auipc	a3,0x4
ffffffffc02013be:	cee68693          	addi	a3,a3,-786 # ffffffffc02050a8 <commands+0xa90>
ffffffffc02013c2:	00004617          	auipc	a2,0x4
ffffffffc02013c6:	98e60613          	addi	a2,a2,-1650 # ffffffffc0204d50 <commands+0x738>
ffffffffc02013ca:	08000593          	li	a1,128
ffffffffc02013ce:	00004517          	auipc	a0,0x4
ffffffffc02013d2:	99a50513          	addi	a0,a0,-1638 # ffffffffc0204d68 <commands+0x750>
...
ffffffffc0201476:	c3668693          	addi	a3,a3,-970 # ffffffffc02050a8 <commands+0xa90>
ffffffffc020147a:	00004617          	auipc	a2,0x4
ffffffffc020147e:	8d660613          	addi	a2,a2,-1834 # ffffffffc0204d50 <commands+0x738>
ffffffffc0201482:	06200593          	li	a1,98
ffffffffc0201486:	00004517          	auipc	a0,0x4
ffffffffc020148a:	8e250513          	addi	a0,a0,-1822 # ffffffffc0204d68 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc020154c:	b9068693          	addi	a3,a3,-1136 # ffffffffc02050d8 <commands+0xac0>
ffffffffc0201550:	00004617          	auipc	a2,0x4
ffffffffc0201554:	80060613          	addi	a2,a2,-2048 # ffffffffc0204d50 <commands+0x738>
ffffffffc0201558:	04900593          	li	a1,73
ffffffffc020155c:	00004517          	auipc	a0,0x4
ffffffffc0201560:	80c50513          	addi	a0,a0,-2036 # ffffffffc0204d68 <commands+0x750>
ffffffffc0201564:	e11fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc0201568:	00004697          	auipc	a3,0x4
ffffffffc020156c:	b4068693          	addi	a3,a3,-1216 # ffffffffc02050a8 <commands+0xa90>
ffffffffc0201570:	00003617          	auipc	a2,0x3
ffffffffc0201574:	7e060613          	addi	a2,a2,2016 # ffffffffc0204d50 <commands+0x738>
ffffffffc0201578:	04600593          	li	a1,70
ffffffffc020157c:	00003517          	auipc	a0,0x3
ffffffffc0201580:	7ec50513          	addi	a0,a0,2028 # ffffffffc0204d68 <commands+0x750>
...
ffffffffc020158e:	bae60613          	addi	a2,a2,-1106 # ffffffffc0205138 <default_pmm_manager+0x38>
ffffffffc0201592:	06500593          	li	a1,101
ffffffffc0201596:	00004517          	auipc	a0,0x4
ffffffffc020159a:	bc250513          	addi	a0,a0,-1086 # ffffffffc0205158 <default_pmm_manager+0x58>
static inline struct Page *pa2page(uintptr_t pa) {
...
ffffffffc02015aa:	bc260613          	addi	a2,a2,-1086 # ffffffffc0205168 <default_pmm_manager+0x68>
ffffffffc02015ae:	07000593          	li	a1,112
ffffffffc02015b2:	00004517          	auipc	a0,0x4
ffffffffc02015b6:	ba650513          	addi	a0,a0,-1114 # ffffffffc0205158 <default_pmm_manager+0x58>
static inline struct Page *pte2page(pte_t pte) {
...
ffffffffc0201722:	af2b3b03          	ld	s6,-1294(s6) # ffffffffc0206210 <error_string+0x38>
...
ffffffffc0201760:	431020ef          	jal	ra,ffffffffc0204390 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc02017d0:	a44b3b03          	ld	s6,-1468(s6) # ffffffffc0206210 <error_string+0x38>
...
ffffffffc0201802:	38f020ef          	jal	ra,ffffffffc0204390 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201862:	93260613          	addi	a2,a2,-1742 # ffffffffc0205190 <default_pmm_manager+0x90>
ffffffffc0201866:	10200593          	li	a1,258
ffffffffc020186a:	00004517          	auipc	a0,0x4
ffffffffc020186e:	94e50513          	addi	a0,a0,-1714 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc0201872:	b03fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201876:	00004617          	auipc	a2,0x4
ffffffffc020187a:	91a60613          	addi	a2,a2,-1766 # ffffffffc0205190 <default_pmm_manager+0x90>
ffffffffc020187e:	10f00593          	li	a1,271
ffffffffc0201882:	00004517          	auipc	a0,0x4
ffffffffc0201886:	93650513          	addi	a0,a0,-1738 # ffffffffc02051b8 <default_pmm_manager+0xb8>
...
ffffffffc0201894:	90060613          	addi	a2,a2,-1792 # ffffffffc0205190 <default_pmm_manager+0x90>
ffffffffc0201898:	10b00593          	li	a1,267
ffffffffc020189c:	00004517          	auipc	a0,0x4
ffffffffc02018a0:	91c50513          	addi	a0,a0,-1764 # ffffffffc02051b8 <default_pmm_manager+0xb8>
...
ffffffffc02018ae:	8e660613          	addi	a2,a2,-1818 # ffffffffc0205190 <default_pmm_manager+0x90>
ffffffffc02018b2:	0ff00593          	li	a1,255
ffffffffc02018b6:	00004517          	auipc	a0,0x4
ffffffffc02018ba:	90250513          	addi	a0,a0,-1790 # ffffffffc02051b8 <default_pmm_manager+0xb8>
...
ffffffffc02019f8:	81c43403          	ld	s0,-2020(s0) # ffffffffc0206210 <error_string+0x38>
...
ffffffffc0201aba:	64a78793          	addi	a5,a5,1610 # ffffffffc0205100 <default_pmm_manager>
...
ffffffffc0201ac8:	70450513          	addi	a0,a0,1796 # ffffffffc02051c8 <default_pmm_manager+0xc8>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201b24:	6c050513          	addi	a0,a0,1728 # ffffffffc02051e0 <default_pmm_manager+0xe0>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201b34:	6e050513          	addi	a0,a0,1760 # ffffffffc0205210 <default_pmm_manager+0x110>
...
ffffffffc0201b4e:	6de50513          	addi	a0,a0,1758 # ffffffffc0205228 <default_pmm_manager+0x128>
...
ffffffffc0201bda:	6a250513          	addi	a0,a0,1698 # ffffffffc0205278 <default_pmm_manager+0x178>
...
ffffffffc0201dfe:	416cbc83          	ld	s9,1046(s9) # ffffffffc0206210 <error_string+0x38>
...
ffffffffc0201ea2:	6c250513          	addi	a0,a0,1730 # ffffffffc0205560 <default_pmm_manager+0x460>
...
ffffffffc0201f58:	74458593          	addi	a1,a1,1860 # ffffffffc0205698 <default_pmm_manager+0x598>
ffffffffc0201f5c:	10000513          	li	a0,256
ffffffffc0201f60:	3ea020ef          	jal	ra,ffffffffc020434a <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f64:	10040593          	addi	a1,s0,256
ffffffffc0201f68:	10000513          	li	a0,256
ffffffffc0201f6c:	3f0020ef          	jal	ra,ffffffffc020435c <strcmp>
...
ffffffffc0201fa2:	10068023          	sb	zero,256(a3) # fffffffffff80100 <end+0x3fd6eb9c>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fa6:	36e020ef          	jal	ra,ffffffffc0204314 <strlen>
...
ffffffffc020209c:	67850513          	addi	a0,a0,1656 # ffffffffc0205710 <default_pmm_manager+0x610>
}
...
ffffffffc02021a2:	42268693          	addi	a3,a3,1058 # ffffffffc02055c0 <default_pmm_manager+0x4c0>
ffffffffc02021a6:	00003617          	auipc	a2,0x3
ffffffffc02021aa:	baa60613          	addi	a2,a2,-1110 # ffffffffc0204d50 <commands+0x738>
ffffffffc02021ae:	1ce00593          	li	a1,462
ffffffffc02021b2:	00003517          	auipc	a0,0x3
ffffffffc02021b6:	00650513          	addi	a0,a0,6 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc02021ba:	9bafe0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc02021be:	00003697          	auipc	a3,0x3
ffffffffc02021c2:	3c268693          	addi	a3,a3,962 # ffffffffc0205580 <default_pmm_manager+0x480>
ffffffffc02021c6:	00003617          	auipc	a2,0x3
ffffffffc02021ca:	b8a60613          	addi	a2,a2,-1142 # ffffffffc0204d50 <commands+0x738>
ffffffffc02021ce:	1cd00593          	li	a1,461
ffffffffc02021d2:	00003517          	auipc	a0,0x3
ffffffffc02021d6:	fe650513          	addi	a0,a0,-26 # ffffffffc02051b8 <default_pmm_manager+0xb8>
...
ffffffffc02021e4:	fb060613          	addi	a2,a2,-80 # ffffffffc0205190 <default_pmm_manager+0x90>
ffffffffc02021e8:	1cd00593          	li	a1,461
ffffffffc02021ec:	00003517          	auipc	a0,0x3
ffffffffc02021f0:	fcc50513          	addi	a0,a0,-52 # ffffffffc02051b8 <default_pmm_manager+0xb8>
...
ffffffffc0202200:	05460613          	addi	a2,a2,84 # ffffffffc0205250 <default_pmm_manager+0x150>
ffffffffc0202204:	07700593          	li	a1,119
ffffffffc0202208:	00003517          	auipc	a0,0x3
ffffffffc020220c:	fb050513          	addi	a0,a0,-80 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc0202210:	964fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc0202214:	00003617          	auipc	a2,0x3
ffffffffc0202218:	03c60613          	addi	a2,a2,60 # ffffffffc0205250 <default_pmm_manager+0x150>
ffffffffc020221c:	0bd00593          	li	a1,189
ffffffffc0202220:	00003517          	auipc	a0,0x3
ffffffffc0202224:	f9850513          	addi	a0,a0,-104 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc0202228:	94cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc020222c:	00003697          	auipc	a3,0x3
ffffffffc0202230:	08c68693          	addi	a3,a3,140 # ffffffffc02052b8 <default_pmm_manager+0x1b8>
ffffffffc0202234:	00003617          	auipc	a2,0x3
ffffffffc0202238:	b1c60613          	addi	a2,a2,-1252 # ffffffffc0204d50 <commands+0x738>
ffffffffc020223c:	19300593          	li	a1,403
ffffffffc0202240:	00003517          	auipc	a0,0x3
ffffffffc0202244:	f7850513          	addi	a0,a0,-136 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc0202248:	92cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020224c:	00003697          	auipc	a3,0x3
ffffffffc0202250:	04c68693          	addi	a3,a3,76 # ffffffffc0205298 <default_pmm_manager+0x198>
ffffffffc0202254:	00003617          	auipc	a2,0x3
ffffffffc0202258:	afc60613          	addi	a2,a2,-1284 # ffffffffc0204d50 <commands+0x738>
ffffffffc020225c:	19200593          	li	a1,402
ffffffffc0202260:	00003517          	auipc	a0,0x3
ffffffffc0202264:	f5850513          	addi	a0,a0,-168 # ffffffffc02051b8 <default_pmm_manager+0xb8>
...
ffffffffc0202274:	0d868693          	addi	a3,a3,216 # ffffffffc0205348 <default_pmm_manager+0x248>
ffffffffc0202278:	00003617          	auipc	a2,0x3
ffffffffc020227c:	ad860613          	addi	a2,a2,-1320 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202280:	19a00593          	li	a1,410
ffffffffc0202284:	00003517          	auipc	a0,0x3
ffffffffc0202288:	f3450513          	addi	a0,a0,-204 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc020228c:	8e8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202290:	00003697          	auipc	a3,0x3
ffffffffc0202294:	08868693          	addi	a3,a3,136 # ffffffffc0205318 <default_pmm_manager+0x218>
ffffffffc0202298:	00003617          	auipc	a2,0x3
ffffffffc020229c:	ab860613          	addi	a2,a2,-1352 # ffffffffc0204d50 <commands+0x738>
ffffffffc02022a0:	19800593          	li	a1,408
ffffffffc02022a4:	00003517          	auipc	a0,0x3
ffffffffc02022a8:	f1450513          	addi	a0,a0,-236 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc02022ac:	8c8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc02022b0:	00003697          	auipc	a3,0x3
ffffffffc02022b4:	04068693          	addi	a3,a3,64 # ffffffffc02052f0 <default_pmm_manager+0x1f0>
ffffffffc02022b8:	00003617          	auipc	a2,0x3
ffffffffc02022bc:	a9860613          	addi	a2,a2,-1384 # ffffffffc0204d50 <commands+0x738>
ffffffffc02022c0:	19400593          	li	a1,404
ffffffffc02022c4:	00003517          	auipc	a0,0x3
ffffffffc02022c8:	ef450513          	addi	a0,a0,-268 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc02022cc:	8a8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02022d0:	00003697          	auipc	a3,0x3
ffffffffc02022d4:	10068693          	addi	a3,a3,256 # ffffffffc02053d0 <default_pmm_manager+0x2d0>
ffffffffc02022d8:	00003617          	auipc	a2,0x3
ffffffffc02022dc:	a7860613          	addi	a2,a2,-1416 # ffffffffc0204d50 <commands+0x738>
ffffffffc02022e0:	1a300593          	li	a1,419
ffffffffc02022e4:	00003517          	auipc	a0,0x3
ffffffffc02022e8:	ed450513          	addi	a0,a0,-300 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc02022ec:	888fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02022f0:	00003697          	auipc	a3,0x3
ffffffffc02022f4:	18068693          	addi	a3,a3,384 # ffffffffc0205470 <default_pmm_manager+0x370>
ffffffffc02022f8:	00003617          	auipc	a2,0x3
ffffffffc02022fc:	a5860613          	addi	a2,a2,-1448 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202300:	1a800593          	li	a1,424
ffffffffc0202304:	00003517          	auipc	a0,0x3
ffffffffc0202308:	eb450513          	addi	a0,a0,-332 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc020230c:	868fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc0202310:	00003697          	auipc	a3,0x3
ffffffffc0202314:	09868693          	addi	a3,a3,152 # ffffffffc02053a8 <default_pmm_manager+0x2a8>
ffffffffc0202318:	00003617          	auipc	a2,0x3
ffffffffc020231c:	a3860613          	addi	a2,a2,-1480 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202320:	1a000593          	li	a1,416
ffffffffc0202324:	00003517          	auipc	a0,0x3
ffffffffc0202328:	e9450513          	addi	a0,a0,-364 # ffffffffc02051b8 <default_pmm_manager+0xb8>
...
ffffffffc0202336:	e5e60613          	addi	a2,a2,-418 # ffffffffc0205190 <default_pmm_manager+0x90>
ffffffffc020233a:	19f00593          	li	a1,415
ffffffffc020233e:	00003517          	auipc	a0,0x3
ffffffffc0202342:	e7a50513          	addi	a0,a0,-390 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc0202346:	82efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020234a:	00003697          	auipc	a3,0x3
ffffffffc020234e:	0be68693          	addi	a3,a3,190 # ffffffffc0205408 <default_pmm_manager+0x308>
ffffffffc0202352:	00003617          	auipc	a2,0x3
ffffffffc0202356:	9fe60613          	addi	a2,a2,-1538 # ffffffffc0204d50 <commands+0x738>
ffffffffc020235a:	1ad00593          	li	a1,429
ffffffffc020235e:	00003517          	auipc	a0,0x3
ffffffffc0202362:	e5a50513          	addi	a0,a0,-422 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc0202366:	80efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020236a:	00003697          	auipc	a3,0x3
ffffffffc020236e:	16668693          	addi	a3,a3,358 # ffffffffc02054d0 <default_pmm_manager+0x3d0>
ffffffffc0202372:	00003617          	auipc	a2,0x3
ffffffffc0202376:	9de60613          	addi	a2,a2,-1570 # ffffffffc0204d50 <commands+0x738>
ffffffffc020237a:	1ac00593          	li	a1,428
ffffffffc020237e:	00003517          	auipc	a0,0x3
ffffffffc0202382:	e3a50513          	addi	a0,a0,-454 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc0202386:	feffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020238a:	00003697          	auipc	a3,0x3
ffffffffc020238e:	12e68693          	addi	a3,a3,302 # ffffffffc02054b8 <default_pmm_manager+0x3b8>
ffffffffc0202392:	00003617          	auipc	a2,0x3
ffffffffc0202396:	9be60613          	addi	a2,a2,-1602 # ffffffffc0204d50 <commands+0x738>
ffffffffc020239a:	1ab00593          	li	a1,427
ffffffffc020239e:	00003517          	auipc	a0,0x3
ffffffffc02023a2:	e1a50513          	addi	a0,a0,-486 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc02023a6:	fcffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc02023aa:	00003697          	auipc	a3,0x3
ffffffffc02023ae:	0de68693          	addi	a3,a3,222 # ffffffffc0205488 <default_pmm_manager+0x388>
ffffffffc02023b2:	00003617          	auipc	a2,0x3
ffffffffc02023b6:	99e60613          	addi	a2,a2,-1634 # ffffffffc0204d50 <commands+0x738>
ffffffffc02023ba:	1aa00593          	li	a1,426
ffffffffc02023be:	00003517          	auipc	a0,0x3
ffffffffc02023c2:	dfa50513          	addi	a0,a0,-518 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc02023c6:	faffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc02023ca:	00003697          	auipc	a3,0x3
ffffffffc02023ce:	27668693          	addi	a3,a3,630 # ffffffffc0205640 <default_pmm_manager+0x540>
ffffffffc02023d2:	00003617          	auipc	a2,0x3
ffffffffc02023d6:	97e60613          	addi	a2,a2,-1666 # ffffffffc0204d50 <commands+0x738>
ffffffffc02023da:	1d800593          	li	a1,472
ffffffffc02023de:	00003517          	auipc	a0,0x3
ffffffffc02023e2:	dda50513          	addi	a0,a0,-550 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc02023e6:	f8ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02023ea:	00003697          	auipc	a3,0x3
ffffffffc02023ee:	06e68693          	addi	a3,a3,110 # ffffffffc0205458 <default_pmm_manager+0x358>
ffffffffc02023f2:	00003617          	auipc	a2,0x3
ffffffffc02023f6:	95e60613          	addi	a2,a2,-1698 # ffffffffc0204d50 <commands+0x738>
ffffffffc02023fa:	1a700593          	li	a1,423
ffffffffc02023fe:	00003517          	auipc	a0,0x3
ffffffffc0202402:	dba50513          	addi	a0,a0,-582 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc0202406:	f6ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_W);
ffffffffc020240a:	00003697          	auipc	a3,0x3
ffffffffc020240e:	03e68693          	addi	a3,a3,62 # ffffffffc0205448 <default_pmm_manager+0x348>
ffffffffc0202412:	00003617          	auipc	a2,0x3
ffffffffc0202416:	93e60613          	addi	a2,a2,-1730 # ffffffffc0204d50 <commands+0x738>
ffffffffc020241a:	1a600593          	li	a1,422
ffffffffc020241e:	00003517          	auipc	a0,0x3
ffffffffc0202422:	d9a50513          	addi	a0,a0,-614 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc0202426:	f4ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc020242a:	00003697          	auipc	a3,0x3
ffffffffc020242e:	11668693          	addi	a3,a3,278 # ffffffffc0205540 <default_pmm_manager+0x440>
ffffffffc0202432:	00003617          	auipc	a2,0x3
ffffffffc0202436:	91e60613          	addi	a2,a2,-1762 # ffffffffc0204d50 <commands+0x738>
ffffffffc020243a:	1e800593          	li	a1,488
ffffffffc020243e:	00003517          	auipc	a0,0x3
ffffffffc0202442:	d7a50513          	addi	a0,a0,-646 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc0202446:	f2ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_U);
ffffffffc020244a:	00003697          	auipc	a3,0x3
ffffffffc020244e:	fee68693          	addi	a3,a3,-18 # ffffffffc0205438 <default_pmm_manager+0x338>
ffffffffc0202452:	00003617          	auipc	a2,0x3
ffffffffc0202456:	8fe60613          	addi	a2,a2,-1794 # ffffffffc0204d50 <commands+0x738>
ffffffffc020245a:	1a500593          	li	a1,421
ffffffffc020245e:	00003517          	auipc	a0,0x3
ffffffffc0202462:	d5a50513          	addi	a0,a0,-678 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc0202466:	f0ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020246a:	00003697          	auipc	a3,0x3
ffffffffc020246e:	f2668693          	addi	a3,a3,-218 # ffffffffc0205390 <default_pmm_manager+0x290>
ffffffffc0202472:	00003617          	auipc	a2,0x3
ffffffffc0202476:	8de60613          	addi	a2,a2,-1826 # ffffffffc0204d50 <commands+0x738>
ffffffffc020247a:	1b200593          	li	a1,434
ffffffffc020247e:	00003517          	auipc	a0,0x3
ffffffffc0202482:	d3a50513          	addi	a0,a0,-710 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc0202486:	eeffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020248a:	00003697          	auipc	a3,0x3
ffffffffc020248e:	05e68693          	addi	a3,a3,94 # ffffffffc02054e8 <default_pmm_manager+0x3e8>
ffffffffc0202492:	00003617          	auipc	a2,0x3
ffffffffc0202496:	8be60613          	addi	a2,a2,-1858 # ffffffffc0204d50 <commands+0x738>
ffffffffc020249a:	1af00593          	li	a1,431
ffffffffc020249e:	00003517          	auipc	a0,0x3
ffffffffc02024a2:	d1a50513          	addi	a0,a0,-742 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc02024a6:	ecffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02024aa:	00003697          	auipc	a3,0x3
ffffffffc02024ae:	ece68693          	addi	a3,a3,-306 # ffffffffc0205378 <default_pmm_manager+0x278>
ffffffffc02024b2:	00003617          	auipc	a2,0x3
ffffffffc02024b6:	89e60613          	addi	a2,a2,-1890 # ffffffffc0204d50 <commands+0x738>
ffffffffc02024ba:	1ae00593          	li	a1,430
ffffffffc02024be:	00003517          	auipc	a0,0x3
ffffffffc02024c2:	cfa50513          	addi	a0,a0,-774 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc02024c6:	eaffd0ef          	jal	ra,ffffffffc0200374 <__panic>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc02024ca:	00003617          	auipc	a2,0x3
ffffffffc02024ce:	cc660613          	addi	a2,a2,-826 # ffffffffc0205190 <default_pmm_manager+0x90>
ffffffffc02024d2:	06a00593          	li	a1,106
ffffffffc02024d6:	00003517          	auipc	a0,0x3
ffffffffc02024da:	c8250513          	addi	a0,a0,-894 # ffffffffc0205158 <default_pmm_manager+0x58>
ffffffffc02024de:	e97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02024e2:	00003697          	auipc	a3,0x3
ffffffffc02024e6:	03668693          	addi	a3,a3,54 # ffffffffc0205518 <default_pmm_manager+0x418>
ffffffffc02024ea:	00003617          	auipc	a2,0x3
ffffffffc02024ee:	86660613          	addi	a2,a2,-1946 # ffffffffc0204d50 <commands+0x738>
ffffffffc02024f2:	1b900593          	li	a1,441
ffffffffc02024f6:	00003517          	auipc	a0,0x3
ffffffffc02024fa:	cc250513          	addi	a0,a0,-830 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc02024fe:	e77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202502:	00003697          	auipc	a3,0x3
ffffffffc0202506:	fce68693          	addi	a3,a3,-50 # ffffffffc02054d0 <default_pmm_manager+0x3d0>
ffffffffc020250a:	00003617          	auipc	a2,0x3
ffffffffc020250e:	84660613          	addi	a2,a2,-1978 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202512:	1b700593          	li	a1,439
ffffffffc0202516:	00003517          	auipc	a0,0x3
ffffffffc020251a:	ca250513          	addi	a0,a0,-862 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc020251e:	e57fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc0202522:	00003697          	auipc	a3,0x3
ffffffffc0202526:	fde68693          	addi	a3,a3,-34 # ffffffffc0205500 <default_pmm_manager+0x400>
ffffffffc020252a:	00003617          	auipc	a2,0x3
ffffffffc020252e:	82660613          	addi	a2,a2,-2010 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202532:	1b600593          	li	a1,438
ffffffffc0202536:	00003517          	auipc	a0,0x3
ffffffffc020253a:	c8250513          	addi	a0,a0,-894 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc020253e:	e37fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202542:	00003697          	auipc	a3,0x3
ffffffffc0202546:	f8e68693          	addi	a3,a3,-114 # ffffffffc02054d0 <default_pmm_manager+0x3d0>
ffffffffc020254a:	00003617          	auipc	a2,0x3
ffffffffc020254e:	80660613          	addi	a2,a2,-2042 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202552:	1b300593          	li	a1,435
ffffffffc0202556:	00003517          	auipc	a0,0x3
ffffffffc020255a:	c6250513          	addi	a0,a0,-926 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc020255e:	e17fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202562:	00003697          	auipc	a3,0x3
ffffffffc0202566:	0c668693          	addi	a3,a3,198 # ffffffffc0205628 <default_pmm_manager+0x528>
ffffffffc020256a:	00002617          	auipc	a2,0x2
ffffffffc020256e:	7e660613          	addi	a2,a2,2022 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202572:	1d700593          	li	a1,471
ffffffffc0202576:	00003517          	auipc	a0,0x3
ffffffffc020257a:	c4250513          	addi	a0,a0,-958 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc020257e:	df7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202582:	00003697          	auipc	a3,0x3
ffffffffc0202586:	06e68693          	addi	a3,a3,110 # ffffffffc02055f0 <default_pmm_manager+0x4f0>
ffffffffc020258a:	00002617          	auipc	a2,0x2
ffffffffc020258e:	7c660613          	addi	a2,a2,1990 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202592:	1d600593          	li	a1,470
ffffffffc0202596:	00003517          	auipc	a0,0x3
ffffffffc020259a:	c2250513          	addi	a0,a0,-990 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc020259e:	dd7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc02025a2:	00003697          	auipc	a3,0x3
ffffffffc02025a6:	03668693          	addi	a3,a3,54 # ffffffffc02055d8 <default_pmm_manager+0x4d8>
ffffffffc02025aa:	00002617          	auipc	a2,0x2
ffffffffc02025ae:	7a660613          	addi	a2,a2,1958 # ffffffffc0204d50 <commands+0x738>
ffffffffc02025b2:	1d200593          	li	a1,466
ffffffffc02025b6:	00003517          	auipc	a0,0x3
ffffffffc02025ba:	c0250513          	addi	a0,a0,-1022 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc02025be:	db7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02025c2:	00003697          	auipc	a3,0x3
ffffffffc02025c6:	f7e68693          	addi	a3,a3,-130 # ffffffffc0205540 <default_pmm_manager+0x440>
ffffffffc02025ca:	00002617          	auipc	a2,0x2
ffffffffc02025ce:	78660613          	addi	a2,a2,1926 # ffffffffc0204d50 <commands+0x738>
ffffffffc02025d2:	1c000593          	li	a1,448
ffffffffc02025d6:	00003517          	auipc	a0,0x3
ffffffffc02025da:	be250513          	addi	a0,a0,-1054 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc02025de:	d97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02025e2:	00003697          	auipc	a3,0x3
ffffffffc02025e6:	d9668693          	addi	a3,a3,-618 # ffffffffc0205378 <default_pmm_manager+0x278>
ffffffffc02025ea:	00002617          	auipc	a2,0x2
ffffffffc02025ee:	76660613          	addi	a2,a2,1894 # ffffffffc0204d50 <commands+0x738>
ffffffffc02025f2:	19b00593          	li	a1,411
ffffffffc02025f6:	00003517          	auipc	a0,0x3
ffffffffc02025fa:	bc250513          	addi	a0,a0,-1086 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc02025fe:	d77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc0202602:	00003617          	auipc	a2,0x3
ffffffffc0202606:	b8e60613          	addi	a2,a2,-1138 # ffffffffc0205190 <default_pmm_manager+0x90>
ffffffffc020260a:	19e00593          	li	a1,414
ffffffffc020260e:	00003517          	auipc	a0,0x3
ffffffffc0202612:	baa50513          	addi	a0,a0,-1110 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc0202616:	d5ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020261a:	00003697          	auipc	a3,0x3
ffffffffc020261e:	d7668693          	addi	a3,a3,-650 # ffffffffc0205390 <default_pmm_manager+0x290>
ffffffffc0202622:	00002617          	auipc	a2,0x2
ffffffffc0202626:	72e60613          	addi	a2,a2,1838 # ffffffffc0204d50 <commands+0x738>
ffffffffc020262a:	19c00593          	li	a1,412
ffffffffc020262e:	00003517          	auipc	a0,0x3
ffffffffc0202632:	b8a50513          	addi	a0,a0,-1142 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc0202636:	d3ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020263a:	00003697          	auipc	a3,0x3
ffffffffc020263e:	dce68693          	addi	a3,a3,-562 # ffffffffc0205408 <default_pmm_manager+0x308>
ffffffffc0202642:	00002617          	auipc	a2,0x2
ffffffffc0202646:	70e60613          	addi	a2,a2,1806 # ffffffffc0204d50 <commands+0x738>
ffffffffc020264a:	1a400593          	li	a1,420
ffffffffc020264e:	00003517          	auipc	a0,0x3
ffffffffc0202652:	b6a50513          	addi	a0,a0,-1174 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc0202656:	d1ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc020265a:	00003697          	auipc	a3,0x3
ffffffffc020265e:	08e68693          	addi	a3,a3,142 # ffffffffc02056e8 <default_pmm_manager+0x5e8>
ffffffffc0202662:	00002617          	auipc	a2,0x2
ffffffffc0202666:	6ee60613          	addi	a2,a2,1774 # ffffffffc0204d50 <commands+0x738>
ffffffffc020266a:	1e000593          	li	a1,480
ffffffffc020266e:	00003517          	auipc	a0,0x3
ffffffffc0202672:	b4a50513          	addi	a0,a0,-1206 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc0202676:	cfffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc020267a:	00003697          	auipc	a3,0x3
ffffffffc020267e:	03668693          	addi	a3,a3,54 # ffffffffc02056b0 <default_pmm_manager+0x5b0>
ffffffffc0202682:	00002617          	auipc	a2,0x2
ffffffffc0202686:	6ce60613          	addi	a2,a2,1742 # ffffffffc0204d50 <commands+0x738>
ffffffffc020268a:	1dd00593          	li	a1,477
ffffffffc020268e:	00003517          	auipc	a0,0x3
ffffffffc0202692:	b2a50513          	addi	a0,a0,-1238 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc0202696:	cdffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 2);
ffffffffc020269a:	00003697          	auipc	a3,0x3
ffffffffc020269e:	fe668693          	addi	a3,a3,-26 # ffffffffc0205680 <default_pmm_manager+0x580>
ffffffffc02026a2:	00002617          	auipc	a2,0x2
ffffffffc02026a6:	6ae60613          	addi	a2,a2,1710 # ffffffffc0204d50 <commands+0x738>
ffffffffc02026aa:	1d900593          	li	a1,473
ffffffffc02026ae:	00003517          	auipc	a0,0x3
ffffffffc02026b2:	b0a50513          	addi	a0,a0,-1270 # ffffffffc02051b8 <default_pmm_manager+0xb8>
...
ffffffffc0202724:	01068693          	addi	a3,a3,16 # ffffffffc0205730 <default_pmm_manager+0x630>
ffffffffc0202728:	00002617          	auipc	a2,0x2
ffffffffc020272c:	62860613          	addi	a2,a2,1576 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202730:	17a00593          	li	a1,378
ffffffffc0202734:	00003517          	auipc	a0,0x3
ffffffffc0202738:	a8450513          	addi	a0,a0,-1404 # ffffffffc02051b8 <default_pmm_manager+0xb8>
...
ffffffffc02027a4:	a706b683          	ld	a3,-1424(a3) # ffffffffc0206210 <error_string+0x38>
...
ffffffffc02027dc:	f7068693          	addi	a3,a3,-144 # ffffffffc0205748 <default_pmm_manager+0x648>
ffffffffc02027e0:	00002617          	auipc	a2,0x2
ffffffffc02027e4:	57060613          	addi	a2,a2,1392 # ffffffffc0204d50 <commands+0x738>
ffffffffc02027e8:	1f000593          	li	a1,496
ffffffffc02027ec:	00003517          	auipc	a0,0x3
ffffffffc02027f0:	9cc50513          	addi	a0,a0,-1588 # ffffffffc02051b8 <default_pmm_manager+0xb8>
...
ffffffffc02027fe:	99660613          	addi	a2,a2,-1642 # ffffffffc0205190 <default_pmm_manager+0x90>
ffffffffc0202802:	06a00593          	li	a1,106
ffffffffc0202806:	00003517          	auipc	a0,0x3
ffffffffc020280a:	95250513          	addi	a0,a0,-1710 # ffffffffc0205158 <default_pmm_manager+0x58>
ffffffffc020280e:	b67fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(base != NULL);
ffffffffc0202812:	00003697          	auipc	a3,0x3
ffffffffc0202816:	f5668693          	addi	a3,a3,-170 # ffffffffc0205768 <default_pmm_manager+0x668>
ffffffffc020281a:	00002617          	auipc	a2,0x2
ffffffffc020281e:	53660613          	addi	a2,a2,1334 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202822:	1f300593          	li	a1,499
ffffffffc0202826:	00003517          	auipc	a0,0x3
ffffffffc020282a:	99250513          	addi	a0,a0,-1646 # ffffffffc02051b8 <default_pmm_manager+0xb8>
...
ffffffffc02028c6:	98e60613          	addi	a2,a2,-1650 # ffffffffc0205250 <default_pmm_manager+0x150>
ffffffffc02028ca:	06c00593          	li	a1,108
ffffffffc02028ce:	00003517          	auipc	a0,0x3
ffffffffc02028d2:	88a50513          	addi	a0,a0,-1910 # ffffffffc0205158 <default_pmm_manager+0x58>
ffffffffc02028d6:	a9ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(ptr != NULL);
ffffffffc02028da:	00003697          	auipc	a3,0x3
ffffffffc02028de:	e9e68693          	addi	a3,a3,-354 # ffffffffc0205778 <default_pmm_manager+0x678>
ffffffffc02028e2:	00002617          	auipc	a2,0x2
ffffffffc02028e6:	46e60613          	addi	a2,a2,1134 # ffffffffc0204d50 <commands+0x738>
ffffffffc02028ea:	1fa00593          	li	a1,506
ffffffffc02028ee:	00003517          	auipc	a0,0x3
ffffffffc02028f2:	8ca50513          	addi	a0,a0,-1846 # ffffffffc02051b8 <default_pmm_manager+0xb8>
ffffffffc02028f6:	a7ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0 && n < 1024 * 0124);
ffffffffc02028fa:	00003697          	auipc	a3,0x3
ffffffffc02028fe:	e4e68693          	addi	a3,a3,-434 # ffffffffc0205748 <default_pmm_manager+0x648>
ffffffffc0202902:	00002617          	auipc	a2,0x2
ffffffffc0202906:	44e60613          	addi	a2,a2,1102 # ffffffffc0204d50 <commands+0x738>
ffffffffc020290a:	1f900593          	li	a1,505
ffffffffc020290e:	00003517          	auipc	a0,0x3
ffffffffc0202912:	8aa50513          	addi	a0,a0,-1878 # ffffffffc02051b8 <default_pmm_manager+0xb8>
...
ffffffffc0202934:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202936:	3d0010ef          	jal	ra,ffffffffc0203d06 <swapfs_init>
...
ffffffffc0202994:	e2850513          	addi	a0,a0,-472 # ffffffffc02057b8 <default_pmm_manager+0x6b8>
    return listelm->next;
...
ffffffffc02029e4:	df050513          	addi	a0,a0,-528 # ffffffffc02057d0 <default_pmm_manager+0x6d0>
ffffffffc02029e8:	ed2fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     
     //now we set the phy pages env     
     struct mm_struct *mm = mm_create();
ffffffffc02029ec:	291000ef          	jal	ra,ffffffffc020347c <mm_create>
...
ffffffffc0202a20:	2a5000ef          	jal	ra,ffffffffc02034c4 <vma_create>
...
ffffffffc0202a2c:	307000ef          	jal	ra,ffffffffc0203532 <insert_vma_struct>

     //setup the temp Page Table vaddr 0~4MB
     cprintf("setup Page Table for vaddr 0X1000, so alloc a page\n");
ffffffffc0202a30:	00003517          	auipc	a0,0x3
ffffffffc0202a34:	e1050513          	addi	a0,a0,-496 # ffffffffc0205840 <default_pmm_manager+0x740>
...
ffffffffc0202a50:	e4450513          	addi	a0,a0,-444 # ffffffffc0205890 <default_pmm_manager+0x790>
...
ffffffffc0202ac4:	e5850513          	addi	a0,a0,-424 # ffffffffc0205918 <default_pmm_manager+0x818>
...
ffffffffc0202ba0:	67cc0c13          	addi	s8,s8,1660 # ffffffffc0206218 <nbase>
...
ffffffffc0202c10:	db450513          	addi	a0,a0,-588 # ffffffffc02059c0 <default_pmm_manager+0x8c0>
...
ffffffffc0202c36:	1cd000ef          	jal	ra,ffffffffc0203602 <mm_destroy>
...
ffffffffc0202c62:	d9250513          	addi	a0,a0,-622 # ffffffffc02059f0 <default_pmm_manager+0x8f0>
ffffffffc0202c66:	c54fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     //assert(count == 0);
     
     cprintf("check_swap() succeeded!\n");
ffffffffc0202c6a:	00003517          	auipc	a0,0x3
ffffffffc0202c6e:	da650513          	addi	a0,a0,-602 # ffffffffc0205a10 <default_pmm_manager+0x910>
...
ffffffffc0202c80:	0c468693          	addi	a3,a3,196 # ffffffffc0204d40 <commands+0x728>
ffffffffc0202c84:	00002617          	auipc	a2,0x2
ffffffffc0202c88:	0cc60613          	addi	a2,a2,204 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202c8c:	0ba00593          	li	a1,186
ffffffffc0202c90:	00003517          	auipc	a0,0x3
ffffffffc0202c94:	b1850513          	addi	a0,a0,-1256 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
ffffffffc0202c98:	edcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202c9c:	00003697          	auipc	a3,0x3
ffffffffc0202ca0:	cfc68693          	addi	a3,a3,-772 # ffffffffc0205998 <default_pmm_manager+0x898>
ffffffffc0202ca4:	00002617          	auipc	a2,0x2
ffffffffc0202ca8:	0ac60613          	addi	a2,a2,172 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202cac:	0fa00593          	li	a1,250
ffffffffc0202cb0:	00003517          	auipc	a0,0x3
ffffffffc0202cb4:	af850513          	addi	a0,a0,-1288 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
ffffffffc0202cb8:	ebcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202cbc:	00002617          	auipc	a2,0x2
ffffffffc0202cc0:	4ac60613          	addi	a2,a2,1196 # ffffffffc0205168 <default_pmm_manager+0x68>
ffffffffc0202cc4:	07000593          	li	a1,112
ffffffffc0202cc8:	00002517          	auipc	a0,0x2
ffffffffc0202ccc:	49050513          	addi	a0,a0,1168 # ffffffffc0205158 <default_pmm_manager+0x58>
ffffffffc0202cd0:	ea4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0202cd4:	00002617          	auipc	a2,0x2
ffffffffc0202cd8:	46460613          	addi	a2,a2,1124 # ffffffffc0205138 <default_pmm_manager+0x38>
ffffffffc0202cdc:	06500593          	li	a1,101
ffffffffc0202ce0:	00002517          	auipc	a0,0x2
ffffffffc0202ce4:	47850513          	addi	a0,a0,1144 # ffffffffc0205158 <default_pmm_manager+0x58>
ffffffffc0202ce8:	e8cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0202cec:	00003697          	auipc	a3,0x3
ffffffffc0202cf0:	be468693          	addi	a3,a3,-1052 # ffffffffc02058d0 <default_pmm_manager+0x7d0>
ffffffffc0202cf4:	00002617          	auipc	a2,0x2
ffffffffc0202cf8:	05c60613          	addi	a2,a2,92 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202cfc:	0db00593          	li	a1,219
ffffffffc0202d00:	00003517          	auipc	a0,0x3
ffffffffc0202d04:	aa850513          	addi	a0,a0,-1368 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
ffffffffc0202d08:	e6cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202d0c:	00003697          	auipc	a3,0x3
ffffffffc0202d10:	bac68693          	addi	a3,a3,-1108 # ffffffffc02058b8 <default_pmm_manager+0x7b8>
ffffffffc0202d14:	00002617          	auipc	a2,0x2
ffffffffc0202d18:	03c60613          	addi	a2,a2,60 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202d1c:	0da00593          	li	a1,218
ffffffffc0202d20:	00003517          	auipc	a0,0x3
ffffffffc0202d24:	a8850513          	addi	a0,a0,-1400 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
ffffffffc0202d28:	e4cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202d2c:	00003617          	auipc	a2,0x3
ffffffffc0202d30:	a5c60613          	addi	a2,a2,-1444 # ffffffffc0205788 <default_pmm_manager+0x688>
ffffffffc0202d34:	02700593          	li	a1,39
ffffffffc0202d38:	00003517          	auipc	a0,0x3
ffffffffc0202d3c:	a7050513          	addi	a0,a0,-1424 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
ffffffffc0202d40:	e34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202d44:	00003697          	auipc	a3,0x3
ffffffffc0202d48:	c3c68693          	addi	a3,a3,-964 # ffffffffc0205980 <default_pmm_manager+0x880>
ffffffffc0202d4c:	00002617          	auipc	a2,0x2
ffffffffc0202d50:	00460613          	addi	a2,a2,4 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202d54:	0f900593          	li	a1,249
ffffffffc0202d58:	00003517          	auipc	a0,0x3
ffffffffc0202d5c:	a5050513          	addi	a0,a0,-1456 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
ffffffffc0202d60:	e14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d64:	00003697          	auipc	a3,0x3
ffffffffc0202d68:	c0c68693          	addi	a3,a3,-1012 # ffffffffc0205970 <default_pmm_manager+0x870>
ffffffffc0202d6c:	00002617          	auipc	a2,0x2
ffffffffc0202d70:	fe460613          	addi	a2,a2,-28 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202d74:	09d00593          	li	a1,157
ffffffffc0202d78:	00003517          	auipc	a0,0x3
ffffffffc0202d7c:	a3050513          	addi	a0,a0,-1488 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
ffffffffc0202d80:	df4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d84:	00003697          	auipc	a3,0x3
ffffffffc0202d88:	bec68693          	addi	a3,a3,-1044 # ffffffffc0205970 <default_pmm_manager+0x870>
ffffffffc0202d8c:	00002617          	auipc	a2,0x2
ffffffffc0202d90:	fc460613          	addi	a2,a2,-60 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202d94:	09f00593          	li	a1,159
ffffffffc0202d98:	00003517          	auipc	a0,0x3
ffffffffc0202d9c:	a1050513          	addi	a0,a0,-1520 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
ffffffffc0202da0:	dd4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert( nr_free == 0);         
ffffffffc0202da4:	00002697          	auipc	a3,0x2
ffffffffc0202da8:	18468693          	addi	a3,a3,388 # ffffffffc0204f28 <commands+0x910>
ffffffffc0202dac:	00002617          	auipc	a2,0x2
ffffffffc0202db0:	fa460613          	addi	a2,a2,-92 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202db4:	0f100593          	li	a1,241
ffffffffc0202db8:	00003517          	auipc	a0,0x3
ffffffffc0202dbc:	9f050513          	addi	a0,a0,-1552 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
ffffffffc0202dc0:	db4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(ret==0);
ffffffffc0202dc4:	00003697          	auipc	a3,0x3
ffffffffc0202dc8:	c2468693          	addi	a3,a3,-988 # ffffffffc02059e8 <default_pmm_manager+0x8e8>
ffffffffc0202dcc:	00002617          	auipc	a2,0x2
ffffffffc0202dd0:	f8460613          	addi	a2,a2,-124 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202dd4:	10000593          	li	a1,256
ffffffffc0202dd8:	00003517          	auipc	a0,0x3
ffffffffc0202ddc:	9d050513          	addi	a0,a0,-1584 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
ffffffffc0202de0:	d94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0202de4:	00003697          	auipc	a3,0x3
ffffffffc0202de8:	a3c68693          	addi	a3,a3,-1476 # ffffffffc0205820 <default_pmm_manager+0x720>
ffffffffc0202dec:	00002617          	auipc	a2,0x2
ffffffffc0202df0:	f6460613          	addi	a2,a2,-156 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202df4:	0ca00593          	li	a1,202
ffffffffc0202df8:	00003517          	auipc	a0,0x3
ffffffffc0202dfc:	9b050513          	addi	a0,a0,-1616 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
ffffffffc0202e00:	d74fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(vma != NULL);
ffffffffc0202e04:	00003697          	auipc	a3,0x3
ffffffffc0202e08:	a2c68693          	addi	a3,a3,-1492 # ffffffffc0205830 <default_pmm_manager+0x730>
ffffffffc0202e0c:	00002617          	auipc	a2,0x2
ffffffffc0202e10:	f4460613          	addi	a2,a2,-188 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202e14:	0cd00593          	li	a1,205
ffffffffc0202e18:	00003517          	auipc	a0,0x3
ffffffffc0202e1c:	99050513          	addi	a0,a0,-1648 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
ffffffffc0202e20:	d54fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc0202e24:	00003697          	auipc	a3,0x3
ffffffffc0202e28:	a5468693          	addi	a3,a3,-1452 # ffffffffc0205878 <default_pmm_manager+0x778>
ffffffffc0202e2c:	00002617          	auipc	a2,0x2
ffffffffc0202e30:	f2460613          	addi	a2,a2,-220 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202e34:	0d500593          	li	a1,213
ffffffffc0202e38:	00003517          	auipc	a0,0x3
ffffffffc0202e3c:	97050513          	addi	a0,a0,-1680 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
ffffffffc0202e40:	d34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(total == nr_free_pages());
ffffffffc0202e44:	00002697          	auipc	a3,0x2
ffffffffc0202e48:	f3c68693          	addi	a3,a3,-196 # ffffffffc0204d80 <commands+0x768>
ffffffffc0202e4c:	00002617          	auipc	a2,0x2
ffffffffc0202e50:	f0460613          	addi	a2,a2,-252 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202e54:	0bd00593          	li	a1,189
ffffffffc0202e58:	00003517          	auipc	a0,0x3
ffffffffc0202e5c:	95050513          	addi	a0,a0,-1712 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
ffffffffc0202e60:	d14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e64:	00003697          	auipc	a3,0x3
ffffffffc0202e68:	aec68693          	addi	a3,a3,-1300 # ffffffffc0205950 <default_pmm_manager+0x850>
ffffffffc0202e6c:	00002617          	auipc	a2,0x2
ffffffffc0202e70:	ee460613          	addi	a2,a2,-284 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202e74:	09500593          	li	a1,149
ffffffffc0202e78:	00003517          	auipc	a0,0x3
ffffffffc0202e7c:	93050513          	addi	a0,a0,-1744 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
ffffffffc0202e80:	cf4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e84:	00003697          	auipc	a3,0x3
ffffffffc0202e88:	acc68693          	addi	a3,a3,-1332 # ffffffffc0205950 <default_pmm_manager+0x850>
ffffffffc0202e8c:	00002617          	auipc	a2,0x2
ffffffffc0202e90:	ec460613          	addi	a2,a2,-316 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202e94:	09700593          	li	a1,151
ffffffffc0202e98:	00003517          	auipc	a0,0x3
ffffffffc0202e9c:	91050513          	addi	a0,a0,-1776 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
ffffffffc0202ea0:	cd4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ea4:	00003697          	auipc	a3,0x3
ffffffffc0202ea8:	abc68693          	addi	a3,a3,-1348 # ffffffffc0205960 <default_pmm_manager+0x860>
ffffffffc0202eac:	00002617          	auipc	a2,0x2
ffffffffc0202eb0:	ea460613          	addi	a2,a2,-348 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202eb4:	09900593          	li	a1,153
ffffffffc0202eb8:	00003517          	auipc	a0,0x3
ffffffffc0202ebc:	8f050513          	addi	a0,a0,-1808 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
ffffffffc0202ec0:	cb4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ec4:	00003697          	auipc	a3,0x3
ffffffffc0202ec8:	a9c68693          	addi	a3,a3,-1380 # ffffffffc0205960 <default_pmm_manager+0x860>
ffffffffc0202ecc:	00002617          	auipc	a2,0x2
ffffffffc0202ed0:	e8460613          	addi	a2,a2,-380 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202ed4:	09b00593          	li	a1,155
ffffffffc0202ed8:	00003517          	auipc	a0,0x3
ffffffffc0202edc:	8d050513          	addi	a0,a0,-1840 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
ffffffffc0202ee0:	c94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202ee4:	00003697          	auipc	a3,0x3
ffffffffc0202ee8:	a5c68693          	addi	a3,a3,-1444 # ffffffffc0205940 <default_pmm_manager+0x840>
ffffffffc0202eec:	00002617          	auipc	a2,0x2
ffffffffc0202ef0:	e6460613          	addi	a2,a2,-412 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202ef4:	09100593          	li	a1,145
ffffffffc0202ef8:	00003517          	auipc	a0,0x3
ffffffffc0202efc:	8b050513          	addi	a0,a0,-1872 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
ffffffffc0202f00:	c74fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202f04:	00003697          	auipc	a3,0x3
ffffffffc0202f08:	a3c68693          	addi	a3,a3,-1476 # ffffffffc0205940 <default_pmm_manager+0x840>
ffffffffc0202f0c:	00002617          	auipc	a2,0x2
ffffffffc0202f10:	e4460613          	addi	a2,a2,-444 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202f14:	09300593          	li	a1,147
ffffffffc0202f18:	00003517          	auipc	a0,0x3
ffffffffc0202f1c:	89050513          	addi	a0,a0,-1904 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
ffffffffc0202f20:	c54fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(mm != NULL);
ffffffffc0202f24:	00003697          	auipc	a3,0x3
ffffffffc0202f28:	8d468693          	addi	a3,a3,-1836 # ffffffffc02057f8 <default_pmm_manager+0x6f8>
ffffffffc0202f2c:	00002617          	auipc	a2,0x2
ffffffffc0202f30:	e2460613          	addi	a2,a2,-476 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202f34:	0c200593          	li	a1,194
ffffffffc0202f38:	00003517          	auipc	a0,0x3
ffffffffc0202f3c:	87050513          	addi	a0,a0,-1936 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
ffffffffc0202f40:	c34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0202f44:	00003697          	auipc	a3,0x3
ffffffffc0202f48:	8c468693          	addi	a3,a3,-1852 # ffffffffc0205808 <default_pmm_manager+0x708>
ffffffffc0202f4c:	00002617          	auipc	a2,0x2
ffffffffc0202f50:	e0460613          	addi	a2,a2,-508 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202f54:	0c500593          	li	a1,197
ffffffffc0202f58:	00003517          	auipc	a0,0x3
ffffffffc0202f5c:	85050513          	addi	a0,a0,-1968 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
ffffffffc0202f60:	c14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0202f64:	00003697          	auipc	a3,0x3
ffffffffc0202f68:	98c68693          	addi	a3,a3,-1652 # ffffffffc02058f0 <default_pmm_manager+0x7f0>
ffffffffc0202f6c:	00002617          	auipc	a2,0x2
ffffffffc0202f70:	de460613          	addi	a2,a2,-540 # ffffffffc0204d50 <commands+0x738>
ffffffffc0202f74:	0e800593          	li	a1,232
ffffffffc0202f78:	00003517          	auipc	a0,0x3
ffffffffc0202f7c:	83050513          	addi	a0,a0,-2000 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
...
ffffffffc0202fc8:	accb0b13          	addi	s6,s6,-1332 # ffffffffc0205a90 <default_pmm_manager+0x990>
                    cprintf("SWAP: failed to save\n");
ffffffffc0202fcc:	00003b97          	auipc	s7,0x3
ffffffffc0202fd0:	aacb8b93          	addi	s7,s7,-1364 # ffffffffc0205a78 <default_pmm_manager+0x978>
...
ffffffffc0203040:	599000ef          	jal	ra,ffffffffc0203dd8 <swapfs_write>
...
ffffffffc0203082:	9b250513          	addi	a0,a0,-1614 # ffffffffc0205a30 <default_pmm_manager+0x930>
...
ffffffffc0203094:	9d068693          	addi	a3,a3,-1584 # ffffffffc0205a60 <default_pmm_manager+0x960>
ffffffffc0203098:	00002617          	auipc	a2,0x2
ffffffffc020309c:	cb860613          	addi	a2,a2,-840 # ffffffffc0204d50 <commands+0x738>
ffffffffc02030a0:	06600593          	li	a1,102
ffffffffc02030a4:	00002517          	auipc	a0,0x2
ffffffffc02030a8:	70450513          	addi	a0,a0,1796 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
...
ffffffffc02030de:	461000ef          	jal	ra,ffffffffc0203d3e <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc02030e2:	00093583          	ld	a1,0(s2)
ffffffffc02030e6:	8626                	mv	a2,s1
ffffffffc02030e8:	00003517          	auipc	a0,0x3
ffffffffc02030ec:	9f850513          	addi	a0,a0,-1544 # ffffffffc0205ae0 <default_pmm_manager+0x9e0>
...
ffffffffc020310e:	9c668693          	addi	a3,a3,-1594 # ffffffffc0205ad0 <default_pmm_manager+0x9d0>
ffffffffc0203112:	00002617          	auipc	a2,0x2
ffffffffc0203116:	c3e60613          	addi	a2,a2,-962 # ffffffffc0204d50 <commands+0x738>
ffffffffc020311a:	07c00593          	li	a1,124
ffffffffc020311e:	00002517          	auipc	a0,0x2
ffffffffc0203122:	68a50513          	addi	a0,a0,1674 # ffffffffc02057a8 <default_pmm_manager+0x6a8>
...
ffffffffc020314a:	e794                	sd	a3,8(a5)
    elm->prev = prev;
ffffffffc020314c:	fa1c                	sd	a5,48(a2)
    page->visited = 1;
ffffffffc020314e:	4785                	li	a5,1
    elm->next = next;
ffffffffc0203150:	fe18                	sd	a4,56(a2)
ffffffffc0203152:	ea1c                	sd	a5,16(a2)
}
ffffffffc0203154:	8082                	ret

ffffffffc0203156 <_clock_init>:
...
ffffffffc020315a <_clock_set_unswappable>:
...
ffffffffc020315e <_clock_tick_event>:
...
ffffffffc020315e:	4501                	li	a0,0
ffffffffc0203160:	8082                	ret

ffffffffc0203162 <_clock_check_swap>:
{
ffffffffc0203162:	1141                	addi	sp,sp,-16
    *(unsigned char *)0x3000 = 0x0c;
ffffffffc0203164:	4731                	li	a4,12
{
ffffffffc0203166:	e406                	sd	ra,8(sp)
    *(unsigned char *)0x3000 = 0x0c;
ffffffffc0203168:	678d                	lui	a5,0x3
ffffffffc020316a:	00e78023          	sb	a4,0(a5) # 3000 <kern_entry-0xffffffffc01fd000>
    assert(pgfault_num == 4);
ffffffffc020316e:	0000e697          	auipc	a3,0xe
ffffffffc0203172:	3f26a683          	lw	a3,1010(a3) # ffffffffc0211560 <pgfault_num>
ffffffffc0203176:	4711                	li	a4,4
ffffffffc0203178:	0ae69363          	bne	a3,a4,ffffffffc020321e <_clock_check_swap+0xbc>
    *(unsigned char *)0x1000 = 0x0a;
ffffffffc020317c:	6705                	lui	a4,0x1
ffffffffc020317e:	4629                	li	a2,10
ffffffffc0203180:	0000e797          	auipc	a5,0xe
ffffffffc0203184:	3e078793          	addi	a5,a5,992 # ffffffffc0211560 <pgfault_num>
ffffffffc0203188:	00c70023          	sb	a2,0(a4) # 1000 <kern_entry-0xffffffffc01ff000>
    assert(pgfault_num == 4);
ffffffffc020318c:	4398                	lw	a4,0(a5)
ffffffffc020318e:	2701                	sext.w	a4,a4
ffffffffc0203190:	20d71763          	bne	a4,a3,ffffffffc020339e <_clock_check_swap+0x23c>
    *(unsigned char *)0x4000 = 0x0d;
ffffffffc0203194:	6691                	lui	a3,0x4
ffffffffc0203196:	4635                	li	a2,13
ffffffffc0203198:	00c68023          	sb	a2,0(a3) # 4000 <kern_entry-0xffffffffc01fc000>
    assert(pgfault_num == 4);
ffffffffc020319c:	4394                	lw	a3,0(a5)
ffffffffc020319e:	2681                	sext.w	a3,a3
ffffffffc02031a0:	1ce69f63          	bne	a3,a4,ffffffffc020337e <_clock_check_swap+0x21c>
    *(unsigned char *)0x2000 = 0x0b;
ffffffffc02031a4:	6709                	lui	a4,0x2
ffffffffc02031a6:	462d                	li	a2,11
ffffffffc02031a8:	00c70023          	sb	a2,0(a4) # 2000 <kern_entry-0xffffffffc01fe000>
    assert(pgfault_num == 4);
ffffffffc02031ac:	4398                	lw	a4,0(a5)
ffffffffc02031ae:	2701                	sext.w	a4,a4
ffffffffc02031b0:	1ad71763          	bne	a4,a3,ffffffffc020335e <_clock_check_swap+0x1fc>
    *(unsigned char *)0x5000 = 0x0e;
ffffffffc02031b4:	6715                	lui	a4,0x5
ffffffffc02031b6:	46b9                	li	a3,14
ffffffffc02031b8:	00d70023          	sb	a3,0(a4) # 5000 <kern_entry-0xffffffffc01fb000>
    assert(pgfault_num == 5);
ffffffffc02031bc:	4398                	lw	a4,0(a5)
ffffffffc02031be:	4695                	li	a3,5
ffffffffc02031c0:	2701                	sext.w	a4,a4
ffffffffc02031c2:	16d71e63          	bne	a4,a3,ffffffffc020333e <_clock_check_swap+0x1dc>
    assert(pgfault_num == 5);
ffffffffc02031c6:	4394                	lw	a3,0(a5)
ffffffffc02031c8:	2681                	sext.w	a3,a3
ffffffffc02031ca:	14e69a63          	bne	a3,a4,ffffffffc020331e <_clock_check_swap+0x1bc>
    assert(pgfault_num == 5);
ffffffffc02031ce:	4398                	lw	a4,0(a5)
ffffffffc02031d0:	2701                	sext.w	a4,a4
ffffffffc02031d2:	12d71663          	bne	a4,a3,ffffffffc02032fe <_clock_check_swap+0x19c>
    assert(pgfault_num == 5);
ffffffffc02031d6:	4394                	lw	a3,0(a5)
ffffffffc02031d8:	2681                	sext.w	a3,a3
ffffffffc02031da:	10e69263          	bne	a3,a4,ffffffffc02032de <_clock_check_swap+0x17c>
    assert(pgfault_num == 5);
ffffffffc02031de:	4398                	lw	a4,0(a5)
ffffffffc02031e0:	2701                	sext.w	a4,a4
ffffffffc02031e2:	0cd71e63          	bne	a4,a3,ffffffffc02032be <_clock_check_swap+0x15c>
    assert(pgfault_num == 5);
ffffffffc02031e6:	4394                	lw	a3,0(a5)
ffffffffc02031e8:	2681                	sext.w	a3,a3
ffffffffc02031ea:	0ae69a63          	bne	a3,a4,ffffffffc020329e <_clock_check_swap+0x13c>
    *(unsigned char *)0x5000 = 0x0e;
ffffffffc02031ee:	6715                	lui	a4,0x5
ffffffffc02031f0:	46b9                	li	a3,14
ffffffffc02031f2:	00d70023          	sb	a3,0(a4) # 5000 <kern_entry-0xffffffffc01fb000>
    assert(pgfault_num == 5);
ffffffffc02031f6:	4398                	lw	a4,0(a5)
ffffffffc02031f8:	4695                	li	a3,5
ffffffffc02031fa:	2701                	sext.w	a4,a4
ffffffffc02031fc:	08d71163          	bne	a4,a3,ffffffffc020327e <_clock_check_swap+0x11c>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203200:	6705                	lui	a4,0x1
ffffffffc0203202:	00074683          	lbu	a3,0(a4) # 1000 <kern_entry-0xffffffffc01ff000>
ffffffffc0203206:	4729                	li	a4,10
ffffffffc0203208:	04e69b63          	bne	a3,a4,ffffffffc020325e <_clock_check_swap+0xfc>
    assert(pgfault_num == 6);
ffffffffc020320c:	439c                	lw	a5,0(a5)
ffffffffc020320e:	4719                	li	a4,6
ffffffffc0203210:	2781                	sext.w	a5,a5
ffffffffc0203212:	02e79663          	bne	a5,a4,ffffffffc020323e <_clock_check_swap+0xdc>
}
ffffffffc0203216:	60a2                	ld	ra,8(sp)
...
ffffffffc0203222:	90268693          	addi	a3,a3,-1790 # ffffffffc0205b20 <default_pmm_manager+0xa20>
ffffffffc0203226:	00002617          	auipc	a2,0x2
ffffffffc020322a:	b2a60613          	addi	a2,a2,-1238 # ffffffffc0204d50 <commands+0x738>
ffffffffc020322e:	09900593          	li	a1,153
ffffffffc0203232:	00003517          	auipc	a0,0x3
ffffffffc0203236:	90650513          	addi	a0,a0,-1786 # ffffffffc0205b38 <default_pmm_manager+0xa38>
ffffffffc020323a:	93afd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num == 6);
ffffffffc020323e:	00003697          	auipc	a3,0x3
ffffffffc0203242:	95268693          	addi	a3,a3,-1710 # ffffffffc0205b90 <default_pmm_manager+0xa90>
ffffffffc0203246:	00002617          	auipc	a2,0x2
ffffffffc020324a:	b0a60613          	addi	a2,a2,-1270 # ffffffffc0204d50 <commands+0x738>
ffffffffc020324e:	0b000593          	li	a1,176
ffffffffc0203252:	00003517          	auipc	a0,0x3
ffffffffc0203256:	8e650513          	addi	a0,a0,-1818 # ffffffffc0205b38 <default_pmm_manager+0xa38>
ffffffffc020325a:	91afd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc020325e:	00003697          	auipc	a3,0x3
ffffffffc0203262:	90a68693          	addi	a3,a3,-1782 # ffffffffc0205b68 <default_pmm_manager+0xa68>
ffffffffc0203266:	00002617          	auipc	a2,0x2
ffffffffc020326a:	aea60613          	addi	a2,a2,-1302 # ffffffffc0204d50 <commands+0x738>
ffffffffc020326e:	0ae00593          	li	a1,174
ffffffffc0203272:	00003517          	auipc	a0,0x3
ffffffffc0203276:	8c650513          	addi	a0,a0,-1850 # ffffffffc0205b38 <default_pmm_manager+0xa38>
ffffffffc020327a:	8fafd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num == 5);
ffffffffc020327e:	00003697          	auipc	a3,0x3
ffffffffc0203282:	8d268693          	addi	a3,a3,-1838 # ffffffffc0205b50 <default_pmm_manager+0xa50>
ffffffffc0203286:	00002617          	auipc	a2,0x2
ffffffffc020328a:	aca60613          	addi	a2,a2,-1334 # ffffffffc0204d50 <commands+0x738>
ffffffffc020328e:	0ad00593          	li	a1,173
ffffffffc0203292:	00003517          	auipc	a0,0x3
ffffffffc0203296:	8a650513          	addi	a0,a0,-1882 # ffffffffc0205b38 <default_pmm_manager+0xa38>
ffffffffc020329a:	8dafd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num == 5);
ffffffffc020329e:	00003697          	auipc	a3,0x3
ffffffffc02032a2:	8b268693          	addi	a3,a3,-1870 # ffffffffc0205b50 <default_pmm_manager+0xa50>
ffffffffc02032a6:	00002617          	auipc	a2,0x2
ffffffffc02032aa:	aaa60613          	addi	a2,a2,-1366 # ffffffffc0204d50 <commands+0x738>
ffffffffc02032ae:	0ab00593          	li	a1,171
ffffffffc02032b2:	00003517          	auipc	a0,0x3
ffffffffc02032b6:	88650513          	addi	a0,a0,-1914 # ffffffffc0205b38 <default_pmm_manager+0xa38>
ffffffffc02032ba:	8bafd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num == 5);
ffffffffc02032be:	00003697          	auipc	a3,0x3
ffffffffc02032c2:	89268693          	addi	a3,a3,-1902 # ffffffffc0205b50 <default_pmm_manager+0xa50>
ffffffffc02032c6:	00002617          	auipc	a2,0x2
ffffffffc02032ca:	a8a60613          	addi	a2,a2,-1398 # ffffffffc0204d50 <commands+0x738>
ffffffffc02032ce:	0a900593          	li	a1,169
ffffffffc02032d2:	00003517          	auipc	a0,0x3
ffffffffc02032d6:	86650513          	addi	a0,a0,-1946 # ffffffffc0205b38 <default_pmm_manager+0xa38>
ffffffffc02032da:	89afd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num == 5);
ffffffffc02032de:	00003697          	auipc	a3,0x3
ffffffffc02032e2:	87268693          	addi	a3,a3,-1934 # ffffffffc0205b50 <default_pmm_manager+0xa50>
ffffffffc02032e6:	00002617          	auipc	a2,0x2
ffffffffc02032ea:	a6a60613          	addi	a2,a2,-1430 # ffffffffc0204d50 <commands+0x738>
ffffffffc02032ee:	0a700593          	li	a1,167
ffffffffc02032f2:	00003517          	auipc	a0,0x3
ffffffffc02032f6:	84650513          	addi	a0,a0,-1978 # ffffffffc0205b38 <default_pmm_manager+0xa38>
ffffffffc02032fa:	87afd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num == 5);
ffffffffc02032fe:	00003697          	auipc	a3,0x3
ffffffffc0203302:	85268693          	addi	a3,a3,-1966 # ffffffffc0205b50 <default_pmm_manager+0xa50>
ffffffffc0203306:	00002617          	auipc	a2,0x2
ffffffffc020330a:	a4a60613          	addi	a2,a2,-1462 # ffffffffc0204d50 <commands+0x738>
ffffffffc020330e:	0a500593          	li	a1,165
ffffffffc0203312:	00003517          	auipc	a0,0x3
ffffffffc0203316:	82650513          	addi	a0,a0,-2010 # ffffffffc0205b38 <default_pmm_manager+0xa38>
ffffffffc020331a:	85afd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num == 5);
ffffffffc020331e:	00003697          	auipc	a3,0x3
ffffffffc0203322:	83268693          	addi	a3,a3,-1998 # ffffffffc0205b50 <default_pmm_manager+0xa50>
ffffffffc0203326:	00002617          	auipc	a2,0x2
ffffffffc020332a:	a2a60613          	addi	a2,a2,-1494 # ffffffffc0204d50 <commands+0x738>
ffffffffc020332e:	0a300593          	li	a1,163
ffffffffc0203332:	00003517          	auipc	a0,0x3
ffffffffc0203336:	80650513          	addi	a0,a0,-2042 # ffffffffc0205b38 <default_pmm_manager+0xa38>
ffffffffc020333a:	83afd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num == 5);
ffffffffc020333e:	00003697          	auipc	a3,0x3
ffffffffc0203342:	81268693          	addi	a3,a3,-2030 # ffffffffc0205b50 <default_pmm_manager+0xa50>
ffffffffc0203346:	00002617          	auipc	a2,0x2
ffffffffc020334a:	a0a60613          	addi	a2,a2,-1526 # ffffffffc0204d50 <commands+0x738>
ffffffffc020334e:	0a100593          	li	a1,161
ffffffffc0203352:	00002517          	auipc	a0,0x2
ffffffffc0203356:	7e650513          	addi	a0,a0,2022 # ffffffffc0205b38 <default_pmm_manager+0xa38>
ffffffffc020335a:	81afd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num == 4);
ffffffffc020335e:	00002697          	auipc	a3,0x2
ffffffffc0203362:	7c268693          	addi	a3,a3,1986 # ffffffffc0205b20 <default_pmm_manager+0xa20>
ffffffffc0203366:	00002617          	auipc	a2,0x2
ffffffffc020336a:	9ea60613          	addi	a2,a2,-1558 # ffffffffc0204d50 <commands+0x738>
ffffffffc020336e:	09f00593          	li	a1,159
ffffffffc0203372:	00002517          	auipc	a0,0x2
ffffffffc0203376:	7c650513          	addi	a0,a0,1990 # ffffffffc0205b38 <default_pmm_manager+0xa38>
ffffffffc020337a:	ffbfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num == 4);
ffffffffc020337e:	00002697          	auipc	a3,0x2
ffffffffc0203382:	7a268693          	addi	a3,a3,1954 # ffffffffc0205b20 <default_pmm_manager+0xa20>
ffffffffc0203386:	00002617          	auipc	a2,0x2
ffffffffc020338a:	9ca60613          	addi	a2,a2,-1590 # ffffffffc0204d50 <commands+0x738>
ffffffffc020338e:	09d00593          	li	a1,157
ffffffffc0203392:	00002517          	auipc	a0,0x2
ffffffffc0203396:	7a650513          	addi	a0,a0,1958 # ffffffffc0205b38 <default_pmm_manager+0xa38>
ffffffffc020339a:	fdbfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num == 4);
ffffffffc020339e:	00002697          	auipc	a3,0x2
ffffffffc02033a2:	78268693          	addi	a3,a3,1922 # ffffffffc0205b20 <default_pmm_manager+0xa20>
ffffffffc02033a6:	00002617          	auipc	a2,0x2
ffffffffc02033aa:	9aa60613          	addi	a2,a2,-1622 # ffffffffc0204d50 <commands+0x738>
ffffffffc02033ae:	09b00593          	li	a1,155
ffffffffc02033b2:	00002517          	auipc	a0,0x2
ffffffffc02033b6:	78650513          	addi	a0,a0,1926 # ffffffffc0205b38 <default_pmm_manager+0xa38>
ffffffffc02033ba:	fbbfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02033be <_clock_swap_out_victim>:
    list_entry_t *head = (list_entry_t *)mm->sm_priv;
ffffffffc02033be:	7518                	ld	a4,40(a0)
{
ffffffffc02033c0:	1141                	addi	sp,sp,-16
ffffffffc02033c2:	e406                	sd	ra,8(sp)
    assert(head != NULL);
ffffffffc02033c4:	cb35                	beqz	a4,ffffffffc0203438 <_clock_swap_out_victim+0x7a>
    assert(in_tick == 0);
ffffffffc02033c6:	ea29                	bnez	a2,ffffffffc0203418 <_clock_swap_out_victim+0x5a>
    return listelm->next;
ffffffffc02033c8:	6710                	ld	a2,8(a4)
ffffffffc02033ca:	852e                	mv	a0,a1
ffffffffc02033cc:	85b2                	mv	a1,a2
    if (head == list_next(head))
ffffffffc02033ce:	02c70f63          	beq	a4,a2,ffffffffc020340c <_clock_swap_out_victim+0x4e>
        while ((le = list_next(le)) != head)
ffffffffc02033d2:	00b70b63          	beq	a4,a1,ffffffffc02033e8 <_clock_swap_out_victim+0x2a>
            if (page->visited)
ffffffffc02033d6:	fe05b683          	ld	a3,-32(a1) # fe0 <kern_entry-0xffffffffc01ff020>
    __list_del(listelm->prev, listelm->next);
ffffffffc02033da:	659c                	ld	a5,8(a1)
ffffffffc02033dc:	ca81                	beqz	a3,ffffffffc02033ec <_clock_swap_out_victim+0x2e>
                page->visited = 0;
ffffffffc02033de:	fe05b023          	sd	zero,-32(a1)
ffffffffc02033e2:	85be                	mv	a1,a5
        while ((le = list_next(le)) != head)
ffffffffc02033e4:	feb719e3          	bne	a4,a1,ffffffffc02033d6 <_clock_swap_out_victim+0x18>
ffffffffc02033e8:	85b2                	mv	a1,a2
ffffffffc02033ea:	b7e5                	j	ffffffffc02033d2 <_clock_swap_out_victim+0x14>
ffffffffc02033ec:	6198                	ld	a4,0(a1)
            struct Page *page = le2page(le, pra_page_link);
ffffffffc02033ee:	fd058693          	addi	a3,a1,-48
                *ptr_page = page;
ffffffffc02033f2:	e114                	sd	a3,0(a0)
    prev->next = next;
ffffffffc02033f4:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc02033f6:	e398                	sd	a4,0(a5)
                cprintf("curr_ptr %p\n", le);
ffffffffc02033f8:	00002517          	auipc	a0,0x2
ffffffffc02033fc:	7d050513          	addi	a0,a0,2000 # ffffffffc0205bc8 <default_pmm_manager+0xac8>
ffffffffc0203400:	cbbfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
}
ffffffffc0203404:	60a2                	ld	ra,8(sp)
ffffffffc0203406:	4501                	li	a0,0
ffffffffc0203408:	0141                	addi	sp,sp,16
ffffffffc020340a:	8082                	ret
ffffffffc020340c:	60a2                	ld	ra,8(sp)
        *ptr_page = NULL;
ffffffffc020340e:	00053023          	sd	zero,0(a0)
}
ffffffffc0203412:	4501                	li	a0,0
ffffffffc0203414:	0141                	addi	sp,sp,16
ffffffffc0203416:	8082                	ret
    assert(in_tick == 0);
ffffffffc0203418:	00002697          	auipc	a3,0x2
ffffffffc020341c:	7a068693          	addi	a3,a3,1952 # ffffffffc0205bb8 <default_pmm_manager+0xab8>
ffffffffc0203420:	00002617          	auipc	a2,0x2
ffffffffc0203424:	93060613          	addi	a2,a2,-1744 # ffffffffc0204d50 <commands+0x738>
ffffffffc0203428:	04600593          	li	a1,70
ffffffffc020342c:	00002517          	auipc	a0,0x2
ffffffffc0203430:	70c50513          	addi	a0,a0,1804 # ffffffffc0205b38 <default_pmm_manager+0xa38>
ffffffffc0203434:	f41fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(head != NULL);
ffffffffc0203438:	00002697          	auipc	a3,0x2
ffffffffc020343c:	77068693          	addi	a3,a3,1904 # ffffffffc0205ba8 <default_pmm_manager+0xaa8>
ffffffffc0203440:	00002617          	auipc	a2,0x2
ffffffffc0203444:	91060613          	addi	a2,a2,-1776 # ffffffffc0204d50 <commands+0x738>
ffffffffc0203448:	04500593          	li	a1,69
ffffffffc020344c:	00002517          	auipc	a0,0x2
ffffffffc0203450:	6ec50513          	addi	a0,a0,1772 # ffffffffc0205b38 <default_pmm_manager+0xa38>
ffffffffc0203454:	f21fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203458 <check_vma_overlap.part.0>:
    return vma;
}
...
ffffffffc020345e:	79668693          	addi	a3,a3,1942 # ffffffffc0205bf0 <default_pmm_manager+0xaf0>
ffffffffc0203462:	00002617          	auipc	a2,0x2
ffffffffc0203466:	8ee60613          	addi	a2,a2,-1810 # ffffffffc0204d50 <commands+0x738>
ffffffffc020346a:	08c00593          	li	a1,140
ffffffffc020346e:	00002517          	auipc	a0,0x2
ffffffffc0203472:	7a250513          	addi	a0,a0,1954 # ffffffffc0205c10 <default_pmm_manager+0xb10>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next)
ffffffffc0203476:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc0203478:	efdfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc020347c <mm_create>:
{
ffffffffc020347c:	1141                	addi	sp,sp,-16
...
ffffffffc020348a:	842a                	mv	s0,a0
    if (mm != NULL)
ffffffffc020348c:	c105                	beqz	a0,ffffffffc02034ac <mm_create+0x30>
    elm->prev = elm->next = elm;
ffffffffc020348e:	e408                	sd	a0,8(s0)
ffffffffc0203490:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
ffffffffc0203492:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc0203496:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc020349a:	02052023          	sw	zero,32(a0)
        if (swap_init_ok)
ffffffffc020349e:	0000e797          	auipc	a5,0xe
ffffffffc02034a2:	0b27a783          	lw	a5,178(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc02034a6:	eb81                	bnez	a5,ffffffffc02034b6 <mm_create+0x3a>
            mm->sm_priv = NULL;
ffffffffc02034a8:	02053423          	sd	zero,40(a0)
}
...
ffffffffc02034b4:	8082                	ret
            swap_init_mm(mm);
ffffffffc02034b6:	acfff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
}
ffffffffc02034ba:	60a2                	ld	ra,8(sp)
ffffffffc02034bc:	8522                	mv	a0,s0
ffffffffc02034be:	6402                	ld	s0,0(sp)
ffffffffc02034c0:	0141                	addi	sp,sp,16
ffffffffc02034c2:	8082                	ret

ffffffffc02034c4 <vma_create>:
{
ffffffffc02034c4:	1101                	addi	sp,sp,-32
ffffffffc02034c6:	e04a                	sd	s2,0(sp)
ffffffffc02034c8:	892a                	mv	s2,a0
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02034ca:	03000513          	li	a0,48
{
ffffffffc02034ce:	e822                	sd	s0,16(sp)
ffffffffc02034d0:	e426                	sd	s1,8(sp)
ffffffffc02034d2:	ec06                	sd	ra,24(sp)
ffffffffc02034d4:	84ae                	mv	s1,a1
ffffffffc02034d6:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02034d8:	aa0ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (vma != NULL)
ffffffffc02034dc:	c509                	beqz	a0,ffffffffc02034e6 <vma_create+0x22>
        vma->vm_start = vm_start;
ffffffffc02034de:	01253423          	sd	s2,8(a0)
        vma->vm_end = vm_end;
ffffffffc02034e2:	e904                	sd	s1,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02034e4:	ed00                	sd	s0,24(a0)
}
ffffffffc02034e6:	60e2                	ld	ra,24(sp)
ffffffffc02034e8:	6442                	ld	s0,16(sp)
ffffffffc02034ea:	64a2                	ld	s1,8(sp)
ffffffffc02034ec:	6902                	ld	s2,0(sp)
ffffffffc02034ee:	6105                	addi	sp,sp,32
ffffffffc02034f0:	8082                	ret

ffffffffc02034f2 <find_vma>:
{
ffffffffc02034f2:	86aa                	mv	a3,a0
    if (mm != NULL)
ffffffffc02034f4:	c505                	beqz	a0,ffffffffc020351c <find_vma+0x2a>
        vma = mm->mmap_cache;
ffffffffc02034f6:	6908                	ld	a0,16(a0)
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr))
ffffffffc02034f8:	c501                	beqz	a0,ffffffffc0203500 <find_vma+0xe>
ffffffffc02034fa:	651c                	ld	a5,8(a0)
ffffffffc02034fc:	02f5f263          	bgeu	a1,a5,ffffffffc0203520 <find_vma+0x2e>
    return listelm->next;
ffffffffc0203500:	669c                	ld	a5,8(a3)
            while ((le = list_next(le)) != list)
ffffffffc0203502:	00f68d63          	beq	a3,a5,ffffffffc020351c <find_vma+0x2a>
                if (vma->vm_start <= addr && addr < vma->vm_end)
ffffffffc0203506:	fe87b703          	ld	a4,-24(a5)
ffffffffc020350a:	00e5e663          	bltu	a1,a4,ffffffffc0203516 <find_vma+0x24>
ffffffffc020350e:	ff07b703          	ld	a4,-16(a5)
ffffffffc0203512:	00e5ec63          	bltu	a1,a4,ffffffffc020352a <find_vma+0x38>
ffffffffc0203516:	679c                	ld	a5,8(a5)
            while ((le = list_next(le)) != list)
ffffffffc0203518:	fef697e3          	bne	a3,a5,ffffffffc0203506 <find_vma+0x14>
    struct vma_struct *vma = NULL;
ffffffffc020351c:	4501                	li	a0,0
}
ffffffffc020351e:	8082                	ret
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr))
ffffffffc0203520:	691c                	ld	a5,16(a0)
ffffffffc0203522:	fcf5ffe3          	bgeu	a1,a5,ffffffffc0203500 <find_vma+0xe>
            mm->mmap_cache = vma;
ffffffffc0203526:	ea88                	sd	a0,16(a3)
ffffffffc0203528:	8082                	ret
                vma = le2vma(le, list_link);
ffffffffc020352a:	fe078513          	addi	a0,a5,-32
            mm->mmap_cache = vma;
ffffffffc020352e:	ea88                	sd	a0,16(a3)
ffffffffc0203530:	8082                	ret

ffffffffc0203532 <insert_vma_struct>:
}
...
ffffffffc0203532:	6590                	ld	a2,8(a1)
ffffffffc0203534:	0105b803          	ld	a6,16(a1)
{
ffffffffc0203538:	1141                	addi	sp,sp,-16
ffffffffc020353a:	e406                	sd	ra,8(sp)
ffffffffc020353c:	87aa                	mv	a5,a0
    assert(vma->vm_start < vma->vm_end);
ffffffffc020353e:	01066763          	bltu	a2,a6,ffffffffc020354c <insert_vma_struct+0x1a>
ffffffffc0203542:	a085                	j	ffffffffc02035a2 <insert_vma_struct+0x70>
...
ffffffffc0203548:	04e66863          	bltu	a2,a4,ffffffffc0203598 <insert_vma_struct+0x66>
ffffffffc020354c:	86be                	mv	a3,a5
ffffffffc020354e:	679c                	ld	a5,8(a5)
    while ((le = list_next(le)) != list)
ffffffffc0203550:	fef51ae3          	bne	a0,a5,ffffffffc0203544 <insert_vma_struct+0x12>
    }
    ...
    /* check overlap */
    if (le_prev != list)
ffffffffc0203554:	02a68463          	beq	a3,a0,ffffffffc020357c <insert_vma_struct+0x4a>
    {
        check_vma_overlap(le2vma(le_prev, list_link), vma);
ffffffffc0203558:	ff06b703          	ld	a4,-16(a3)
    assert(prev->vm_start < prev->vm_end);
ffffffffc020355c:	fe86b883          	ld	a7,-24(a3)
ffffffffc0203560:	08e8f163          	bgeu	a7,a4,ffffffffc02035e2 <insert_vma_struct+0xb0>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203564:	04e66f63          	bltu	a2,a4,ffffffffc02035c2 <insert_vma_struct+0x90>
    }
    if (le_next != list)
ffffffffc0203568:	00f50a63          	beq	a0,a5,ffffffffc020357c <insert_vma_struct+0x4a>
        if (mmap_prev->vm_start > vma->vm_start)
ffffffffc020356c:	fe87b703          	ld	a4,-24(a5)
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203570:	05076963          	bltu	a4,a6,ffffffffc02035c2 <insert_vma_struct+0x90>
    assert(next->vm_start < next->vm_end);
ffffffffc0203574:	ff07b603          	ld	a2,-16(a5)
ffffffffc0203578:	02c77363          	bgeu	a4,a2,ffffffffc020359e <insert_vma_struct+0x6c>
    }
    ...
    mm->map_count++;
ffffffffc020357c:	5118                	lw	a4,32(a0)
    vma->vm_mm = mm;
ffffffffc020357e:	e188                	sd	a0,0(a1)
    list_add_after(le_prev, &(vma->list_link));
ffffffffc0203580:	02058613          	addi	a2,a1,32
    prev->next = next->prev = elm;
ffffffffc0203584:	e390                	sd	a2,0(a5)
ffffffffc0203586:	e690                	sd	a2,8(a3)
}
ffffffffc0203588:	60a2                	ld	ra,8(sp)
    elm->next = next;
ffffffffc020358a:	f59c                	sd	a5,40(a1)
    elm->prev = prev;
ffffffffc020358c:	f194                	sd	a3,32(a1)
    mm->map_count++;
ffffffffc020358e:	0017079b          	addiw	a5,a4,1
ffffffffc0203592:	d11c                	sw	a5,32(a0)
}
ffffffffc0203594:	0141                	addi	sp,sp,16
ffffffffc0203596:	8082                	ret
    if (le_prev != list)
ffffffffc0203598:	fca690e3          	bne	a3,a0,ffffffffc0203558 <insert_vma_struct+0x26>
ffffffffc020359c:	bfd1                	j	ffffffffc0203570 <insert_vma_struct+0x3e>
ffffffffc020359e:	ebbff0ef          	jal	ra,ffffffffc0203458 <check_vma_overlap.part.0>
    assert(vma->vm_start < vma->vm_end);
ffffffffc02035a2:	00002697          	auipc	a3,0x2
ffffffffc02035a6:	67e68693          	addi	a3,a3,1662 # ffffffffc0205c20 <default_pmm_manager+0xb20>
ffffffffc02035aa:	00001617          	auipc	a2,0x1
ffffffffc02035ae:	7a660613          	addi	a2,a2,1958 # ffffffffc0204d50 <commands+0x738>
ffffffffc02035b2:	09200593          	li	a1,146
ffffffffc02035b6:	00002517          	auipc	a0,0x2
ffffffffc02035ba:	65a50513          	addi	a0,a0,1626 # ffffffffc0205c10 <default_pmm_manager+0xb10>
ffffffffc02035be:	db7fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02035c2:	00002697          	auipc	a3,0x2
ffffffffc02035c6:	69e68693          	addi	a3,a3,1694 # ffffffffc0205c60 <default_pmm_manager+0xb60>
ffffffffc02035ca:	00001617          	auipc	a2,0x1
ffffffffc02035ce:	78660613          	addi	a2,a2,1926 # ffffffffc0204d50 <commands+0x738>
ffffffffc02035d2:	08b00593          	li	a1,139
ffffffffc02035d6:	00002517          	auipc	a0,0x2
ffffffffc02035da:	63a50513          	addi	a0,a0,1594 # ffffffffc0205c10 <default_pmm_manager+0xb10>
ffffffffc02035de:	d97fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02035e2:	00002697          	auipc	a3,0x2
ffffffffc02035e6:	65e68693          	addi	a3,a3,1630 # ffffffffc0205c40 <default_pmm_manager+0xb40>
ffffffffc02035ea:	00001617          	auipc	a2,0x1
ffffffffc02035ee:	76660613          	addi	a2,a2,1894 # ffffffffc0204d50 <commands+0x738>
ffffffffc02035f2:	08a00593          	li	a1,138
ffffffffc02035f6:	00002517          	auipc	a0,0x2
ffffffffc02035fa:	61a50513          	addi	a0,a0,1562 # ffffffffc0205c10 <default_pmm_manager+0xb10>
ffffffffc02035fe:	d77fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203602 <mm_destroy>:

// mm_destroy - free mm and mm internal fields
void mm_destroy(struct mm_struct *mm)
{
ffffffffc0203602:	1141                	addi	sp,sp,-16
ffffffffc0203604:	e022                	sd	s0,0(sp)
ffffffffc0203606:	842a                	mv	s0,a0
    return listelm->next;
ffffffffc0203608:	6508                	ld	a0,8(a0)
ffffffffc020360a:	e406                	sd	ra,8(sp)

    list_entry_t *list = &(mm->mmap_list), *le;
    while ((le = list_next(list)) != list)
ffffffffc020360c:	00a40e63          	beq	s0,a0,ffffffffc0203628 <mm_destroy+0x26>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203610:	6118                	ld	a4,0(a0)
ffffffffc0203612:	651c                	ld	a5,8(a0)
    {
        list_del(le);
        kfree(le2vma(le, list_link), sizeof(struct vma_struct)); // kfree vma
ffffffffc0203614:	03000593          	li	a1,48
ffffffffc0203618:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc020361a:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc020361c:	e398                	sd	a4,0(a5)
ffffffffc020361e:	a14ff0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203622:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list)
ffffffffc0203624:	fea416e3          	bne	s0,a0,ffffffffc0203610 <mm_destroy+0xe>
    }
    kfree(mm, sizeof(struct mm_struct)); // kfree mm
ffffffffc0203628:	8522                	mv	a0,s0
    mm = NULL;
}
ffffffffc020362a:	6402                	ld	s0,0(sp)
...
ffffffffc0203632:	0141                	addi	sp,sp,16
    kfree(mm, sizeof(struct mm_struct)); // kfree mm
ffffffffc0203634:	9feff06f          	j	ffffffffc0202832 <kfree>

ffffffffc0203638 <vmm_init>:

// vmm_init - initialize virtual memory management
//          - now just call check_vmm to check correctness of vmm
void vmm_init(void)
{
ffffffffc0203638:	715d                	addi	sp,sp,-80
ffffffffc020363a:	e486                	sd	ra,72(sp)
ffffffffc020363c:	f44e                	sd	s3,40(sp)
ffffffffc020363e:	f052                	sd	s4,32(sp)
ffffffffc0203640:	e0a2                	sd	s0,64(sp)
ffffffffc0203642:	fc26                	sd	s1,56(sp)
ffffffffc0203644:	f84a                	sd	s2,48(sp)
ffffffffc0203646:	ec56                	sd	s5,24(sp)
ffffffffc0203648:	e85a                	sd	s6,16(sp)
ffffffffc020364a:	e45e                	sd	s7,8(sp)
...
ffffffffc020364c:	846fe0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
...
{
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc0203652:	840fe0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203656:	8a2a                	mv	s4,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203658:	03000513          	li	a0,48
ffffffffc020365c:	91cff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (mm != NULL)
ffffffffc0203660:	56050863          	beqz	a0,ffffffffc0203bd0 <vmm_init+0x598>
    elm->prev = elm->next = elm;
ffffffffc0203664:	e508                	sd	a0,8(a0)
ffffffffc0203666:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc0203668:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc020366c:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc0203670:	02052023          	sw	zero,32(a0)
        if (swap_init_ok)
ffffffffc0203674:	0000e797          	auipc	a5,0xe
ffffffffc0203678:	edc7a783          	lw	a5,-292(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc020367c:	84aa                	mv	s1,a0
ffffffffc020367e:	e7b9                	bnez	a5,ffffffffc02036cc <vmm_init+0x94>
            mm->sm_priv = NULL;
ffffffffc0203680:	02053423          	sd	zero,40(a0)
{
ffffffffc0203684:	03200413          	li	s0,50
ffffffffc0203688:	a811                	j	ffffffffc020369c <vmm_init+0x64>
        vma->vm_start = vm_start;
...
ffffffffc020368e:	00053c23          	sd	zero,24(a0)
    ...
    int i;
    for (i = step1; i >= 1; i--)
ffffffffc0203692:	146d                	addi	s0,s0,-5
    {
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc0203694:	8526                	mv	a0,s1
ffffffffc0203696:	e9dff0ef          	jal	ra,ffffffffc0203532 <insert_vma_struct>
    for (i = step1; i >= 1; i--)
ffffffffc020369a:	cc05                	beqz	s0,ffffffffc02036d2 <vmm_init+0x9a>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc020369c:	03000513          	li	a0,48
ffffffffc02036a0:	8d8ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02036a4:	85aa                	mv	a1,a0
ffffffffc02036a6:	00240793          	addi	a5,s0,2
    if (vma != NULL)
ffffffffc02036aa:	f165                	bnez	a0,ffffffffc020368a <vmm_init+0x52>
        assert(vma != NULL);
ffffffffc02036ac:	00002697          	auipc	a3,0x2
ffffffffc02036b0:	18468693          	addi	a3,a3,388 # ffffffffc0205830 <default_pmm_manager+0x730>
ffffffffc02036b4:	00001617          	auipc	a2,0x1
ffffffffc02036b8:	69c60613          	addi	a2,a2,1692 # ffffffffc0204d50 <commands+0x738>
ffffffffc02036bc:	0e400593          	li	a1,228
ffffffffc02036c0:	00002517          	auipc	a0,0x2
ffffffffc02036c4:	55050513          	addi	a0,a0,1360 # ffffffffc0205c10 <default_pmm_manager+0xb10>
ffffffffc02036c8:	cadfc0ef          	jal	ra,ffffffffc0200374 <__panic>
            swap_init_mm(mm);
ffffffffc02036cc:	8b9ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc02036d0:	bf55                	j	ffffffffc0203684 <vmm_init+0x4c>
ffffffffc02036d2:	03700413          	li	s0,55
    }

    for (i = step1 + 1; i <= step2; i++)
ffffffffc02036d6:	1f900913          	li	s2,505
ffffffffc02036da:	a819                	j	ffffffffc02036f0 <vmm_init+0xb8>
        vma->vm_start = vm_start;
ffffffffc02036dc:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc02036de:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02036e0:	00053c23          	sd	zero,24(a0)
    for (i = step1 + 1; i <= step2; i++)
ffffffffc02036e4:	0415                	addi	s0,s0,5
    {
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc02036e6:	8526                	mv	a0,s1
ffffffffc02036e8:	e4bff0ef          	jal	ra,ffffffffc0203532 <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i++)
ffffffffc02036ec:	03240a63          	beq	s0,s2,ffffffffc0203720 <vmm_init+0xe8>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
...
ffffffffc02036fa:	00240793          	addi	a5,s0,2
    if (vma != NULL)
ffffffffc02036fe:	fd79                	bnez	a0,ffffffffc02036dc <vmm_init+0xa4>
        assert(vma != NULL);
ffffffffc0203700:	00002697          	auipc	a3,0x2
ffffffffc0203704:	13068693          	addi	a3,a3,304 # ffffffffc0205830 <default_pmm_manager+0x730>
ffffffffc0203708:	00001617          	auipc	a2,0x1
ffffffffc020370c:	64860613          	addi	a2,a2,1608 # ffffffffc0204d50 <commands+0x738>
ffffffffc0203710:	0eb00593          	li	a1,235
ffffffffc0203714:	00002517          	auipc	a0,0x2
ffffffffc0203718:	4fc50513          	addi	a0,a0,1276 # ffffffffc0205c10 <default_pmm_manager+0xb10>
ffffffffc020371c:	c59fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    return listelm->next;
ffffffffc0203720:	649c                	ld	a5,8(s1)
ffffffffc0203722:	471d                	li	a4,7
    }

    list_entry_t *le = list_next(&(mm->mmap_list));

    for (i = 1; i <= step2; i++)
ffffffffc0203724:	1fb00593          	li	a1,507
    {
        assert(le != &(mm->mmap_list));
ffffffffc0203728:	2ef48463          	beq	s1,a5,ffffffffc0203a10 <vmm_init+0x3d8>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc020372c:	fe87b603          	ld	a2,-24(a5)
ffffffffc0203730:	ffe70693          	addi	a3,a4,-2
ffffffffc0203734:	26d61e63          	bne	a2,a3,ffffffffc02039b0 <vmm_init+0x378>
ffffffffc0203738:	ff07b683          	ld	a3,-16(a5)
ffffffffc020373c:	26e69a63          	bne	a3,a4,ffffffffc02039b0 <vmm_init+0x378>
    for (i = 1; i <= step2; i++)
ffffffffc0203740:	0715                	addi	a4,a4,5
ffffffffc0203742:	679c                	ld	a5,8(a5)
ffffffffc0203744:	feb712e3          	bne	a4,a1,ffffffffc0203728 <vmm_init+0xf0>
ffffffffc0203748:	4b1d                	li	s6,7
ffffffffc020374a:	4415                	li	s0,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i += 5)
ffffffffc020374c:	1f900b93          	li	s7,505
    {
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc0203750:	85a2                	mv	a1,s0
ffffffffc0203752:	8526                	mv	a0,s1
ffffffffc0203754:	d9fff0ef          	jal	ra,ffffffffc02034f2 <find_vma>
ffffffffc0203758:	892a                	mv	s2,a0
        assert(vma1 != NULL);
ffffffffc020375a:	2c050b63          	beqz	a0,ffffffffc0203a30 <vmm_init+0x3f8>
        struct vma_struct *vma2 = find_vma(mm, i + 1);
ffffffffc020375e:	00140593          	addi	a1,s0,1
ffffffffc0203762:	8526                	mv	a0,s1
ffffffffc0203764:	d8fff0ef          	jal	ra,ffffffffc02034f2 <find_vma>
ffffffffc0203768:	8aaa                	mv	s5,a0
        assert(vma2 != NULL);
ffffffffc020376a:	2e050363          	beqz	a0,ffffffffc0203a50 <vmm_init+0x418>
        struct vma_struct *vma3 = find_vma(mm, i + 2);
ffffffffc020376e:	85da                	mv	a1,s6
ffffffffc0203770:	8526                	mv	a0,s1
ffffffffc0203772:	d81ff0ef          	jal	ra,ffffffffc02034f2 <find_vma>
        assert(vma3 == NULL);
ffffffffc0203776:	2e051d63          	bnez	a0,ffffffffc0203a70 <vmm_init+0x438>
        struct vma_struct *vma4 = find_vma(mm, i + 3);
ffffffffc020377a:	00340593          	addi	a1,s0,3
ffffffffc020377e:	8526                	mv	a0,s1
ffffffffc0203780:	d73ff0ef          	jal	ra,ffffffffc02034f2 <find_vma>
        assert(vma4 == NULL);
ffffffffc0203784:	30051663          	bnez	a0,ffffffffc0203a90 <vmm_init+0x458>
        struct vma_struct *vma5 = find_vma(mm, i + 4);
ffffffffc0203788:	00440593          	addi	a1,s0,4
ffffffffc020378c:	8526                	mv	a0,s1
ffffffffc020378e:	d65ff0ef          	jal	ra,ffffffffc02034f2 <find_vma>
        assert(vma5 == NULL);
ffffffffc0203792:	30051f63          	bnez	a0,ffffffffc0203ab0 <vmm_init+0x478>

        assert(vma1->vm_start == i && vma1->vm_end == i + 2);
ffffffffc0203796:	00893783          	ld	a5,8(s2)
ffffffffc020379a:	24879b63          	bne	a5,s0,ffffffffc02039f0 <vmm_init+0x3b8>
ffffffffc020379e:	01093783          	ld	a5,16(s2)
ffffffffc02037a2:	25679763          	bne	a5,s6,ffffffffc02039f0 <vmm_init+0x3b8>
        assert(vma2->vm_start == i && vma2->vm_end == i + 2);
ffffffffc02037a6:	008ab783          	ld	a5,8(s5)
ffffffffc02037aa:	22879363          	bne	a5,s0,ffffffffc02039d0 <vmm_init+0x398>
ffffffffc02037ae:	010ab783          	ld	a5,16(s5)
ffffffffc02037b2:	21679f63          	bne	a5,s6,ffffffffc02039d0 <vmm_init+0x398>
    for (i = 5; i <= 5 * step2; i += 5)
ffffffffc02037b6:	0415                	addi	s0,s0,5
ffffffffc02037b8:	0b15                	addi	s6,s6,5
ffffffffc02037ba:	f9741be3          	bne	s0,s7,ffffffffc0203750 <vmm_init+0x118>
ffffffffc02037be:	4411                	li	s0,4
    }

    for (i = 4; i >= 0; i--)
ffffffffc02037c0:	597d                	li	s2,-1
    {
        struct vma_struct *vma_below_5 = find_vma(mm, i);
ffffffffc02037c2:	85a2                	mv	a1,s0
ffffffffc02037c4:	8526                	mv	a0,s1
ffffffffc02037c6:	d2dff0ef          	jal	ra,ffffffffc02034f2 <find_vma>
ffffffffc02037ca:	0004059b          	sext.w	a1,s0
        if (vma_below_5 != NULL)
ffffffffc02037ce:	c90d                	beqz	a0,ffffffffc0203800 <vmm_init+0x1c8>
        {
            cprintf("vma_below_5: i %x, start %x, end %x\n", i, vma_below_5->vm_start, vma_below_5->vm_end);
ffffffffc02037d0:	6914                	ld	a3,16(a0)
ffffffffc02037d2:	6510                	ld	a2,8(a0)
ffffffffc02037d4:	00002517          	auipc	a0,0x2
ffffffffc02037d8:	5ac50513          	addi	a0,a0,1452 # ffffffffc0205d80 <default_pmm_manager+0xc80>
ffffffffc02037dc:	8dffc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc02037e0:	00002697          	auipc	a3,0x2
ffffffffc02037e4:	5c868693          	addi	a3,a3,1480 # ffffffffc0205da8 <default_pmm_manager+0xca8>
ffffffffc02037e8:	00001617          	auipc	a2,0x1
ffffffffc02037ec:	56860613          	addi	a2,a2,1384 # ffffffffc0204d50 <commands+0x738>
ffffffffc02037f0:	11100593          	li	a1,273
ffffffffc02037f4:	00002517          	auipc	a0,0x2
ffffffffc02037f8:	41c50513          	addi	a0,a0,1052 # ffffffffc0205c10 <default_pmm_manager+0xb10>
ffffffffc02037fc:	b79fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    for (i = 4; i >= 0; i--)
ffffffffc0203800:	147d                	addi	s0,s0,-1
ffffffffc0203802:	fd2410e3          	bne	s0,s2,ffffffffc02037c2 <vmm_init+0x18a>
ffffffffc0203806:	a811                	j	ffffffffc020381a <vmm_init+0x1e2>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203808:	6118                	ld	a4,0(a0)
ffffffffc020380a:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link), sizeof(struct vma_struct)); // kfree vma
ffffffffc020380c:	03000593          	li	a1,48
ffffffffc0203810:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203812:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203814:	e398                	sd	a4,0(a5)
ffffffffc0203816:	81cff0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc020381a:	6488                	ld	a0,8(s1)
    while ((le = list_next(list)) != list)
ffffffffc020381c:	fea496e3          	bne	s1,a0,ffffffffc0203808 <vmm_init+0x1d0>
    kfree(mm, sizeof(struct mm_struct)); // kfree mm
ffffffffc0203820:	03000593          	li	a1,48
ffffffffc0203824:	8526                	mv	a0,s1
ffffffffc0203826:	80cff0ef          	jal	ra,ffffffffc0202832 <kfree>
    }

    mm_destroy(mm);

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc020382a:	e69fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc020382e:	3caa1163          	bne	s4,a0,ffffffffc0203bf0 <vmm_init+0x5b8>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc0203832:	00002517          	auipc	a0,0x2
ffffffffc0203836:	5b650513          	addi	a0,a0,1462 # ffffffffc0205de8 <default_pmm_manager+0xce8>
...
check_pgfault(void)
{
    ...
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc020383e:	e55fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203842:	84aa                	mv	s1,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203844:	03000513          	li	a0,48
ffffffffc0203848:	f31fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc020384c:	842a                	mv	s0,a0
    if (mm != NULL)
ffffffffc020384e:	2a050163          	beqz	a0,ffffffffc0203af0 <vmm_init+0x4b8>
        if (swap_init_ok)
ffffffffc0203852:	0000e797          	auipc	a5,0xe
ffffffffc0203856:	cfe7a783          	lw	a5,-770(a5) # ffffffffc0211550 <swap_init_ok>
    elm->prev = elm->next = elm;
ffffffffc020385a:	e508                	sd	a0,8(a0)
ffffffffc020385c:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc020385e:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc0203862:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc0203866:	02052023          	sw	zero,32(a0)
        if (swap_init_ok)
ffffffffc020386a:	14079063          	bnez	a5,ffffffffc02039aa <vmm_init+0x372>
            mm->sm_priv = NULL;
ffffffffc020386e:	02053423          	sd	zero,40(a0)
    ...
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0203872:	0000e917          	auipc	s2,0xe
ffffffffc0203876:	ca693903          	ld	s2,-858(s2) # ffffffffc0211518 <boot_pgdir>
    assert(pgdir[0] == 0);
ffffffffc020387a:	00093783          	ld	a5,0(s2)
    check_mm_struct = mm_create();
ffffffffc020387e:	0000e717          	auipc	a4,0xe
ffffffffc0203882:	cc873d23          	sd	s0,-806(a4) # ffffffffc0211558 <check_mm_struct>
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0203886:	01243c23          	sd	s2,24(s0)
    assert(pgdir[0] == 0);
ffffffffc020388a:	24079363          	bnez	a5,ffffffffc0203ad0 <vmm_init+0x498>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc020388e:	03000513          	li	a0,48
ffffffffc0203892:	ee7fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203896:	8a2a                	mv	s4,a0
    if (vma != NULL)
ffffffffc0203898:	28050063          	beqz	a0,ffffffffc0203b18 <vmm_init+0x4e0>
        vma->vm_end = vm_end;
ffffffffc020389c:	002007b7          	lui	a5,0x200
ffffffffc02038a0:	00fa3823          	sd	a5,16(s4)
        vma->vm_flags = vm_flags;
ffffffffc02038a4:	4789                	li	a5,2
    ...
    insert_vma_struct(mm, vma);
ffffffffc02038a6:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc02038a8:	00fa3c23          	sd	a5,24(s4)
    insert_vma_struct(mm, vma);
ffffffffc02038ac:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc02038ae:	000a3423          	sd	zero,8(s4)
    insert_vma_struct(mm, vma);
ffffffffc02038b2:	c81ff0ef          	jal	ra,ffffffffc0203532 <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc02038b6:	10000593          	li	a1,256
ffffffffc02038ba:	8522                	mv	a0,s0
ffffffffc02038bc:	c37ff0ef          	jal	ra,ffffffffc02034f2 <find_vma>
ffffffffc02038c0:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i++)
ffffffffc02038c4:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc02038c8:	26aa1863          	bne	s4,a0,ffffffffc0203b38 <vmm_init+0x500>
    {
        *(char *)(addr + i) = i;
ffffffffc02038cc:	00f78023          	sb	a5,0(a5) # 200000 <kern_entry-0xffffffffc0000000>
    for (i = 0; i < 100; i++)
ffffffffc02038d0:	0785                	addi	a5,a5,1
ffffffffc02038d2:	fee79de3          	bne	a5,a4,ffffffffc02038cc <vmm_init+0x294>
        sum += i;
ffffffffc02038d6:	6705                	lui	a4,0x1
ffffffffc02038d8:	10000793          	li	a5,256
ffffffffc02038dc:	35670713          	addi	a4,a4,854 # 1356 <kern_entry-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i++)
ffffffffc02038e0:	16400613          	li	a2,356
    {
        sum -= *(char *)(addr + i);
ffffffffc02038e4:	0007c683          	lbu	a3,0(a5)
    for (i = 0; i < 100; i++)
ffffffffc02038e8:	0785                	addi	a5,a5,1
        sum -= *(char *)(addr + i);
ffffffffc02038ea:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i++)
ffffffffc02038ec:	fec79ce3          	bne	a5,a2,ffffffffc02038e4 <vmm_init+0x2ac>
    }
    assert(sum == 0);
ffffffffc02038f0:	26071463          	bnez	a4,ffffffffc0203b58 <vmm_init+0x520>

    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc02038f4:	4581                	li	a1,0
ffffffffc02038f6:	854a                	mv	a0,s2
ffffffffc02038f8:	824fe0ef          	jal	ra,ffffffffc020191c <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc02038fc:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc0203900:	0000e717          	auipc	a4,0xe
ffffffffc0203904:	c2073703          	ld	a4,-992(a4) # ffffffffc0211520 <npage>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203908:	078a                	slli	a5,a5,0x2
ffffffffc020390a:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc020390c:	26e7f663          	bgeu	a5,a4,ffffffffc0203b78 <vmm_init+0x540>
    return &pages[PPN(pa) - nbase];
ffffffffc0203910:	00003717          	auipc	a4,0x3
ffffffffc0203914:	90873703          	ld	a4,-1784(a4) # ffffffffc0206218 <nbase>
ffffffffc0203918:	8f99                	sub	a5,a5,a4
ffffffffc020391a:	00379713          	slli	a4,a5,0x3
ffffffffc020391e:	97ba                	add	a5,a5,a4
ffffffffc0203920:	078e                	slli	a5,a5,0x3

    free_page(pde2page(pgdir[0]));
ffffffffc0203922:	0000e517          	auipc	a0,0xe
ffffffffc0203926:	c0653503          	ld	a0,-1018(a0) # ffffffffc0211528 <pages>
ffffffffc020392a:	953e                	add	a0,a0,a5
ffffffffc020392c:	4585                	li	a1,1
ffffffffc020392e:	d25fd0ef          	jal	ra,ffffffffc0201652 <free_pages>
    return listelm->next;
ffffffffc0203932:	6408                	ld	a0,8(s0)

    pgdir[0] = 0;
ffffffffc0203934:	00093023          	sd	zero,0(s2)

    mm->pgdir = NULL;
ffffffffc0203938:	00043c23          	sd	zero,24(s0)
    while ((le = list_next(list)) != list)
ffffffffc020393c:	00a40e63          	beq	s0,a0,ffffffffc0203958 <vmm_init+0x320>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203940:	6118                	ld	a4,0(a0)
ffffffffc0203942:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link), sizeof(struct vma_struct)); // kfree vma
ffffffffc0203944:	03000593          	li	a1,48
ffffffffc0203948:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc020394a:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc020394c:	e398                	sd	a4,0(a5)
ffffffffc020394e:	ee5fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203952:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list)
ffffffffc0203954:	fea416e3          	bne	s0,a0,ffffffffc0203940 <vmm_init+0x308>
    kfree(mm, sizeof(struct mm_struct)); // kfree mm
ffffffffc0203958:	03000593          	li	a1,48
ffffffffc020395c:	8522                	mv	a0,s0
ffffffffc020395e:	ed5fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    mm_destroy(mm);

    check_mm_struct = NULL;
    nr_free_pages_store--; // szx : Sv39第二级页表多占了一个内存页，所以执行此操作
ffffffffc0203962:	14fd                	addi	s1,s1,-1
    check_mm_struct = NULL;
ffffffffc0203964:	0000e797          	auipc	a5,0xe
ffffffffc0203968:	be07ba23          	sd	zero,-1036(a5) # ffffffffc0211558 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc020396c:	d27fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203970:	22a49063          	bne	s1,a0,ffffffffc0203b90 <vmm_init+0x558>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc0203974:	00002517          	auipc	a0,0x2
ffffffffc0203978:	4c450513          	addi	a0,a0,1220 # ffffffffc0205e38 <default_pmm_manager+0xd38>
ffffffffc020397c:	f3efc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203980:	d13fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
    nr_free_pages_store--; // szx : Sv39三级页表多占一个内存页，所以执行此操作
ffffffffc0203984:	19fd                	addi	s3,s3,-1
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203986:	22a99563          	bne	s3,a0,ffffffffc0203bb0 <vmm_init+0x578>
}
...
ffffffffc02039a0:	4bc50513          	addi	a0,a0,1212 # ffffffffc0205e58 <default_pmm_manager+0xd58>
}
ffffffffc02039a4:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc02039a6:	f14fc06f          	j	ffffffffc02000ba <cprintf>
            swap_init_mm(mm);
ffffffffc02039aa:	ddaff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc02039ae:	b5d1                	j	ffffffffc0203872 <vmm_init+0x23a>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc02039b0:	00002697          	auipc	a3,0x2
ffffffffc02039b4:	2e868693          	addi	a3,a3,744 # ffffffffc0205c98 <default_pmm_manager+0xb98>
ffffffffc02039b8:	00001617          	auipc	a2,0x1
ffffffffc02039bc:	39860613          	addi	a2,a2,920 # ffffffffc0204d50 <commands+0x738>
ffffffffc02039c0:	0f500593          	li	a1,245
ffffffffc02039c4:	00002517          	auipc	a0,0x2
ffffffffc02039c8:	24c50513          	addi	a0,a0,588 # ffffffffc0205c10 <default_pmm_manager+0xb10>
ffffffffc02039cc:	9a9fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i && vma2->vm_end == i + 2);
ffffffffc02039d0:	00002697          	auipc	a3,0x2
ffffffffc02039d4:	38068693          	addi	a3,a3,896 # ffffffffc0205d50 <default_pmm_manager+0xc50>
ffffffffc02039d8:	00001617          	auipc	a2,0x1
ffffffffc02039dc:	37860613          	addi	a2,a2,888 # ffffffffc0204d50 <commands+0x738>
ffffffffc02039e0:	10700593          	li	a1,263
ffffffffc02039e4:	00002517          	auipc	a0,0x2
ffffffffc02039e8:	22c50513          	addi	a0,a0,556 # ffffffffc0205c10 <default_pmm_manager+0xb10>
ffffffffc02039ec:	989fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i && vma1->vm_end == i + 2);
ffffffffc02039f0:	00002697          	auipc	a3,0x2
ffffffffc02039f4:	33068693          	addi	a3,a3,816 # ffffffffc0205d20 <default_pmm_manager+0xc20>
ffffffffc02039f8:	00001617          	auipc	a2,0x1
ffffffffc02039fc:	35860613          	addi	a2,a2,856 # ffffffffc0204d50 <commands+0x738>
ffffffffc0203a00:	10600593          	li	a1,262
ffffffffc0203a04:	00002517          	auipc	a0,0x2
ffffffffc0203a08:	20c50513          	addi	a0,a0,524 # ffffffffc0205c10 <default_pmm_manager+0xb10>
ffffffffc0203a0c:	969fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203a10:	00002697          	auipc	a3,0x2
ffffffffc0203a14:	27068693          	addi	a3,a3,624 # ffffffffc0205c80 <default_pmm_manager+0xb80>
ffffffffc0203a18:	00001617          	auipc	a2,0x1
ffffffffc0203a1c:	33860613          	addi	a2,a2,824 # ffffffffc0204d50 <commands+0x738>
ffffffffc0203a20:	0f300593          	li	a1,243
ffffffffc0203a24:	00002517          	auipc	a0,0x2
ffffffffc0203a28:	1ec50513          	addi	a0,a0,492 # ffffffffc0205c10 <default_pmm_manager+0xb10>
ffffffffc0203a2c:	949fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc0203a30:	00002697          	auipc	a3,0x2
ffffffffc0203a34:	2a068693          	addi	a3,a3,672 # ffffffffc0205cd0 <default_pmm_manager+0xbd0>
ffffffffc0203a38:	00001617          	auipc	a2,0x1
ffffffffc0203a3c:	31860613          	addi	a2,a2,792 # ffffffffc0204d50 <commands+0x738>
ffffffffc0203a40:	0fc00593          	li	a1,252
ffffffffc0203a44:	00002517          	auipc	a0,0x2
ffffffffc0203a48:	1cc50513          	addi	a0,a0,460 # ffffffffc0205c10 <default_pmm_manager+0xb10>
ffffffffc0203a4c:	929fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203a50:	00002697          	auipc	a3,0x2
ffffffffc0203a54:	29068693          	addi	a3,a3,656 # ffffffffc0205ce0 <default_pmm_manager+0xbe0>
ffffffffc0203a58:	00001617          	auipc	a2,0x1
ffffffffc0203a5c:	2f860613          	addi	a2,a2,760 # ffffffffc0204d50 <commands+0x738>
ffffffffc0203a60:	0fe00593          	li	a1,254
ffffffffc0203a64:	00002517          	auipc	a0,0x2
ffffffffc0203a68:	1ac50513          	addi	a0,a0,428 # ffffffffc0205c10 <default_pmm_manager+0xb10>
ffffffffc0203a6c:	909fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203a70:	00002697          	auipc	a3,0x2
ffffffffc0203a74:	28068693          	addi	a3,a3,640 # ffffffffc0205cf0 <default_pmm_manager+0xbf0>
ffffffffc0203a78:	00001617          	auipc	a2,0x1
ffffffffc0203a7c:	2d860613          	addi	a2,a2,728 # ffffffffc0204d50 <commands+0x738>
ffffffffc0203a80:	10000593          	li	a1,256
ffffffffc0203a84:	00002517          	auipc	a0,0x2
ffffffffc0203a88:	18c50513          	addi	a0,a0,396 # ffffffffc0205c10 <default_pmm_manager+0xb10>
ffffffffc0203a8c:	8e9fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203a90:	00002697          	auipc	a3,0x2
ffffffffc0203a94:	27068693          	addi	a3,a3,624 # ffffffffc0205d00 <default_pmm_manager+0xc00>
ffffffffc0203a98:	00001617          	auipc	a2,0x1
ffffffffc0203a9c:	2b860613          	addi	a2,a2,696 # ffffffffc0204d50 <commands+0x738>
ffffffffc0203aa0:	10200593          	li	a1,258
ffffffffc0203aa4:	00002517          	auipc	a0,0x2
ffffffffc0203aa8:	16c50513          	addi	a0,a0,364 # ffffffffc0205c10 <default_pmm_manager+0xb10>
ffffffffc0203aac:	8c9fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc0203ab0:	00002697          	auipc	a3,0x2
ffffffffc0203ab4:	26068693          	addi	a3,a3,608 # ffffffffc0205d10 <default_pmm_manager+0xc10>
ffffffffc0203ab8:	00001617          	auipc	a2,0x1
ffffffffc0203abc:	29860613          	addi	a2,a2,664 # ffffffffc0204d50 <commands+0x738>
ffffffffc0203ac0:	10400593          	li	a1,260
ffffffffc0203ac4:	00002517          	auipc	a0,0x2
ffffffffc0203ac8:	14c50513          	addi	a0,a0,332 # ffffffffc0205c10 <default_pmm_manager+0xb10>
ffffffffc0203acc:	8a9fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203ad0:	00002697          	auipc	a3,0x2
ffffffffc0203ad4:	d5068693          	addi	a3,a3,-688 # ffffffffc0205820 <default_pmm_manager+0x720>
ffffffffc0203ad8:	00001617          	auipc	a2,0x1
ffffffffc0203adc:	27860613          	addi	a2,a2,632 # ffffffffc0204d50 <commands+0x738>
ffffffffc0203ae0:	12900593          	li	a1,297
ffffffffc0203ae4:	00002517          	auipc	a0,0x2
ffffffffc0203ae8:	12c50513          	addi	a0,a0,300 # ffffffffc0205c10 <default_pmm_manager+0xb10>
ffffffffc0203aec:	889fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203af0:	00002697          	auipc	a3,0x2
ffffffffc0203af4:	38068693          	addi	a3,a3,896 # ffffffffc0205e70 <default_pmm_manager+0xd70>
ffffffffc0203af8:	00001617          	auipc	a2,0x1
ffffffffc0203afc:	25860613          	addi	a2,a2,600 # ffffffffc0204d50 <commands+0x738>
ffffffffc0203b00:	12600593          	li	a1,294
ffffffffc0203b04:	00002517          	auipc	a0,0x2
ffffffffc0203b08:	10c50513          	addi	a0,a0,268 # ffffffffc0205c10 <default_pmm_manager+0xb10>
    check_mm_struct = mm_create();
ffffffffc0203b0c:	0000e797          	auipc	a5,0xe
ffffffffc0203b10:	a407b623          	sd	zero,-1460(a5) # ffffffffc0211558 <check_mm_struct>
    assert(check_mm_struct != NULL);
ffffffffc0203b14:	861fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(vma != NULL);
ffffffffc0203b18:	00002697          	auipc	a3,0x2
ffffffffc0203b1c:	d1868693          	addi	a3,a3,-744 # ffffffffc0205830 <default_pmm_manager+0x730>
ffffffffc0203b20:	00001617          	auipc	a2,0x1
ffffffffc0203b24:	23060613          	addi	a2,a2,560 # ffffffffc0204d50 <commands+0x738>
ffffffffc0203b28:	12d00593          	li	a1,301
ffffffffc0203b2c:	00002517          	auipc	a0,0x2
ffffffffc0203b30:	0e450513          	addi	a0,a0,228 # ffffffffc0205c10 <default_pmm_manager+0xb10>
ffffffffc0203b34:	841fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203b38:	00002697          	auipc	a3,0x2
ffffffffc0203b3c:	2d068693          	addi	a3,a3,720 # ffffffffc0205e08 <default_pmm_manager+0xd08>
ffffffffc0203b40:	00001617          	auipc	a2,0x1
ffffffffc0203b44:	21060613          	addi	a2,a2,528 # ffffffffc0204d50 <commands+0x738>
ffffffffc0203b48:	13200593          	li	a1,306
ffffffffc0203b4c:	00002517          	auipc	a0,0x2
ffffffffc0203b50:	0c450513          	addi	a0,a0,196 # ffffffffc0205c10 <default_pmm_manager+0xb10>
ffffffffc0203b54:	821fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203b58:	00002697          	auipc	a3,0x2
ffffffffc0203b5c:	2d068693          	addi	a3,a3,720 # ffffffffc0205e28 <default_pmm_manager+0xd28>
ffffffffc0203b60:	00001617          	auipc	a2,0x1
ffffffffc0203b64:	1f060613          	addi	a2,a2,496 # ffffffffc0204d50 <commands+0x738>
ffffffffc0203b68:	13e00593          	li	a1,318
ffffffffc0203b6c:	00002517          	auipc	a0,0x2
ffffffffc0203b70:	0a450513          	addi	a0,a0,164 # ffffffffc0205c10 <default_pmm_manager+0xb10>
ffffffffc0203b74:	801fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203b78:	00001617          	auipc	a2,0x1
ffffffffc0203b7c:	5c060613          	addi	a2,a2,1472 # ffffffffc0205138 <default_pmm_manager+0x38>
ffffffffc0203b80:	06500593          	li	a1,101
ffffffffc0203b84:	00001517          	auipc	a0,0x1
ffffffffc0203b88:	5d450513          	addi	a0,a0,1492 # ffffffffc0205158 <default_pmm_manager+0x58>
ffffffffc0203b8c:	fe8fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203b90:	00002697          	auipc	a3,0x2
ffffffffc0203b94:	23068693          	addi	a3,a3,560 # ffffffffc0205dc0 <default_pmm_manager+0xcc0>
ffffffffc0203b98:	00001617          	auipc	a2,0x1
ffffffffc0203b9c:	1b860613          	addi	a2,a2,440 # ffffffffc0204d50 <commands+0x738>
ffffffffc0203ba0:	14c00593          	li	a1,332
ffffffffc0203ba4:	00002517          	auipc	a0,0x2
ffffffffc0203ba8:	06c50513          	addi	a0,a0,108 # ffffffffc0205c10 <default_pmm_manager+0xb10>
ffffffffc0203bac:	fc8fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203bb0:	00002697          	auipc	a3,0x2
ffffffffc0203bb4:	21068693          	addi	a3,a3,528 # ffffffffc0205dc0 <default_pmm_manager+0xcc0>
ffffffffc0203bb8:	00001617          	auipc	a2,0x1
ffffffffc0203bbc:	19860613          	addi	a2,a2,408 # ffffffffc0204d50 <commands+0x738>
ffffffffc0203bc0:	0d100593          	li	a1,209
ffffffffc0203bc4:	00002517          	auipc	a0,0x2
ffffffffc0203bc8:	04c50513          	addi	a0,a0,76 # ffffffffc0205c10 <default_pmm_manager+0xb10>
ffffffffc0203bcc:	fa8fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc0203bd0:	00002697          	auipc	a3,0x2
ffffffffc0203bd4:	c2868693          	addi	a3,a3,-984 # ffffffffc02057f8 <default_pmm_manager+0x6f8>
ffffffffc0203bd8:	00001617          	auipc	a2,0x1
ffffffffc0203bdc:	17860613          	addi	a2,a2,376 # ffffffffc0204d50 <commands+0x738>
ffffffffc0203be0:	0dc00593          	li	a1,220
ffffffffc0203be4:	00002517          	auipc	a0,0x2
ffffffffc0203be8:	02c50513          	addi	a0,a0,44 # ffffffffc0205c10 <default_pmm_manager+0xb10>
ffffffffc0203bec:	f88fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203bf0:	00002697          	auipc	a3,0x2
ffffffffc0203bf4:	1d068693          	addi	a3,a3,464 # ffffffffc0205dc0 <default_pmm_manager+0xcc0>
ffffffffc0203bf8:	00001617          	auipc	a2,0x1
ffffffffc0203bfc:	15860613          	addi	a2,a2,344 # ffffffffc0204d50 <commands+0x738>
ffffffffc0203c00:	11600593          	li	a1,278
ffffffffc0203c04:	00002517          	auipc	a0,0x2
ffffffffc0203c08:	00c50513          	addi	a0,a0,12 # ffffffffc0205c10 <default_pmm_manager+0xb10>
ffffffffc0203c0c:	f68fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203c10 <do_pgfault>:
...
ffffffffc0203c12:	85b2                	mv	a1,a2
{
ffffffffc0203c14:	f022                	sd	s0,32(sp)
ffffffffc0203c16:	ec26                	sd	s1,24(sp)
ffffffffc0203c18:	f406                	sd	ra,40(sp)
ffffffffc0203c1a:	e84a                	sd	s2,16(sp)
ffffffffc0203c1c:	8432                	mv	s0,a2
ffffffffc0203c1e:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203c20:	8d3ff0ef          	jal	ra,ffffffffc02034f2 <find_vma>

    pgfault_num++;
ffffffffc0203c24:	0000e797          	auipc	a5,0xe
ffffffffc0203c28:	93c7a783          	lw	a5,-1732(a5) # ffffffffc0211560 <pgfault_num>
ffffffffc0203c2c:	2785                	addiw	a5,a5,1
ffffffffc0203c2e:	0000e717          	auipc	a4,0xe
ffffffffc0203c32:	92f72923          	sw	a5,-1742(a4) # ffffffffc0211560 <pgfault_num>
    // If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr)
ffffffffc0203c36:	c549                	beqz	a0,ffffffffc0203cc0 <do_pgfault+0xb0>
ffffffffc0203c38:	651c                	ld	a5,8(a0)
ffffffffc0203c3a:	08f46363          	bltu	s0,a5,ffffffffc0203cc0 <do_pgfault+0xb0>
...
ffffffffc0203c3e:	6d1c                	ld	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203c40:	4941                	li	s2,16
    if (vma->vm_flags & VM_WRITE)
ffffffffc0203c42:	8b89                	andi	a5,a5,2
ffffffffc0203c44:	efa9                	bnez	a5,ffffffffc0203c9e <do_pgfault+0x8e>
    {
        perm |= (PTE_R | PTE_W);
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203c46:	75fd                	lui	a1,0xfffff
     * VARIABLES:
...
ffffffffc0203c48:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203c4a:	8c6d                	and	s0,s0,a1
    ptep = get_pte(mm->pgdir, addr, 1); //(1) try to find a pte, if pte's
ffffffffc0203c4c:	85a2                	mv	a1,s0
ffffffffc0203c4e:	4605                	li	a2,1
ffffffffc0203c50:	a7dfd0ef          	jal	ra,ffffffffc02016cc <get_pte>
                                        // PT(Page Table) isn't existed, then
                                        // create a PT.
    if (*ptep == 0)
ffffffffc0203c54:	610c                	ld	a1,0(a0)
ffffffffc0203c56:	c5b1                	beqz	a1,ffffffffc0203ca2 <do_pgfault+0x92>
         ...
         */
        if (swap_init_ok)
ffffffffc0203c58:	0000e797          	auipc	a5,0xe
ffffffffc0203c5c:	8f87a783          	lw	a5,-1800(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203c60:	cbad                	beqz	a5,ffffffffc0203cd2 <do_pgfault+0xc2>
...
ffffffffc0203c62:	0030                	addi	a2,sp,8
ffffffffc0203c64:	85a2                	mv	a1,s0
ffffffffc0203c66:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0203c68:	e402                	sd	zero,8(sp)
            if (swap_in(mm, addr, &page) != 0)
ffffffffc0203c6a:	c46ff0ef          	jal	ra,ffffffffc02030b0 <swap_in>
ffffffffc0203c6e:	e935                	bnez	a0,ffffffffc0203ce2 <do_pgfault+0xd2>
            {
...
ffffffffc0203c70:	65a2                	ld	a1,8(sp)
ffffffffc0203c72:	6c88                	ld	a0,24(s1)
ffffffffc0203c74:	86ca                	mv	a3,s2
ffffffffc0203c76:	8622                	mv	a2,s0
ffffffffc0203c78:	d3ffd0ef          	jal	ra,ffffffffc02019b6 <page_insert>
ffffffffc0203c7c:	892a                	mv	s2,a0
ffffffffc0203c7e:	e93d                	bnez	a0,ffffffffc0203cf4 <do_pgfault+0xe4>
            {
...
ffffffffc0203c80:	6622                	ld	a2,8(sp)
ffffffffc0203c82:	4685                	li	a3,1
ffffffffc0203c84:	85a2                	mv	a1,s0
ffffffffc0203c86:	8526                	mv	a0,s1
ffffffffc0203c88:	b08ff0ef          	jal	ra,ffffffffc0202f90 <swap_map_swappable>
            page->pra_vaddr = addr;
ffffffffc0203c8c:	67a2                	ld	a5,8(sp)
ffffffffc0203c8e:	e3a0                	sd	s0,64(a5)
    }
...
ffffffffc0203c90:	70a2                	ld	ra,40(sp)
ffffffffc0203c92:	7402                	ld	s0,32(sp)
ffffffffc0203c94:	64e2                	ld	s1,24(sp)
ffffffffc0203c96:	854a                	mv	a0,s2
ffffffffc0203c98:	6942                	ld	s2,16(sp)
ffffffffc0203c9a:	6145                	addi	sp,sp,48
ffffffffc0203c9c:	8082                	ret
        perm |= (PTE_R | PTE_W);
ffffffffc0203c9e:	4959                	li	s2,22
ffffffffc0203ca0:	b75d                	j	ffffffffc0203c46 <do_pgfault+0x36>
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL)
ffffffffc0203ca2:	6c88                	ld	a0,24(s1)
ffffffffc0203ca4:	864a                	mv	a2,s2
ffffffffc0203ca6:	85a2                	mv	a1,s0
ffffffffc0203ca8:	a19fe0ef          	jal	ra,ffffffffc02026c0 <pgdir_alloc_page>
    ret = 0;
ffffffffc0203cac:	4901                	li	s2,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL)
ffffffffc0203cae:	f16d                	bnez	a0,ffffffffc0203c90 <do_pgfault+0x80>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203cb0:	00002517          	auipc	a0,0x2
ffffffffc0203cb4:	20850513          	addi	a0,a0,520 # ffffffffc0205eb8 <default_pmm_manager+0xdb8>
ffffffffc0203cb8:	c02fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203cbc:	5971                	li	s2,-4
            goto failed;
ffffffffc0203cbe:	bfc9                	j	ffffffffc0203c90 <do_pgfault+0x80>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203cc0:	85a2                	mv	a1,s0
ffffffffc0203cc2:	00002517          	auipc	a0,0x2
ffffffffc0203cc6:	1c650513          	addi	a0,a0,454 # ffffffffc0205e88 <default_pmm_manager+0xd88>
ffffffffc0203cca:	bf0fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    int ret = -E_INVAL;
ffffffffc0203cce:	5975                	li	s2,-3
        goto failed;
ffffffffc0203cd0:	b7c1                	j	ffffffffc0203c90 <do_pgfault+0x80>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203cd2:	00002517          	auipc	a0,0x2
ffffffffc0203cd6:	27650513          	addi	a0,a0,630 # ffffffffc0205f48 <default_pmm_manager+0xe48>
ffffffffc0203cda:	be0fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203cde:	5971                	li	s2,-4
            goto failed;
ffffffffc0203ce0:	bf45                	j	ffffffffc0203c90 <do_pgfault+0x80>
                cprintf("Failed to load page from disk for address: %x\n", addr);
ffffffffc0203ce2:	85a2                	mv	a1,s0
ffffffffc0203ce4:	00002517          	auipc	a0,0x2
ffffffffc0203ce8:	1fc50513          	addi	a0,a0,508 # ffffffffc0205ee0 <default_pmm_manager+0xde0>
ffffffffc0203cec:	bcefc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203cf0:	5971                	li	s2,-4
ffffffffc0203cf2:	bf79                	j	ffffffffc0203c90 <do_pgfault+0x80>
                cprintf("Failed to insert page into page table for address: %x\n", addr);
ffffffffc0203cf4:	85a2                	mv	a1,s0
ffffffffc0203cf6:	00002517          	auipc	a0,0x2
ffffffffc0203cfa:	21a50513          	addi	a0,a0,538 # ffffffffc0205f10 <default_pmm_manager+0xe10>
ffffffffc0203cfe:	bbcfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203d02:	5971                	li	s2,-4
ffffffffc0203d04:	b771                	j	ffffffffc0203c90 <do_pgfault+0x80>

ffffffffc0203d06 <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
ffffffffc0203d0a:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc0203d0c:	f88fc0ef          	jal	ra,ffffffffc0200494 <ide_device_valid>
ffffffffc0203d10:	cd01                	beqz	a0,ffffffffc0203d28 <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203d12:	4505                	li	a0,1
ffffffffc0203d14:	f86fc0ef          	jal	ra,ffffffffc020049a <ide_device_size>
}
ffffffffc0203d18:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203d1a:	810d                	srli	a0,a0,0x3
ffffffffc0203d1c:	0000e797          	auipc	a5,0xe
ffffffffc0203d20:	82a7b223          	sd	a0,-2012(a5) # ffffffffc0211540 <max_swap_offset>
}
ffffffffc0203d24:	0141                	addi	sp,sp,16
ffffffffc0203d26:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0203d28:	00002617          	auipc	a2,0x2
ffffffffc0203d2c:	24860613          	addi	a2,a2,584 # ffffffffc0205f70 <default_pmm_manager+0xe70>
ffffffffc0203d30:	45b5                	li	a1,13
ffffffffc0203d32:	00002517          	auipc	a0,0x2
ffffffffc0203d36:	25e50513          	addi	a0,a0,606 # ffffffffc0205f90 <default_pmm_manager+0xe90>
ffffffffc0203d3a:	e3afc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203d3e <swapfs_read>:
...
ffffffffc0203d46:	c3a5                	beqz	a5,ffffffffc0203da6 <swapfs_read+0x68>
ffffffffc0203d48:	0000d717          	auipc	a4,0xd
ffffffffc0203d4c:	7f873703          	ld	a4,2040(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203d50:	04e7fb63          	bgeu	a5,a4,ffffffffc0203da6 <swapfs_read+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203d54:	0000d617          	auipc	a2,0xd
ffffffffc0203d58:	7d463603          	ld	a2,2004(a2) # ffffffffc0211528 <pages>
ffffffffc0203d5c:	8d91                	sub	a1,a1,a2
ffffffffc0203d5e:	4035d613          	srai	a2,a1,0x3
ffffffffc0203d62:	00002597          	auipc	a1,0x2
ffffffffc0203d66:	4ae5b583          	ld	a1,1198(a1) # ffffffffc0206210 <error_string+0x38>
ffffffffc0203d6a:	02b60633          	mul	a2,a2,a1
ffffffffc0203d6e:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203d72:	00002797          	auipc	a5,0x2
ffffffffc0203d76:	4a67b783          	ld	a5,1190(a5) # ffffffffc0206218 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203d7a:	0000d717          	auipc	a4,0xd
ffffffffc0203d7e:	7a673703          	ld	a4,1958(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203d82:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203d84:	00c61793          	slli	a5,a2,0xc
ffffffffc0203d88:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203d8a:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203d8c:	02e7f963          	bgeu	a5,a4,ffffffffc0203dbe <swapfs_read+0x80>
}
ffffffffc0203d90:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203d92:	0000d797          	auipc	a5,0xd
ffffffffc0203d96:	7a67b783          	ld	a5,1958(a5) # ffffffffc0211538 <va_pa_offset>
ffffffffc0203d9a:	46a1                	li	a3,8
ffffffffc0203d9c:	963e                	add	a2,a2,a5
ffffffffc0203d9e:	4505                	li	a0,1
}
ffffffffc0203da0:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203da2:	efefc06f          	j	ffffffffc02004a0 <ide_read_secs>
ffffffffc0203da6:	86aa                	mv	a3,a0
ffffffffc0203da8:	00002617          	auipc	a2,0x2
ffffffffc0203dac:	20060613          	addi	a2,a2,512 # ffffffffc0205fa8 <default_pmm_manager+0xea8>
ffffffffc0203db0:	45d1                	li	a1,20
ffffffffc0203db2:	00002517          	auipc	a0,0x2
ffffffffc0203db6:	1de50513          	addi	a0,a0,478 # ffffffffc0205f90 <default_pmm_manager+0xe90>
ffffffffc0203dba:	dbafc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203dbe:	86b2                	mv	a3,a2
ffffffffc0203dc0:	06a00593          	li	a1,106
ffffffffc0203dc4:	00001617          	auipc	a2,0x1
ffffffffc0203dc8:	3cc60613          	addi	a2,a2,972 # ffffffffc0205190 <default_pmm_manager+0x90>
ffffffffc0203dcc:	00001517          	auipc	a0,0x1
ffffffffc0203dd0:	38c50513          	addi	a0,a0,908 # ffffffffc0205158 <default_pmm_manager+0x58>
ffffffffc0203dd4:	da0fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203dd8 <swapfs_write>:
...
ffffffffc0203de0:	c3a5                	beqz	a5,ffffffffc0203e40 <swapfs_write+0x68>
ffffffffc0203de2:	0000d717          	auipc	a4,0xd
ffffffffc0203de6:	75e73703          	ld	a4,1886(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203dea:	04e7fb63          	bgeu	a5,a4,ffffffffc0203e40 <swapfs_write+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203dee:	0000d617          	auipc	a2,0xd
ffffffffc0203df2:	73a63603          	ld	a2,1850(a2) # ffffffffc0211528 <pages>
ffffffffc0203df6:	8d91                	sub	a1,a1,a2
ffffffffc0203df8:	4035d613          	srai	a2,a1,0x3
ffffffffc0203dfc:	00002597          	auipc	a1,0x2
ffffffffc0203e00:	4145b583          	ld	a1,1044(a1) # ffffffffc0206210 <error_string+0x38>
ffffffffc0203e04:	02b60633          	mul	a2,a2,a1
ffffffffc0203e08:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203e0c:	00002797          	auipc	a5,0x2
ffffffffc0203e10:	40c7b783          	ld	a5,1036(a5) # ffffffffc0206218 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e14:	0000d717          	auipc	a4,0xd
ffffffffc0203e18:	70c73703          	ld	a4,1804(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e26:	02e7f963          	bgeu	a5,a4,ffffffffc0203e58 <swapfs_write+0x80>
}
ffffffffc0203e2a:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e2c:	0000d797          	auipc	a5,0xd
ffffffffc0203e30:	70c7b783          	ld	a5,1804(a5) # ffffffffc0211538 <va_pa_offset>
...
ffffffffc0203e3a:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e3c:	e88fc06f          	j	ffffffffc02004c4 <ide_write_secs>
ffffffffc0203e40:	86aa                	mv	a3,a0
ffffffffc0203e42:	00002617          	auipc	a2,0x2
ffffffffc0203e46:	16660613          	addi	a2,a2,358 # ffffffffc0205fa8 <default_pmm_manager+0xea8>
ffffffffc0203e4a:	45e5                	li	a1,25
ffffffffc0203e4c:	00002517          	auipc	a0,0x2
ffffffffc0203e50:	14450513          	addi	a0,a0,324 # ffffffffc0205f90 <default_pmm_manager+0xe90>
ffffffffc0203e54:	d20fc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203e58:	86b2                	mv	a3,a2
ffffffffc0203e5a:	06a00593          	li	a1,106
ffffffffc0203e5e:	00001617          	auipc	a2,0x1
ffffffffc0203e62:	33260613          	addi	a2,a2,818 # ffffffffc0205190 <default_pmm_manager+0x90>
ffffffffc0203e66:	00001517          	auipc	a0,0x1
ffffffffc0203e6a:	2f250513          	addi	a0,a0,754 # ffffffffc0205158 <default_pmm_manager+0x58>
...
ffffffffc0203eac:	00002797          	auipc	a5,0x2
ffffffffc0203eb0:	11c78793          	addi	a5,a5,284 # ffffffffc0205fc8 <default_pmm_manager+0xec8>
...
ffffffffc0203ee4:	ecce                	sd	s3,88(sp)
ffffffffc0203ee6:	e8d2                	sd	s4,80(sp)
ffffffffc0203ee8:	e4d6                	sd	s5,72(sp)
ffffffffc0203eea:	e0da                	sd	s6,64(sp)
ffffffffc0203eec:	fc5e                	sd	s7,56(sp)
...
ffffffffc0203f00:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0203f02:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203f06:	5b7d                	li	s6,-1
ffffffffc0203f08:	00002a97          	auipc	s5,0x2
ffffffffc0203f0c:	0f4a8a93          	addi	s5,s5,244 # ffffffffc0205ffc <default_pmm_manager+0xefc>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203f10:	00002b97          	auipc	s7,0x2
ffffffffc0203f14:	2c8b8b93          	addi	s7,s7,712 # ffffffffc02061d8 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f18:	000d4503          	lbu	a0,0(s10) # 80000 <kern_entry-0xffffffffc0180000>
ffffffffc0203f1c:	001d0413          	addi	s0,s10,1
ffffffffc0203f20:	01350a63          	beq	a0,s3,ffffffffc0203f34 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0203f24:	c121                	beqz	a0,ffffffffc0203f64 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0203f26:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f28:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0203f2a:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f2c:	fff44503          	lbu	a0,-1(s0)
ffffffffc0203f30:	ff351ae3          	bne	a0,s3,ffffffffc0203f24 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f34:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203f38:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203f3c:	4c81                	li	s9,0
ffffffffc0203f3e:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0203f40:	5c7d                	li	s8,-1
ffffffffc0203f42:	5dfd                	li	s11,-1
ffffffffc0203f44:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0203f48:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f4a:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203f4e:	0ff5f593          	zext.b	a1,a1
ffffffffc0203f52:	00140d13          	addi	s10,s0,1
ffffffffc0203f56:	04b56263          	bltu	a0,a1,ffffffffc0203f9a <vprintfmt+0xbc>
ffffffffc0203f5a:	058a                	slli	a1,a1,0x2
ffffffffc0203f5c:	95d6                	add	a1,a1,s5
ffffffffc0203f5e:	4194                	lw	a3,0(a1)
ffffffffc0203f60:	96d6                	add	a3,a3,s5
ffffffffc0203f62:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0203f64:	70e6                	ld	ra,120(sp)
ffffffffc0203f66:	7446                	ld	s0,112(sp)
ffffffffc0203f68:	74a6                	ld	s1,104(sp)
ffffffffc0203f6a:	7906                	ld	s2,96(sp)
ffffffffc0203f6c:	69e6                	ld	s3,88(sp)
ffffffffc0203f6e:	6a46                	ld	s4,80(sp)
ffffffffc0203f70:	6aa6                	ld	s5,72(sp)
ffffffffc0203f72:	6b06                	ld	s6,64(sp)
ffffffffc0203f74:	7be2                	ld	s7,56(sp)
ffffffffc0203f76:	7c42                	ld	s8,48(sp)
ffffffffc0203f78:	7ca2                	ld	s9,40(sp)
ffffffffc0203f7a:	7d02                	ld	s10,32(sp)
ffffffffc0203f7c:	6de2                	ld	s11,24(sp)
ffffffffc0203f7e:	6109                	addi	sp,sp,128
ffffffffc0203f80:	8082                	ret
            padc = '0';
ffffffffc0203f82:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0203f84:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
...
ffffffffc0203f96:	fcb572e3          	bgeu	a0,a1,ffffffffc0203f5a <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0203f9a:	85a6                	mv	a1,s1
ffffffffc0203f9c:	02500513          	li	a0,37
ffffffffc0203fa0:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0203fa2:	fff44783          	lbu	a5,-1(s0)
ffffffffc0203fa6:	8d22                	mv	s10,s0
ffffffffc0203fa8:	f73788e3          	beq	a5,s3,ffffffffc0203f18 <vprintfmt+0x3a>
ffffffffc0203fac:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0203fb0:	1d7d                	addi	s10,s10,-1
ffffffffc0203fb2:	ff379de3          	bne	a5,s3,ffffffffc0203fac <vprintfmt+0xce>
ffffffffc0203fb6:	b78d                	j	ffffffffc0203f18 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0203fb8:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0203fbc:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fc0:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0203fc2:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0203fc6:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203fca:	02d86463          	bltu	a6,a3,ffffffffc0203ff2 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0203fce:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0203fd2:	002c169b          	slliw	a3,s8,0x2
ffffffffc0203fd6:	0186873b          	addw	a4,a3,s8
ffffffffc0203fda:	0017171b          	slliw	a4,a4,0x1
ffffffffc0203fde:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0203fe0:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0203fe4:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0203fe6:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0203fea:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203fee:	fed870e3          	bgeu	a6,a3,ffffffffc0203fce <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0203ff2:	f40ddce3          	bgez	s11,ffffffffc0203f4a <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0203ff6:	8de2                	mv	s11,s8
ffffffffc0203ff8:	5c7d                	li	s8,-1
ffffffffc0203ffa:	bf81                	j	ffffffffc0203f4a <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0203ffc:	fffdc693          	not	a3,s11
ffffffffc0204000:	96fd                	srai	a3,a3,0x3f
ffffffffc0204002:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204006:	00144603          	lbu	a2,1(s0)
ffffffffc020400a:	2d81                	sext.w	s11,s11
ffffffffc020400c:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020400e:	bf35                	j	ffffffffc0203f4a <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204010:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
...
ffffffffc020401c:	bfd9                	j	ffffffffc0203ff2 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc020401e:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204020:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204024:	01174463          	blt	a4,a7,ffffffffc020402c <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204028:	1a088e63          	beqz	a7,ffffffffc02041e4 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc020402c:	000a3603          	ld	a2,0(s4)
ffffffffc0204030:	46c1                	li	a3,16
ffffffffc0204032:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204034:	2781                	sext.w	a5,a5
ffffffffc0204036:	876e                	mv	a4,s11
ffffffffc0204038:	85a6                	mv	a1,s1
ffffffffc020403a:	854a                	mv	a0,s2
ffffffffc020403c:	e37ff0ef          	jal	ra,ffffffffc0203e72 <printnum>
            break;
ffffffffc0204040:	bde1                	j	ffffffffc0203f18 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204042:	000a2503          	lw	a0,0(s4)
ffffffffc0204046:	85a6                	mv	a1,s1
ffffffffc0204048:	0a21                	addi	s4,s4,8
ffffffffc020404a:	9902                	jalr	s2
            break;
ffffffffc020404c:	b5f1                	j	ffffffffc0203f18 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc020404e:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204050:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204054:	01174463          	blt	a4,a7,ffffffffc020405c <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204058:	18088163          	beqz	a7,ffffffffc02041da <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc020405c:	000a3603          	ld	a2,0(s4)
ffffffffc0204060:	46a9                	li	a3,10
ffffffffc0204062:	8a2e                	mv	s4,a1
ffffffffc0204064:	bfc1                	j	ffffffffc0204034 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204066:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc020406a:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020406c:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020406e:	bdf1                	j	ffffffffc0203f4a <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204070:	85a6                	mv	a1,s1
ffffffffc0204072:	02500513          	li	a0,37
ffffffffc0204076:	9902                	jalr	s2
            break;
ffffffffc0204078:	b545                	j	ffffffffc0203f18 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020407a:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc020407e:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204080:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204082:	b5e1                	j	ffffffffc0203f4a <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204084:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204086:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020408a:	01174463          	blt	a4,a7,ffffffffc0204092 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc020408e:	14088163          	beqz	a7,ffffffffc02041d0 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204092:	000a3603          	ld	a2,0(s4)
ffffffffc0204096:	46a1                	li	a3,8
ffffffffc0204098:	8a2e                	mv	s4,a1
ffffffffc020409a:	bf69                	j	ffffffffc0204034 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc020409c:	03000513          	li	a0,48
ffffffffc02040a0:	85a6                	mv	a1,s1
ffffffffc02040a2:	e03e                	sd	a5,0(sp)
ffffffffc02040a4:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc02040a6:	85a6                	mv	a1,s1
ffffffffc02040a8:	07800513          	li	a0,120
ffffffffc02040ac:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc02040ae:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc02040b0:	6782                	ld	a5,0(sp)
ffffffffc02040b2:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc02040b4:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc02040b8:	bfb5                	j	ffffffffc0204034 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02040ba:	000a3403          	ld	s0,0(s4)
ffffffffc02040be:	008a0713          	addi	a4,s4,8
ffffffffc02040c2:	e03a                	sd	a4,0(sp)
ffffffffc02040c4:	14040263          	beqz	s0,ffffffffc0204208 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc02040c8:	0fb05763          	blez	s11,ffffffffc02041b6 <vprintfmt+0x2d8>
ffffffffc02040cc:	02d00693          	li	a3,45
ffffffffc02040d0:	0cd79163          	bne	a5,a3,ffffffffc0204192 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02040d4:	00044783          	lbu	a5,0(s0)
ffffffffc02040d8:	0007851b          	sext.w	a0,a5
ffffffffc02040dc:	cf85                	beqz	a5,ffffffffc0204114 <vprintfmt+0x236>
ffffffffc02040de:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02040e2:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02040e6:	000c4563          	bltz	s8,ffffffffc02040f0 <vprintfmt+0x212>
ffffffffc02040ea:	3c7d                	addiw	s8,s8,-1
ffffffffc02040ec:	036c0263          	beq	s8,s6,ffffffffc0204110 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc02040f0:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02040f2:	0e0c8e63          	beqz	s9,ffffffffc02041ee <vprintfmt+0x310>
ffffffffc02040f6:	3781                	addiw	a5,a5,-32
ffffffffc02040f8:	0ef47b63          	bgeu	s0,a5,ffffffffc02041ee <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc02040fc:	03f00513          	li	a0,63
ffffffffc0204100:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204102:	000a4783          	lbu	a5,0(s4)
ffffffffc0204106:	3dfd                	addiw	s11,s11,-1
ffffffffc0204108:	0a05                	addi	s4,s4,1
ffffffffc020410a:	0007851b          	sext.w	a0,a5
ffffffffc020410e:	ffe1                	bnez	a5,ffffffffc02040e6 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204110:	01b05963          	blez	s11,ffffffffc0204122 <vprintfmt+0x244>
ffffffffc0204114:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204116:	85a6                	mv	a1,s1
ffffffffc0204118:	02000513          	li	a0,32
ffffffffc020411c:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc020411e:	fe0d9be3          	bnez	s11,ffffffffc0204114 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204122:	6a02                	ld	s4,0(sp)
ffffffffc0204124:	bbd5                	j	ffffffffc0203f18 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204126:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204128:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc020412c:	01174463          	blt	a4,a7,ffffffffc0204134 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204130:	08088d63          	beqz	a7,ffffffffc02041ca <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204134:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204138:	0a044d63          	bltz	s0,ffffffffc02041f2 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc020413c:	8622                	mv	a2,s0
ffffffffc020413e:	8a66                	mv	s4,s9
ffffffffc0204140:	46a9                	li	a3,10
ffffffffc0204142:	bdcd                	j	ffffffffc0204034 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204144:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204148:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc020414a:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc020414c:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204150:	8fb5                	xor	a5,a5,a3
ffffffffc0204152:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204156:	02d74163          	blt	a4,a3,ffffffffc0204178 <vprintfmt+0x29a>
ffffffffc020415a:	00369793          	slli	a5,a3,0x3
ffffffffc020415e:	97de                	add	a5,a5,s7
ffffffffc0204160:	639c                	ld	a5,0(a5)
ffffffffc0204162:	cb99                	beqz	a5,ffffffffc0204178 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204164:	86be                	mv	a3,a5
ffffffffc0204166:	00002617          	auipc	a2,0x2
ffffffffc020416a:	e9260613          	addi	a2,a2,-366 # ffffffffc0205ff8 <default_pmm_manager+0xef8>
ffffffffc020416e:	85a6                	mv	a1,s1
ffffffffc0204170:	854a                	mv	a0,s2
ffffffffc0204172:	0ce000ef          	jal	ra,ffffffffc0204240 <printfmt>
ffffffffc0204176:	b34d                	j	ffffffffc0203f18 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204178:	00002617          	auipc	a2,0x2
ffffffffc020417c:	e7060613          	addi	a2,a2,-400 # ffffffffc0205fe8 <default_pmm_manager+0xee8>
ffffffffc0204180:	85a6                	mv	a1,s1
ffffffffc0204182:	854a                	mv	a0,s2
ffffffffc0204184:	0bc000ef          	jal	ra,ffffffffc0204240 <printfmt>
ffffffffc0204188:	bb41                	j	ffffffffc0203f18 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc020418a:	00002417          	auipc	s0,0x2
ffffffffc020418e:	e5640413          	addi	s0,s0,-426 # ffffffffc0205fe0 <default_pmm_manager+0xee0>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204192:	85e2                	mv	a1,s8
ffffffffc0204194:	8522                	mv	a0,s0
ffffffffc0204196:	e43e                	sd	a5,8(sp)
ffffffffc0204198:	196000ef          	jal	ra,ffffffffc020432e <strnlen>
ffffffffc020419c:	40ad8dbb          	subw	s11,s11,a0
ffffffffc02041a0:	01b05b63          	blez	s11,ffffffffc02041b6 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc02041a4:	67a2                	ld	a5,8(sp)
ffffffffc02041a6:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041aa:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc02041ac:	85a6                	mv	a1,s1
ffffffffc02041ae:	8552                	mv	a0,s4
ffffffffc02041b0:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041b2:	fe0d9ce3          	bnez	s11,ffffffffc02041aa <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02041b6:	00044783          	lbu	a5,0(s0)
ffffffffc02041ba:	00140a13          	addi	s4,s0,1
ffffffffc02041be:	0007851b          	sext.w	a0,a5
ffffffffc02041c2:	d3a5                	beqz	a5,ffffffffc0204122 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02041c4:	05e00413          	li	s0,94
ffffffffc02041c8:	bf39                	j	ffffffffc02040e6 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc02041ca:	000a2403          	lw	s0,0(s4)
ffffffffc02041ce:	b7ad                	j	ffffffffc0204138 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc02041d0:	000a6603          	lwu	a2,0(s4)
ffffffffc02041d4:	46a1                	li	a3,8
ffffffffc02041d6:	8a2e                	mv	s4,a1
ffffffffc02041d8:	bdb1                	j	ffffffffc0204034 <vprintfmt+0x156>
ffffffffc02041da:	000a6603          	lwu	a2,0(s4)
ffffffffc02041de:	46a9                	li	a3,10
ffffffffc02041e0:	8a2e                	mv	s4,a1
ffffffffc02041e2:	bd89                	j	ffffffffc0204034 <vprintfmt+0x156>
ffffffffc02041e4:	000a6603          	lwu	a2,0(s4)
ffffffffc02041e8:	46c1                	li	a3,16
ffffffffc02041ea:	8a2e                	mv	s4,a1
ffffffffc02041ec:	b5a1                	j	ffffffffc0204034 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc02041ee:	9902                	jalr	s2
ffffffffc02041f0:	bf09                	j	ffffffffc0204102 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc02041f2:	85a6                	mv	a1,s1
ffffffffc02041f4:	02d00513          	li	a0,45
ffffffffc02041f8:	e03e                	sd	a5,0(sp)
ffffffffc02041fa:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc02041fc:	6782                	ld	a5,0(sp)
ffffffffc02041fe:	8a66                	mv	s4,s9
ffffffffc0204200:	40800633          	neg	a2,s0
ffffffffc0204204:	46a9                	li	a3,10
ffffffffc0204206:	b53d                	j	ffffffffc0204034 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204208:	03b05163          	blez	s11,ffffffffc020422a <vprintfmt+0x34c>
ffffffffc020420c:	02d00693          	li	a3,45
ffffffffc0204210:	f6d79de3          	bne	a5,a3,ffffffffc020418a <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204214:	00002417          	auipc	s0,0x2
ffffffffc0204218:	dcc40413          	addi	s0,s0,-564 # ffffffffc0205fe0 <default_pmm_manager+0xee0>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020421c:	02800793          	li	a5,40
ffffffffc0204220:	02800513          	li	a0,40
ffffffffc0204224:	00140a13          	addi	s4,s0,1
ffffffffc0204228:	bd6d                	j	ffffffffc02040e2 <vprintfmt+0x204>
ffffffffc020422a:	00002a17          	auipc	s4,0x2
ffffffffc020422e:	db7a0a13          	addi	s4,s4,-585 # ffffffffc0205fe1 <default_pmm_manager+0xee1>
ffffffffc0204232:	02800513          	li	a0,40
ffffffffc0204236:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020423a:	05e00413          	li	s0,94
ffffffffc020423e:	b565                	j	ffffffffc02040e6 <vprintfmt+0x208>

ffffffffc0204240 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204240:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204242:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204246:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204248:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020424a:	ec06                	sd	ra,24(sp)
ffffffffc020424c:	f83a                	sd	a4,48(sp)
ffffffffc020424e:	fc3e                	sd	a5,56(sp)
ffffffffc0204250:	e0c2                	sd	a6,64(sp)
ffffffffc0204252:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204254:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204256:	c89ff0ef          	jal	ra,ffffffffc0203ede <vprintfmt>
}
ffffffffc020425a:	60e2                	ld	ra,24(sp)
ffffffffc020425c:	6161                	addi	sp,sp,80
ffffffffc020425e:	8082                	ret

ffffffffc0204260 <readline>:
...
ffffffffc0204262:	e486                	sd	ra,72(sp)
ffffffffc0204264:	e0a6                	sd	s1,64(sp)
ffffffffc0204266:	fc4a                	sd	s2,56(sp)
ffffffffc0204268:	f84e                	sd	s3,48(sp)
ffffffffc020426a:	f452                	sd	s4,40(sp)
ffffffffc020426c:	f056                	sd	s5,32(sp)
ffffffffc020426e:	ec5a                	sd	s6,24(sp)
ffffffffc0204270:	e85e                	sd	s7,16(sp)
    if (prompt != NULL) {
ffffffffc0204272:	c901                	beqz	a0,ffffffffc0204282 <readline+0x22>
ffffffffc0204274:	85aa                	mv	a1,a0
        cprintf("%s", prompt);
ffffffffc0204276:	00002517          	auipc	a0,0x2
ffffffffc020427a:	d8250513          	addi	a0,a0,-638 # ffffffffc0205ff8 <default_pmm_manager+0xef8>
ffffffffc020427e:	e3dfb0ef          	jal	ra,ffffffffc02000ba <cprintf>
readline(const char *prompt) {
...
ffffffffc0204290:	e6cb8b93          	addi	s7,s7,-404 # ffffffffc02110f8 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204294:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc0204298:	e5bfb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc020429c:	00054a63          	bltz	a0,ffffffffc02042b0 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042a0:	00a95a63          	bge	s2,a0,ffffffffc02042b4 <readline+0x54>
ffffffffc02042a4:	029a5263          	bge	s4,s1,ffffffffc02042c8 <readline+0x68>
        c = getchar();
ffffffffc02042a8:	e4bfb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042ac:	fe055ae3          	bgez	a0,ffffffffc02042a0 <readline+0x40>
            return NULL;
ffffffffc02042b0:	4501                	li	a0,0
ffffffffc02042b2:	a091                	j	ffffffffc02042f6 <readline+0x96>
        else if (c == '\b' && i > 0) {
ffffffffc02042b4:	03351463          	bne	a0,s3,ffffffffc02042dc <readline+0x7c>
ffffffffc02042b8:	e8a9                	bnez	s1,ffffffffc020430a <readline+0xaa>
        c = getchar();
ffffffffc02042ba:	e39fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042be:	fe0549e3          	bltz	a0,ffffffffc02042b0 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042c2:	fea959e3          	bge	s2,a0,ffffffffc02042b4 <readline+0x54>
ffffffffc02042c6:	4481                	li	s1,0
            cputchar(c);
ffffffffc02042c8:	e42a                	sd	a0,8(sp)
ffffffffc02042ca:	e27fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i ++] = c;
ffffffffc02042ce:	6522                	ld	a0,8(sp)
ffffffffc02042d0:	009b87b3          	add	a5,s7,s1
ffffffffc02042d4:	2485                	addiw	s1,s1,1
ffffffffc02042d6:	00a78023          	sb	a0,0(a5)
ffffffffc02042da:	bf7d                	j	ffffffffc0204298 <readline+0x38>
        else if (c == '\n' || c == '\r') {
ffffffffc02042dc:	01550463          	beq	a0,s5,ffffffffc02042e4 <readline+0x84>
ffffffffc02042e0:	fb651ce3          	bne	a0,s6,ffffffffc0204298 <readline+0x38>
            cputchar(c);
ffffffffc02042e4:	e0dfb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i] = '\0';
ffffffffc02042e8:	0000d517          	auipc	a0,0xd
ffffffffc02042ec:	e1050513          	addi	a0,a0,-496 # ffffffffc02110f8 <buf>
ffffffffc02042f0:	94aa                	add	s1,s1,a0
ffffffffc02042f2:	00048023          	sb	zero,0(s1)
            return buf;
        }
    }
}
ffffffffc02042f6:	60a6                	ld	ra,72(sp)
ffffffffc02042f8:	6486                	ld	s1,64(sp)
ffffffffc02042fa:	7962                	ld	s2,56(sp)
ffffffffc02042fc:	79c2                	ld	s3,48(sp)
ffffffffc02042fe:	7a22                	ld	s4,40(sp)
ffffffffc0204300:	7a82                	ld	s5,32(sp)
ffffffffc0204302:	6b62                	ld	s6,24(sp)
ffffffffc0204304:	6bc2                	ld	s7,16(sp)
ffffffffc0204306:	6161                	addi	sp,sp,80
ffffffffc0204308:	8082                	ret
            cputchar(c);
ffffffffc020430a:	4521                	li	a0,8
ffffffffc020430c:	de5fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            i --;
ffffffffc0204310:	34fd                	addiw	s1,s1,-1
ffffffffc0204312:	b759                	j	ffffffffc0204298 <readline+0x38>

ffffffffc0204314 <strlen>:
...
strlen(const char *s) {
ffffffffc0204318:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc020431a:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc020431c:	cb81                	beqz	a5,ffffffffc020432c <strlen+0x18>
        cnt ++;
ffffffffc020431e:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204320:	00a707b3          	add	a5,a4,a0
ffffffffc0204324:	0007c783          	lbu	a5,0(a5)
ffffffffc0204328:	fbfd                	bnez	a5,ffffffffc020431e <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc020432e:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204330:	e589                	bnez	a1,ffffffffc020433a <strnlen+0xc>
ffffffffc0204332:	a811                	j	ffffffffc0204346 <strnlen+0x18>
        cnt ++;
ffffffffc0204334:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204336:	00f58863          	beq	a1,a5,ffffffffc0204346 <strnlen+0x18>
ffffffffc020433a:	00f50733          	add	a4,a0,a5
ffffffffc020433e:	00074703          	lbu	a4,0(a4)
ffffffffc0204342:	fb6d                	bnez	a4,ffffffffc0204334 <strnlen+0x6>
ffffffffc0204344:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204346:	852e                	mv	a0,a1
ffffffffc0204348:	8082                	ret

ffffffffc020434a <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc020434a:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc020434c:	0005c703          	lbu	a4,0(a1)
ffffffffc0204350:	0785                	addi	a5,a5,1
ffffffffc0204352:	0585                	addi	a1,a1,1
ffffffffc0204354:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204358:	fb75                	bnez	a4,ffffffffc020434c <strcpy+0x2>
        /* nothing */;
    return dst;
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020435c:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204360:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204364:	cb89                	beqz	a5,ffffffffc0204376 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204366:	0505                	addi	a0,a0,1
ffffffffc0204368:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020436a:	fee789e3          	beq	a5,a4,ffffffffc020435c <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc020436e:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204372:	9d19                	subw	a0,a0,a4
ffffffffc0204374:	8082                	ret
ffffffffc0204376:	4501                	li	a0,0
ffffffffc0204378:	bfed                	j	ffffffffc0204372 <strcmp+0x16>

ffffffffc020437a <strchr>:
...
strchr(const char *s, char c) {
    while (*s != '\0') {
ffffffffc020437a:	00054783          	lbu	a5,0(a0)
ffffffffc020437e:	c799                	beqz	a5,ffffffffc020438c <strchr+0x12>
        if (*s == c) {
ffffffffc0204380:	00f58763          	beq	a1,a5,ffffffffc020438e <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204384:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204388:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc020438a:	fbfd                	bnez	a5,ffffffffc0204380 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204390:	ca01                	beqz	a2,ffffffffc02043a0 <memset+0x10>
ffffffffc0204392:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204394:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204396:	0785                	addi	a5,a5,1
ffffffffc0204398:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc020439c:	fec79de3          	bne	a5,a2,ffffffffc0204396 <memset+0x6>
    }
    return s;
...
ffffffffc02043a2 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc02043a2:	ca19                	beqz	a2,ffffffffc02043b8 <memcpy+0x16>
ffffffffc02043a4:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc02043a6:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc02043a8:	0005c703          	lbu	a4,0(a1)
ffffffffc02043ac:	0585                	addi	a1,a1,1
ffffffffc02043ae:	0785                	addi	a5,a5,1
ffffffffc02043b0:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc02043b4:	fec59ae3          	bne	a1,a2,ffffffffc02043a8 <memcpy+0x6>
    }
    return dst;
