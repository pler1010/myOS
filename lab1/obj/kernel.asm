...
void print_kerninfo(void) {
    ...
    802000a6:	9a650513          	addi	a0,a0,-1626 # 80200a48 <etext+0x2c>
void print_kerninfo(void) {
    ...
    80200126:	9c650513          	addi	a0,a0,-1594 # 80200ae8 <etext+0xcc>
}
...
void clock_set_next_event(void) { sbi_set_timer(get_cycles() + timebase); }
    ...
    80200146:	075000ef          	jal	ra,802009ba <sbi_set_timer>
}
    ...
    80200158:	9c450513          	addi	a0,a0,-1596 # 80200b18 <etext+0xfc>
}
...
void clock_set_next_event(void) { sbi_set_timer(get_cycles() + timebase); }
    ...
    8020016c:	04f0006f          	j	802009ba <sbi_set_timer>
...
void cons_putc(int c) { sbi_console_putchar((unsigned char)c); }
    ...
    80200176:	02b0006f          	j	802009a0 <sbi_console_putchar>
...
void idt_init(void) {
    ...
    80200188:	37878793          	addi	a5,a5,888 # 802004fc <__alltraps>
...
void print_regs(struct pushregs *gpr) {
    ...
    8020019e:	99e50513          	addi	a0,a0,-1634 # 80200b38 <etext+0x11c>
void print_regs(struct pushregs *gpr) {
    ...
    80200356:	ace50513          	addi	a0,a0,-1330 # 80200e20 <etext+0x404>
}
...
void print_trapframe(struct trapframe *tf) {
    ...
    8020036a:	ad250513          	addi	a0,a0,-1326 # 80200e38 <etext+0x41c>
void print_trapframe(struct trapframe *tf) {
    ...
    802003b6:	ae650513          	addi	a0,a0,-1306 # 80200e98 <etext+0x47c>
}
...
void interrupt_handler(struct trapframe *tf) {
    ...
    802003d0:	b9470713          	addi	a4,a4,-1132 # 80200f60 <etext+0x544>
    ...
    802003e2:	b3250513          	addi	a0,a0,-1230 # 80200f10 <etext+0x4f4>
    802003e6:	b151                	j	8020006a <cprintf>
            cprintf("Hypervisor software interrupt\n");
    802003e8:	00001517          	auipc	a0,0x1
    802003ec:	b0850513          	addi	a0,a0,-1272 # 80200ef0 <etext+0x4d4>
    802003f0:	b9ad                	j	8020006a <cprintf>
            cprintf("User software interrupt\n");
    802003f2:	00001517          	auipc	a0,0x1
    802003f6:	abe50513          	addi	a0,a0,-1346 # 80200eb0 <etext+0x494>
    802003fa:	b985                	j	8020006a <cprintf>
            cprintf("Supervisor software interrupt\n");
    802003fc:	00001517          	auipc	a0,0x1
    80200400:	ad450513          	addi	a0,a0,-1324 # 80200ed0 <etext+0x4b4>
...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200432:	b1250513          	addi	a0,a0,-1262 # 80200f40 <etext+0x524>
    ...
    80200442:	af250513          	addi	a0,a0,-1294 # 80200f30 <etext+0x514>
    ...
    80200462:	0141                	addi	sp,sp,16
                sbi_shutdown();
    80200464:	ab85                	j	802009d4 <sbi_shutdown>
...
void exception_handler(struct trapframe *tf) {
    ...
    switch (tf->cause) {
    80200470:	470d                	li	a4,3
void exception_handler(struct trapframe *tf) {
    80200472:	842a                	mv	s0,a0
    switch (tf->cause) {
    80200474:	04e78663          	beq	a5,a4,802004c0 <exception_handler+0x5a>
    80200478:	02f76c63          	bltu	a4,a5,802004b0 <exception_handler+0x4a>
    8020047c:	4709                	li	a4,2
    8020047e:	02e79563          	bne	a5,a4,802004a8 <exception_handler+0x42>
    ...
    80200482:	00001517          	auipc	a0,0x1
    80200486:	b0e50513          	addi	a0,a0,-1266 # 80200f90 <etext+0x574>
    8020048a:	be1ff0ef          	jal	ra,8020006a <cprintf>
            cprintf("Illegal instruction caught at 0x%x\n",tf->epc);
    8020048e:	10843583          	ld	a1,264(s0)
    80200492:	00001517          	auipc	a0,0x1
    80200496:	b2650513          	addi	a0,a0,-1242 # 80200fb8 <etext+0x59c>
    8020049a:	bd1ff0ef          	jal	ra,8020006a <cprintf>
            tf->epc+=4;
    8020049e:	10843783          	ld	a5,264(s0)
    802004a2:	0791                	addi	a5,a5,4
    ...
    802004b4:	fef77ae3          	bgeu	a4,a5,802004a8 <exception_handler+0x42>
}
    ...
    802004c4:	b2050513          	addi	a0,a0,-1248 # 80200fe0 <etext+0x5c4>
    802004c8:	ba3ff0ef          	jal	ra,8020006a <cprintf>
            cprintf("ebreak caught at 0x%u\n",tf->epc);
    802004cc:	10843583          	ld	a1,264(s0)
    802004d0:	00001517          	auipc	a0,0x1
    802004d4:	b3050513          	addi	a0,a0,-1232 # 80201000 <etext+0x5e4>
    ...
    802004e0:	60a2                	ld	ra,8(sp)
            tf->epc+=4;
    802004e2:	0791                	addi	a5,a5,4
    802004e4:	10f43423          	sd	a5,264(s0)
}
    802004e8:	6402                	ld	s0,0(sp)
    802004ea:	0141                	addi	sp,sp,16
    802004ec:	8082                	ret

00000000802004ee <trap>:

/* trap_dispatch - dispatch based on what type of trap occurred */
static inline void trap_dispatch(struct trapframe *tf) {
    if ((intptr_t)tf->cause < 0) {
    802004ee:	11853783          	ld	a5,280(a0)
    802004f2:	0007c363          	bltz	a5,802004f8 <trap+0xa>
        // interrupts
        interrupt_handler(tf);
    } else {
        // exceptions
        exception_handler(tf);
    802004f6:	bf85                	j	80200466 <exception_handler>
        interrupt_handler(tf);
    802004f8:	b5d9                	j	802003be <interrupt_handler>
	...
...
__alltraps:
    ...
    jal trap
    80200560:	f8fff0ef          	jal	ra,802004ee <trap>
